<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Not_At_All_Prom_Prod.aspx.cs"
    Inherits="MasterFiles_AnalysisReports_rpt_Not_At_All_Prom_Prod" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showMissedDR(sSf_code, div_code, mode) {
            ...
            popUpObj = window.open("rpt_Not_At_All_Prom_Prod_Zoom.aspx?sSf_code=" + sSf_code + "&div_code=" + div_code + "&mode=" + mode,
            "_blank",
    "ModalPopUp," +
    "0" //+
    //"toolbar=no," +
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <asp:Panel ID="pnlContents" runat="server">
                            ...
                            <%--    <table style="border: 1px; border-color: Black;border-width:thick; width:300px">
                        <tr>
                            <th colspan="8">
                                Listeddr Range & Colour
                            </th>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <div style="background-color: #ff6666; padding: 10px; border: 1px solid black;">
                                </div>
                            </td>
                            <td>
                                50 - 150
                            ...
                            <td>
                                <div style="background-color: #ff3232; padding: 10px; border: 1px solid black;">
                                </div>
                            </td>
                            <td>
                                200 - 500
                            ...
                            <td>
                                <div style="background-color: #ff0000; padding: 10px; border: 1px solid black;">
                                </div>
                            </td>
                            <td>
                                1000 - 2000
                        ...
                        <tr>
                            <td>
                                <div style="background-color: #ff9999; padding: 10px; border: 1px solid black;">
                                </div>
                            </td>
                            <td>
                                0 - 50
                            ...
                            <td>
                                <div style="background-color: #ff4c4c; padding: 10px; border: 1px solid black;">
                                </div>
                            </td>
                            <td>
                                150 - 200
                            ...
                            <td>
                                <div style="background-color: #ff1919; padding: 10px; border: 1px solid black;">
                                </div>
                            </td>
                            <td>
                                500 - 1000
                            ...
                            <td>
                                <div style="background-color: #cc0000; padding: 10px; border: 1px solid black;">
                                </div>
                            </td>
                            <td>
                                > 2000

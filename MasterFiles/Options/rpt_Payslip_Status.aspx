<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Payslip_Status.aspx.cs"
    Inherits="MasterFiles_ActivityReports_rpt_Payslip_Status" %>
                                ...
                                <div class="table-responsive" style="scrollbar-width: thin; max-height: 700px;">
                                    <asp:GridView ID="grdSalesForce" runat="server" AlternatingRowStyle-CssClass="alt"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Uploaded" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpay" runat="server" Text='<%# Bind("Avail_Pay") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

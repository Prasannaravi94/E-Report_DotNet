<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptExp_Consolidated_View_Multiple.aspx.cs" Inherits="MasterFiles_AnalysisReports_rptExp_Consolidated_View_Multiple" %>
                        ...
                        <div class="col-lg-11">
                            <table width="100%" align="center">
                                <tbody>
                                    <tr>
                                        <td align="center">
                                            <asp:Label ID="lblHead" runat="server" Text="Consolidated View from " CssClass="reportheader"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <asp:Label ID="LblForceName" Font-Size="14px" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>

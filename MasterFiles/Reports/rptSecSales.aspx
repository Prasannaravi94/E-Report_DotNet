                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnPrint" runat="server" Visible="false" Text="Print" Font-Names="Verdana"
                                            Font-Size="10px" BorderColor="#168fa2" ForeColor="White" BackColor="#168fa2"
                                            BorderStyle="Solid" BorderWidth="1" Height="25px" Width="60px" />
                                    </td>
                                    <td>
                                        <asp:Button ID="btnExcel" runat="server" Text="Excel" Font-Names="Verdana" Font-Size="10px"
                                            BorderColor="#168fa2" BorderStyle="Solid" ForeColor="White" BackColor="#168fa2"
                                            BorderWidth="1" Height="25px" Width="60px" OnClick="btnExcel_Click" />
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:Button ID="btnClose" runat="server" Text="Close" Font-Names="Verdana" Font-Size="10px"
                                            BorderColor="#168fa2" ForeColor="White" BackColor="#168fa2" BorderStyle="Solid"
                                            BorderWidth="1" Height="25px" Width="60px" OnClientClick="RefreshParent();" />
                                    </td>
                                </tr>
                            </table>
                        </td>

...
public partial class MasterFiles_MR_ListedDoctor_rptService_Product_Doctorwise_DetailCRM : System.Web.UI.Page
{
    #region
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Prd_Code = Request.QueryString["Prd_Code"].ToString();
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblHead.Text = "Doctorwise Product Service Detail " + strFrmMonth + " " + Year;
    ...
    private void FillReport_1()
    {
        ...
        if (sf_code.Contains("MGR"))
        {
            ...
            sProc_Name = "SP_Get_Doctorwise_Product_Detail_CRM";
            ...
            cmd.Parameters.AddWithValue("@Prd_Det_Code", Prd_Code);
            ...
            GrdFixation.FooterRow.Cells[0].ColumnSpan = 9;
            ...
            if (Prd_Code == "0")
            {
                GrdFixation.FooterRow.Cells.RemoveAt(7);
                GrdFixation.FooterRow.Cells.RemoveAt(8);
                GrdFixation.FooterRow.Cells.RemoveAt(9);
                GrdFixation.FooterRow.Cells.RemoveAt(10);
        ...
        else
        {
            ...
            //decimal total = dsts.Tables[0].AsEnumerable().Sum(row => row.Field<decimal>("Price"));
            ...
            else
            {
                ...
                //GrdFixation.FooterRow.Cells.RemoveAt(1);
                //GrdFixation.FooterRow.Cells.RemoveAt(2);
            }
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            if (Prd_Code != "0")
            {
                AddMergedCells(objgridviewrow, objtablecell, 0, "Total Product Name", "#0097AC", true);
                AddMergedCells(objgridviewrow, objtablecell, 0, "Product Total", "#0097AC", true);
                AddMergedCells(objgridviewrow, objtablecell, 0, "Service Product Name", "#0097AC", true);
                AddMergedCells(objgridviewrow, objtablecell, 0, "Service Product Total", "#0097AC", true);
            }
            else
            {
    ...
    protected void gvMyDayPlan_OnDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        //        {
        //            GridViewRow previousRow = gvProduct.Rows[e.Row.RowIndex - 1];
        //            previousRow.Cells[12].Text = previousRow.Cells[12].Text.Replace(",", "<br/>");
        //        }
        //    }
        //}

...
<link type="text/css" href="../../css/Report.css" rel="Stylesheet" />
        ...
        <table>
            <tr>
                <td align="center" style="color:#8A2EE6;font-family:Verdana;font-weight:bold;text-transform: capitalize; font-size: 14px;
                                        text-align: center;">
                    <asp:Label ID="lblHead" runat="server" Text="Doctor Business View" Font-Underline="True"
    ...
    <center>
        <table>
            ...
            <center>
                    <asp:Button ID="CmdView" runat="server" Text="View" Width="60px" Height="25px" CssClass="savebutton" OnClick="CmdView_Click" />
                </center>

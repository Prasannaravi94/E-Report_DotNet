<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Chmst_UnLstDr_Report.aspx.cs" Inherits="MIS_Reports_Visit_Details_Basedonfield_Level1" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, SfName, Months, Year, fmon, fyr, cmode, Type) {
            popUpObj = window.open("Visit_Details_Chmst_UnLstDr_Zoom_Report.aspx?sfcode=" + sfcode + "&SfName=" + SfName + "&Months=" + Months + "&Year=" + Year + "&FMonth=" + fmon + "&FYear=" + fyr + "&cMode=" + cmode + "&Type=" + Type,
            "_blank",
        "ModalPopUp_Level1," +
         "0" //+
        //"toolbar=no," +
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp1(sfcode, SfName, Months, Year, fmon, fyr, cmode, Type) {
            popUpObj = window.open("Visit_Details_Chmst_UnLstDr_StZoom_Report.aspx?sfcode=" + sfcode + "&SfName=" + SfName + "&Months=" + Months + "&Year=" + Year + "&FMonth=" + fmon + "&FYear=" + fyr + "&cMode=" + cmode + "&Type=" + Type,
           "_blank",
       "ModalPopUp_Level1," +
        "0" //+
       //"toolbar=no," +
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp2(sfcode, SfName, Months, Year, fmon, fyr, cmode, Type) {
            popUpObj = window.open("Visit_Details_Chmst_UnLstDr_Zoom_UnListDrs_Report.aspx?sfcode=" + sfcode + "&SfName=" + SfName + "&Months=" + Months + "&Year=" + Year + "&FMonth=" + fmon + "&FYear=" + fyr + "&cMode=" + cmode + "&Type=" + Type,
           "_blank",
       "ModalPopUp_Level1," +
        "0"// +
       //"toolbar=no," +

...
public partial class MasterFiles_AnalysisReports_rpt_Campaign_View_FF : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Campaign Drs - View For " + sfname + "  - For The Month Of  : " + strFMonthName + " " + FYear + " To " + strTMonthName + " " + " " + TYear;
    ...
    private void FillSample_Prd()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("Campaign_DR_View", con);
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 0, "Level 1 HQ", "#F1F5F8", true);
            AddMergedCells(objgridviewrow, objtablecell, 0, "Level 2 HQ", "#F1F5F8", true);
            AddMergedCells(objgridviewrow, objtablecell, 0, "SVL No", "#F1F5F8", true);
            AddMergedCells(objgridviewrow, objtablecell, 0, "Listed Doctor Name", "#F1F5F8", true);
    ...
    protected void GrdFixation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            int iDateList;
            for (int i = 15, j = 0; i < e.Row.Cells.Count; i++)
            {

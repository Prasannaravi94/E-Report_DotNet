<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDoctorService_CRM.aspx.cs"
    Inherits="MasterFiles_MR_ListedDoctor_rptDoctorService_CRM" %>
   ...
   <%-- <script type="text/javascript">
        function validateDec(key) {
            ...
            else 
            {
                ...
                var parts = key.srcElement.value.length;
                if (parts >0 && key.keyCode == 45)
                    return false;
        ...
        <center>
            ...
            <center>
                <asp:Panel ID="pnlContents" runat="server">
                    <div align="center">
                        <asp:Label ID="lblHead" runat="server" Text="Doctor Service CRM Report" Font-Underline="True"

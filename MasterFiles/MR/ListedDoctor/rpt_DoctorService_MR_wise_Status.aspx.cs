...
public partial class MasterFiles_MR_ListedDoctor_rpt_DoctorService_MR_wise_Status : System.Web.UI.Page
{
    ...
    private void FillReport_1()
    {
        ...
        {
            //SP_Get_DoctorService_MR_wise_Status_Rpt

            sProc_Name = "SP_Get_DoctorService_MR_DoctorChemist_Rpt";
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            else if (ModeType == "2")
            {
                ...
                AddMergedCells(objgridviewrow, objtablecell, 0, "Chemists HQ", "#0097AC", true);
            }

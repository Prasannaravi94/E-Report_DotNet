        ...
        success: function (_0x1783x18) {
            ...
            if (dataTableSt['length'] > 0) {
                ...
                if (_0x1783x31['length'] - 2 > 0) {
                    var _0x1783x32 = '<table id="tblHQSale" class="table" style="min-width:95%;max-width:100%;background-color:white;">';
                    _0x1783x32 += '<tr>';
                    _0x1783x32 += '<th rowspan="3" >#</th>';
                    _0x1783x32 += '<th rowspan="3" >Product Name</th>';
                    _0x1783x32 += '<th rowspan="3" >Product ERP Code</th>';
                    _0x1783x32 += '<th rowspan="3" >Pack</th>';
                    ...
                    _0x1783x32 += '<tr>';
                    for (var _0x1783x17 = 0; _0x1783x17 < ArrHQDet['length']; _0x1783x17++) {
                        _0x1783x32 += '<th colspan='+(ArrMonth['length']-1)+' >Qty</th>';
                        _0x1783x32 += '<th>Total Value</th>';
                    };
                    _0x1783x32 += '<th rowspan="2">Sale Qty</th>';
                    _0x1783x32 += '<th rowspan="2">Sale Value</th>';
                    _0x1783x32 += '</tr>';
                    
                    _0x1783x32 += '<tr>';
                    for (var _0x1783x17 = 0; _0x1783x17 < ArrHQDet['length']; _0x1783x17++) {
                        for (var _0x1783x34 = 0; _0x1783x34 < ArrMonth['length']; _0x1783x34++) {
                            _0x1783x32 += '<th style="background-color:#f1f5f8 !important;color:#636d73;font-size: 14px;">' + ArrMonth[_0x1783x34] + '</th>'
                        }
                    };
                    ...
                    for (var _0x1783x17 = 2; _0x1783x17 < _0x1783x31['length']; _0x1783x17++) {
                        ...
                        for (var _0x1783x23 = 0; _0x1783x23 < _0x1783x31[_0x1783x17]['length']; _0x1783x23++) {
                            ...
                            console.log(_0x1783x31[_0x1783x17][_0x1783x23]);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Audit_Team_Selection_New.aspx.cs" Inherits="MasterFiles_Audit_Team_Selection_New" %>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:UpdatePanel ID="Upl" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div id="divPrc" runat="server" class="ProcessMsg modalDialog rmv-Process">
                                                <div class="center">
                                                    <a class="txtMsg">Selecting Subordinate.Please Wait....</a>
                                                    <br />
                                                    <progress></progress>
                                                </div>
                                            </div>

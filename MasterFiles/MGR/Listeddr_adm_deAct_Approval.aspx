...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <center>
            <asp:Button ID="btnApprove" runat="server" CssClass="savebutton buttons" Text="Approve - Deactivate Lst.Drs" OnClick="btnApprove_Click" Visible="false" />&nbsp;
            <asp:Button ID="btnReject" runat="server" CssClass="savebutton buttons1" Text="Reject - Add Lst.Drs" OnClick="btnReject_Click" Visible="false" />
        </center>
    </form>

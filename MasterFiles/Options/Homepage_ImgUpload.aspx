                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="designation-area clearfix">
                            <div class="single-des clearfix">
                             ...
                             <div class="single-des clearfix">
                                 <asp:Label ID="lblDes" runat="server" CssClass="label" Text="Designation"></asp:Label>
                                 <asp:CheckBox ID="ChkAll" runat="server" Text=" All"  />
             
                             <asp:CheckBoxList ID="chkDesig" DataTextField="Designation_Short_Name" CssClass="chkboxLocation"
                            DataValueField="Designation_Code" runat="server" RepeatDirection="Vertical" RepeatColumns="5"

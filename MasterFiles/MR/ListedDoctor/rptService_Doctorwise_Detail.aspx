<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptService_Doctorwise_Detail.aspx.cs"
    Inherits="MasterFiles_MR_ListedDoctor_rptService_Doctorwise_Detail" %>
                                            ...
                                            <table width="100%">
                                                <caption>
                                                    <asp:GridView ID="GrdFixation" runat="server" AlternatingRowStyle-CssClass="alt"
                                                       ...
                                                       ShowFooter="true" OnRowDataBound="gvDoctor_OnDataBound">

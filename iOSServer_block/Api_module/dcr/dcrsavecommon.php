...
function dcrsavecommon( $data, $ARCd ) {
    ...
    if ( $data[ 'CusType' ] == "2" || $data[ 'CusType' ] == "3" ) {
        ...
        $details = cshdcr( $ARCd, $Prods, $ProdsNm, $Inps, $InpsNm, $JWWrk, $JWWrkNm, $GC, $GN, $GQ, $StockNm, $data, $data[ 'vstTime' ] );
    }
    if ( $data[ 'CusType' ] == "4" ) {
    ...
    if ( isset( $data[ "AdCuss" ] ) && count( $data[ "AdCuss" ] ) > 0 ) {
        ...
        adcuss( $result[ 'ACD' ], $result[ 'ADCD' ], $Prods, $ProdsNm, $Inps, $InpsNm, $JWWrk, $JWWrkNm, $GC, $GN, $GQ, $StockNm, $data );
    }
    if ( isset( $data[ "Products" ] ) && count( $data[ 'Products' ] ) > 0 ) {

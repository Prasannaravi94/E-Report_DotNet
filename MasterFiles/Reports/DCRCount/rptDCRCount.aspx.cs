...
public partial class Reports_DCRCount_rptDCRCount : System.Web.UI.Page
{
    ...
    private void FillSF()
    {
        ...
        if (StrVacant == 0)
        {
            ...
            {
                dsSalesForce = sf.sp_UserListMr_FieldForce(sf_code, div_code, Month, Year,StrVacant.ToString()); // 28-Aug-15 -Sridevi                
                dsSalesCurrent = sf.sp_Get_DCRCount_Current_Pending_date_Count(sf_code, div_code, Convert.ToString(Month), Year,StrVacant.ToString()); // 28-Aug-15 -Sridevi 
            }
            else
            {

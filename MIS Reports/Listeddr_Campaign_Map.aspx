<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listeddr_Campaign_Map.aspx.cs" Inherits="MIS_Reports_Listeddr_Campaign_Map" %>
...
<head id="Head1" runat="server">
    ...
    <title id="Title1" runat="server">Doctor - Campaign Map Details</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <asp:Panel ID="pnlContents" runat="server" Width="99%">
                            <div align="center">
                                <asp:Label ID="lblHead" runat="server" Text="Doctor - Campaign Map Details" CssClass="reportheader"></asp:Label>
                                <br />
                                <br />
                            ...
                            <div class="display-reporttable clearfix">
                                <div class="table-responsive" style="max-height: 700px; scrollbar-width: thin;">
                                    <table width="100%" align="center">
                                        <tr>
                                            <td align="center">
                                                <asp:GridView ID="grdDoctor" runat="server" Width="100%"  GridLines="None"

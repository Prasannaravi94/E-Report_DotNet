<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard_Effort_Analysis_CatSpecVst_Dashboard.aspx.cs" Inherits="MasterFiles_Dashboard_Effort_Analysis_CatSpecVst_Dashboard"
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upAdmDashboard" runat="server">
            <ContentTemplate>
                ...
                <div id="main" class="container" style="margin-top: 12px;height:200px;">
                    <div class="row">
                        <div class="col-sm-12" >
                                    ...
                                    <div class="row">
                                        <div class="container-fluid">
                                            <div class="table-responsive">
                                                <iframe id="ifmReviewRep" runat="server" style="border: 0px none; height: 600.9px;width:1280px;"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>

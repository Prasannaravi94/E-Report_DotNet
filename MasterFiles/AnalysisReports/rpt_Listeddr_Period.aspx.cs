...
public partial class MasterFiles_AnalysisReports_rpt_Listeddr_Period : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["sf_code"].ToString() != "")
        {
            ...
            lblHead.Text = "Listed Doctor Visit - Periodically for the month of  " + strFrmMonth + " " + FYear + "  To  " + strToMonth + " " + TYear;
            LblForceName.Text = "Field Force Name : " + strFieledForceName;
            screen_name = "rpt_Listeddr_Period";
            if (!Page.IsPostBack)
            {
                FillReport();
            }
        }
        lblHead.Text = "Listed Doctor Category/Speciality Wise  ";
    }
    ...
    private void FillReport()
    {
        ...
        sProc_Name = "Listeddr_Period_Vst";

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_NotLogin_Datewise.aspx.cs"
    Inherits="MasterFiles_ActivityReports_rpt_NotLogin_Datewise" %>
                ...
                <div class="row justify-center">
                    <div class="col-lg-12">
                        ...
                        <div style="margin-left: 40px">
                            <asp:Label ID="lbllog" runat="server" Font-Bold="true" CssClass="label"><span style="color:Red">*</span> Yellow Color Indicates, Whoever Not Login in between Selected Dates</asp:Label>
                        </div>
                        <div class="designation-reactivation-table-area clearfix">
                            <br />
                            <div class="display-table clearfix">
                                <div class="table-responsive" style="scrollbar-width: thin;overflow:inherit">
                                    <asp:GridView ID="grdSalesForce" runat="server" AlternatingRowStyle-CssClass="alt" style="background-color:white"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="First Level Manager" HeaderStyle-Width="250px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblrep" runat="server" Text='<%# Bind("Reporting_Manager1") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Second Level Manager" HeaderStyle-Width="250px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblrep1" runat="server" Text='<%# Bind("Reporting_To_SF_2") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Last Login Date" HeaderStyle-Width="150px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbldate" runat="server" Width="150" Text='<%# Bind("lastdate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Duration of WO <br/> Login Days" HeaderStyle-Width="120px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbldays" runat="server" Width="100" Text='<%# Bind("No_of_Days") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>

...
public partial class MIS_Reports_sampleDatewise_Report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Sample Despatch View for  " + FDate + " " + "To"  + " " + TDate;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.SalesForceListMgrGet(divcode, sfCode);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            tc_DR_Des.BorderColor = System.Drawing.Color.FromName("#DCE2E8");
            ...
            FDate = Request.QueryString["FDate"].ToString();
            TDate = Request.QueryString["TDate"].ToString();
            DateTime parsedFDate = DateTime.Parse(FDate);
            DateTime parsedTDate = DateTime.Parse(TDate);
            ...
            months = (Convert.ToInt32(TTYear) - Convert.ToInt32(FFYear)) * 12 + Convert.ToInt32(TTMonth) - Convert.ToInt32(FFMonth); //(Date2.Year - Date1.Year) * 12 + Date2.Month - Date1.Month;
            cmonth = Convert.ToInt32(FFMonth);
            cyear = Convert.ToInt32(FFYear);
            ...
            tr_header2.BackColor = System.Drawing.Color.FromName("#DCE2E8");
            tr_header2.Style.Add("Class", "rptCellBorder");
           
                    TableCell tc_monthAck = new TableCell();
                    //tc_monthAck.ColumnSpan = 1;
                    Literal lit_monthAck = new Literal();
                    lit_monthAck.Text = "Despatched";
                    //tc_monthAck.BorderColor = System.Drawing.Color.FromName("#DCE2E8");
                    tc_monthAck.Attributes.Add("Class", "rptCellBorder");
                    //tc_monthAck.BorderStyle = BorderStyle.Solid;
                    //tc_monthAck.BorderWidth = 1;
                    tc_monthAck.HorizontalAlign = HorizontalAlign.Center;
                    //tc_month.Width = 200;
                    tc_monthAck.Controls.Add(lit_monthAck);
                    tr_header2.Cells.Add(tc_monthAck);

                    TableCell tc_monthdes = new TableCell();
                    //tc_monthdes.ColumnSpan = 1;
                    Literal lit_monthdes = new Literal();
                    lit_monthdes.Text = "Acknowledged";
                    tc_monthdes.Attributes.Add("Class", "rptCellBorder");
                    //tc_monthdes.BorderColor = System.Drawing.Color.FromName("#DCE2E8");
                    //tc_monthdes.BorderStyle = BorderStyle.Solid;
                    //tc_monthdes.BorderWidth = 1;
                    tc_monthdes.HorizontalAlign = HorizontalAlign.Center;
                    //tc_month.Width = 200;
                    tc_monthdes.Controls.Add(lit_monthdes);
                    tr_header2.Cells.Add(tc_monthdes);
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                tc_det_Designation.BorderColor = System.Drawing.Color.FromName("#DCE2E8");
                ...
                tr_det.Cells.Add(tc_det_Designation);
                        ...
                        dsDoc = sf.despatch_quantity_MrDateWise(drFF["sf_code"].ToString(), divcode, FromDate, ToDate);
                        ...
                        if (tot_dr != "")
                        {
                            hyp_lst_month.Text = tot_dr1;
                            //iTotLstCount +=Convert.ToInt16( tot_dr);

                            hyp_lst_month.Attributes.Add("href", "javascript:showModalPopUp('" + drFF["sf_code"].ToString() + "', '" + drFF["sf_name"] + "','" + FromDate + "','" + ToDate + "')");

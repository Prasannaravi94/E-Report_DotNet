<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="Mail_Head.aspx.cs" Inherits="MasterFiles_Mails_Mail_Head"
...
<head runat="server">
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(TransSlNo) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("Mail_Status_View1.aspx?&TransSlNo=" + TransSlNo,
                "_blank",
                "ModalPopUp",
                "toolbar=no," +
                "scrollbars=yes," +
        ...
        <div class="container-fluid">
            ...
            <ContentTemplate>
                <asp:Panel ID="pnlpopup" runat="server" BackColor="AliceBlue" MinWidth="700px" Width="70%"
                    Style="left: 19%; top: 10%; position: fixed;z-index:9999" BorderStyle="Solid" BorderWidth="1">
                    <div>
            ...
            <asp:Panel ID="pnlViewMailInbox" BorderStyle="Solid" BorderWidth="1" BorderColor="#41cac0" runat="server" Style="background: none repeat scroll 0 0 #41cac0;">
                ...
                <div style="background-color: White; padding: 1% 2% 3% 2%; min-height: 350px; height: auto; max-height: 95%;">
                    <span style="white-space: pre-line;">
                        ...
                        <table id="divInboxList" runat="server" width="100%">
                            <tr>
                                <td>
                                    <asp:GridView ID="gvInbox" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvInbox_RowDataBound"
                                        ...
                                        CssClass="table table-inbox table-hover" HeaderStyle-HorizontalAlign="Left"
                                    ...
                                    <td>
                                        <asp:GridView ID="grdSent" runat="server" AutoGenerateColumns="False" OnRowDataBound="grdSent_RowDataBound"
                                            ...
                                            <Columns>
                                              ...
                                              <asp:TemplateField HeaderImageUrl="~/Images/Attachment.gif" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:ImageButton runat="server" ID="lbl2" ImageUrl="~/Images/Attachment.gif" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                   <asp:TemplateField ItemStyle-HorizontalAlign="Left"
                                                    HeaderText="View Detail" HeaderStyle-Width="17%" ItemStyle-Width="17%" ItemStyle-CssClass="print"
                                                    SortExpression="Details" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="imgAttach2" Text="" runat="server"/>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>

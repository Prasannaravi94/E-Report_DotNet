<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inputdesDatewiseZoom.aspx.cs" Inherits="MIS_Reports_inputdesDatewiseZoom" %>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="80%" align="center">
                        <asp:Label ID="lblProd" runat="server" Text="Input Despatch View" CssClass="reportheader"></asp:Label>
                    </td>
                    <td align="right">
                        <table>
                            <tr>

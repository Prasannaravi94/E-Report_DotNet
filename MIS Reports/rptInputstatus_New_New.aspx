<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptInputstatus_New_New.aspx.cs" Inherits="MIS_Reports_rptInputstatus_New_New" %>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                   <%-- <asp:LinkButton ID="linkDetail" Text="Detail View" runat="server" ForeColor="#6B8E23" CssClass="blink_me"
                                    ...
                                    <asp:Button ID="btnDetail" Text="Detail View" runat="server" ForeColor="#6B8E23" CssClass="blink_me"
                                        Font-Bold="true" Font-Size="14px" OnClick="btnDetail_Click"></asp:Button>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <asp:GridView ID="grdDespatch" runat="server" AlternatingRowStyle-CssClass="alt"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Input Name" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblGift_Name" runat="server" Text='<%#Eval("Gift_Name")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

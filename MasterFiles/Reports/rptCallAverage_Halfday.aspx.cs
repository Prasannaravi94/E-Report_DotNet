...
public partial class MasterFiles_Reports_rptCallAverage_Halfday : System.Web.UI.Page
{
    ...
    private void FillSF()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            tc_DR_LastDCRDate.Style.Add("color", "white");
            tc_DR_LastDCRDate.Style.Add("font-weight", "bold");
            tc_DR_LastDCRDate.Style.Add("border-color", "Black");
            tc_DR_LastDCRDate.HorizontalAlign = HorizontalAlign.Center;
            tc_DR_LastDCRDate.Style.Add("font-family", "Calibri");
            tc_DR_LastDCRDate.BackColor = System.Drawing.ColorTranslator.FromHtml("#0097AC");
            ...
            if (months > 0)
            {
                ...
                tc_DR_DCR_SubDays.HorizontalAlign = HorizontalAlign.Center;
                ...
                tc_DR_FldWrk.HorizontalAlign = HorizontalAlign.Center;
                ...
                TableCell tc_DR_Leave2 = new TableCell();
                //tc_DR_Leave.BackColor = System.Drawing.Color.LavenderBlush;
                tc_DR_Leave2.Width = 50;
                Literal lit_DR_Leave2 = new Literal();
                lit_DR_Leave2.Text = "<center>Leave</center>";
                tc_DR_Leave2.Controls.Add(lit_DR_Leave2);
                tc_DR_Leave2.Style.Add("color", "white");
                tc_DR_Leave2.Style.Add("font-weight", "bold");
                tc_DR_Leave2.Style.Add("border-color", "Black");
                tc_DR_Leave2.HorizontalAlign = HorizontalAlign.Center;
                tc_DR_Leave2.Style.Add("font-family", "Calibri");
                tc_DR_Leave2.BackColor = System.Drawing.ColorTranslator.FromHtml("#0097AC");
                tr_lst_det.Cells.Add(tc_DR_Leave2);
              ...
              //  tc_DR_Total.Controls.Add(lit_DR_Leave);
                ...
                tc_average.HorizontalAlign = HorizontalAlign.Center;
                ...
                tc_Docs_chemmet.HorizontalAlign = HorizontalAlign.Center;
                ...
                tc_Docs_CallAvg.HorizontalAlign = HorizontalAlign.Center;
                ...
                TableCell tc_Docs_ChemPOB3 = new TableCell();
                tc_Docs_ChemPOB3.Width = 50;
                Literal lit_Docs_ChemPOB3 = new Literal();
                lit_Docs_ChemPOB3.Text = "<center>Chem.POB</center>";
                tc_Docs_ChemPOB3.Visible = false;
                tc_Docs_ChemPOB3.Controls.Add(lit_Docs_ChemPOB3);
                tc_Docs_ChemPOB3.Style.Add("color", "white");
                tc_Docs_ChemPOB3.Style.Add("font-weight", "bold");
                tc_Docs_ChemPOB3.Style.Add("border-color", "Black");
                tc_Docs_ChemPOB3.HorizontalAlign = HorizontalAlign.Center;
                tc_Docs_ChemPOB3.Style.Add("font-family", "Calibri");
                tc_Docs_ChemPOB3.BackColor = System.Drawing.ColorTranslator.FromHtml("#0097AC");
                tr_lst_det.Cells.Add(tc_Docs_ChemPOB3);
                ...
                tc_Docs_Stockmet.HorizontalAlign = HorizontalAlign.Center;
                ...
                //tc_Docs_Stock_CallAvg.Controls.Add(lit_Docs_Stockmet);
                ...
                tc_Docs_Stock_CallAvg.HorizontalAlign = HorizontalAlign.Center;
                ...
                tc_Docs_New_Drs_met.HorizontalAlign = HorizontalAlign.Center;
                ...
                tc_Docs_New_Call_Avg.HorizontalAlign = HorizontalAlign.Center;
                ...
                //TableCell tc_Docs_New_Cip_met = new TableCell();
                //tc_Docs_New_Cip_met.Width = 50;
                //Literal lit_Docs_New_CIP_met = new Literal();
                //lit_Docs_New_CIP_met.Text = "<center>UnLDrs <br> Seen</center>";
                //tc_Docs_New_Cip_met.Controls.Add(lit_Docs_New_CIP_met);
                //tc_Docs_New_Cip_met.Style.Add("padding", "15px 5px");
                //tc_Docs_New_Cip_met.Style.Add("border-bottom", "10px solid #fff");
                //tc_Docs_New_Cip_met.Style.Add("border-top", "0px");
                //tc_Docs_New_Cip_met.Style.Add("font-size", "12px");
                //tc_Docs_New_Cip_met.Style.Add("font-weight", "400");
                //tc_Docs_New_Cip_met.Style.Add("text-align", "center");
                //tc_Docs_New_Cip_met.Style.Add("border-left", "1px solid #DCE2E8");
                //tc_Docs_New_Cip_met.Style.Add("vertical-align", "inherit");
                //tc_Docs_New_Cip_met.Style.Add("text-transform", "uppercase");
                //tc_Docs_New_Cip_met.Style.Add("background-color", "#F1F5F8");
                //tc_Docs_New_Cip_met.Attributes.Add("class", "stickyFirstRow");
                //tr_lst_det.Cells.Add(tc_Docs_New_Cip_met);

                //TableCell tc_CIP_New_Call_Avg = new TableCell();
                //tc_CIP_New_Call_Avg.Width = 50;
                //Literal lit_CIP_New_Call_Avg = new Literal();
                //lit_CIP_New_Call_Avg.Text = "<center>Call <br> Avg</center>";
                //tc_CIP_New_Call_Avg.Controls.Add(lit_CIP_New_Call_Avg);
                //tc_CIP_New_Call_Avg.Style.Add("padding", "15px 5px");
                //tc_CIP_New_Call_Avg.Style.Add("border-bottom", "10px solid #fff");
                //tc_CIP_New_Call_Avg.Style.Add("border-top", "0px");
                //tc_CIP_New_Call_Avg.Style.Add("font-size", "12px");
                //tc_CIP_New_Call_Avg.Style.Add("font-weight", "400");
                //tc_CIP_New_Call_Avg.Style.Add("text-align", "center");
                //tc_Docs_New_Call_Avg.Style.Add("border-left", "1px solid #DCE2E8");
                //tc_CIP_New_Call_Avg.Style.Add("vertical-align", "inherit");
                //tc_CIP_New_Call_Avg.Style.Add("text-transform", "uppercase");
                //tc_CIP_New_Call_Avg.Style.Add("background-color", "#F1F5F8");
                //tc_CIP_New_Call_Avg.Attributes.Add("class", "stickyFirstRow");
                //tr_lst_det.Cells.Add(tc_CIP_New_Call_Avg);
                ...
                tc_Docs_New_Rem_calls.Style.Add("color", "white");
                tc_Docs_New_Rem_calls.Style.Add("font-weight", "bold");
                tc_Docs_New_Rem_calls.Style.Add("border-color", "Black");
                tc_Docs_New_Rem_calls.HorizontalAlign = HorizontalAlign.Center;
                tc_Docs_New_Rem_calls.Style.Add("font-family", "Calibri");
                tc_Docs_New_Rem_calls.BackColor = System.Drawing.ColorTranslator.FromHtml("#0097AC");
                ...
                tc_Docs_Remarks.HorizontalAlign = HorizontalAlign.Center;
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                //        str = sf_name.Split('(');
                //        lit_det_doc_name.Text = "&nbsp;" + dsSf.Tables[0].Rows[0]["sf_name"].ToString().Replace(dsSf.Tables[0].Rows[0]["sf_name"].ToString(), "<span style='color:Red'>" + "( " + dsSf.Tables[0].Rows[0]["sf_name"].ToString() + " )" + "</span>");
                ...
                tc_det_doc_name.Style.Add("font-size", "11px");
                ...
                if (months > 0)
                {
                    ...
                    {
                        dsDoc = dcs.DCR_TotalFLDWRKQuery_With_HalfDay(drFF["sf_code"].ToString(), divcode, iMonth, iYear);
                    }
                    else if (drFF["sf_code"].ToString().Contains("MGR"))
                    {
                        dsDoc = dcs.DCR_TotalFLDWRKQuery_MGR_With_HalfDay(drFF["sf_code"].ToString(), divcode, iMonth, iYear);
                    }
                    else 
                    {
                    ...
                    fldwrk_total = fldwrk_total + Convert.ToDouble(tot_fldwrk);
    ...
    private void FillPeriodically()
    {
        ...
        tc_DR_DCR_Month.HorizontalAlign = HorizontalAlign.Center;
        tc_DR_DCR_Month.Style.Add("font-family", "Calibri");
        ...
        tc_DR_Leave.HorizontalAlign = HorizontalAlign.Center;
        ...
        for (int j = 1; j <= months + 1; j++)
        {
            ...
            if (months >= 0)
            {
                ...
                {
                    dsDoc = dcs.DCR_TotalFLDWRKQuery_With_HalfDay(sfCode, divcode, cmonth, cyear);
                }
                else
                {
                    dsDoc = dcs.DCR_TotalFLDWRKQuery_MGR_With_HalfDay(sfCode, divcode, cmonth, cyear);
                }
    ...
    private void FillPeriodically_FieldForce()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            tc_DR_kumulative.BackColor = System.Drawing.ColorTranslator.FromHtml("#0097AC");
            tc_DR_kumulative.Style.Add("color", "white");
            tc_DR_kumulative.Style.Add("font-weight", "bold");
            tc_DR_kumulative.Style.Add("border-color", "Black");
            tc_DR_kumulative.HorizontalAlign = HorizontalAlign.Center;
            tc_DR_kumulative.Style.Add("font-family", "Calibri");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months1 + 1; j++)
                    {
                        ...
                        if (months >= 0)
                        {
                            ...
                            if (drFF["sf_code"].ToString().Contains("MR"))
                            {
                                dsDoc = dcs.DCR_TotalFLDWRKQuery_With_HalfDay(drFF["sf_code"].ToString(), divcode, cmonth1, cyear1);
                            }
                            else
                            {
                                dsDoc = dcs.DCR_TotalFLDWRKQuery_MGR_With_HalfDay(drFF["sf_code"].ToString(), divcode, cmonth1, cyear1);
                            }

                            if (dsDoc.Tables[0].Rows.Count > 0)
                                tot_fldwrk = dsDoc.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();

                            fldwrk_total = Convert.ToDouble(tot_fldwrk);
    ...
    private void FillDateWise()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            tc_Docs_ChemPOB.HorizontalAlign = HorizontalAlign.Center;
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                if (drFF["sf_code"].ToString().Contains("MR"))
                {
                    dsDoc = dcs.DCR_TotalFLDWRKQuery_DateWise_With_HalfDay(drFF["sf_code"].ToString(), divcode, dtFrmDate.ToString("MM/dd/yyyy"), dtToDate.ToString("MM/dd/yyyy"));
                }
                else
                {
                    dsDoc = dcs.DCR_TotalFLDWRKQuery_MGR_DateWise_With_HalfDay(drFF["sf_code"].ToString(), divcode, dtFrmDate.ToString("MM/dd/yyyy"), dtToDate.ToString("MM/dd/yyyy"));
                }
    ...
    //                    lit_det_doc_name.Text = "&nbsp;" + drFF["sf_name"].ToString(); //+ " - " + drFF["sf_hq"].ToString() + " - " + drFF["Designation_Short_Name"].ToString();
    //                }
    //            }
    //            else
    //            {
    ...
    //            lit_det_doc_name.Attributes.Add("href", "javascript:showModalPopUp('" + drFF["sf_code"].ToString() + "','" + drFF["sf_name"].ToString() + "','" + divcode + "','" + "Date Wise(With out Approval)" + "', '" + dtFrmDate + "', '" + dtToDate + "')");
    //            tc_det_doc_name.HorizontalAlign = HorizontalAlign.Left;
    //            tc_det_doc_name.BorderStyle = BorderStyle.Solid;
    ...
    private void FillDateWise_WithOut_Approval()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            tc_DR_Start.BackColor = System.Drawing.ColorTranslator.FromHtml("#0097AC");
            tc_DR_Start.Style.Add("color", "white");
            tc_DR_Start.Style.Add("font-weight", "bold");
            tc_DR_Start.Style.Add("border-color", "Black");
            tc_DR_Start.HorizontalAlign = HorizontalAlign.Center;
            tc_DR_Start.Style.Add("font-family", "Calibri");
            ...
            tc_DR_EndTime.BackColor = System.Drawing.ColorTranslator.FromHtml("#0097AC");
            tc_DR_EndTime.Style.Add("color", "white");
            tc_DR_EndTime.Style.Add("font-weight", "bold");
            tc_DR_EndTime.Style.Add("border-color", "Black");
            tc_DR_EndTime.HorizontalAlign = HorizontalAlign.Center;
            tc_DR_EndTime.Style.Add("font-family", "Calibri");

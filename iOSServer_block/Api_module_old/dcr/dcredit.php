...
$rcphead="select PK_ID,SF_Code,SF_Name,RCPA_Date,DrCode,DrName,ChmCode,ChmName,OPCode,OPName,OPQty,OPRate,OPValue,AR_Code,ARMSL_Code,UpdatedOn,EID,OPUnit from Trans_RCPA_Head where Sf_Code='".$data['sfcode']."' and DrCode='".$a1[0]["Trans_Detail_Info_Code"]."' and cast(convert(varchar,RCPA_Date,101) as datetime) =cast(convert(varchar,GetDate(),101) as datetime)";

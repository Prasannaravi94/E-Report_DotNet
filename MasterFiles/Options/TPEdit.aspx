<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TPEdit.aspx.cs" Inherits="MasterFiles_Options_TPEdit" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                if (FDay == "---Select---") { alert("Select Day."); $('#ddlDay').focus(); return false; }
...
<body>
    ...
    <div>
        ...
        <br />
        <center>
            <asp:Button ID="btnGo" Width="30px" Height="25px" Text="Go" CssClass="savebutton" runat="server"
                OnClick="btnGo_Click" />
        </center>
        ...
        <table width="100%">
            <tr>
                <td align="center">
                    <asp:Button ID="btnSubmit" runat="server" CssClass="savebutton" Width="80px" Height="25px" Text="TP Edit" Visible="false" OnClientClick="return confirm('Do you want to edit the Tour Plan');"

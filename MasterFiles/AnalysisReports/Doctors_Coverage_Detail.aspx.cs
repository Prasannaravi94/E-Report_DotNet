...
public partial class MasterFiles_AnalysisReports_Doctors_Coverage_Detail : System.Web.UI.Page
{
    ...
    private void FillSpeciality()
    {
       ...
       if(dsListedDR.Tables[0].Rows.Count >0)
        {
            ddlspcl.DataValueField = "Doc_Special_Code";
            ddlspcl.DataTextField = "Doc_Special_SName";
            ddlspcl.DataSource = dsListedDR;
            ddlspcl.DataBind();
        }
    }

...
public partial class Reports_rptDcrViewDetails : System.Web.UI.Page
{
    ...
    private void CreateDynamicTable(int imonth, int iyear, string sf_code)
    {
        ...
        tblUnLstDoc.Style.Add("width", "100%");
        ...
        tbldetailstk.Style.Add("width", "100%");
        ...
        tc_line.Style.Add("border-collapse", "collapse");
        tc_line.Style.Add("border-top", "none");
        tc_line.Style.Add("border-right", "none");
        tc_line.Style.Add("margin-left", "-70px");
        tc_line.Style.Add("border-bottom ", "solid 2px #dee2e6");
        tc_line.Style.Add("margin-bottom ", "25px");

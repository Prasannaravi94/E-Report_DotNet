...
public partial class MasterFiles_ActivityReports_rptTargetVsSales_Cummulative_Performance : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Performance Sales Report " + strFrmMonth + " " + FYear;
    ...
    {
        //int months = (Convert.ToInt32(TYear) - Convert.ToInt32(FYear)) * 12 ; //(Date2.Year - Date1.Year) * 12 + Date2.Month - Date1.Month;
        ...
        sProc_Name = "Target_Vs_Sale_Cumm_Sales_Performance";
        ...
        cmd.Parameters.AddWithValue("@yr", FYear);
        ...
        dsts.Tables[1].Columns.RemoveAt(7);
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 2, 0, "#", "#414D55", true);
            AddMergedCells(objgridviewrow, objtablecell, 2, 0, "Brand Name", "#F1F5F8", true);
            AddMergedCells(objgridviewrow, objtablecell, 2, 0, "Product Name", "#F1F5F8", true);
            AddMergedCells(objgridviewrow, objtablecell, 2, 0, "Pack", "#F1F5F8", true);
            ...
            SalesForce sf = new SalesForce();
                ...
                string sTxt = "&nbsp;" + sf.getMonthName(FMonth.ToString()) + "-" + FYear;
                AddMergedCells(objgridviewrow, objtablecell, 0, 4, "CURRENT MONTH("+ sTxt+")", "#F1F5F8", true);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, 0, "TARGET IN UNITS", "#F1F5F8", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, 0, "MONTH ACH(SEC)", "#F1F5F8", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, 0, " MONTH %Ach", "#F1F5F8", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, 0, "CLOSING STOCK", "#F1F5F8", false);
                 AddMergedCells(objgridviewrow, objtablecell, 0, 6, "CUMMULATIVE( April -"+cyear+" to "+ sTxt+" )", "#F1F5F8", true);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, 0, "CUM TAR IN UNITS", "#F1F5F8", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, 0, "CUM CUR YR ACH(SEC)", "#F1F5F8", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, 0, "CUM %Ach", "#F1F5F8", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, 0, "CUM LAST Yrs  Sec Ach", "#F1F5F8", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, 0, "GROWTH IN UNIT", "#F1F5F8", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, 0, "Cum Gr/Dgr", "#F1F5F8", false);

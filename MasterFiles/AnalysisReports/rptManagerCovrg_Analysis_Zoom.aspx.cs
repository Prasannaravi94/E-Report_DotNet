...
public partial class MasterFiles_AnalysisReports_rptManagerCovrg_Analysis_Zoom : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //sMode = Request.QueryString["sf_name"].ToString();
            //sf_code = Request.QueryString["cmode"].ToString();
            ...
            lblHead.Text = "Manager wise Coverage Analysis for the Period of " + "<span style='color:red'>" + strFrmMonth + " " + FYear + "</span>" + " " + "To" + " " + "<span style='color:red'>" + strToMonth + " " + TYear + "</span>";
    ...
    private void FillReport()
    {
        ...
        sProc_Name = "MGR_Covg_Analysis_Zoom";
        ...
        cmd.Parameters.AddWithValue("@Field", "FFName");
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (e.Row.Cells[1].Text == "zzy") //if (e.Row.RowIndex == dtrowClr.Rows.Count - 1)
            {
                ...
                for (int n = 7, m = 0; n <= e.Row.Cells.Count; n++)
                {
                    ...
                    {
                        for (int i = 0; i <= GrdFixation.Rows.Count-1; i++)
                        {
                            Rowcounts = dtrowClr.Rows[i][n + 3].ToString();
                    ...
                    if ((months1 + 1) > (Ass))
                    {
                        if ((months1 + 1) == (Ass))
                        {
                            e.Row.Cells[n - 5].Text = ("").ToString();
                        }
                        else
                        {
                            e.Row.Cells[n - 5].Text = (numberOfElements1 - 1).ToString();
                        }
                        e.Row.Cells[n - 5].HorizontalAlign = HorizontalAlign.Center;
                        e.Row.Cells[n - 5].Height = 30;
                        e.Row.Cells[n - 5].Attributes.Add("style", "font-weight:bold;");
                        e.Row.Cells[n - 5].Style.Add("font-size", "10pt");
                        //e.Row.Cells[3].Text = "";
                        //e.Row.Cells[4].Text = "";
                        Ass = Ass + 1;
                        m++;

    ...
    <ucl:Menu ID="menu1" runat="server" />
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center ">
                <div class="col-lg-11">
                    <h2 class="text-center">Doctor-Qualification</h2>
                        ...
                        <div class="display-name-heading clearfix">
                            <div class="row clearfix">
                                <div class="col-lg-12">
                                    ...
                                    <asp:Button ID="btnTransfer_Qua" runat="server" CssClass="resetbutton"  Width="155px" Text="Transfer Qualification" onClick="btnTransfer_Qua_Click" />
                                    ...
                                    <asp:Button ID="btnspltytransfer" runat="server" CssClass="resetbutton"  Width="140px" Text="Splty-Qual.Transfer" OnClick="btnspltytransfer_click" />
                                </div>
                            </div>
                        </div>
                        <p>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="2" align="center">
                                                <asp:GridView ID="grdDocQua" runat="server" Width="100%" HorizontalAlign="Center"
                                                    ...
                                                    AllowSorting="True" OnSorting="grdDocQua_Sorting">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField SortExpression="Doc_QuaName" HeaderText="Qualification Name">
                                                            <EditItemTemplate>
                                                        ...
                                                        <asp:CommandField ShowHeader="True" EditText="Inline Edit" HeaderText="Inline Edit"
                                                           ShowEditButton="True" ItemStyle-CssClass="align"  ItemStyle-HorizontalAlign="Center">
                                                        ...
                                                        <asp:TemplateField HeaderText="Deactivate" ItemStyle-HorizontalAlign="Center">
                                                            ...
                                                            <ItemTemplate>
                                                               ...
                                                               <img src="../Images/deact2.png" alt="" width="75px" title="This Qualification Exists in Doctor" />
                                                                </asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>

...
namespace Bus_EReport.DynamicDashboard.DrillDown.MarketingKpi
{
    ...
    public class ProductPriorityDrillDown : DrilldownBase
    {
        public int StartMonth;
        public int EndMonth;
        public int StartYear;
        public int EndYear;
        public ProductPriorityDrillDown()
        {
            FileName = "Priority Product Wise visited";
            PreferenceName = "ProductPriorityDrillDown";
            Columns = new Dictionary<string, DrillDownColumn>
            {
                ...
                {"ProductName", new DrillDownColumn {Label = "Porduct Name", Select = "Mas_Product_Detail.Product_Detail_Name as ProductName"}},
        ...
        public string getQuery()
        {
            ...
            {
                sqlQry += " AND Mas_Product_Detail.Product_Code_SlNo IN (" + Filters["widgetFilters"]["products"] + ") ";
            }
            return sqlQry;
        }
        ...
        public override int GetTotalRecords()
        {
            ...
            if (Filters["widgetFilters"].ContainsKey("products") && Filters["widgetFilters"]["products"] != null && Filters["widgetFilters"]["products"] != "")
            {
                strQry += " AND Mas_Product_Detail.Product_Code_SlNo IN (" + Filters["widgetFilters"]["products"] + ") ";
            }

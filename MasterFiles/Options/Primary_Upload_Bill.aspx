<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Primary_Upload_Bill.aspx.cs" Inherits="MasterFiles_Options_Primary_Upload_Bill" %>

<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Primary Bill Upload</title>
    <style type="text/css">
        td.stylespc {
            padding-bottom: 5px;
            padding-right: 5px;
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                               ...
                               <div class="single-des clearfix">
                                            <asp:RadioButtonList ID="rdolstrpt" runat="server" RepeatDirection="Horizontal" RepeatColumns="2" Font-Size="Small">
                                                <asp:ListItem Value="1" Text="Delete & Update&nbsp;&nbsp;&nbsp;" Selected="True"></asp:ListItem>
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:Label ID="Label1" runat="server" CssClass="label">1) Sheet Name Must be 'UPL_Primary_Bill'</asp:Label>
                            </div>
                            <div class="single-des clearfix">

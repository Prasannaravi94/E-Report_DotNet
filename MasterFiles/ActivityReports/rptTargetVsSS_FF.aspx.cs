...
public partial class MasterFiles_ActivityReports_rptTargetVsSS_FF : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Target Vs Secondary Sales Report From " + strFrmMonth + " " + FYear + " to " + " " + strToMonth + " " + " " + TYear;
    ...
    private void FillReport()
    {
        ...
        if (mode == "6")
        {
            sProc_Name = "TargetVsSS_HQwise_P";
        }
         else
        {
            sProc_Name = "TargetVsSS_HQwise_P_New";
        }
    
        // sProc_Name = "TargetVsPrimary_HQwise_New";//TargetVsPrimary_HQwise  
        //sProc_Name = "TargetVsSS_HQwise_P";//TargetVsPrimary_HQwise  

    ...
    <div>
        ...
        <center>
            <table cellpadding="8" width="85%" cellspacing="8">
                <tr align="right">
                    <td>
                        <asp:HyperLink ID="hypLinkApproval" runat="server" Text="Confirm List View" style="font-size:10pt;  font-family:Verdana; font-weight:bold"  NavigateUrl="~/MasterFiles/MGR/TP_Approve.aspx?Index=8"></asp:HyperLink>
                    </td>
                </tr>
                <tr>
                    <td align="center">

...
public partial class MIS_Reports_inputmr : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //FillProd();
            lblProd.Text = "Input Despatch Status for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    private void CreateDynamicTable()
    {
        ...
        //foreach (string prd in Product_Code)
        //{
        dsDr = dr.getinput_status(div_code, sf_code, sCurrentDate);
        ...
        if (dsDr.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drdoctor in dsDr.Tables[0].Rows)
            {
                ...
                lit_det_dr_qua.Text = drdoctor["Gift_Name"].ToString();
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.input_quantity_status(sf_code, div_code, cmonth, cyear, sCurrentDate, productid);
                        dsdoc1 = sf.inputissue_quantity_product(sf_code, div_code, cmonth, cyear, sCurrentDate, productid);

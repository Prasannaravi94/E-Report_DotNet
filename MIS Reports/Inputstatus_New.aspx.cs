...
public partial class MIS_Reports_Inputstatus_New : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dsmonth = sf.inputmnthyr(div_code);
        if (dsmonth.Tables[0].Rows.Count <= 0)
        {
            monthval.Value = "1";
        }
        else if (dsmonth.Tables[0].Rows.Count > 0 && dsmonth.Tables[0].Rows[0]["IN_EM_Month"].ToString() == "0" || dsmonth.Tables[0].Rows[0]["IN_EM_Year"].ToString() == "0")
        {
            monthval.Value = "1";
        }
        if (!Page.IsPostBack)

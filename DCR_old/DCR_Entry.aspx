...
<body class="loading">
    ...
    <form id="frm" runat="server">
        ...
        <div class="pad HDBg"><a href="#" class="button mnu-bt" onclick="toggleMenu()"><i class="fa fa-bars"></i></a><a runat="server" id="aHome" class="button home-bt">Home</a><div class='hCap'>Daily Calls Report For :
        ...
        <div id="mnuWrapr">
            ...
            <div id="WorkArea" class="Work-Area active">
                ...
                <div id="wDetProd" class="wind-o">
                    <table class="fg-group TBH">
                        <tr>
                            <th w="280">Product</th>
                            <th w="40"><a href="#" class="button go-bt" onclick="addRow('tDetProd')">+</a></th>
                        </tr>
                    </table>
                    <div class="wScroll">
                        <table id='tDetProd' class="fg-group TBD">
                            <tr>
                                <td>
                    ...
                    <div class="wScroll">
                        <table id='tProd' class="fg-group TBD">
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="tPQ" name="tPQ" min="0" maxlength="3"></td>
                    ...
                    <div class="wScroll">
                        <table id="tInput" class="fg-group TBD">
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="tGQ" name="tGQ" min="0" maxlength="3"></td>
                                <td><a href="#" class="button button-red go-bt" onclick="delRow(this)">-</a></td>
                            </tr>
                        </table>
                    </div>
                    <div style="height: 22px; padding: 2px; margin: 5px 0px;">
                        <a href='#' class='button button-green go-bt' onclick="svWinVal(event)"
                            style="margin: 0px 5px; float: left">Save</a><a href='#' class='button button-red go-bt'
                                style="margin: 0px 5px; float: left" onclick="ddlWinClose()">Cancel</a>
                    </div>
                </div>
               <%-- --------%>
                <div id="wRMProd" class="wind-o" style="padding: 5px 1px">
                    <table class="fg-group TBH">
                        <tr>
                            <th w="100%">Call Feedback</th>
                        </tr>
                        <tr>
                            <td>
                                <div id="ddl_fedBk" class="ddl-Box" style="width: 100%;" data-value="" data-text="- Select the Call Feedback -" data-src="d_fedbk" data-vf='id' data-tf='name' onclick="ddlcbsel()"></div>
                            </td>
                        </tr>
                        <tr>
                            <th></th>
                        ...
                        <tr>
                            <td>
                                <textarea id="tPrdCusRem" style="display: block; width: 430px; height: 80px"></textarea></td>
                        </tr>
                    </table>
                    <table class="fg-group TBH">
                        <tr id="pnlRemarks">
                            <th w="280">Product</th>
                            <th w="80">Qty/Week</th>
                            <th w="40"><a href="#" class="button go-bt" onclick="addRow('cftprod')">+</a></th>
                        </tr>
                        </table>
                    <div class="wScroll">
                        <table id='cftprod' class="fg-group TBD">
                            <tr>
                                <td>
                                    <div class="ddl-Box search Prod" data-value="" data-text="- Select the Product -" data-src="d_Prod" data-vf='id' data-tf='name'></div>
                                </td>
               ...
               <%-- ---------%>
                <div id="wRem" class="wind-o" style="padding: 5px 1px">
                    <table class="fg-group TBH">
                        ...
                        <tr>
                            <td>
                                <div id="ddl_fedBkRmk" class="ddl-Box" style="width: 100%;" data-value="" data-text="- Select the Call Feedback -" data-src="d_fedbk" data-vf='id' data-tf='name' onclick="ddlcbsel()"></div>
                            </td>
                        </tr>
                        <tr>
                            <th></th>
                        ...
                        <tr>
                            <td>
                                <textarea id="tCusRem" style="display: block; width: 430px; height: 80px"></textarea></td>
                        </tr>
                    </table>
                  </div> 
        ...
        <script type="text/javascript">
            _C = {
                ...
                dprd: { id: 'dprd', cap: 'Detail', w: '90', src: 'wDetProd', vf: 'id', tf: 'name', df: '- Product -', val: '', ty: 'ddl-Box wind', iw: '300' },
                prd: { id: 'prd', cap: 'Sample', w: '90', src: 'wProd', vf: 'id', tf: 'name', df: '- Product -', val: '', ty: 'ddl-Box wind', iw: '300' },
                inp: { id: 'inp', cap: 'Input', w: '90', src: 'wInput', vf: 'id', tf: 'name', df: '- Input -', val: '', ty: 'ddl-Box wind', iw: '300' },
                //rprd: { id: 'rprd', cap: 'Remark Product', w: '90', src: 'wProd', vf: 'id', tf: 'name', df: '- Product -', val: '', ty: 'ddl-Box wind', iw: '300' },
                prem: { id: 'prem', cap: 'CallFeedback', w: '140', src: 'wRMProd', vf: 'id', tf: 'name', df: '- Product -', val: '', ty: 'ddl-Box wind', iw: '300' },

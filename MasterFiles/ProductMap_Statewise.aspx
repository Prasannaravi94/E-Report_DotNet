<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductMap_Statewise.aspx.cs"
    Inherits="MasterFiles_ProductMap_Statewise" %>

<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>State - Product Tag </title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            <%-- $('#btnGo').click(function () {
                ...
                var type = $('#<%=ddlStateProduct.ClientID%> :selected').text();
                ...
                if (type == "---Select---") {
                    ...
                    // alert("");
                    $('#ddlStateProduct').focus();
                    return false;
                }
                else if (SubDiv == "---Select---") {
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <br />
                        <h2 class="text-center" style="border-bottom: none">State - Product Tag</h2>

                        <div class="designation-area clearfix">
                            <div class="single-des clearfix">
                                <div class="single-des-option">
                                    <asp:Label ID="lblStateProduct" runat="server" Text="Select State" CssClass="label"></asp:Label>
                                    <asp:DropDownList ID="ddlStateProduct" runat="server" CssClass="nice-select">
                                    </asp:DropDownList>
                        ...
                        <div class="w-100 designation-submit-button text-center clearfix">
                            <asp:Button ID="btnGo" Text="GO" CssClass="savebutton" runat="server" OnClientClick="return Validation();"
                                OnClick="btnGo_Click" />
                                                            ...
                                                            <table>
                                                                <tr style="width: 100%; border-bottom: 1px solid #DCE2E8; border-right: 1px solid #DCE2E8; border-left: 1px solid #DCE2E8;">
                                                                    ...
                                                                    <td style="min-width: 230px; max-width: 250px; text-align: left; border-left: none">
                                                                        <asp:CheckBox ID="chkCatName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Product_Detail_Name")%>' />
                                                                    </td>
                                                                    <td style="min-width: 65px; max-width: 75px">

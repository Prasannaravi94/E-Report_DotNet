...
public partial class MIS_Reports_dcview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Doctor_Productwise_Business_for_" + strFMonthName + "_" + FYear + "_" + "To" + "_" + strTMonthName + "_" + TYear;
    ...
    private void FillSF()
    {
        ...
        string strQry = "EXEC ViewDetails_DrsTmp_Temp3 '" + divcode + "', '" + sfCode + "' ";
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                if (months >= 0)
                {
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = dr.rpListedDrBus_value(drFF["sf_code"].ToString(), divcode, cmonth, cyear, basedOn);

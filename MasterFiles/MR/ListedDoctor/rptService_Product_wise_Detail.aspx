<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptService_Product_wise_Detail.aspx.cs"
    Inherits="MasterFiles_MR_ListedDoctor_rptService_Product_wise_Detail" %>
                        ...
                        <asp:Panel ID="Panel1" runat="server">
                            <table width="95%">
                               ...
                               <RowStyle Font-Names="calibri" Font-Size="9" />    
                                ...
                                <asp:BoundField DataField="ListedDr_Name" HeaderText="Doctor Name" HeaderStyle-BackColor="#0097AC" HeaderStyle-ForeColor="White" ItemStyle-Width="70" />
                                <asp:BoundField DataField="Doc_Cat_ShortName" HeaderText="Category" HeaderStyle-BackColor="#0097AC" HeaderStyle-ForeColor="White" ItemStyle-Width="70" />
                                <asp:BoundField DataField="Doc_Spec_ShortName" HeaderText="Speciality" HeaderStyle-BackColor="#0097AC" HeaderStyle-ForeColor="White" ItemStyle-Width="150" />                              
                                <asp:BoundField DataField="Doc_Qua_Name" HeaderText="Qualification" HeaderStyle-BackColor="#0097AC" HeaderStyle-ForeColor="White" ItemStyle-Width="150" />

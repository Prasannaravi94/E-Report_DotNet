...
using DBase_EReport;
using ClosedXML;
public partial class MasterFiles_AnalysisReports_SS_ALL_Dump : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("SecSale_Analysis_All_MR_Single_Mnth", con);
      ...
      //  ds.Tables[0].Columns.Remove("sf_code2");
        ...
        Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "SS_Dump.xls"));

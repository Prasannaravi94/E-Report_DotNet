<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listeddr_Dump.aspx.cs" Inherits="MasterFiles_AnalysisReports_Listeddr_Dump" %>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Listeddr - Dump</h2>
                        ...
                        <div class="designation-area clearfix">
                            <div class="single-des clearfix">
                             ...
                             <%-- <div class="single-des clearfix">
                                <asp:CheckBox ID="ChkDocdetail" Text="Listeddr Detail" runat="server" />
                            </div> --%>
                          <div class="single-des clearfix">
                                <asp:Label ID="lblmode" runat="server" Text="Mode" CssClass="label"></asp:Label>
                                <asp:DropDownList ID="ddlmode" runat="server" Width="100%" CssClass="custom-select2 nice-select">
                                       <asp:ListItem Value="1">Active Listeddr</asp:ListItem>
                                       <asp:ListItem Value="2">With Deactivate Listeddr</asp:ListItem>
                                       <asp:ListItem Value="3">Listeddr Detail</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>

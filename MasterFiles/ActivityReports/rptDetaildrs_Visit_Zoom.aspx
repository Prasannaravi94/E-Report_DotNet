<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDetaildrs_Visit_Zoom.aspx.cs"
...
#page {
 ...
 <script type = "text/javascript">
        ...
        function showModalPopUp(sfcode, divcode, FMonth, FYear, SfMGR,mode, selValues, drcode, Sf_Name) {
            //alert('HI');
            popUpObj = window.open("rptDetaildrs_Visit_SlideZoom.aspx?sfcode=" + sfcode + "&divcode=" + divcode + "&FMnth=" + FMonth + "&FYear=" + FYear + "&SfMGR=" + SfMGR + "&drcode=" + drcode + "&mode=" + mode + "&selValues=" + selValues + "&Sf_Name=" + Sf_Name,
            "_blank",
        "ModalPopUp_Level1," +
         "0," +
        "toolbar=no," +

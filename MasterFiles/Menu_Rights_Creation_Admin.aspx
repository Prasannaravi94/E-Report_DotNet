<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Menu_Rights_Creation_Admin.aspx.cs"
    Inherits="MasterFiles_Menu_Rights_Creation_Admin" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <center>
                <table>
                    <tr>
                        <td align="left" class="stylespc">
                            <asp:Label ID="lblName" runat="server" Visible="false" Text="Name" SkinID="lblMand"></asp:Label>
                        </td>
                        <td align="left" class="stylespc">
                            <asp:TextBox ID="txtName" runat="server" Visible="false" TabIndex="1" SkinID="MandTxtBox" Width="250"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100px;" align="left" class="stylespc">
                            <asp:Label ID="lblUserName" runat="server" Visible="false" Text="User Name" SkinID="lblMand"></asp:Label>
                        </td>
                        <td align="left" class="stylespc">
                            <asp:TextBox ID="txtUserName" runat="server" Visible="false" TabIndex="2" SkinID="MandTxtBox" Width="170"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" class="stylespc">
                            <asp:Label ID="lblPassword" runat="server" Visible="false" Text="Password" SkinID="lblMand"></asp:Label>
                        </td>
                        <td align="left" class="stylespc">
                            <asp:TextBox ID="txtPassword" runat="server" Visible="false" TabIndex="3" SkinID="MandTxtBox" MaxLength="15"
                                TextMode="Password" Width="170"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" class="stylespc">
                ...
                <br />
                <asp:Button ID="btnSubmit" runat="server" Visible="false" Width="70px" CssClass="btnnew" TabIndex="7"
                    Height="25px" Text="Submit" OnClick="btnSubmit_Click" />
                &nbsp;&nbsp;
            <asp:Button ID="btnReset" runat="server" Visible="false" TabIndex="8" Width="70px" Height="25px"
                CssClass="btnnew" Text="Reset" OnClick="btnReset_Click" />
            </center>
            <br />
            <br />
            <center>
                <asp:Label ID="lblmenu" runat="server" SkinID="lblMand">Menu Rights</asp:Label>&nbsp;&nbsp;
            <asp:DropDownList ID="ddlmenu" runat="server" SkinID="ddlRequired" AutoPostBack="true"
            ...
            <asp:Panel ID="pnladmin" runat="server" Visible="false">
                    ...
                    <asp:Panel ID="pnlNew" runat="server">
                        <table cellpadding="4" cellspacing="4" align="center" style="border: solid 1px #347C17; border-collapse: collapse"
                            ...
                            <tr style="border: solid 1px">
                                <td style="background-color: #98AFC7; color: White; font-weight: bold; font-family: Arial; border: solid 1px black"
                                    align="center">Master
                                </td>
                                <td style="background-color: #98AFC7; color: White; font-weight: bold; font-family: Arial; border: solid 1px black;"
                            ...
                            <tr style="border: solid 1px">
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="chkaccess" DataTextField="Menu_Name" runat="server" RepeatDirection="Vertical"
                                        RepeatColumns="1" BackColor="#FEFCFF" ForeColor="#7F525D" CellPadding="2" CellSpacing="5"
                                        Width="200px" Font-Names="Calibri">
                                ...
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="chkReports" runat="server" RepeatDirection="Vertical" RepeatColumns="1"
                                        BackColor="#FEFCFF" ForeColor="#7F525D" CellPadding="2" CellSpacing="5" Width="200px"
                                        Font-Names="Calibri">
                                        <asp:ListItem Value="liuser" Text="User List"></asp:ListItem>
                                        <asp:ListItem Value="lidoc" Text="Doctor Details"></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="lidcrst" Text="DCR Count View Stwise"></asp:ListItem>
                                        <asp:ListItem Value="li2VacantBlockId" Text="Hold / Blocked Id's - View"></asp:ListItem>
                                    </asp:CheckBoxList>
                                </td>
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="ChkOptions" runat="server" RepeatDirection="Vertical" RepeatColumns="1"
                                        ...
                                        <asp:ListItem Value="licnt" Text="Listeddr Count View"></asp:ListItem>
                                    </asp:CheckBoxList>
                                </td>
                            </tr>
                        </table>
                    ...
                    <asp:Panel ID="pnlhome" runat="server">
                        <table cellpadding="4" cellspacing="4" align="center" style="border: solid 1px #347C17; border-collapse: collapse"
                            ...
                            <tr style="border: solid 1px">
                                ...
                                <td style="background-color: #98AFC7; color: White; font-weight: bold; font-family: Arial; border: solid 1px black;"
                                    align="center">Activities
                                </td>
                                <td style="background-color: #98AFC7; color: White; font-weight: bold; font-family: Arial; border: solid 1px black;"
                                    align="center">Activity Reports
                                </td>
                                <td style="background-color: #98AFC7; color: White; font-weight: bold; font-family: Arial; border: solid 1px black;"
                                    align="center">MIS Reports
                                </td>
                                <td style="background-color: #98AFC7; color: White; font-weight: bold; font-family: Arial; border: solid 1px black;"
                                    align="center">Option
                                </td>
                            ...
                            <tr style="border: solid 1px">
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="chkmasters" DataTextField="Menu_Name" runat="server" RepeatDirection="Vertical"
                                        RepeatColumns="1" BackColor="#FEFCFF" ForeColor="#7F525D" CellPadding="2" CellSpacing="5"
                                        Width="230px" Font-Names="Calibri">
                                        ...
                                        <asp:ListItem Value="li19" Text="Area Cluster-lat long"></asp:ListItem>
                                        <asp:ListItem Value="lim24">Statewise - Holiday Fixation<hr width="40%" /></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="limStE" Text="Statewise Entry Status"></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="lim33" Text="Allowance Fixation"></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="liExps" Text="Expense Setup"></asp:ListItem>
                                        <asp:ListItem Value="ulliMGE">Manager Expense</asp:ListItem>
                                        <asp:ListItem Value="limMGR31" Text="SFC Updation"></asp:ListItem>
                                        <asp:ListItem Value="limMGR32" Text="SFC View"></asp:ListItem>
                                ...
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="ChkActive" runat="server" RepeatDirection="Vertical" RepeatColumns="1"
                                        ...
                                        <asp:ListItem Value="liA6">Expense Approval</asp:ListItem>
                                        <asp:ListItem Value="lianaly">Expense Analysis<hr width="40%" /></asp:ListItem>
                                        <asp:ListItem Value="LiCPBE13">Chemist-Productwise Business</asp:ListItem>
                                        <asp:ListItem Value="liCPBE14" Text="Chemist-Productwise Business Entry"></asp:ListItem>
                                        <asp:ListItem Value="liCPBE15">Chemist-Productwise Business View<hr width="40%" /></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="liA19" Text="Target Fixation Productwise Entry"></asp:ListItem>
                                        <asp:ListItem Value="liA20" Text="Target Fixation Productwise View"></asp:ListItem>
                                        <asp:ListItem Value="liTFV11" Text="Target Fixation Valuewise Entry"></asp:ListItem>
                                        <asp:ListItem Value="liTFV12">Target Fixation Valuewise View<hr width="40%" /></asp:ListItem>
                                        <asp:ListItem Value="Li4">RCPA</asp:ListItem>
                                        <asp:ListItem Value="li6" Text="RCPA Entry"></asp:ListItem>
                                        <asp:ListItem Value="li7">RCPA View<hr width="40%" /></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="liA22">Leave Entitlement View<hr width="40%" /></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="liDocBusVwView">Doctor Business Valuewise View<hr width="40%" /></asp:ListItem>
                                        <asp:ListItem Value="liA23" Text="Login Details"></asp:ListItem>
                                        <asp:ListItem Value="liA24" Text="Login Into Fieldforce"></asp:ListItem>
                                        <asp:ListItem Value="Li600" Text="Secondary Sales Entry"></asp:ListItem>
                                        <asp:ListItem Value="ulliSFE" Text="KPI - SFE"></asp:ListItem>
                                    </asp:CheckBoxList>
                                </td>
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="ChkAcReports" runat="server" RepeatDirection="Vertical" RepeatColumns="1"
                                        ...
                                        <asp:ListItem Value="liAR9">DCR Not Submitted</asp:ListItem>
                                        <asp:ListItem Value="li3">Count - Modewise<hr width="40%" /></asp:ListItem>
                                        <asp:ListItem Value="liAR10" Text="Dash Board"></asp:ListItem>
                                        <asp:ListItem Value="li38" Text="Sale Dash Board"></asp:ListItem>
                                    </asp:CheckBoxList>
                                </td>
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="ChkMIS" runat="server" RepeatDirection="Vertical" RepeatColumns="1"
                                        ...
                                        <asp:ListItem Value="li8" Text="Doctor - Analysis"></asp:ListItem>
                                        <asp:ListItem Value="li12" Text="Rep Vs Manager"></asp:ListItem>
                                        <asp:ListItem Value="li17" Text="Review Report"></asp:ListItem>
                                        <asp:ListItem Value="liassrpt">Assessment Report<hr width="40%" /></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="li20">Leave Entry</asp:ListItem>
                                        <asp:ListItem Value="liMis28">Leave Status<hr width="40%" /></asp:ListItem>
                                        <asp:ListItem Value="ulliliMis29" Text="Exception TP"></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="liMis29">Resigned User Status<hr width="40%" /></asp:ListItem>
                                        <asp:ListItem Value="ulliPrimary" Text="Primary"></asp:ListItem>
                                        <asp:ListItem Value="lip1" Text="Stockist View"></asp:ListItem>
                                        <asp:ListItem Value="lip2" Text="Product View"></asp:ListItem>
                                        <asp:ListItem Value="lip3">Uploadwise View<hr width="40%" /> </asp:ListItem>

                                        <asp:ListItem Value="ulliBill" Text="Primary Bill"></asp:ListItem>
                                        <asp:ListItem Value="lib1" Text="Stockist View"></asp:ListItem>
                                        <asp:ListItem Value="lib2">Product View<hr width="40%" /></asp:ListItem>
                                ...
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="ChkOpt" runat="server" RepeatDirection="Vertical" RepeatColumns="1"
                                        ...
                                        <asp:ListItem Value="li24DDSlide" Text="Slides Upload"></asp:ListItem>
                                        <asp:ListItem Value="li33Holoday" Text="Holiday Fixation Upload"></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="lipayF">Payslip Upload File</asp:ListItem>
                                        <asp:ListItem Value="ulliTran" Text="Transaction Upload"></asp:ListItem>
                                        <asp:ListItem Value="liTr1">Primary Upload</asp:ListItem>
                                        <asp:ListItem Value="liTr2">Sample Upload</asp:ListItem>
                                        <asp:ListItem Value="liTr3">Input Upload</asp:ListItem>
                                        <asp:ListItem Value="liTr4">Target Upload<hr width="40%" /></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="LocFin">Location Finder<hr width="40%" /></asp:ListItem>

                                        <asp:ListItem Value="liQuiz" Text="Quiz"></asp:ListItem>
                                        <asp:ListItem Value="liQuizCat" Text="Quiz Category"></asp:ListItem>
                                    </asp:CheckBoxList>
                                </td>
                            </tr>
                        </table>
                ...
                <br />
                <center>
                    <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" BackColor="LightBlue" Visible="false"
                        Width="70px" />
                </center>
            </asp:Panel>
            <br />
                            ...
                            <tr style="border: solid 1px">
                                ...
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="ChkMgrMis" runat="server" RepeatDirection="Vertical" RepeatColumns="1"
                                        ...
                                        <asp:ListItem Value="ulliMgrSS" Text="Secondary Sale"></asp:ListItem>
                                        ...
                                        <%--<asp:ListItem Value="ulliMgrSS" Text="Secondary Sales Report"></asp:ListItem>--%>
                                        ...
                                        <asp:ListItem Value="ulliSamIn" Text="Sample / Input"></asp:ListItem>
                                        <asp:ListItem Value="liMis25" Text="Sample Issued - Fieldforce Wise"></asp:ListItem>
                                        <asp:ListItem Value="liMis26" Text="Input Issued - Fieldforce Wise"></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="liMgrMis26" Text="Exception TP"></asp:ListItem>
                                    </asp:CheckBoxList>
                                </td>
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="ChkMgrOpt" runat="server" RepeatDirection="Vertical" RepeatColumns="1"
                                        ...
                                        <asp:ListItem Value="lipayF" Text="Payslip File View"></asp:ListItem>
                                        <asp:ListItem Value="Li1" Text="Status View"></asp:ListItem>
                                    </asp:CheckBoxList>
                                </td>
                            </tr>
            ...
            <br />
            <center>
                <asp:Button ID="btnMgr" runat="server" Text="Save MGR" Width="100px" Visible="false"
                    BackColor="LightBlue" OnClick="btnMgr_Click" />
            </center>
            <br />
                            ...
                            <tr style="border: solid 1px">
                                ...
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="ChkMrAct" runat="server" RepeatDirection="Vertical" RepeatColumns="1"
                                        ...
                                        <asp:ListItem Value="LiMrCPBE13" Text="Chemist-Productwise Business"></asp:ListItem>
                                        <asp:ListItem Value="liMrCPBE14" Text="Chemist-Productwise Business Entry"></asp:ListItem>
                                        <asp:ListItem Value="liMrCPBE15" Text="Chemist-Productwise Business View"></asp:ListItem>
                                ...
                                <td align="left" style="border: solid 1px; background-color: White">
                                    <asp:CheckBoxList ID="ChkMrMis" runat="server" RepeatDirection="Vertical" RepeatColumns="1"
                                        ...
                                        <asp:ListItem Value="ulliMrSV" Text="Secondary Sales View"></asp:ListItem>
            ...
            <br />
            <center>
                <asp:Button ID="btnMR" runat="server" Text="Save MR" Width="100px" Visible="false"
                    BackColor="LightBlue" OnClick="btnMR_Click" />
            </center>

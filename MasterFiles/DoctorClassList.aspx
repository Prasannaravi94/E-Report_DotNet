<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorClassList.aspx.cs" Inherits="MasterFiles_DoctorClassList" %>
                    ...
                    <div class="designation-reactivation-table-area clearfix">
                        <div class="display-name-heading clearfix">
                            <div class="row clearfix">
                                <div class="col-lg-7">
                                    ...
                                    <asp:Button ID="btnDoc_Class_Trans" runat="server" CssClass="resetbutton"  Width="110px" Text="Transfer Class" OnClick="btnDoc_Class_Trans_Click" />
                                    <asp:Button ID="btnReactivate" runat="server" CssClass="resetbutton"  Width="105px" Text="Reactivation" OnClick="btnReactivate_Onclick" />
                                </div>
                            </div>
                        </div>
                        <p>
                        ...
                        <div class="display-table clearfix">
                            <div class="table-responsive">
                                <asp:GridView ID="grdDocCls" runat="server" Width="100%" HorizontalAlign="Center" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField SortExpression="Doc_ClsSName" HeaderText="Short Name" ItemStyle-HorizontalAlign="Left">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtDoc_Cls_SName" MaxLength="6" runat="server" CssClass="input" Text='<%# Bind("Doc_ClsSName") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblDoc_Cls_SName" runat="server" Text='<%# Bind("Doc_ClsSName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField SortExpression="Doc_ClsName" ItemStyle-HorizontalAlign="Left" HeaderText="Class Name">
                                            <EditItemTemplate>
                                        ...
                                        <asp:CommandField ShowHeader="True" EditText="Inline Edit"  ItemStyle-HorizontalAlign="Center" HeaderText="Inline Edit" HeaderStyle-HorizontalAlign="CENTER"
                                            ShowEditButton="True">
                                        </asp:CommandField>
                                        <asp:HyperLinkField HeaderText="Edit" Text="Edit" ItemStyle-HorizontalAlign="Center" DataNavigateUrlFormatString="DoctorClass.aspx?Doc_ClsCode={0}"
                                        ...
                                        <asp:TemplateField HeaderText="Deactivate" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                              ...
                                              <img src="../Images/deact2.png" alt="" width="75px" title="This Class Exists in Doctor" />
                                                </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

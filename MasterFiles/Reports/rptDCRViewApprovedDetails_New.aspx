<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDCRViewApprovedDetails_New.aspx.cs"
    Inherits="Reports_rptDCRViewApprovedDetails_New" %>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <asp:Panel ID="pnlContents" runat="server" Width="100%">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdLstDr" runat="server" Width="100%" HorizontalAlign="Center"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Hospital as Per Master" ItemStyle-Width="10%"
                                                    ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDoc_Hos" runat="server" Text='<%# Bind("HospitalName_Master") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Hospital as Per Tagging" ItemStyle-Width="10%"
                                                    ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDoc_TagHos" runat="server" Text='<%# Bind("HospitalName_Tag") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Qual" ItemStyle-Width="260" 
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Sub Area" ItemStyle-Width="10%"
                                                  ...
                                                  <asp:TemplateField HeaderText="Territory Type" ItemStyle-Width="10%"
                                                    ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblterType" runat="server" Text='<%# Bind("Territory_Cat") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Worked With" ItemStyle-Wrap="false" ItemStyle-Width="15%"  ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblWorked_With" runat="server" Text='<%# Bind("Worked_with_Name") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField> 
                                                <asp:TemplateField HeaderText="POB" ItemStyle-Wrap="false" ItemStyle-Width="15%"  ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPOB" runat="server" Text='<%# Bind("POB") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField> 
                                                <asp:TemplateField HeaderText="Product Detailed" ItemStyle-Wrap="false" ItemStyle-Width="45%"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblProduct_Detail" runat="server" Text='<%# Bind("Detailed") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Product Sampled" ItemStyle-Wrap="false" ItemStyle-Width="45%"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblProduct_Sampled" runat="server" Text='<%# Bind("Sampled") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Product Rx" ItemStyle-Wrap="false" ItemStyle-Width="45%"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblProduct_Rx" runat="server" Text='<%# Bind("PrdRx") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Call FeedBack" ItemStyle-Wrap="false" ItemStyle-Width="35%"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCallFeedback" runat="server" Text='<%# Bind("CallFeed") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Call Remark" ItemStyle-Wrap="false" ItemStyle-Width="35%"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCallRemarks" runat="server" Text='<%# Bind("Activity_Remarks") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Actual Address" ItemStyle-Width="10%"
                                                    ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GVChemist" runat="server" Width="100%" HorizontalAlign="Center" GridLines="None"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="POB" ItemStyle-Width="200"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPOB" runat="server" Text='<%# Bind("POB") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Lat & Long" ItemStyle-Wrap="false" ItemStyle-Width="35%"
                                                 ...
                                                 <asp:TemplateField HeaderText="Actual Address" ItemStyle-Wrap="false" ItemStyle-Width="10%"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GVUnlstDr" runat="server" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Qualification" ItemStyle-Width="320"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDoc_Qua" runat="server" Text='<%# Bind("Doc_QuaName") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField> 
                                                <asp:TemplateField HeaderText="Sub Area" ItemStyle-Width="10%"
                                                    ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Left">
                                                ...
                                                <asp:TemplateField HeaderText="POB" ItemStyle-Width="10%"
                                                    ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPOB" runat="server" Text='<%# Bind("POB") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Product Sampled" ItemStyle-Wrap="false" ItemStyle-Width="45%"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblProduct_sample" runat="server" Text='<%# Bind("Sampled") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Product Rx" ItemStyle-Wrap="false" ItemStyle-Width="45%"
                                                    ItemStyle-HorizontalAlign="Left">
                                                ...
                                                <asp:TemplateField HeaderText="Call Remark" ItemStyle-Wrap="false" ItemStyle-Width="35%"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCallRemark" runat="server" Text='<%# Bind("Activity_Remarks") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField> 
                                                <asp:TemplateField HeaderText="Lat & Long" ItemStyle-Wrap="false" ItemStyle-Width="35%"
                                                    ItemStyle-HorizontalAlign="Left">
                                                ...
                                                <asp:TemplateField HeaderText="Actual Address" ItemStyle-Width="10%"
                                                    ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblActAddrs" runat="server" Text='<%# Bind("GeoAddrs") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>  
                                            </Columns>
                                            <EmptyDataRowStyle CssClass="no-result-area" />
                                ...
                                <div class="display-reportMaintable clearfix">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GVStockist" runat="server" AutoGenerateColumns="false" OnRowDataBound="GVStockist_RowDataBound"
                                            CellPadding="2" CssClass="table" EmptyDataText="" GridLines="None"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField
                                                    HeaderText="Actual Address" ItemStyle-HorizontalAlign="Left"
                                                    ItemStyle-Width="200">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblActAdrs" runat="server" Text='<%# Bind("GeoAddrs") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField
                                                    HeaderText="Lat & Long" ItemStyle-HorizontalAlign="Left"
                                                    ItemStyle-Width="200">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLatilong" runat="server" Text='<%# Bind("latilong") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <EmptyDataRowStyle CssClass="no-result-area" />

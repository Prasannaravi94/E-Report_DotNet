<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_CoreDr_Mgr_Period.aspx.cs" Inherits="MasterFiles_AnalysisReports_rpt_CoreDr_Mgr_Period" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showMissedDR(sfcode, fmon, fyr, sf_name) {
            //popUpObj = window.open("MissedCallReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rpt_Listeddr_CoreMap_Zoom.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &sf_name=" + sf_name,
          "_blank",
  "ModalPopUp," +
  "0" //+
  //"toolbar=no," +
  ...
  //"top = 0"
        ...
        function showMissedDR_2(sfcode, fmon, tmon, fyr, tyr, sf_name) {

            //popUpObj = window.open("MissedCallReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rpt_Listeddr_CoreMap_Zoom_Mnth.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&To_Month=" + tmon + "&Frm_year=" + fyr + "&To_year=" + tyr + " &sf_name=" + sf_name,
          "_blank",
  "ModalPopUp," +
  "0" //+
  //"toolbar=no," +

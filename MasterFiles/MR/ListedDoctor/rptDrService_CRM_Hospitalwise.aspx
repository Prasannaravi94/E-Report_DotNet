<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDrService_CRM_Hospitalwise.aspx.cs" Inherits="MasterFiles_MR_ListedDoctor_rptDrService_CRM_Hospitalwise" %>
...
<head runat="server">
    ...
    <title>CRM Analysis Hospital Wise</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div>
                <br />
                <%--    <asp:TextBox ID="txtDays" runat="server" onkeypress="return validateDec(event)" />--%>
                <center>
                    <table width="100%">
                        <tr>
                            <td></td>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <asp:Panel ID="pnlContents" runat="server">
                                    <div align="center">
                                        <asp:Label ID="lblHead" runat="server" Text="Doctor Service CRM Report" CssClass="reportheader"></asp:Label>
                                        <br />
                                        <br />

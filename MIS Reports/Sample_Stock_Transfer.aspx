<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sample_Stock_Transfer.aspx.cs" Inherits="MIS_Reports_Sample_Stock_Transfer" %>
   ...
   <script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
    ...
    <%--<script type="text/javascript">
        function jsFunction(value) {
            if (value == "3") {
                var x = document.getElementById("ddlmon");
                var y = document.getElementById("ddlyear");
                var z = document.getElementById("tofieldforce");
            ...
            $.ajax({
                ...
                url: "Sample_Stock_Transfer.aspx/FillMRfor_mr",
                data: {},
                dataType: "json",
                        ...
                        <asp:GridView ID="grdsample" runat="server" AutoGenerateColumns="false" CssClass="table" PagerStyle-CssClass="gridview1" GridLines="None" EmptyDataText="No Records Found" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ERP Code">
                                    <ItemTemplate>
                                        <asp:Label ID="lblsaleerpcode" runat="server" Text='<%#Eval("Sample_Erp_Code") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Closing Balance">
                                    <ItemTemplate>
                                        <asp:Label ID="lblClosingBal" runat="server" Text='<%#Eval("Sample_AsonDate") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                        ...
                        <asp:GridView ID="grdadjusment" runat="server" AutoGenerateColumns="false" CssClass="table" PagerStyle-CssClass="gridview1" GridLines="None" EmptyDataText="No Records Found" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ClosingBalance">
                                    <ItemTemplate>
                                        <asp:Label ID="lblClosingBal" runat="server" CssClass="ClosingBal" Text='<%#Eval("Sample_AsonDate") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

...
public partial class Reports_rptCampaign_View : System.Web.UI.Page
{
    ...
    private void CreateDynamicTable()
    {
        ...
        if (Request.QueryString["mode"] != null)
        {
            ...
            else if (Request.QueryString["mode"].ToString() == "2")
            {
                sf_code = Request.QueryString["sf_code"].ToString();
            }
            else if (Request.QueryString["mode"].ToString() == "3")
            {
                sf_code = Request.QueryString["sf_code"].ToString();
            }
            else if (Request.QueryString["mode"].ToString() == "4")
            {
                sf_code = Request.QueryString["sf_code"].ToString();
            }
        }
        ...
        if (dsListedDR.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsListedDR.Tables[0].Rows)
            {
                ...
                tc_sf.BorderWidth = 1;
                //tc_FF.Width = 400;
                tc_sf.BorderColor = System.Drawing.Color.Gray;
                ...
                //tc_FF.Width = 400;
                tc_doc.BorderColor = System.Drawing.Color.Gray;
                ...
                tc_spec.BorderColor = System.Drawing.Color.Gray;
                ...
                tc_catg.BorderColor = System.Drawing.Color.Gray;
                ...
                tc_qual.BorderColor = System.Drawing.Color.Gray;
                ...
                tc_class.BorderColor = System.Drawing.Color.Gray;
                ...
                if (Request.QueryString["sf_code"].ToString().Contains("MGR"))
                {
                    // dsSfMR = sf1.SalesForceList_New(div_code, sf_code);

                    dsSfMR = sf1.getSecSales_MR(div_code, sf_code);
                }
                else if (Request.QueryString["sf_code"].ToString().Contains("admin"))
                {
                    //  dsSfMR = sf1.SalesForceList_New(div_code, sf_code);
                    dsSfMR = sf1.getSecSales_MR(div_code, sf_code);
                }
                ...
                {
                    dsSfMR = sf1.getMR_Doc_List(div_code, sf_code);
                ...
                foreach (DataRow dr in dsSfMR.Tables[0].Rows)
                {
                    ...
                    if (dtRP.Rows.Count != 0)
                    {
                        foreach (DataRow drRP in dtRP.Rows)
                        {
                            ...
                            tc_SNo_det.BorderColor = System.Drawing.Color.Gray;
                            ...
                            ////tc_FF.Width = 400;
                            tc_sf_det.BorderColor = System.Drawing.Color.Gray;
                            ...
                            ////tc_FF.Width = 400;
                            tc_doc_det.BorderColor = System.Drawing.Color.Gray;
                            ...
                            tc_spec_det.BorderColor = System.Drawing.Color.Gray;
                            ...
                            tc_catg_det.BorderColor = System.Drawing.Color.Gray;
                            ...
                            tc_qual_det.BorderColor = System.Drawing.Color.Gray;
                            ...
                            tc_class_det.BorderColor = System.Drawing.Color.Gray;

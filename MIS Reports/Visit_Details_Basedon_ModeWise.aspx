<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Basedon_ModeWise.aspx.cs" Inherits="MIS_Reports_Visit_Details_Basedonfield" %>
...
<head runat="server">
    <title>Visit Details (Based on Mode Wise)</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name, cmode, div_code) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("Visit_Details_Basedon_ModeWise_Report.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name + "&cMode=" + cmode + "&div_code=" + div_code,
        ...
        //"top=0"
            ...
            $(popUpObj.document.body).ready(function () {
                var ImgSrc = "https://s4.postimg.org/mzh117fv1/loading17.gif"
                $(popUpObj.document.body).append('<div><p style="color:orange;margin-top:10%;margin-left:35%;"></p></div><div class="preload"> <img src="' + ImgSrc + '"  style=" width:250px; height: 250px;position: fixed;top: 20%;left: 30%;"  alt="" /></div>');
            });
        }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                var FMonth = new Date(frmMonYear[0] + '-1-01').getMonth() + 1 == "NaN" ? new Date(frmMonYear[0] + '-1-01').getMonth() + 1 :
                    new Date(frmMonYear[0] + '01, 0001').getMonth() + 1;
                var FYear = frmMonYear[1];
                ...
                if (ddMdINDEX != 0 && ddMdINDEX != 4) {
                    ...
                    TMonth = new Date(ToMonYear[0] + '-1-01').getMonth() + 1 == "NaN" ? new Date(ToMonYear[0] + '-1-01').getMonth() + 1 :
                    ...
                    var mnth = FMonth, yr = parseInt(FYear), validate = '', tmp = '';
                    if ((FMonth <= TMonth && parseInt(FYear) === parseInt(TYear)) || (parseInt(FYear) < parseInt(TYear) && (FMonth <= TMonth || FMonth >= TMonth))) {
                        showModalPopUp(sf_Code, FMonth, FYear, TMonth, TYear, SName, ddMdINDEX, div_code);
                    }
                    else {
                ...
                if (ddMdINDEX != 0 && ddMdINDEX == 4) {
                    ...
                    showModalPopUp(sf_Code, FMonth, FYear, FMonth, FYear, SName, ddMdINDEX, div_code);
                }
            });
        });
    </script>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:DropDownList ID="ddlType" runat="server" CssClass="nice-select" AutoPostBack="true" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:DropDownList ID="ddlFieldForce" runat="server" CssClass="custom-select2 nice-select" Visible="false" AutoPostBack="false" Width="100%">

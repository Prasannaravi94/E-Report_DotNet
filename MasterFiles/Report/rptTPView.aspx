...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function popUp(Terr, Sf_Code, Date, Div_Code) {
            strOpen = "TerritoryWiseDrList.aspx?Terr=" + Terr + "&Sf_Code=" + Sf_Code + "&Date=" + Date + "&Div_Code=" + Div_Code
        ...
        <center>
            ...
            <div align="center" width="100%">
                <asp:GridView ID="grdTP" runat="server" Width="100%" HorizontalAlign="Center" BorderWidth="1"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#" ItemStyle-Width="50" HeaderStyle-BorderWidth="1"
                        ...
                        <asp:TemplateField HeaderText="Joint Work (WorkedWith)" ItemStyle-Width="200" HeaderStyle-BorderWidth="1"
                       ...
                       <%-- <asp:TemplateField HeaderText="Territory Planned1" ItemStyle-Width="200" HeaderStyle-BorderWidth="1"
                        ...
                        <asp:TemplateField HeaderStyle-BorderWidth="1" HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="50">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkcount" runat="server" CausesValidation="False" Text='<%# Eval("Tour_Schedule1") %>'
                                         OnClientClick='<%# "return popUp(\"" + Eval("Tour_Schedule1") + "\",\"" + Eval("sf_code")  + "\",\"" + Eval("tour_date")  + "\",\"" + Eval("division_code")  + "\");" %>' style="text-decoration:none;color:Black" >
                                        </asp:LinkButton>
                                    </ItemTemplate>
                         </asp:TemplateField>

                         <%--<asp:TemplateField ItemStyle-Width="100" HeaderStyle-BorderWidth="1" HeaderStyle-Font-Size="8pt"
                            ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:HyperLink Target="_blank" ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/MasterFiles/Report/TerritoryWiseDrList.aspx?Terr={0}&Sf_Code={1}",
                    HttpUtility.UrlEncode(Eval("Tour_Schedule1").ToString()), HttpUtility.UrlEncode(Eval("sf_code").ToString())) %>'
                                    Text='<%# Eval("Tour_Schedule1") %>' style="text-decoration:none;color:Black" />
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        ...
                        <asp:TemplateField HeaderText="Work Type" ItemStyle-Width="100" HeaderStyle-BorderWidth="1"
                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="lblWorkType1" runat="server" Text='<%# Bind("Worktype_Name_B1") %>'
                                    Font-Size="9pt"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <%--<asp:TemplateField ItemStyle-Width="100" HeaderStyle-BorderWidth="1" HeaderStyle-Font-Size="8pt"
                            ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:HyperLink Target="_blank" ID="HyperLink2" runat="server" NavigateUrl='<%# string.Format("~/MasterFiles/Report/TerritoryWiseDrList.aspx?Terr={0}&Sf_Code={1}",
                    HttpUtility.UrlEncode(Eval("Tour_Schedule2").ToString()), HttpUtility.UrlEncode(Eval("sf_code").ToString())) %>'
                                    Text='<%# Eval("Tour_Schedule2") %>' style="text-decoration:none;color:Black" />
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:TemplateField HeaderText="Work Type" ItemStyle-Width="100" HeaderStyle-BorderWidth="1"
                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="lblWorkType2" runat="server" Text='<%# Bind("Worktype_Name_B2") %>'
                                    Font-Size="9pt"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Territory Planned3" ItemStyle-Width="100" HeaderStyle-BorderWidth="1"
                         ...
                         <asp:TemplateField HeaderText="Manager_JFW" ItemStyle-Width="50" HeaderStyle-BorderWidth="1" Visible="false"
                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="lblManager_JFW" runat="server" Text='<%# Bind("Manager_JFW") %>'
                                    Font-Size="9pt"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

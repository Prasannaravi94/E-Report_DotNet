<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Unique_ListedDrDeactivate.aspx.cs"
    Inherits="MasterFiles_Common_Doctors_Unique_ListedDrDeactivate" %>
<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<%@ Register Src="~/UserControl/MR_Menu.ascx" TagName="Menu1" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Unique Doctor Deactivation</title>
            ...
            <tr>
              <td style="width:8%" />
                <td>
                    ...
                    <asp:DropDownList ID="ddlSrc2" runat="server"  Visible="false"
                       Width="130px"
                        SkinID="ddlRequired" TabIndex="4">
                    </asp:DropDownList>
                    <asp:Button ID="Btnsrc" runat="server" CssClass="savebutton" Width="30px" Height="25px" Text="Go" OnClick="Btnsrc_Click"
                        Visible="false" />
                </td>
            </tr>
        </table>
                        ...
                        <asp:GridView ID="grdDoctor" runat="server" Width="85%" HorizontalAlign="Center" EmptyDataText="No Records Found"
                            ...
                            <Columns>
                               ...
                               <asp:TemplateField HeaderText="Qualification" HeaderStyle-ForeColor="White">
                                ...
                                <asp:TemplateField HeaderText="Division Name" HeaderStyle-ForeColor="White">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Area Cluster Name" HeaderStyle-ForeColor="White">
                                  ...
                                  <asp:TemplateField HeaderText="Reason" HeaderStyle-ForeColor="White">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtReason" runat="server" Width="150px" SkinID="MandTxtBox"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Chmst_UnLstDr.aspx.cs" Inherits="MIS_Reports_Visit_Details_Basedonfield" %>
...
<head runat="server">
    <title>Visit Details For Chemist & UnListed Doctors</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name, cmode,div_code) {
            ...
            popUpObj = window.open("Visit_Details_Chmst_UnLstDr_Report.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name + "&cMode=" + cmode + "&div_code=" + div_code,
            ...
            $('#btnGo').click(function () {
                ...
                if (ddMdINDEX != 0 && ddMdINDEX != 4) {
                    ...
                    if ((frmMonth <= toMonth && parseInt(frmYear) === parseInt(toYear)) || (parseInt(frmYear) < parseInt(toYear) && (frmMonth <= toMonth || frmMonth >= toMonth))) {
                        showModalPopUp(sf_Code, frmMonth, frmYear, toMonth, toYear, SName, ddMdINDEX, div_code);
                    }
                    else {
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="designation-area clearfix">
                            <div class="single-des clearfix">
                                ...
                                <asp:DropDownList ID="ddlFieldForce" runat="server" SkinID="ddlRequired" CssClass="nice-select" AutoPostBack="false">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:DropDownList ID="ddlMR" runat="server" CssClass="nice-select" Visible="false" Width="100%"
                            ...
                            <div class="w-100 designation-submit-button text-center clearfix">
                                <asp:Button ID="btnGo" runat="server" Text="Go" CssClass="savebutton" Enabled="false" OnClick="btnGo_Click1" />
                            </div>
                        </div>
                    </div>
                </div>

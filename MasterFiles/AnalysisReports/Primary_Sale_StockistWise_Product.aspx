<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Primary_Sale_StockistWise_Product.aspx.cs" Inherits="MasterFiles_AnalysisReports_Primary_Sale_StockistWise_Product" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name, Stok_code, sk_Name,div_code) {
            popUpObj = window.open("rpt_Primary_Sale_StockistWise_Product.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name + "&selectedValue=" + "4" + "&Stok_code=" + Stok_code + " &sk_Name=" + sk_Name + " &div_code=" + div_code,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +

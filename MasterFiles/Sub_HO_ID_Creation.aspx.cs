...
public partial class MasterFiles_Sub_HO_ID_Creation : System.Web.UI.Page
{
        ...
        if (!Page.IsPostBack)
        {
            ...
            if ((HO_ID != "") && (HO_ID != null))
            {
                ...
                if (dsSales.Tables[0].Rows.Count > 0)
                {
                    ...
                    txtemp.Text = dsSales.Tables[0].Rows[0].ItemArray.GetValue(5).ToString();
                    rdoDCR.SelectedValue = dsSales.Tables[0].Rows[0].ItemArray.GetValue(6).ToString();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (HO_ID == null)
        {
           ...
           // int iReturn = sf.Sub_HO_ID_RecordAdd(txtUserName.Text.Trim(), txtPassword.Text.Trim(), txtName.Text.Trim(),"", div_code,"","", Ho_Id);
            int iReturn = sf.Sub_HO_ID_RecordAdd_With_Emp(txtUserName.Text.Trim(), txtPassword.Text.Trim(), txtName.Text.Trim(), "", div_code, "", "", Ho_Id, txtemp.Text.Trim(), rdoDCR.SelectedValue);
            if (iReturn > 0)
            {
        ...
        else
        {
            ...
            int iReturn = sf.Update_Sub_HO_Id_With_Emp(HO_Id, txtName.Text, txtUserName.Text, txtPassword.Text, div_code, txtemp.Text, rdoDCR.SelectedValue);
            if (iReturn > 0)
            {
    ...
    protected void btnBack_Click(object sender, EventArgs e)
    {
        ...
        System.Threading.Thread.Sleep(time);
        Response.Redirect("Sub_HO_ID_View.aspx");
    }
}
...
public partial class MasterFiles_MR_Chemist_Chemist_Terr_View : System.Web.UI.Page
{
    ...
    private void CreateDynamicTable(int tblRows, int tblCols)
    {
        ...
        if (ViewState["dsSalesForce"] != null)
        {
            ...
            tc_FF.ForeColor = System.Drawing.Color.FromName("#636d73");
            tc_FF.RowSpan = 2;
            ...
            tc_Total.ForeColor = System.Drawing.Color.FromName("#636d73");
            ...
            if (Session["sf_type"].ToString() == "1")
            {
                tr_catg.BackColor = System.Drawing.Color.FromName("#F1F5F8");

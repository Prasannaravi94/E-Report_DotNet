<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="deletesam.aspx.cs" Inherits="MasterFiles_AnalysisReports_deletesam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateDelete() {
            ...
            if (lstFieldForce.selectedIndex == 0) {
            ...
            if (ddlYear.selectedIndex == 0) {
                ...
                return confirm('Do you want to delete Input(s)?') && confirm('Are you sure want to delete permanently?');
            }
        }
        function Validate() {
            //          
            ...
            <div class="col-lg-5">
                <center>
                    <table>
                        <tr>
                            <td align="center">
                                <h2 class="text-center">Sample Despatch - Delete</h2>
                            </td>
                        </tr>
                    </table>
                </center>
                ...
                <div class="w-100 designation-submit-button text-center clearfix">
                    ...
                    <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="savebutton" OnClick="btnDelete_Click" OnClientClick="return ValidateDelete()" />
                                                    ...
                                                    <table>
                                                        <tr style="width: 100%; border-bottom: 1px solid #DCE2E8; border-right: 1px solid #DCE2E8; border-left: 1px solid #DCE2E8;">
                                                            ...
                                                            <td style="width: 250px; border-left: none;">
                                                                <asp:Label ID="lblProducts" runat="server" Text='<%# Eval("Product_Code") %>' Width="225px"></asp:Label>
                                                            </td>
                                                            <td style="width: 100px; border-left: none">
                                                                <asp:Label ID="lblprd_sale" runat="server" Text='<%#Eval("Product_Sale_Unit")%>' Width="75px"></asp:Label>
                                                            </td>
                                                            <td style="width: 175px; text-align: center;">
                                                                <asp:Label ID="Label3" runat="server" Text='<%#Eval("Despatch_Qty")%>' Width="100px"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                    ...
                    <table>
                        <tr>
                            <td colspan="4" align="center">
                                <asp:Button ID="btnSave" runat="server" Text="Delete" OnClientClick="return confirm('Are you sure to delete?'); " OnClick="btnSave_Click2"

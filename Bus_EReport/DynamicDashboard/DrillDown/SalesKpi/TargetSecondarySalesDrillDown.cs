...
namespace Bus_EReport.DynamicDashboard.DrillDown.SalesKpi
{
    ...
    public class TargetSecondarySalesDrillDown : DrilldownBase
    {
        ...
        public TargetSecondarySalesDrillDown()
        {
        ...
        {
            FileName = "Target Vs Secondary Sales";
            PreferenceName = "TargetSecondaryhSalesDrillDown";
        ...
        public string getQuery(bool count = false)
        {
            ...
            else
            {
                ...
                {
                    strQry += ",SUM(SecondarySales.Sale_Quantity) AS SalesQuantity";
                }
                ...
                {
                    strQry += ",SUM(SecondarySales.Sale_Value) AS SalesValue";
                }
            }
            strQry += " FROM Targets " +

...
function creCtrl() {
    ...
    var $sH = "<table class='noPrnCtrl' style='border-collapse:collapse;'><tr>"; if (NeNCtrl == false) $sH += "<td id='btnprint' style='border:solid 1px #000000;background-Color:#666633;color:#FFFFFF;cursor:pointer;font-size:13px' onclick=\"cnvtExc('_P')\">Print</td><td style='width:2px'></td><td style='border:solid 1px #000000;background-Color:#666633;color:#FFFFFF;font-size:13px;cursor:pointer' onclick=\"tableToExcel('divpnl','Sale Table')\">Excel</td>";
    if (window.opener != null) {
        $sH += "<td style='width:2px'></td><td style='border:solid 1px #000000;background-Color:#666633;color:#FFFFFF;font-size:13px;cursor:pointer' onclick=\"cnvtExc('_C')\">Close</td>"
    }
    $sH = $sH + "</tr></table>";

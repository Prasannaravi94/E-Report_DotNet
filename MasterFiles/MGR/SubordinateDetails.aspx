...
<body>
    ...
    <div>
        ...
        <center>
            ...
            <br />
            <center>
                <asp:Button ID="btnGo" runat="server" Text="Go" Width="35px" Height="25px" CssClass="savebutton"
                    OnClick="btnGo_Click" />
            </center>
            <br />
            <center>
                            ...
                            <asp:TemplateField HeaderText="Terr" >
                              ...
                              <asp:TemplateField HeaderText="DCR St.Date" >
                                <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="PassWord" HeaderStyle-ForeColor="White" Visible="false" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>

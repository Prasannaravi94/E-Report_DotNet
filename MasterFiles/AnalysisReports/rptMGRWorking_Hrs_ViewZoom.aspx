<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptMGRWorking_Hrs_ViewZoom.aspx.cs" Inherits="MasterFiles_AnalysisReports_rptMGRWorking_Hrs_ViewZoom" MaintainScrollPositionOnPostback="true" %>
                ...
                <asp:Panel ID="pnlContents" runat="server">
                    ...
                    <div class="display-reportMaintable clearfix">
                            <div class="table-responsive">
                                <asp:GridView ID="GrdTimeSt" runat="server" AlternatingRowStyle-CssClass="alt" CssClass="table table-bordered table-hover tbSSBFS"
                                    AutoGenerateColumns="false" EmptyDataText="No Records Found" Font-Bold="true" 
                                    GridLines="None" HorizontalAlign="Center"  AllowSorting="True" OnSorting="GrdTimeSt_Sorting"
                                     Width="100%">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sno">
                                         ...
                                         <asp:TemplateField HeaderText="Dr/Chm/Reminder Name" SortExpression="Name">
                                            <ItemTemplate>
                                                 <asp:Label ID="lblname" runat="server" CssClass="textHQ" Text='<%# Bind("Name") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Visted Date" SortExpression="Activity_Date">
                                            <ItemTemplate>
                                                 <asp:Label ID="lblActivity_Date" runat="server" CssClass="textHQ" Text='<%# Bind("Activity_Date") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Visted time" SortExpression="time">
                                            <ItemTemplate>
                                                 <asp:Label ID="lblActivity_time" runat="server" CssClass="textHQ" Text='<%# Bind("time") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Mode" SortExpression="mode">
                                            <ItemTemplate>
                                                 <asp:Label ID="lblmode" runat="server" CssClass="textHQ" Text='<%# Bind("mode") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                     
                                         <asp:TemplateField HeaderText="Speciality" SortExpression="SpecialityName">
                                            <ItemTemplate>
                                                 <asp:Label ID="lblspec" runat="server" CssClass="textHQ" Text='<%# Bind("SpecialityName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Category" SortExpression="CatName">
                                            <ItemTemplate>
                                                 <asp:Label ID="lblCat" runat="server" CssClass="textHQ" Text='<%# Bind("CatName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="Territory" SortExpression="TerritoryName">
                                            <ItemTemplate>
                                                 <asp:Label ID="lblTerritory" runat="server" CssClass="textHQ" Text='<%# Bind("TerritoryName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

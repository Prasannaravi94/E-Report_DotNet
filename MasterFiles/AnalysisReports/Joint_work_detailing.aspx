<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Joint_work_detailing.aspx.cs" Inherits="MasterFiles_AnalysisReports_Joint_work_detailing" %>
...
<head runat="server">
    <title>Slide Wise - Attendance</title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Slide Wise - Attendance</h2>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SecondarySale_Multi_Mnth_Dump_New.aspx.cs" Inherits="MasterFiles_AnalysisReports_SecondarySale_Multi_Mnth_Dump_New" %>
...
<head runat="server">
    <title>Secondary Sales - Dump </title>
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name, selectedValue) {
            popUpObj = window.open("rpt_SecondarySale_Multi_Mnth.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + "&To_year=" + tyear + "&To_Month=" + tmonth + "&selectedValue=" + selectedValue + "&sf_name=" + sf_name + "&Stok_code=" + "-2" + " &sk_Name=" + "",
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
    ...
    //"top=0"
        ...
        function showModalPopUp_HQ(sfcode, fmon, fyr, tyear, tmonth, sf_name, selectedValue, div_code) {
            popUpObj = window.open('/MasterFiles/ActivityReports/rptTargetVsSS_FF.aspx?&mode=' + selectedValue + '&sf_code=' + sfcode + '&sf_name=' + sf_name + '&fromMonthName=' + "" + '&Frm_Month=' + fmon + '&Frm_year=' + fyr + '&toMonthName=' + "" + '&To_Month=' + tmonth + '&To_year=' + tyear + '&div_code=' + div_code,
          ...
          var popUpObj2;
        function showModalPopUp_New(sfcode, fmon, fyr, tyear, tmonth, sf_name, selectedValue) {
            popUpObj2 = window.open("rpt_SecondarySale_Multi_Mnth.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + "&To_year=" + tyear + "&To_Month=" + tmonth + "&selectedValue=" + selectedValue + "&sf_name=" + sf_name + "&Stok_code=" + "-2" + " &sk_Name=" + "",
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
    ...
    //"top=0"
            ...
            popUpObj2.focus();
            $(popUpObj2.document.body).ready(function () {
                var ImgSrc = "https://s17.postimg.org/his04fcbz/v00106.gif"
                $(popUpObj2.document.body).append('<div><p style="color:red;">Loading Please Wait ....</p></div><div class="preload"> <img src="' + ImgSrc + '"  style=" width:200px; height: 200px;position: fixed;top: 10%;left: 10%;"  alt="" /></div>');
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                if (selectedValue == '9') {
                    showModalPopUp_HQ(sf_Code, Month1, Year1, Year2, Month2, Name, "9", div_code);
                }
                else if (selectedValue == '5') {
                    showModalPopUp_HQ(sf_Code, Month1, Year1, Year2, Month2, Name, "2",div_code);
                }
                else if (selectedValue == '8') {
                   showModalPopUp_New(sf_Code, Month1, Year1, Year2, Month2, Name, 5);
                }
                else {
                    showModalPopUp(sf_Code, Month1, Year1, Year2, Month2, Name, selectedValue);
                }
            });
        });
    </script>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $("[id*=rdolstrpt] input").on("click", function () {
                ...
                var selectedText = $(this).next().html();
                if (selectedValue == '3' || selectedValue == '4' || selectedValue == '6' || selectedValue == '5' || selectedValue == '8' || selectedValue == '9') {
                    $("#btnSubmit").css("display", "block");
                    $("#btnDump").css("display", "none");
                }
                else {
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <%--    <asp:ListItem Value="3" Text="Primary Sale HQ Wise(Bifurcation)&nbsp;&nbsp;&nbsp;" Selected="True"></asp:ListItem>--%>
                                  <%--     <asp:ListItem Value="4" Text="Secondary Sale Product Wise&nbsp;&nbsp;&nbsp;" Selected="True"></asp:ListItem>
                                   
                                   <asp:ListItem Value="6" Text="Secondary Sale HQ Wise&nbsp;&nbsp;&nbsp;"></asp:ListItem>--%>
                                      <asp:ListItem Value="8" Text="Secondary Sale Product Wise Comparision&nbsp;&nbsp;&nbsp;" Selected="True" ></asp:ListItem>
                                      <asp:ListItem Value="9" Text="Secondary Sale HQ Wise Comparision&nbsp;&nbsp;&nbsp;" ></asp:ListItem>

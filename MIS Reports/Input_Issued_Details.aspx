<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Input_Issued_Details.aspx.cs" Inherits="MIS_Reports_Input_Issued_Details" %>
...
<head runat="server">
    <title>Gift Issued Details</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name, div_code) {
            ...
            popUpObj = window.open("rptInputIssued_Details.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name + "&div_code=" + div_code,
   "ModalPopUp"//,
   //"toolbar=no," +
   //"scrollbars=yes," +
   //"location=no," +
        ...
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                if ((frmMonth <= toMonth && parseInt(frmYear) === parseInt(toYear)) || (parseInt(frmYear) < parseInt(toYear) && (frmMonth <= toMonth || frmMonth >= toMonth))) {
                    ...
                    showModalPopUp(sf_Code, frmMonth, frmYear, toMonth, frmYear, SName, div_code);
                }
                else {
    ...
    <form id="form1" runat="server">
        <div>
            <div id="Divid" runat="server">
             ...
             <asp:Panel ID="pnlContents" runat="server" Width="100%" Visible="true">
            <div class="container home-section-main-body position-relative clearfix">
                    ...
                    <div class="col-lg-5">
                        <center>
                            <table>
                                <tr>
                                    <td align="center">
                                        <h2 class="text-center">Input Periodical - Status</h2>
                                    </td>
                                </tr>
                            </table>
                        </center>
             ...
             <asp:Panel ID="Panel1" runat="server" Width="100%" Visible="false">
                 <center>
                     <asp:Label ID="lbllock" runat="server" Visible="true" CssClass="blink_me" Style="font-size:30px; color: red; font-weight: bold;">Under Maintenance </asp:Label>
                     </center>
                    </asp:Panel>
        </div>
    </form>

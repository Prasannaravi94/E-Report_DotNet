...
public partial class rpt_Stock_Product_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Primary Sale - Stockistwise for the Month of  " + strFrmMonth + " " + FYear;
    ...
    protected void GrdSale_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //{
            //    //// e.Row.Cells[8].Text = Math.Round(double.Parse(e.Row.Cells[8].Text), 2).ToString("");
            //    // e.Row.Cells[8].Text = Convert.ToInt32(e.Row.Cells[8].Text).ToString("#0.00");

            //    double value = Convert.ToDouble(e.Row.Cells[10].Text);
            //    e.Row.Cells[10].Text = System.Math.Round(value, 2).ToString();
    ...
    protected void GrdSale_RowCreated(object sender, GridViewRowEventArgs e)
    {
        SalesForce sf = new SalesForce();
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 1, "", "#F1F5F8", true);
            AddMergedCells(objgridviewrow, objtablecell, 1, "", "#F1F5F8", true);
            AddMergedCells(objgridviewrow, objtablecell, 1, "", "#F1F5F8", true);
            AddMergedCells(objgridviewrow, objtablecell, 1, "", "#F1F5F8", true);
            ...
            AddMergedCells(objgridviewrow2, objtablecell2, 0, "Customer", "#F1F5F8", false);
            AddMergedCells(objgridviewrow2, objtablecell2, 0, "State", "#F1F5F8", false);
            AddMergedCells(objgridviewrow2, objtablecell2, 0, "HQ-Wise", "#F1F5F8", false);

            AddMergedCells(objgridviewrow2, objtablecell2, 0, "Code", "#F1F5F8", false);

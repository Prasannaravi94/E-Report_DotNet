<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard_Product_Exp.aspx.cs" Inherits="MasterFiles_Dashboard_TargetvsSales"
...
<body>
                                            ...
                                            <div class="panel panel-primary">
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="container-fluid">
                                                            <div class="table-responsive">
                                                                <asp:GridView ID="GrdPrdExp" runat="server"
                                                                    AutoGenerateColumns="true" CssClass="table table-striped table-bordered table-hover tbSSBFS"
                                                                    EmptyDataText="No Records Found" OnRowCreated="GrdPrdExp_RowCreated" CellSpacing="0"
                                                                    OnRowDataBound="GrdPrdExp_RowDataBound" ShowHeader="False">
    ...
    <script>
        ...
        function show(sfcode, sf_name, cyear, cmonth, Prod_Name, Prod, sCurrentDate, mode, div_code) {
            popUpObj = window.open("/MIS Reports/rptProduct_Exp_Detail1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod + "&sCurrentDate=" + sCurrentDate + "&type=2" + "&mode=" + mode + "&div_code=" + div_code,
                                       "_blank",
                                      "ModalPopUp," +
                                      "toolbar=no," +
                                      "scrollbars=yes," +
        ...
        function showModal(sfcode, sf_name, Prod_Name, Prod, div_code) {
            popUpObj = window.open("/MIS Reports/rptProduct_Exp_Detail1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod + "&div_code=" + div_code,
                                       "_blank",
                                      "ModalPopUp," +
                                      "toolbar=no," +
                                      "scrollbars=yes," +

        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">HO ID Creation</h2>
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:TextBox ID="txtPassword" runat="server" TabIndex="3" CssClass="input" Width="100%" MaxLength="15" TextMode="Password" ></asp:TextBox>
                            </div>
                            ...
                            <div class="single-des clearfix">     
                    <asp:Label ID="lblemp" runat="server" Text="Employee ID" CssClass="label"></asp:Label>
               
            <asp:TextBox ID="txtemp" runat="server"  TabIndex="1" CssClass="input" Width="100%"></asp:TextBox>
                </div>

             <div class="single-des clearfix">   
               
                    <asp:Label ID="lbldcr" runat="server" Text="DCR Joint Work Display" CssClass="label"></asp:Label>
              <br />
                 <asp:RadioButtonList ID="rdoDCR" Font-Names="Verdana" Font-Size="11px" runat="server"

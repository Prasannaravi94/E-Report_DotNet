...
public partial class MasterFiles_FVAddExpense_Parameter : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            iReturn = terr.ExpenseParameter_Insert(txtParameter.Text, ddlExpenseType.SelectedValue, div_code, txtbse.Text, "1", txtmgr.Text, baselvl.ToString(), mgrlvl.ToString());
    ...
    {    
        Response.Redirect("FVExpense_Parameter.aspx");
    }
}
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptAutoexpense_View_Resigned_Cibles.aspx.cs"
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <asp:LinkButton Visible="false" ID="lnk" runat="server" Text="Old/Resigned Expense Process" CssClass="buttonlabel label" OnClick="lnk_Click">
                        </asp:LinkButton>
                    </div>
                    <div class="col-lg-5">

...
public partial class MasterFiles_MR_ListedDoctor_ListedDrEdit : System.Web.UI.Page
{
    ...
    protected DataSet FillCity()
    {
        ...
        dsListedDR = lstDR.FetchTown_MR(sf_code);
        return dsListedDR;
    }
    ...
    private void FillDoctor()
    {
        ...
        if (dsListedDR.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (GridViewRow gridRow in grdDoctor.Rows)
            {
                ...
                DropDownList ddlTown = (DropDownList)gridRow.Cells[8].FindControl("Town_City");
                DropDownList ddlgeo = (DropDownList)gridRow.Cells[17].FindControl("Geo_Tag_Count");
                ...
                if (dsCatgType.Tables[0].Rows.Count > 0)
                {
                    ...
                    ddlTown.SelectedValue = dsCatgType.Tables[0].Rows[0]["Town_City"].ToString();
                    ddlgeo.SelectedValue = dsCatgType.Tables[0].Rows[0]["Geo_Tag_Count"].ToString();
    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        ...
        if (count > 5)
        {
            ...
            ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>createCustomAlert('Cannot enter more than 5 field ');</script>");
        ...
        else
        {
            ...
            if (bsrch == true)
            {
                ...
                ShowHideTerritory();
                if (CblDoctorCode.Items[0].Selected == true || CblDoctorCode.Items[1].Selected == true || CblDoctorCode.Items[2].Selected == true || CblDoctorCode.Items[3].Selected == true || CblDoctorCode.Items[4].Selected == true || CblDoctorCode.Items[14].Selected == true || CblDoctorCode.Items[17].Selected == true || CblDoctorCode.Items[18].Selected == true)
                {
                    foreach (GridViewRow gridRow in grdDoctor.Rows)
                    {
                        ...
                        DropDownList ddlQual = (DropDownList)gridRow.Cells[6].FindControl("Doc_QuaCode");
                        DropDownList ddlClass = (DropDownList)gridRow.Cells[7].FindControl("Doc_ClsCode");
                        DropDownList Doctor_Type = (DropDownList)gridRow.Cells[17].FindControl("Doctor_Type");
                        DropDownList ddlTown = (DropDownList)gridRow.Cells[18].FindControl("Town_City");
                        DropDownList ddlgeo = (DropDownList)gridRow.Cells[19].FindControl("Geo_Tag_Count");
                        if (CblDoctorCode.Items[0].Selected == true || CblDoctorCode.Items[1].Selected == true || CblDoctorCode.Items[2].Selected == true || CblDoctorCode.Items[3].Selected == true || CblDoctorCode.Items[4].Selected == true || CblDoctorCode.Items[14].Selected == true || CblDoctorCode.Items[17].Selected == true || CblDoctorCode.Items[18].Selected == true)
                        {
                            DataSet dsCatgType = LstDoc.getDoctor_Terr_Catg_Spec_Class_Qual(Listed_DR_Code, sf_code, div_code);
                            if (dsCatgType.Tables[0].Rows.Count > 0)
                            {
                                ...
                                ddlClass.SelectedValue = dsCatgType.Tables[0].Rows[0].ItemArray.GetValue(3).ToString();
                                ddlQual.SelectedValue = dsCatgType.Tables[0].Rows[0].ItemArray.GetValue(4).ToString();
                                Doctor_Type.SelectedValue = dsCatgType.Tables[0].Rows[0].ItemArray.GetValue(6).ToString();
                                ddlTown.SelectedValue = dsCatgType.Tables[0].Rows[0]["Town_City"].ToString();
                                ddlgeo.SelectedValue = dsCatgType.Tables[0].Rows[0]["Geo_Tag_Count"].ToString();
                            }
                ...
                if (CblDoctorCode.Items[16].Selected == true)
                {
                    grdDoctor.Columns[20].Visible = true;
                }
                Territory terr = new Territory();
                dsTerritory = terr.getWorkAreaName(div_code);
            ...
            {
                ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>createCustomAlert('Please select atleast one field to edit');</script>");
                btnSave.Visible = false;
                btnUpdate.Visible = false;
            }
        }
    ...
    protected void btnClr_Click(object sender, EventArgs e)
    {
        ...
        //foreach (ListItem item in CblDoctorCode.Items)
        //{
        //    if ((item.Value) == "Doc_QuaCode" || (item.Value) == "ListedDR_Address1" || (item.Value) == "No_of_Visit" || (item.Value) == "ListedDR_Mobile" || (item.Value) == "ListedDR_Phone" || (item.Value) == "ListedDR_EMail" || (item.Value) == "ListedDr_PinCode")
        //    {
        //        item.Attributes.Add("style", "display:none;");
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdDoctor.Rows)
        {
            ...
            for (i = 0; i < CblDoctorCode.Items.Count; i++)
            {
                if (CblDoctorCode.Items[i].Selected == true)
                {
                    ...
                    if ((i != 0) && (i != 1) && (i != 2) && (i != 3) && (i != 4) && (i != 14) && (i != 17) && (i != 18))
                    {
                        ...
                        if (i == 15)
                        {
                            Label lblDoctorCode = (Label)gridRow.Cells[1].FindControl("lblDoctorCode");
                            Listed_DR_Code = lblDoctorCode.Text.ToString();
                            TextBox txtDay1 = (TextBox)gridRow.Cells[1].FindControl("txtDay1");
                            int stxtone = Convert.ToInt32(txtDay1.Text);
                            TextBox txtDay2 = (TextBox)gridRow.Cells[1].FindControl("txtDay2");
                            int stxttwo = Convert.ToInt32(txtDay2.Text);
                            TextBox txtDay3 = (TextBox)gridRow.Cells[1].FindControl("txtDay3");
                            int stxtthree = Convert.ToInt32(txtDay3.Text);
                            strTextBox = strTextBox + "Day_1" + "= " + stxtone + ",Day_2" + "= " + stxttwo + ",Day_3" + "= " + stxtthree + ",";
                        }
                        else if (i == 16)
                        {
                            Label lblDoctorCode = (Label)gridRow.Cells[1].FindControl("lblDoctorCode");
                            Listed_DR_Code = lblDoctorCode.Text.ToString();
                            TextBox txtContri = (TextBox)gridRow.Cells[1].FindControl("txtContri");
                            string Contri = txtContri.Text.Trim();
                            TextBox txtPot = (TextBox)gridRow.Cells[1].FindControl("txtPot");
                            string Poten = txtPot.Text.Trim();

                            strTextBox = strTextBox + "Dr_Potential" + "= '" + Poten + "',Dr_Contribution" + "= '" + Contri + "',";
                        }
                        else if ((i == 6) || (i == 7))
                        {
                            if (sTextBox.Text != "")
                            {
                                string Sdate = sTextBox.Text;
                                ...
                                string Stext = month + "/" + day + "/" + year;

                                Label lblDoctorCode = (Label)gridRow.Cells[1].FindControl("lblDoctorCode");
                                Listed_DR_Code = lblDoctorCode.Text.ToString();

                                strTextBox = strTextBox + CblDoctorCode.Items[i].Value + "= '" + Stext + "',";
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (CblDoctorCode.Items[i].Value.Trim() == "Doc_Special_Code")
                            {
                                ...
                                dsSpec = dc.getDocSpe(div_code, sDDL.SelectedValue.Trim());
                                if (dsSpec.Tables[0].Rows.Count > 0)
                                {
                                    spec_short_name = dsSpec.Tables[0].Rows[0]["Doc_Special_SName"].ToString();
                                }

                                strTextBox = strTextBox + "Doc_Spec_ShortName = '" + spec_short_name + "',";
            ...
            if (strTextBox.Trim().Length > 0)
            {
                ...
                ListedDR lstDR = new ListedDR();
                iReturn = lstDR.BulkEdit_New(strTextBox, Listed_DR_Code, div_code, sf_code);
                strTextBox = "";
            }
        }
        ...
        if (iReturn > 0)
        {
            ...
            //ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>createCustomAlert('Updated Successfully');window.location='ListedDrEdit.aspx'</script>");

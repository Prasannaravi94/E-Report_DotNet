...
//
//
public partial class MIS_Reports_rpt_Fully_Operative_Report : System.Web.UI.Page
{
    //
    #region Variables
    ...
    {       
        ...
        if (sReportType==1)
        {
            sHeading = " Fieldforcewise";
        }
       
        lblHead.Text = "Fully Operative Report "+sHeading+" Between  - " + strFrmMonth + " " + FYear +"  To  "+strToMonth+" "+TYear;
    ...
    private void FillReport()
    {
        ...
        string sProc_Name = "";
            ...
            //sProc_Name = "Full_Operative_Doctor_Detail_New";
        sProc_Name = "Full_Operative_Doctor_Detail_Chemis";//added 18-07-25
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Designation", "#003300", true);
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Joining Date", "#003300", true);
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "First Level Manager", "#003300", true);
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Second Level Manager", "#003300", true);
            //  AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Last DCR Date", "#003300", true);
            //
            ...
            for (int i = 0; i <= months; i++)
            {
                ...
                int iColSpan = 0;
                AddMergedCells(objgridviewrow2, objtablecell2, 2, 0, "Last DCR Date", "#003300", false);
                AddMergedCells(objgridviewrow2, objtablecell2, 0, 3, "Actual FW Days", "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "HQ", "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Other than HQ", "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Total FW", "#003300", false);

                foreach (DataRow dtRow in dsDoctor.Tables[0].Rows)
                {
                    int iCnt = 0;
                    iColSpan += Convert.ToInt32(dtRow["No_of_visit"].ToString()) + 1;
                    iCnt = Convert.ToInt32(dtRow["No_of_visit"].ToString()) + 1;
                    ...
                    AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Drs List", "#003300", false);
                    string sVstVal = "";
                ...
                AddMergedCells(objgridviewrow2, objtablecell2, 0, 2, "SVL", "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Drs List", "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Met", "#003300", false);

                AddMergedCells(objgridviewrow2, objtablecell2, 2, 0, " % ", "#003300", false);
                AddMergedCells(objgridviewrow2, objtablecell2, 2, 0, "Drs Visit", "#003300", false);
                AddMergedCells(objgridviewrow2, objtablecell2, 2, 0, "Call Avg", "#003300", false);


                AddMergedCells(objgridviewrow2, objtablecell2, 2, 0, "Chem Visit", "#003300", false);
                AddMergedCells(objgridviewrow2, objtablecell2, 2, 0, "Chem Call Avg", "#003300", false);


                string sTxt = "&nbsp;" + sf.getMonthName(cmonth.ToString()) + "-" + cyear;
             
                //AddMergedCells(objgridviewrow, objtablecell, 0, iColSpan + 9, sTxt, "#003300", true);
                AddMergedCells(objgridviewrow, objtablecell, 0, iColSpan + 11, sTxt, "#003300", true); //added
                cmonth = cmonth + 1;
                if (cmonth == 13)
                {
                    cmonth = 1;
    ...
    protected void GrdFixation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            for (int i = iColSpan + 11, j = 0; i < e.Row.Cells.Count; i += iColSpan + 11)//added 9-->11
            {
                int iMax = (e.Row.Cells[i].Text == "-") ? 0 : (e.Row.Cells[i].Text == "") ? 0 : (e.Row.Cells[i].Text == "&nbsp;") ? 0  : Convert.ToInt32(e.Row.Cells[i].Text);
                int iMin = (e.Row.Cells[i + 1].Text == "-") ? 0: (e.Row.Cells[i +1].Text == "") ? 0 : (e.Row.Cells[i + 1].Text == "&nbsp;") ? 0 : Convert.ToInt32(e.Row.Cells[i + 1].Text);
                ...
                if (iMax != 0 && iMin != 0)
                {
                    ...
                    e.Row.Cells[i + 2].Text = dCvg.ToString("##");
                }

                int iMax2 = (e.Row.Cells[i + 3].Text == "-") ? 0 : (e.Row.Cells[i + 3].Text == "") ? 0 : (e.Row.Cells[i + 3].Text == "&nbsp;") ? 0 : Convert.ToInt32(e.Row.Cells[i + 3].Text);
                int iMin2 = (e.Row.Cells[i - iColSpan - 1].Text == "-") ? 0 : (e.Row.Cells[i - iColSpan - 1].Text == "") ? 0 : (e.Row.Cells[i - iColSpan - 1].Text == "&nbsp;") ? 0 : Convert.ToInt32(e.Row.Cells[i - iColSpan - 1].Text);
                decimal dCvg2 = 0;
                decimal mCvg2 = 0;
                if (iMax2 != 0 && iMin2 != 0)
                {
                    dCvg2 = Decimal.Divide((iMax2), iMin2);
                    e.Row.Cells[i + 4].Text = dCvg2.ToString("0.##");
                }



                int iMaxchem1 = (e.Row.Cells[i + 5].Text == "-") ? 0 : (e.Row.Cells[i + 5].Text == "") ? 0 : (e.Row.Cells[i + 5].Text == "&nbsp;") ? 0 : Convert.ToInt32(e.Row.Cells[i + 5].Text);
                int iMinchem1 = (e.Row.Cells[i - iColSpan - 1].Text == "-") ? 0 : (e.Row.Cells[i - iColSpan - 1].Text == "") ? 0 : (e.Row.Cells[i - iColSpan - 1].Text == "&nbsp;") ? 0 : Convert.ToInt32(e.Row.Cells[i - iColSpan - 1].Text);
                decimal dCvgchem1 = 0;
                decimal mCvgchem1 = 0;
                if (iMaxchem1 != 0 && iMinchem1 != 0)
                {
                    //dCvgchem1 = Decimal.Divide((iMaxchem1 * 100), iMaxchem1);
                    //e.Row.Cells[i + 6].Text = dCvgchem1.ToString("##");

                    dCvgchem1 = Decimal.Divide((iMaxchem1), iMinchem1);
                    e.Row.Cells[i + 6].Text = dCvgchem1.ToString("0.##");
                ...
                int ilast = (e.Row.Cells[i - iColSpan - 4].Text == "-") ? 0 : (e.Row.Cells[i - iColSpan - 4].Text == "") ? 0 : (e.Row.Cells[i - iColSpan - 4].Text == "&nbsp;") ? 0 : Convert.ToInt32(e.Row.Cells[i - iColSpan - 4].Text);
                if (ilast != 0)
                {
                    e.Row.Cells[i - iColSpan - 4].Text = ilast + "/" + cmonth + "/" + cyear;
                }
                else
                {
                    e.Row.Cells[i - iColSpan - 4].Text = "";
                }
            ...
            try
            {
                ...
                e.Row.Attributes.Add("style", "background-color:" + "#" + Convert.ToString(dtrowClr.Rows[j][8].ToString()));
            }
            catch
            {

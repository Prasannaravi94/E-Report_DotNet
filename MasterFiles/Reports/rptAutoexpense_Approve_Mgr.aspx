<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptAutoexpense_Approve_Mgr.aspx.cs" Inherits="MasterFiles_Reports_rptAutoexpense_Approve_Mgr" %>
     ...
     <table>
                <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="lblhead" runat="server" SkinID="lblhead" Text="Your Setup Not Yet Fixed..... "></asp:Label>
                    </td>
                   </tr></table></center>
    </div>
        ...
        <center>
            <table>
                <tr>
                    ...
                    <td>&nbsp;&nbsp;&nbsp;</td>
                   <td><asp:Button ID="btnSF" runat="server" Width="30px" Height="25px" Text="Go" CssClass="savebutton"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Fieldforce Name">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="mgrFlagHidden" runat="server" Value='<%#Eval("mgr_flag")%>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>

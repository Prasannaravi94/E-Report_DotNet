<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard_Single_Dr_Analysis.aspx.cs" Inherits="MasterFiles_Single_Dr_Analysis"
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group form-group-sm">
                                        <asp:DropDownList ID="ddlFieldForce" runat="server" AutoPostBack="true"
                                            OnSelectedIndexChanged="ddlFieldForce_SelectedIndexChanged" CssClass="selectpicker" data-live-search="true">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group form-group-sm">
                                        <asp:DropDownList ID="ddlDr" runat="server" CssClass="selectpicker" data-live-search="true">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3">

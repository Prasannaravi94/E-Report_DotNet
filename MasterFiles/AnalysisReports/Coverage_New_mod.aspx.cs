...
public partial class MasterFiles_AnalysisReports_Coverage_New_Mod : System.Web.UI.Page
{
            ...
            foreach (DataRow drFF in dsFF.Tables[0].Rows)
            {
                if (drFF["sf_code"].ToString() != "admin")
                {
                    ...
                    if (drFF["sf_type"].ToString() == "1")
                    {
                        ...
                        //int itotWorkType = 0;
                        //int fldwrk_total = 0;
                        dsdoc = dcrdoc.Doctor_count(div_code, drFF["sf_code"].ToString(), cmonthdoc, cyeardoc, dtCurrent);
                        ...
                        int itotWorkType = 0;
                        int fldwrk_total = 0;
                        ds = dcr1.DCR_Doc_Met_Count(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        ...
                        // if (tot_fldwrk != "0")
                        if (Convert.ToDecimal(tot_fldwrkodc) != 0)
                        ...
                        dsdays = dcr1.Get_WorkDaysField_all(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        ...
                        dsField = dcr1.Get_WorkDaysFieldWork_All(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        ...
                        dsNonField = dcr1.Get_WorkDaysNoFW_All(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        ...
                        //   DataSet ds = new DataSet();
                        ds = dcr1.Get_WorkDaysLeave_All(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        ...
                        dsCall = dcr1.Get_Doc_sumary(drFF["sf_code"].ToString(), div_code, cmonthcall, cyearcall);
                        if (dsCall.Tables[0].Rows.Count > 0)
                            tot_docSeen = dsCall.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                        lit_det_call.Text = "" + tot_docSeen;
                        ...
                        lit_det_callavg.Text = "" + RoundLstCallAvg;
                        ...
                        string tot_wrkdays = "";
                        dsworkday = dcr1.Get_JW_Day_Mr(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        if (dsworkday.Tables[0].Rows.Count > 0)
                            tot_wrkdays = dsworkday.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                        TableCell tc_det_days = new TableCell();
                        Literal lit_det_days = new Literal();
                        lit_det_days.Text = "" + tot_wrkdays;
                        tc_det_days.BorderStyle = BorderStyle.Solid;
                        tc_det_days.BorderWidth = 1;
                        tc_det_days.Controls.Add(lit_det_days);
                        tc_det_days.HorizontalAlign = HorizontalAlign.Center;
                        ...
                        dsworkmet = dcr1.Get_JW_DocMet_Mr(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        if (dsworkmet.Tables[0].Rows.Count > 0)
                            tot_wrkdoc = dsworkmet.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                        lit_det_callmet.Text = "" + tot_wrkdoc;
                        ...
                        dsworkseen = dcr1.Get_JW_DocSeen_Mr(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        if (dsworkseen.Tables[0].Rows.Count > 0)
                            tot_wrkseen = dsworkseen.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                        lit_det_callseen.Text = "" + tot_wrkseen;
                        ...
                        lit_det_Jcallavg.Text = "" + RoundLstCallAvg5;
                    ...
                    else
                    {
                      //  TableRow tr_det = new TableRow();
                        ...
                        int itotWorkType = 0;
                        int fldwrk_total = 0;
                        ds = dcr1.Get_Doc_Met_cnt(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        //if (ds.tables[0].rows.count > 0)
                        //    tot_fldwrk = ds.tables[0].rows[0].itemarray.getvalue(0).tostring();
                        //itotworktype += fldwrk_total + convert.toint16(tot_fldwrk);
                        if (ds.Tables[0].Rows.Count > 0)
                            tot_fldwrk = ds.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                        itotWorkType += fldwrk_total + Convert.ToInt32(tot_fldwrk);
                       ...
                       // lit_det_FF.Text = " - ";
                        ...
                        DataSet dsworkday = new DataSet();
                        string tot_wrkdays = "";
                        dsworkday = dcr1.Get_JW_Day_MGR(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        if (dsworkday.Tables[0].Rows.Count > 0)
                            tot_wrkdays = dsworkday.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                        TableCell tc_det_days = new TableCell();
                        Literal lit_det_days = new Literal();
                        ...
                        string tot_wrkdoc = "";
                        DataSet dsworkmet = new DataSet();
                        dsworkmet = dcr1.Get_JW_DocMet_Mgr(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        if (dsworkmet.Tables[0].Rows.Count > 0)
                            tot_wrkdoc = dsworkmet.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                        lit_det_callmet.Text = "" + tot_wrkdoc;
                        tc_det_callmet.BorderStyle = BorderStyle.Solid;
                        ...
                        string tot_wrkseen = "";
                        DataSet dsworkseen = new DataSet();
                        dsworkseen = dcr1.Get_JW_DocSeen_Mgr(drFF["sf_code"].ToString(), div_code, cmonth1, cyear1);
                        if (dsworkseen.Tables[0].Rows.Count > 0)
                            tot_wrkseen = dsworkseen.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                        lit_det_callseen.Text = "" + tot_wrkseen;
                        tc_det_callseen.BorderStyle = BorderStyle.Solid;

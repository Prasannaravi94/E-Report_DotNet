...
public partial class MasterFiles_MR_Leave_Status : System.Web.UI.Page
{
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        ...
        int FYear = Convert.ToInt32(Convert.ToDateTime(txtFromMonthYear.Value).Year);
        int TYear = Convert.ToInt32(Convert.ToDateTime(txtToMonthYear.Value).Year);
        int FMonth = Convert.ToInt32(Convert.ToDateTime(txtFromMonthYear.Value).Month);
        int TMonth = Convert.ToInt32(Convert.ToDateTime(txtToMonthYear.Value).Month);
        ...
        else
        {
            if (FYear <= TYear)
            {
                ...
                // dsTP = adm.GetStatus(sf_code, ddlFMonth.SelectedValue, ddlFYear.SelectedValue, ddlTMonth.SelectedValue, ddlTYear.SelectedValue);
                ...
                //else
                //{
                //    dsTP = adm.GetStatus_MGR(sf_code, ddlFMonth.SelectedValue, ddlFYear.SelectedValue, ddlTMonth.SelectedValue, ddlTYear.SelectedValue);
                //}
                if (chk_indi.Checked)
                {
                    chk_self = "1";
                ...
                dsTP = adm.GetStatus_MGR_Self(div_code, sf_code, FMonth.ToString(), FYear.ToString(), TMonth.ToString(), TYear.ToString(), chk_self);
                // dsTP = adm.GetStatus_MGR_Self(div_code, sf_code, ddlFMonth.SelectedValue, ddlFYear.SelectedValue, ddlTMonth.SelectedValue, ddlTYear.SelectedValue);
                if (dsTP.Tables[0].Rows.Count > 0)
                {

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product_Priority_Wise.aspx.cs" Inherits="MIS_Reports_Product_Priority_Wise" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, ddlprod, prd_name, SName) {
            ...
            popUpObj = window.open("rptProduct_Priority_Wise.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&Prod=" + ddlprod + "&Prod_Name=" + prd_name + "&sf_name=" + SName,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Product Prioritywise Analysis</h2>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTargetVsSales_Cummulative_Performance.aspx.cs" Inherits="MasterFiles_ActivityReports_rptTargetVsSales_Cummulative_Performance" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .display-table {
            ...
            .display-table .table td:nth-column(2) {

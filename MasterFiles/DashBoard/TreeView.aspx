                                        ...
                                        <tr>
                                            <td>
                                                <asp:ListBox ID="lstmas" runat="server" CssClass="myListBox" AutoPostBack="true"
                                                    ...
                                                    <asp:ListItem Value="1">- Doctors Category</asp:ListItem>
                                                    <asp:ListItem Value="2">- Doctors Speciality</asp:ListItem>
                                                    <asp:ListItem Value="3">- Doctors Class</asp:ListItem>
                                                    <asp:ListItem Value="4">- Doctors Qualification</asp:ListItem>
                                                </asp:ListBox>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:ListBox ID="lstkpi" runat="server">
                                                    <asp:ListItem Value="1">- Doctors Coverage</asp:ListItem>

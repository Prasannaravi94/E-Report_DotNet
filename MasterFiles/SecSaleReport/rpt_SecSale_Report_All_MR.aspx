<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_SecSale_Report_All_MR.aspx.cs" Inherits="MasterFiles_SecSaleReport_rpt_SecSale_Report_All_MR" %>
                ...
                <div class="col-lg-12">
                    <asp:Panel ID="pnlContents" runat="server">
                        <div align="center">
                            ...
                            <asp:Label ID="lblstock" runat="server" CssClass="label" Font-Size="16px"></asp:Label>
                        </div>
                        <br />

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptAnalysis_Pob_count_Periodically.aspx.cs" Inherits="MasterFiles_AnalysisReports_rptAnalysis_Pob_count_Periodically" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, sf_name, mode, from_date, to_date) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rptAnalysis_Pob_count_Periodically2.aspx?sfcode=" + sfcode + "&sf_name=" + sf_name + "&mode=" + mode + "&from_date=" + from_date + "&to_date=" + to_date,
   "_blank",
  "ModalPopUp"//,
  //"toolbar=no," +
  //"scrollbars=yes," +
                                        ...
                                        <table width="100%">
                                            <caption>
                                                <asp:GridView ID="GrdFixation" runat="server" AlternatingRowStyle-CssClass="alt"
                                                    ...
                                                    GridLines="Both" HorizontalAlign="Center" BorderWidth="1" Style="background-color: white"

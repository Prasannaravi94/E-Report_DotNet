...
<head runat="server">
    <title>Doctor Speciality Serial No Generation</title>
    ...
    <div>
        ...
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center">
                <div class="col-lg-11">
                    <br />
                    <h2 class="text-center">Doctor Speciality Serial No Generation</h2>
                    <div class="display-table clearfix">
                        <div class="table-responsive">
                            <asp:GridView ID="grdDocCat" runat="server" Width="80%" HorizontalAlign="Center" EmptyDataText="No Records Found"
                               ...
                               <%-- <asp:BoundField DataField="Doc_Special_Code" ShowHeader="true" HeaderText="DR Cat Code"  ItemStyle-Width="7%"  Visible="false"/>--%>
                                <asp:BoundField DataField="Doc_Special_SName" ItemStyle-HorizontalAlign="Left" SortExpression="Doc_Special_SName" ShowHeader="true" HeaderText="Short Name"/>
                                <asp:BoundField DataField="Doc_Special_Name" ItemStyle-HorizontalAlign="Left" SortExpression="Doc_Special_Name" ShowHeader="true" HeaderText="Name" />
                        ...
                        <center>
                            <asp:Button ID="btnSubmit" runat="server" Text="Generate - Sl No" CssClass="savebutton" Width="125px" OnClick="btnSubmit_Click" />

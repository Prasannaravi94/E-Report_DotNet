 ...
 <asp:LinkButton ID="lnkQueries" runat="server" Text="Queries" ForeColor="Red" Font-Size="Medium" Font-Bold="true" ></asp:LinkButton>
	...
	<ul id="menu">
		...
		<li><a href="#">Information &raquo;</a>
			<ul>
                ...
                <li><a href="#">Listed Doctor Details &raquo;</a>
                <ul>                
                ...
                <li><a href="#">Unlisted Doctor Details &raquo;</a>
                <ul>
                <li><a href="../../../../MasterFiles/MR/UnListedDoctor/UnLstDoctorList.aspx" onclick="ShowProgress();">Entry</a></li>
                 <li><a href="../../../../MasterFiles/MR/UnListedDoctor/Unlisteddr_Terr_View.aspx" onclick="ShowProgress();">View</a></li>
                  ...
                  <li><a href="../../../../MasterFiles/MR/Doctor_Spec_List.aspx">Doctor - Speciality List</a></li>
                <li><a href="../../../../MasterFiles/MR/HolidayList_MR.aspx" onclick="ShowProgress();">Holiday List</a></li>
                <li><a href="../../../../MasterFiles/MR/ListedDr_Approval_Pending.aspx" onclick="ShowProgress();">Lst.Dr - Approval Pending View</a></li>
    		</ul>
		</li>
            ...
            <%--    <li><a href="../MasterFiles/MR_DCRAnalysis.aspx" onclick="ShowProgress();">DCR Analysis</a></li>--%>
                    ...
                    <ul>
                           <%--  <li><a href="../../../../MIS Reports/Visit_Details_Report.aspx" onclick="ShowProgress();">
                                Listed Doctorwise</a></li>--%>
                                  <li><a href="../../../../MasterFiles/AnalysisReports/Visit_Details_Cat_Cls_Spclty_LstDr_Wise.aspx" onclick="ShowProgress();">
                                Cat/Cls/Splty/LstDr Wise</a></li>
                ...
                <li><a href="#">Campaign &raquo;</a>
                     ...
                     <li><a href="#">Exception &raquo;</a>
                        <ul>
                            <li><a href="../../../../MIS Reports/TP_Deviation.aspx" onclick="ShowProgress();">Tour Plan</a>
                            </li>
                        </ul>
                    </li>
            </ul>
    ...
    <li><a href="../../../../MasterFiles/MR/UserManual_View.aspx" onclick="ShowProgress();">User Manual - View</a></li>               
                  ...
                  <li><a href="../../../../MasterFiles/MR/Leave_Status.aspx" onclick="ShowProgress();">Status</a></li>               
                    ...
                    <li><a href="../../../../MasterFiles/MR/Doctor-SubCategory-Map.aspx" onclick="ShowProgress();">Doctor - Campaign Map</a></li>               

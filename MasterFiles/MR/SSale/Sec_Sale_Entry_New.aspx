<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sec_Sale_Entry_New.aspx.cs" Inherits="MasterFiles_MR_SSale_Sec_Sale_Entry_New" %>
...
//                    }
            ...
            lb[lb.length - 6].innerHTML = total.toFixed(2);
            lb[lb.length - 9].innerHTML = OB.toFixed(2); 
        }
    ...
    <form id="form1" runat="server">
        ...
        <div>
         ...
         <%--   <table width="80%">
                ...
                <asp:GridView ID="grdProd" runat="server" Width="900px" Height="100%" HorizontalAlign="Center"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Prod_Code" Visible="false">
                            <ItemStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="lblProd_Code" runat="server" Text='<%#   Bind("Prod_Detail_Sl_No") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="OB" ItemStyle-Width="100px">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtOB" Width="40px" Style="text-align: right;" MaxLength="6" CssClass="TEXTAREA"
                                    Text='<%#(Eval("1_AAT"))%>' runat="server" onkeyup="CalculateOB();"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="CB" ItemStyle-Width="100px">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtCB" Width="60px" Style="text-align: right;" MaxLength="6" CssClass="TEXTAREA"
                                    Text='<%#(Eval("1_AFT"))%>' runat="server" onkeyup="CalculateTotals();"></asp:TextBox>
            ...
            <br />
            <center>
                <asp:Button ID="btnBackBill" runat="server" Text="Back to Bill Selection" Width="140px"
                    Height="25px" BackColor="LightBlue" OnClick="btnBackBill_Click" />
                &nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnDraft" runat="server" Text="Draft Save" Width="90px" Height="25px"
                Visible="false" BackColor="LightBlue" />
                &nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnApprove" runat="server" Text="Send to Manager Approval" Width="180px"
                OnClick="btnApprove_Click" Height="25px" BackColor="LightBlue" />
                &nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnSubmit" runat="server" Text="Approve" Width="80px" Height="25px"
                BackColor="LightBlue" OnClick="btnSubmit_Click" />
                &nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnReject" runat="server" Text="Reject" Width="80px" Height="25px"

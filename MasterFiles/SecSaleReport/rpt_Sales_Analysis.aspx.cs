...
public partial class MasterFiles_SecSaleReport_rpt_Sales_Analysis : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        if (St_Name.Trim() == "--ALL--")
        {
            sProc_Name = "SecSale_Analysis_Statewise_All";
            ...
            //  cmd.Parameters.AddWithValue("@state", St_Name);
        ...
        {
            sProc_Name = "SecSale_Analysis_Statewise";

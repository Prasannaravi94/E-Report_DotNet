<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="inputdelete.aspx.cs" Inherits="MasterFiles_ActivityReports_inputdelete" %>
            ...
            <div class="col-lg-5">
                <center>
                    <table>
                        <tr>
                            <td align="center">
                                <h2 class="text-center">Input Despatch - Delete</h2>
                            </td>
                        </tr>
                    </table>
                </center>
                <div class="designation-area clearfix">
                    ...
                    <div class="single-des clearfix">
                        ...
                        <asp:RadioButtonList ID="rdoInput" runat="server" RepeatDirection="Horizontal" CellPadding="2" Width="230px"
                            Font-Bold="True">
                ...
                <div class="w-100 designation-submit-button text-center clearfix">
                    ...
                    <asp:Button ID="LinkButton1" runat="server" Text="Clear List" class="savebutton"
                        OnClick="LinkButton1_Click" OnClientClick="Reset()" />
                </div>
            </div>
            <div class="col-lg-12">
                <table>
                ...
                <center>
                                                ...
                                                <div style="height: 50px; width: 100%">
                                                    <div style="height: 50px;">
                                                        <table style="width: 100%; background-color: #f1f5f8;">
                                                            <tr>
                                                                <td style="width: 75px; height: 50px !important; text-align: center;">
                                                ...
                                                <div style="height: 30px; width: 100%">
                                                    <table>
                                                        <tr style="width: 100%; border-bottom: 1px solid #DCE2E8; border-right: 1px solid #DCE2E8; border-left: 1px solid #DCE2E8;">
                                                            ...
                                                            <td style="width: 175px; text-align: center;">
                                                                <asp:Label ID="txtQuantity" runat="server" Text='<%#Eval("Despatch_Qty")%>' Width="100px"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                    ...
                    <table>
                        <tr>
                            <td colspan="4" align="center" style="padding-right: 90px;">

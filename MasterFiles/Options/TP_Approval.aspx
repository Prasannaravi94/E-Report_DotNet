...
<body>
    ...
    <div>
        ...
        <div style="margin-left: 40%">
            <asp:Button ID="btnSave" CssClass="savebutton" runat="server" Width="90px" Text="Approve TP" OnClick="btnSave_Click" 
                OnClientClick="return ValidateEmptyValue()" />
            &nbsp
            
                    <asp:Button ID="btnReject" CssClass="savebutton" runat="server" Text="Reject TP" Width="90px" OnClick="btnReject_Click"/>

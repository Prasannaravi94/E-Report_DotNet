...
public partial class MasterFiles_MR_RptAutoExpense : System.Web.UI.Page
{
    ...
    string dcrstart_Date = string.Empty;
    string dcrend_Date = string.Empty;
    string divcode = string.Empty;
    string mon = string.Empty;
    string yr = string.Empty;
    string s4 = string.Empty;
    string s5 = string.Empty;
    //string dcrend_Date1 = null;
    //string dcrstart_Date1 = null;
    ...
    string dcrstart_Date1 = string.Empty;
    string dcrend_Date1 = string.Empty;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        mon = Request.QueryString["cur_month"].ToString();
        yr = Request.QueryString["cur_year"].ToString();
        sfcode = Request.QueryString["sf_code"].ToString();
        dcrstart_Date= Request.QueryString["DcrStartDate"].ToString();
        dcrend_Date = Request.QueryString["DcrEndDate"].ToString();
        string[] Trans_DateSplit1 = dcrstart_Date.Split('/');
         dcrstart_Date1 = Trans_DateSplit1[1] + "/" + Trans_DateSplit1[0] + "/" + Trans_DateSplit1[2];
        string[] Trans_DateSplit2 = dcrend_Date.Split('/');
         dcrend_Date1 = Trans_DateSplit2[1] + "/" + Trans_DateSplit2[0] + "/" + Trans_DateSplit2[2];
    ...
    private void grdExp()
    {
            ...
            DataTable ds = Exp.getFieldForce_Vacant(divcode, sfcode, dcrstart_Date1, dcrend_Date1);
            ...
            DataTable headDetailsDt = Exp.getFieldForce_Vacant_slno(sfcode, mon, yr, dcrstart_Date1, dcrend_Date1);
            ...
            else
            {
                ...
                expenseDataset = Exp.getExpense_Vacant(sfcode, mon, yr, dcrstart_Date1, dcrend_Date1);
    ...
    protected void btnField_Click(object sender, EventArgs e)
    {
        ...
        DataTable headDetailsDt = dsCa.getFieldForce_Vacant_slno(sfcode, mon, yr, dcrstart_Date1, dcrend_Date1);
        if (headDetailsDt.Rows.Count > 0)
        {
    ...
    private void saveData(string flag)
    {
        ...
        DataTable ds1 = dist.getFieldForce_Vacant(divcode, sfcode, dcrstart_Date1, dcrend_Date1);
        string soj = ds1.Rows[0]["Sf_Joining_Date"].ToString();
        DataTable sfvacant = dist.getFieldForce_Vacant_month(sfcode, mon, yr, dcrend_Date);
        if (sfvacant.Rows.Count > 0)
        {
            DataTable sfvacslno = dist.getFieldForce_Vacant_slno(sfcode, mon, yr, dcrstart_Date1, dcrend_Date1);
    ...
    private void generateOtherExpControls(Distance_calculation dist)
    {
        ...
        DataTable headDetailsDt = dist.getFieldForce_Vacant_slno(sfcode, mon, yr, dcrstart_Date1, dcrend_Date1);

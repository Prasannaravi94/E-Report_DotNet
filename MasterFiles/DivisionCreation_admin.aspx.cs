...
public partial class MasterFiles_DivisionCreation_admin : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (div_code == null)
        {
            ...
            if (iReturn > 0)
            {
                ...
                var datasource = "103.171.45.109,26578";//your server
                var database = "SANeFORCE_Billing"; //your database name
                var username = "FPL2PA5I"; //username of server to connect
                var password = "948xNgzS@0Fxc*NwSe05_3dEy=MT"; //password
                ...
                conn.Open();
                using (SqlCommand command = new SqlCommand("insert into mas_new_division_updation (Div_name,URL,created_date)values('" + div_name + "','torssfa',getdate())", conn)) //pass SQL query created above and connection
                {

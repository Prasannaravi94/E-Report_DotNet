...
public partial class Reports_rptDCRStatus : System.Web.UI.Page
{
    ...
    private void FillSalesForce(string div_code, string sf_code, int cmonth, int cyear)
    {
       ...
       {
           dtSalesforce = sf.getUserListReportingTo_WithVacant(div_code, sf_code, 0);
    ...
    private void CreateDynamicTable()
    {
        ...
        if (ViewState["dsSalesForce"] != null)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                lit_det_SNo.Text =  iCount.ToString() + "</center>";
                ...
                //dsSf = sf1.CheckSFNameVacant_Temp(drFF["sf_code"].ToString(), cmonth, cyear);
                //if (dsSf.Tables[0].Rows.Count > 0)
                //{
                //    int i = dsSf.Tables[0].Rows.Count - 1;
                //    string sf_name = dsSf.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                ...
                //        else
                //        {
                //            sf_name = strVacant[0] + " - " + drFF["sf_hq"].ToString() + " - " + drFF["Designation_Short_Name"].ToString();
                //        }
                //    }
                //    else
                //    {
                ...
                if (dsDCR.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow datarow in dsDCR.Tables[0].Rows)
                    {
                        while (ddate <= Convert.ToInt16(datarow["Activity_Date"].ToString()))
                        {
                            ...
                            if (sDCR.Trim() == "P" || sDCR.Trim() == "FW" && (sDCR.Trim() != "MD" || sDCR.Trim() != "MR") && (sDCR!="NA"))
                            {
                                tot_No_of_Days += 1;
                            }

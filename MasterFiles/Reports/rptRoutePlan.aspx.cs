...
public partial class Reports_rptRoutePlan : System.Web.UI.Page
{
    ...
    //{
    //    if (ddlMR.SelectedValue == "-1")
    //    {
    //        string sURL = "rptRoutePlanView.aspx?sf_code=" + ddlFieldForce.SelectedValue.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&mgract="+ 2+"   " ;

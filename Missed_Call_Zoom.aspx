<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Missed_Call_Zoom.aspx.cs" Inherits="Missed_Call_Zoom" %>
...
<head runat="server">
 ...
 //"top = 0"
        ...
        function showMissedDR_Zoom(sfcode, fmon, fyr, cmode, vmode, cnt, div_code, sfName) {
            //popUpObj = window.open("MissedCallReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("Missed_Call_Zoom_Team.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&cMode=" + cmode + "&vMode=" + vmode + "&cnt=" + cnt + "&div_code=" + div_code + "&sf_name=" + sfName,
         "_blank",
 "ModalPopUp" //+
 //"0," +
 //"toolbar=no," +
                    ...
                    <div class="col-lg-12">
                        <asp:Panel ID="pnlContents" runat="server">
                            <div align="center">
                                ...
                                <br />
                                <br />
                                <asp:Label ID="LblForceName" runat="server"  Font-Size="12pt"

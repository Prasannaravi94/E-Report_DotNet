<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Discipline_Coverage_Report.aspx.cs" Inherits="MasterFiles_AnalysisReports_Discipline_Coverage_Report" %>
...
<head runat="server">
    <title>Discipline Coverage Report</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name, Vacant) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rpt_Discipline_Coverage_Report.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name + " &Vacant=" + Vacant,
        ...
        //"top=0"
            ...
            $(popUpObj.document.body).ready(function () {
                ...
                var ImgSrc = "https://s8.postimg.cc/rpts09jwl/triangle_square_animation_ook.gif"
                $(popUpObj.document.body).append('<div><p style="color:orange;">Loading Please Wait.....</p></div><div class="preload"> <img src="' + ImgSrc + '"  style=" width:250px; height: 200px;position: fixed;top: 20%;left: 30%;"  alt="" /></div>');
            });
        }
        ...
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                if (chkDetail.checked) {
                    showModalPopUp(sf_Code, fromMon, fromYear, ToMon, ToYear, SName,0);
                }
                else {
                    showModalPopUp(sf_Code, fromMon, fromYear, ToMon, ToYear, SName,1);
                }
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Discipline Coverage Report</h2>
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <div style="float: right; width: 45%">
                                    <asp:Label ID="lblTMonth" runat="server" CssClass="label" Text="To Month-Year"></asp:Label>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TargetFixationValueView.aspx.cs" Inherits="MIS_Reports_doctorbusview" %>
...
<head id="Head1" runat="server">
    <title>Target Fixation Value - View</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sfname) {
            popUpObj = window.open("rptTargetFixationValueView.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sfname,
                        "ModalPopUp"//,
                        //"toolbar=no," +
                        //"scrollbars=yes," +
                        //"location=no," +
        ...
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                if (FYea <= TYea) {
                    ...
                    showModalPopUp(sfcode, FMont, TYea, TMont, TYea, sfname)
                }
            });
        });
    </script>
                ...
                <div class="col-lg-5">
                    <center>
                        <table>
                            <tr>
                                <td align="center">
                                    <h2 class="text-center">Target Valuewise View</h2>
                                </td>
                            </tr>
                        </table>
                    </center>

...
using System.Data;
using Bus_EReport;
public partial class MIS_Reports_ChemistCamp_View : System.Web.UI.Page
{
       ...
       private void FillSalesForce()
    {
       ...
       private void FillCampaign()
       {
           ...
           dsDoctor = doc.getChemCampaign_all(div_code);
           if (dsDoctor.Tables[0].Rows.Count > 0)
           {
               ddlCampaign.DataTextField = "chm_campaign_name";
               ddlCampaign.DataValueField = "chm_campaign_code";

     ...
     <script type="text/javascript">
        ...
        <center>
                ...
                <tr >
                    <td align="left">
                        <asp:CheckBoxList ID="CblSFCode" RepeatColumns="4" CssClass="Checkbox" runat="server" style="margin-left:280px"
                            ...
                            <asp:ListItem Value="Fieldforce_Type">&nbsp;Fieldforce Type</asp:ListItem>
                        </asp:CheckBoxList>
                    </td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    <td align="center">
                        <asp:Button ID="btnOk" runat="server" CssClass="savebutton" Text="Ok" Width="35px" Height="25px" OnClick="btnOk_Click" />
                        <asp:Button ID="btnClr" CssClass="savebutton" runat="server" Text="Clear"  Width="60px" Height="25px"
     ...
     <a onclick="Sys.Extended.UI.PopupControlBehavior.__VisiblePopup.hidePopup();return false;"
       title="Close">X</a>
                                   ...
                                   <asp:TemplateField HeaderText="Fieldforce Type" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="Fieldforce_Type" runat="server" Width="180px" SkinID="ddlRequired">
               ...
               <br />
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="btnUpdate" CssClass="savebutton" runat="server" Width="70px" Height="25px" Text="Update" OnClick="btnUpdate_Click" />
                    </td>
                </tr>
            </table>
        </center>

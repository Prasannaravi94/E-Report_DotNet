<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard_Product_prclst.aspx.cs" Inherits="MasterFiles_Dashboard_Product_prclst"
                ...
                <nav class="navbar navbar-default">
                    <div class="container" style="margin-top: 12px;">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group form-group-sm">
                                    <asp:DropDownList ID="ddlState" runat="server" CssClass="selectpicker" data-live-search="true">
                                    </asp:DropDownList>
                                </div>
                            </div>                       

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_SecSale_Free_Product_HQwise_Sale.aspx.cs"
    Inherits="MasterFiles_AnalysisReports_rpt_SecSale_Free_Product_HQwise_Sale" %>
...
<head id="Head1" runat="server">
    ...
    <%-- <script src="../../JScript/Service_CRM/SecSale/rpt_Product_HQ_Sale_JS.js" type="text/javascript"></script>--%>

    <script src="../../JScript/Service_CRM/SecSale/rpt_HQwise_Rpt_Sale_JS.js" type="text/javascript"></script>
    <style type="text/css">
        .noPrnCtrl {
                            ...
                            <asp:Panel ID="pnlContents" runat="server">
                                <div id="MainDiv">
                                    ...
                                    <div class="display-reportMaintable clearfix">
                                        <div class="table-responsive" style="scrollbar-width: thin; overflow: inherit;background: white">
                                            <div id="divpnl" style="background: white">
                                            </div>
                                            <br />
                                            <div id="div_DeAct">
                                            </div>

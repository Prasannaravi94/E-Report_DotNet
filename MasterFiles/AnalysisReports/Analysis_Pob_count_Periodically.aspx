<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Analysis_Pob_count_Periodically.aspx.cs" Inherits="MasterFiles_AnalysisReports_Analysis_Pob_count_Periodically" %>
...
<head id="Head1" runat="server">
    <title>Product wise Rx Report</title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Product wise Rx Report</h2>

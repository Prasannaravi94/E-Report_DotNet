...
public partial class MasterFiles_MR_Order_BookingStatus : System.Web.UI.Page
{
    #region "Declaration"
    DataSet dsDoc = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //if(ddlFieldForce.SelectedItem.ToString()!="---Select---")
        //{
        //    FillDoc();
        //}
    }
    ...
    private void FillDoc()
    {
        ...
        strQry = " EXEC Rpt_Order_Booking_Status '" + div_code + "', '" + ddlFieldForce.SelectedValue.ToString() + "', '" + (txtEffFrom.Text) + "', '" + (txtEffTo.Text) + "','" + ddlMode.SelectedValue.ToString() + "' ";
    ...
    protected void btnReject_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdDoctor.Rows)
        {
            ...
            if ((ListedDR.Trim().Length > 0) && (Trans_SlNo.Trim().Length > 0) && (bCheck == true))
            {
                ...
                iReturn = lstDR.Update_Order_Booking_Status(ListedDR, 2, div_code, Trans_SlNo, ddlReson.SelectedItem.ToString(), txtRmrks.Text);
            }
        }

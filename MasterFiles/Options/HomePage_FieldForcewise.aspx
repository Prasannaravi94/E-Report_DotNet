                ...
                <div class="col-lg-5">
                    ...
                    <div class="designation-area clearfix">
                        <div class="single-des clearfix">
                            ...
                            <asp:Label ID="lblFilter" runat="server" CssClass="label">Filter By Manager</asp:Label>
                            <asp:DropDownList ID="ddlFilter" CssClass="custom-select2 nice-select" runat="server">
                            </asp:DropDownList>
                        ...
                        <div class="single-des clearfix">
                            <asp:Label ID="lblSelect" Text="" runat="server" ForeColor="Red" CssClass="label">Please Select the Filter By Manager</asp:Label>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="display-table clearfix">
                            <div class="table-responsive">
                                <asp:GridView ID="grdSalesForce" runat="server" Width="100%" HorizontalAlign="Center"
                                    ...
                                    CssClass="table" PagerStyle-CssClass="gridview1" OnRowCommand="grdSalesForce_RowCommand" OnRowDeleting="grdSalesForce_RowDeleting"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Uploaded File" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Button ID="bt_upload" runat="server" EnableViewState="False" Width="80px" Height="25px" Text="Upload" CssClass="savebutton" CommandName="Upload" OnClick="bt_upload_OnClick" />
                                            </ItemTemplate>
                                        </asp:TemplateField>

...
public partial class MIS_Reports_rptTP_Dev_atglance_new2 : System.Web.UI.Page
{
    ...
    private void FillDeviation()
    {
        ...
        dsSalesForce = sal.TP_Deviationat_glance_new(divcode, sfCode, Convert.ToInt16(FMonth), Convert.ToInt16(FYear));

        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            if (sfCode.Contains("MR"))
            {
                this.grdTP.Columns[8].Visible = false;
                this.grdTP.Columns[11].Visible = false;
            }
    ...
    protected void grdTP_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 0, "Date", "#0097AC", true);
            AddMergedCells(objgridviewrow, objtablecell, 0, "Day", "#0097AC", true);


            if (sfCode.Contains("MGR"))
            {

                AddMergedCells(objgridviewrow, objtablecell, 3, "As Per TP", "#0097AC", true);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, "Worktype", "#D6E9C6", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, "Territory", "#D6E9C6", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, "Worked With", "#D6E9C6", false);



                AddMergedCells(objgridviewrow, objtablecell, 3, "As Per DCR", "#0097AC", true);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, "Worktype", "#D6E9C6", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, "Territory", "#D6E9C6", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, "Worked With", "#D6E9C6", false);
            }
            ...
            {
                AddMergedCells(objgridviewrow, objtablecell, 2, "As Per TP", "#0097AC", true);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, "Worktype", "#D6E9C6", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, "Territory", "#D6E9C6", false);
                ...
                AddMergedCells(objgridviewrow, objtablecell, 2, "As Per DCR", "#0097AC", true);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, "Worktype", "#D6E9C6", false);
                AddMergedCells(objgridviewrow1, objtablecell1, 0, "Territory", "#D6E9C6", false);

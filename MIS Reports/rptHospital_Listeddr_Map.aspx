<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptHospital_Listeddr_Map.aspx.cs"
    Inherits="Reports_Core_drs_details" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <asp:Panel ID="pnlContents" runat="server" Width="99%">
                            <div align="center">
                                <asp:Label ID="lblHead" runat="server" Text="Hospital - Listed Doctor Mapped Details" CssClass="reportheader"></asp:Label>
                                <br />
                                <br />
                                                   ...
                                                   AutoGenerateColumns="false" OnRowDataBound="grdDoctor_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Hospital Name" >
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblHName" runat="server" Text='<%# Bind("Hospital_Name") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

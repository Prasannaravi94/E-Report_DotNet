    ...
    <div >
        ...
        <table >
            ...
            <table width="100%" align="center">
                    ...
                    <tr>
                        <td align="center">
                            <asp:Label ID="lbldcr" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana" ForeColor="Chocolate">DCR</asp:Label>
                        </td>
                        <td><a href="MasterFiles/TMail/Mail_Head.aspx">.</a> </td>
                    </tr>
                    <tr>
                    <td align="center" >
                          <asp:GridView ID="grdDCR" runat="server" Width="65%" HorizontalAlign="Center" 
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField HeaderText="Approve" DataTextField="Month" DataNavigateUrlFormatString="~/MasterFiles/MR/TourPlan.aspx?refer={0}"
                                     ...
                                     <asp:HyperLinkField DataTextField="Month" ShowHeader="false"
                                            DataNavigateUrlFormatString="~/MasterFiles/MGR/TourPlan_Calen.aspx?refer={0}"
        ...
        <center>
            <table width="100%" align="center">
                <tbody>
                    <tr>
                        <td align="center">
                            <asp:Label ID="lblAdd" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana" ForeColor="Chocolate">Listed Doctor Addition</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
       ...
       <%--     <br />--%>
            ...
            <table width="100%" align="center">
                <tbody>
                    <tr>
                        <td align="center">
                            <asp:Label ID="Label1" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana" ForeColor="Chocolate">Listed Doctor Deactivation</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
       ...
       <%-- <br />--%>
        ...
        <br />  --%>
            ...
            <table width="100%" align="center">
                    ...
                    <tr>
                <td align="center">
                    <asp:GridView ID="grdLeave" runat="server" Width="65%" HorizontalAlign="Center" 
                        AutoGenerateColumns="false"  EmptyDataText="No Data found for Approval's"   
                        GridLines="None" CssClass="mGridImg" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
                        <HeaderStyle Font-Bold="False" />
                        <SelectedRowStyle BackColor="BurlyWood"/>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_At_a_Glance.aspx.cs" Inherits="MIS_Reports_Visit_Details_Basedonfield" %>
...
<head runat="server">
    <title>Visit Details (At a Glance)</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name, cmode, modewise,div_code) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("Visit_Details_At_a_Glance_Report.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name + "&cMode=" + cmode + "&modewise=" + modewise+ "&div_code=" + div_code,
        ...
        //"top=0"
            ...
            $(popUpObj.document.body).ready(function () {
                ...
                var ImgSrc = "https://s3.postimg.org/s213yc45v/loading15.gif"
                $(popUpObj.document.body).append('<div><p style="color:orange;"></p></div><div class="preload"> <img src="' + ImgSrc + '"  style=" width:400px; height: 380px;position: fixed;top: 20%;left: 30%;"  alt="" /></div>');
            });
        }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                var modewise = $('#ddlwise').find(":selected").index();
                ...
                if (ddMdINDEX != 0 && ddMdINDEX != 4) {
                    ...
                    var ToMonYear = document.getElementById('<%=txtToMonthYear.ClientID%>').value.split('-');
                    toMonth = new Date(ToMonYear[0] + '-1-01').getMonth() + 1 == "NaN" ? new Date(ToMonYear[0] + '-1-01').getMonth() + 1 :
                    ...
                    if ((frmMonth <= toMonth && parseInt(frmYear) === parseInt(toYear)) || (parseInt(frmYear) < parseInt(toYear) && (frmMonth <= toMonth || frmMonth >= toMonth))) {
                        showModalPopUp(sf_Code, frmMonth, frmYear, toMonth, toYear, SName, ddMdINDEX, modewise, div_code);
                    }
                    else {
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                <asp:DropDownList ID="ddlSF" runat="server" SkinID="ddlRequired" Visible="false" Width="100%">
                                </asp:DropDownList>
                            </div>
                            <div class="single-des clearfix">
                            ...
                            <div class="single-des clearfix">
                                <asp:Label ID="Label2" runat="server" CssClass="label" Text="Modewise"></asp:Label>
                                <asp:DropDownList ID="ddlwise" runat="server" CssClass="nice-select">
                                    <asp:ListItem Value="0" Text="Column Wise"></asp:ListItem>
                                    <asp:ListItem Value="1" Text="Row Wise"></asp:ListItem>

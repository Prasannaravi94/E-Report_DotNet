<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sec_Sale_Entry_Bk.aspx.cs" Inherits="MasterFiles_MR_SSale_Sec_Sale_Entry_Bk" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Button ID="btnDraft" runat="server" Text="Draft Save" Width="90px" Height="25px"
                ...
                &nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnApprove" runat="server" Text="Submit" Width="120px" 

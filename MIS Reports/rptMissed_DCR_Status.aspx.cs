...
public partial class MIS_Reports_rptMissed_DCR_Status : System.Web.UI.Page
{
    int cmonth = -1;
    int cyear = -1;
    ...
    protected void GrdDoctor_OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        string Delayed_Dates_Release_entry = "";
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            strNSDays = DataBinder.Eval(e.Row.DataItem, "DCR_Missed_Dates").ToString();
            strNSDays_Release = DataBinder.Eval(e.Row.DataItem, "Missed_Dates_Release").ToString();
            Delayed_Dates_Release_entry = DataBinder.Eval(e.Row.DataItem, "Missed_Dates_Release_entry").ToString();
            ...
            Label lblNSD_Re_entry = (Label)e.Row.FindControl("lblNSD_Re_entry");

            if (strNSDays == "" && strNSDays_Release == "" && Delayed_Dates_Release_entry == "")
            {
                e.Row.Visible = false;
            }
    ...
    private void FillSalesForce(int cmonth, int cyear)
    {
        ...
        dsSalesForce = sf.DCR_Missed_Dates(div_code, SF_code, cmonth.ToString(), cyear.ToString());

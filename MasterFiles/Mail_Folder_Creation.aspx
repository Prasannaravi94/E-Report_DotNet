    ...
    <div>
       ...
       <br />
        <table width="78%">
           <tr align="center" >
              <td>
                 <asp:Button ID="btnTransfer_mail" runat="server" CssClass="savebutton"  Width="90px" Height="25px" Text="Transfer Mail" onClick="btnTransfer_mail_Click" />
              </td>
            </tr>
        </table>
        <br />
         ...
         <center >
                  ...
                  <td colspan="2" align="center">
                        ...
                        <AlternatingRowStyle CssClass="alt" />
                           ...
                           <asp:TemplateField HeaderText="More" HeaderStyle-Width="40px">
                             <FooterTemplate>
                             <asp:Button ID="btnadd" runat="server" CssClass="savebutton" CausesValidation ="true"  Width="90px" Height="25px" CommandName ="Select" Text="Add Folder" OnClientClick="GetGridFooterRowvalues()" />
                         ...
                         <%--<EmptyDataRowStyle HorizontalAlign="Center" VerticalAlign="Middle" />--%>                              
                           ...
                           <asp:Button ID="btnaddnew" runat="server" CssClass="savebutton" Width="90px" Height="25px" Text="Add Folder" OnClick="btnaddnew_Click" />&nbsp
            ...
            <%--<table >
               <tr>
              <td align="center" >
                 <asp:Button ID="btnnew" runat="server" CssClass="savebutton" Width="70px" 

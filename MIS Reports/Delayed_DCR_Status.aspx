...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(cmon, cyear, SF_code) {
            ...
            popUpObj = window.open("rptDelayed_DCR_Status.aspx?cmon=" + cmon + "&cyear=" + cyear + "&SF_code=" + SF_code,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                var cmon = new Date(ToMonYear[0] + '-1-01').getMonth() + 1 == "NaN" ? new Date(ToMonYear[0] + '-1-01').getMonth() + 1 :
                    new Date(ToMonYear[0] + '01, 0001').getMonth() + 1;
                var cyear = ToMonYear[1];

...
public partial class MasterFiles_AnalysisReports_Consolidated_Report : System.Web.UI.Page
{
    ...
    private void BindDate()
    {
        ...
        if (dsTP.Tables[0].Rows.Count > 0)
        {
            ...
            txtMonthYear.Text = Month.ToString("MMM") + "-" + DateTime.Now.Year.ToString();

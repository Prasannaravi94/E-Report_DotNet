<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTP_Dev_MR.aspx.cs" Inherits="MIS_Reports_rptTP_Dev_MR" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>TP - Deviation (Base Level)</title>
    ...
    <style type="text/css">
        ...
        .display-Approvaltable .table tr:nth-child(n+4) td:nth-child(8), .display-Approvaltable .table tr:nth-child(n+4) td:nth-child(10) {
                            ...
                            <asp:Label ID="lblYear" runat="server" SkinID="lblMand"></asp:Label>
                                ...
                                <div class="display-Approvaltable clearfix">
                                    <div class="table-responsive" style="scrollbar-width: thin; overflow: inherit;">
                                        ...
                                        <asp:GridView ID="grdTP" runat="server" Width="100%" HorizontalAlign="Center" EmptyDataText="No Records Found" Style="background-color: white" AutoGenerateColumns="false" GridLines="Both" BorderColor="WhiteSmoke" BorderWidth="1" CssClass="table" AlternatingRowStyle-CssClass="alt" OnRowDataBound="grdTP_RowDataBound" OnRowCreated="grdTP_RowCreated" ShowHeader="false">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="DCR Territory" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDCR_terr" runat="server" Text='<%# Bind("DCR_terr") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

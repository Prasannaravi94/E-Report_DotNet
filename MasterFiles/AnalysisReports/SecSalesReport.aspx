...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name, Stok_code, sk_Name) {
            popUpObj = window.open("rpt_SecSale_Report.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name + " &Stok_code=" + Stok_code + " &sk_Name=" + sk_Name,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                if (rdolstrpt == 2) {
                    showModalPopUp(sf_Code, Month1, Year1, Year2, Month2, Name, Stok_code, stk_Name);
                }
                else if (rdolstrpt == 1) {

...
public partial class MIS_Reports_Visit_Details_Basedonfield_Level1 : System.Web.UI.Page
{
    ...
    
    {
        ...
        lblHead.Text = "Chemist - UnListed Doctors - Stockiest Visit Between  - " + strFrmMonth + " " + FYear + "  To  " + strToMonth + " " + TYear;
    ...
    private void FillReport()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("visit_details_Chmst_UnLst_NewTest", con);
    ...
    protected void GrdFixationMode_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "FieldForce Name", "#99FF99", true);
            ...
            for (int i = 0; i <= months; i++)
            {
                ...
                AddMergedCells(objgridviewrow, objtablecell, 0, 11, sTxt, "#99FF99", true);

                AddMergedCells(objgridviewrow2, objtablecell2, 0, 7, "Chemist", "#ccffcc", false);


                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Fw Days", "#99FF99", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "List", "#99FF99", false);

                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Met", "#99FF99", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Seen", "#99FF99", false);

                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Call.Avg", "#99FF99", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Covg(%)", "#99FF99", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Miss", "#99FF99", false);


                AddMergedCells(objgridviewrow2, objtablecell2, 0, 2, "UnList Drs", "#FFFFCC", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Met", "#99FF99", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Seen", "#99FF99", false);

                AddMergedCells(objgridviewrow2, objtablecell2, 0, 2, "Stockiest", "#FFFF", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Met", "#99FF99", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Seen", "#99FF99", false);
    ...
    protected void GrdFixationMode_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //
            #region Calculations
            int inxMnth = 0, inxYr = 0;
            int months = (Convert.ToInt32(Request.QueryString["Tyear"].ToString()) - Convert.ToInt32(Request.QueryString["Fyear"].ToString())) * 12 + Convert.ToInt32(Request.QueryString["TMonth"].ToString()) - Convert.ToInt32(Request.QueryString["FMonth"].ToString()); //(Date2.Year - Date1.Year) * 12 + Date2.Month - Date1.Month;
            int cmonth1 = Convert.ToInt32(Request.QueryString["FMonth"].ToString());
            int cyear1 = Convert.ToInt32(Request.QueryString["Fyear"].ToString());
                  ...
                  i4 = i4 + 11;
                    ...
                    try
                    {
                        ...
                        if (e.Row.Cells[i2].Text != "&nbsp;" && e.Row.Cells[i2].Text != "0" && e.Row.Cells[i2].Text != "-")
                        {
                            ...
                            hLink.Attributes.Add("onclick", "javascript:showModalPopUp('" + Convert.ToString(dtrowClr.Rows[indx][1].ToString()) + "', '" + e.Row.Cells[1].Text + "',  '" + iLstMonth[inxMnth] + "', '" + iLstYear[inxYr] + "', '" + cmonth + "', '" + cyear + "','" + e.Row.Cells[2].Text + "','" + e.Row.Cells[3].Text + "')");
                            hLink.ToolTip = "Click here";
                            hLink.Font.Underline = false;
                            hLink.ToolTip = AssignToolTip(iLstMonth[inxMnth].ToString(), iLstYear[inxYr].ToString());
                            hLink.ForeColor = System.Drawing.Color.Blue;
                            e.Row.Cells[i2].Controls.Add(hLink);
                        }
                        if (e.Row.Cells[i3].Text != "&nbsp;" && e.Row.Cells[i3].Text != "0" && e.Row.Cells[i3].Text != "-")
                        {
                            HyperLink hLink1 = new HyperLink();
                            hLink1.Text = e.Row.Cells[i3].Text;
                            hLink1.Attributes.Add("class", "btnDrSn");
                            hLink1.Attributes.Add("onclick", "javascript:showModalPopUp1('" + Convert.ToString(dtrowClr.Rows[indx][1].ToString()) + "', '" + e.Row.Cells[1].Text + "',  '" + iLstMonth[inxMnth] + "', '" + iLstYear[inxYr] + "', '" + cmonth + "', '" + cyear + "','" + e.Row.Cells[2].Text + "','" + e.Row.Cells[3].Text + "')");
                            hLink1.ToolTip = "Click here";
                            hLink1.Font.Underline = false;
                            hLink1.ToolTip = AssignToolTip(iLstMonth[inxMnth].ToString(), iLstYear[inxYr].ToString());
                            hLink1.ForeColor = System.Drawing.Color.Blue;
                            e.Row.Cells[i3].Controls.Add(hLink1);
                        }
                        if (e.Row.Cells[i4].Text != "&nbsp;" && e.Row.Cells[i4].Text != "0" && e.Row.Cells[i4].Text != "-")
                        {
                            HyperLink hLink2 = new HyperLink();
                            hLink2.Text = e.Row.Cells[i4].Text;
                            hLink2.Attributes.Add("class", "btnDrSn");
                            hLink2.Attributes.Add("onclick", "javascript:showModalPopUp2('" + Convert.ToString(dtrowClr.Rows[indx][1].ToString()) + "', '" + e.Row.Cells[1].Text + "',  '" + iLstMonth[inxMnth] + "', '" + iLstYear[inxYr] + "', '" + cmonth + "', '" + cyear + "','" + e.Row.Cells[2].Text + "','" + e.Row.Cells[3].Text + "')");
                            hLink2.ToolTip = "Click here";
                            hLink2.Font.Underline = false;
                            hLink2.ToolTip = AssignToolTip(iLstMonth[inxMnth].ToString(), iLstYear[inxYr].ToString());
                            hLink2.ForeColor = System.Drawing.Color.Blue;
                            e.Row.Cells[i4].Controls.Add(hLink2);
                        }
            ...
            for (int i1 = 4; i1 < e.Row.Cells.Count; i1++)
            {
                ...
                {
                    e.Row.Cells[i1].Text = "-";
                    e.Row.Cells[i1].Attributes.Add("style", "font-weight:normal;");
                }
    ...
    private string AssignToolTip(string sMnth, string sYr)
    {
        SalesForce sf = new SalesForce();

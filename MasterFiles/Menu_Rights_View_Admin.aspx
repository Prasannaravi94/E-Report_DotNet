<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Menu_Rights_View_Admin.aspx.cs" Inherits="MasterFiles_Menu_Rights_View_Admin" %>
                ...
                <td colspan="2" align="center" >
                     ...
                     <Columns >
                       <asp:TemplateField HeaderText="#" HeaderStyle-ForeColor="White">
                        ...
                        <asp:HyperLinkField HeaderText="Edit" Text="Edit" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="center" DataNavigateUrlFormatString="Menu_Rights_Creation_Admin.aspx?HO_ID={0}&amp;Division_Code={1} "

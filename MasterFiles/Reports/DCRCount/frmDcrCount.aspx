...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, sf_name, StrVacant, div_Code) {
            popUpObj = window.open("rptDCRCount_New.aspx?sf_code=" + sfcode + "&Month=" + fmon + "&Year=" + fyr + "&sf_name=" + sf_name + "&StrVacant=" + StrVacant + "&div_Code=" + div_Code
    //            ,
    //"ModalPopUp",
    //"null," +
    //"toolbar=no," +
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5">
                        <h2 class="text-center">DCR Count</h2>
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                <div class="single-des-option">
                                    <asp:Label ID="lblFilter" runat="server" Text="Filed Force Name" CssClass="label"></asp:Label><br />
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:CheckBox ID="chkWOVacant" Text="With Vacants" runat="server" />
                            </div>
                        </div>

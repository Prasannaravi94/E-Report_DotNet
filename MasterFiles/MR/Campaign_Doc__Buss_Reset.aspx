<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Campaign_Doc__Buss_Reset.aspx.cs"
    Inherits="MasterFiles_MR_Campaign_Doc__Buss_Reset" %>

<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Campaign Doctor Business Reset</title>
                    ...
                    <div class="col-lg-11">
                        ...
                        <div class="w-100 designation-submit-button text-center clearfix">
                            ...
                            <asp:Button ID="btnSubmit" runat="server" Text="Reset" CssClass="savebutton"
                                OnClientClick="return confirm('Do you want to Reset the Campaign Bussiness');"

...
public partial class MasterFiles_Dashboard_Sales_Analysis : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MasterFiles/SecSaleReport/rpt_SecSale_Report.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&Frm_Month=" + cmonth + "&Frm_year=" + cyear + "&To_Month=" + cmonth + "&To_year=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text +  "&div_code=" + div_code + "&Stok_code=" + -2 + "&sk_Name="+"---All---");

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Assesment_MR.aspx.cs" Inherits="Assesment_MR" %>
...
<head runat="server">
    <title>Interview Assesment MR</title>
    <meta charset="utf-8">
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <div align="center">
                            <asp:Label ID="lblhead" runat="server" Text="Interview Assesment MR" Visible="false" CssClass="reportheader"></asp:Label>
                        </div>
                        <br />
                        <br />
                            ...
                            <table align="center" border="0" id="tblAsses">
                                ...
                                <tr>
                                    <td align="left" width="200px">
                                        <asp:Label ID="lblName" runat="server" Text="NAME " ForeColor="#414d55" Font-Bold="true" CssClass="label">NAME<span style="Color:Red;padding-left:2px;">*</span></asp:Label>
                                    </td>
                                    ...
                                    <td align="left" width="178px">
                                        <div class="single-des">
                                            <asp:TextBox ID="txtName" runat="server" MaxLength="50" onfocus="this.style.backgroundColor='LavenderBlush'"
                                                onblur="this.style.backgroundColor='#f4f8fa'"
                                    ...
                                    <td width="30px"></td>
                                    <td align="left" width="200px">
                                        <asp:Label ID="lblPost" runat="server" Text="POST" ForeColor="#414d55" Font-Bold="true" CssClass="label"></asp:Label>
                                    </td>
                                    <td align="center" width="2px">
                                    ...
                                    <td align="left" width="178px">
                                        <div class="single-des">
                                            <asp:TextBox ID="txtPost" runat="server" MaxLength="50" onfocus="this.style.backgroundColor='LavenderBlush'"
                                                onblur="this.style.backgroundColor='#f4f8fa'"
                                ...
                                <tr>
                                    ...
                                    <td align="left" width="178px">
                                        <div class="single-des">
                                            <asp:TextBox ID="TxtQual" runat="server" MaxLength="50" onfocus="this.style.backgroundColor='LavenderBlush'"
                                                onblur="this.style.backgroundColor='#f4f8fa'"
                                                Width="178px" TabIndex="27" CssClass="input" onkeypress="AlphaNumeric_NoSpecialChars(event);"></asp:TextBox>
                                        </div>
                                    ...
                                    <td align="left" width="178px">
                                        <div class="single-des">
                                            <asp:TextBox ID="txtExp" runat="server" MaxLength="12" onfocus="this.style.backgroundColor='LavenderBlush'"
                                                onblur="this.style.backgroundColor='#f4f8fa'"
                                                Width="178px" TabIndex="28" CssClass="input"
                                ...
                                <tr>
                                    ...
                                    <td align="left" width="178px">
                                        <div class="single-des">
                                            <asp:TextBox ID="txtmarital" runat="server" MaxLength="50" onfocus="this.style.backgroundColor='LavenderBlush'"
                                                onblur="this.style.backgroundColor='#f4f8fa'"
                                                Width="178px" TabIndex="27" CssClass="input" onkeypress="AlphaNumeric_NoSpecialChars(event);"></asp:TextBox>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td width="178px" align="left">
                                        <asp:DropDownList ID="ddltwowheel" runat="server" onblur="this.style.backgroundColor='White'"
                                            onfocus="this.style.backgroundColor='#E0EE9D'" CssClass="nice-select">
                                    ...
                                    <td align="left" width="178px">
                                        <div class="single-des">
                                            <asp:TextBox ID="txtuan" runat="server" MaxLength="50" onfocus="this.style.backgroundColor='LavenderBlush'"
                                                onblur="this.style.backgroundColor='#f4f8fa'"
                                                Width="178px" TabIndex="27" CssClass="input" onkeypress="AlphaNumeric_NoSpecialChars(event);"></asp:TextBox>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td align="left" width="178px">
                                        <div class="single-des">
                                            <asp:TextBox ID="txtHq" runat="server" MaxLength="50" onfocus="this.style.backgroundColor='LavenderBlush'"
                                                onblur="this.style.backgroundColor='#f4f8fa'"
                                                Width="178px" TabIndex="27" CssClass="input" onkeypress="AlphaNumeric_NoSpecialChars(event);"></asp:TextBox>
                                        </div>
                            ...
                            <div class="display-reporttable clearfix">
                                <div class="table-responsive" style="scrollbar-width: thin">
                                    <asp:GridView ID="grdDCR" runat="server" Width="75%" HorizontalAlign="Center"
                                        CellPadding="1" EmptyDataText="No Data found for View" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="POOR" ItemStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkPoor" runat="server" Text="." onclick="checkPoor(this); " />
                                            ...
                                            <asp:TemplateField HeaderText="AVERAGE" ItemStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkAVERAGE" runat="server" Text="." onclick="checkAverage(this);" />
                                            ...
                                            <asp:TemplateField HeaderText="GOOD" ItemStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkgood" runat="server" Text="." onclick="checGood(this);" />
                            ...
                            <table align="left" width="85%">
                                <tr>
                                    ...
                                    <td align="left" width="270px">
                                        <asp:Label ID="lblEMail" runat="server" Width="270px" Text="EMAIL ID OF THE PREVIOUS COMPANY " ForeColor="#414d55" Font-Bold="true"
                                            CssClass="label"></asp:Label>

                                    </td>
                                    <td align="left" width="168px">
                                        <div class="single-des">
                        ...
                        <div align="left">
                            <table>
                                <tr>
                                    ...
                                    <td class="style76"></td>
                                    <td>
                                        <asp:Label ID="Label1" runat="server" Text="OPERATING STOCKIEST OF PREVIOUS COMPANY"
                                            CssClass="reportheader" Font-Size="16px" Width="403px" Height="23px"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div class="display-reporttable clearfix">
                            <div class="table-responsive" style="scrollbar-width: thin">
                                <asp:GridView ID="grdStock" runat="server" Width="75%" HorizontalAlign="Center"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="#" ItemStyle-HorizontalAlign="center" ItemStyle-Width="10px">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblS_no" runat="server" Text='<%# Bind("sno") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Name" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                                            <HeaderStyle Width="280px" />
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtNamegrd" runat="server" Width="350px" CssClass="input" Height="40px"></asp:TextBox>
                                                <asp:Label ID="txtNamegrdlbl" runat="server" Visible="false"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Address with contact Detail"
                                            ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                                            <HeaderStyle Width="280px" />
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtAddress" runat="server" Width="350px" TextMode="MultiLine" CssClass="input" Rows="5" Height="100%" ReadOnly="false"></asp:TextBox>
                                                <asp:Label ID="txtAddresslbl" runat="server" Visible="false"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    <EmptyDataRowStyle CssClass="no-result-area" />
                        ...
                        <div>
                            <table align="left" id="tblalign1">
                                <tr>
                                    ...
                                    <td class="style76"></td>
                                    <td align="left">
                                        <asp:Label ID="lblSale" runat="server" Text="SALE GENERATED IN THE PREVIOUS COMPANY (PER MONTH)" ForeColor="#414d55" Font-Bold="true"
                                            CssClass="label"></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td align="left">
                                ...
                                <tr>
                                    ...
                                    <td class="style76"></td>
                                    <td align="left">
                                        <asp:Label ID="lblPerfo" runat="server" Text="PERFORMANCE IN PREVIOUS COMPANY(%)" ForeColor="#414d55" Font-Bold="true"
                                            CssClass="label"></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td align="left">
                        ...
                        <div>
                            <table align="left" id ="tblalign">
                                <tr>
                                    ...
                                    <td class="style76"></td>
                                    <td align="left">
                                        <asp:Label ID="lblreason" runat="server" Text="REASON FOR CHANGING" CssClass="label" ForeColor="#414d55" Font-Bold="true"></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td align="left">
                                        <div class="single-des">
                                ...
                                <tr>
                                    ...
                                    <td class="style76"></td>
                                    <td align="left">
                                        <asp:Label ID="lblL_Salary" runat="server" Text="LAST SALARY DRAWN (CTC) " CssClass="label" ForeColor="#414d55" Font-Bold="true"></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td align="left">
                                        <div class="single-des">
                                ...
                                <tr>
                                    ...
                                    <td class="style76"></td>
                                    <td align="left">
                                        <asp:Label ID="lblmin_sal" runat="server" Text="MINIMUM SALARY EXPECTED(CTC)" CssClass="label" ForeColor="#414d55" Font-Bold="true"></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td align="left">
                                        <div class="single-des">
                                ...
                                <tr>
                                    ...
                                    <td class="style76"></td>
                                    <td align="left">
                                        <asp:Label ID="lblJdate" runat="server" Text="JOINING DATE " CssClass="label" ForeColor="#414d55" Font-Bold="true"></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td align="left">
                                        <div class="single-des">
                                ...
                                <tr>
                                    ...
                                    <td class="style76"></td>
                                    <td align="left">
                                        <asp:Label ID="Label7" runat="server" Text="INDUCTION BY " CssClass="label" ForeColor="#414d55" Font-Bold="true"></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td align="left">
                                        <div class="single-des">
                                ...
                                <tr>
                                    ...
                                    <td class="style76"></td>
                                    <td align="left">
                                        <asp:Label ID="lblfrmdate" runat="server" Text="INDUCTION FROM " CssClass="label" ForeColor="#414d55" Font-Bold="true">INDUCTION FROM <span style="Color:Red;padding-left:2px;">*</span></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td align="left">
                                        <div class="single-des">
                                    ...
                                    <td class="style76"></td>
                                    <td align="left">
                                        <asp:Label ID="lbltodate" runat="server" Text="TO" CssClass="label" ForeColor="#414d55" Font-Bold="true">TO<span style="Color:Red;padding-left:2px;">*</span></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td align="left">
                                        <div class="single-des">
                        ...
                        <center>
                            <table id="tbl" runat="server" width="90%" visible="false">
                                ...
                                <table width="70%">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <asp:Label ID="Label15" CssClass="label" ForeColor="#414d55" runat="server" Font-Bold="true">(VICE-PRESIDENT)</asp:Label>
                                        </td>
                                        <td align="center">
                                            <asp:Label ID="Label16" CssClass="label" ForeColor="#414d55" runat="server" Font-Bold="true">(PRESIDENT)</asp:Label>
                                        </td>
                                        <td align="center">
                                ...
                                <table width="80%">
                                    ...
                                    <tr>
                                        <td align="left">
                                            <asp:Label ID="Label12" CssClass="label" runat="server">5. Stock and Sales Statement of the Previous Company (Last 3 Months)</asp:Label>
                                        </td>

                                    </tr>
                                    <tr>
                                        <td align="left">
                                            <asp:Label ID="Label13" CssClass="label" runat="server">6. Aadhar Copy</asp:Label>
                                        </td>

                                    </tr>
                                    <tr>
                                        <td align="left">
                                            <asp:Label ID="Label14" CssClass="label" runat="server">7. Vehicle RC Book Copy(First Page)</asp:Label>
                                        </td>

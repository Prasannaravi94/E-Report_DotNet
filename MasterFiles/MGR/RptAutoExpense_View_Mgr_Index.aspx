<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAutoExpense_View_Mgr_Index.aspx.cs" Inherits="MasterFiles_MR_RptAutoExpense" %>
...
<tr>
<td align="right" >
                   <div align="center" id="divAttach"  style="border: 1px; border-style: solid; background-color: #ffebcd;
                    color: Black; height: 50px" runat="server">
                    <br />
...
<br />
        ...
        <asp:Button ID="btnDrftSave" runat="server" CssClass="savebutton" Width="80px" Height="25px"
            ...
            Text="Approve" Visible="true" OnClientClick="saveOtherExp()" OnClick="btnSave_Click" />
                    <asp:Button ID="bakfldfrce" runat="server" CssClass="savebutton" Width="130px" Height="25px"
            Text="BacK To FieldForce" Visible="true" OnClientClick="saveOtherExp()" OnClick="btnField_Click" />
    </center>

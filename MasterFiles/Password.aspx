<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Password.aspx.cs" Inherits="MasterFiles_Password" %>
        ...
        //});
            ...
            function Validate_Auth() {
                ...
                if ($("#password").val() == Auth) {
                    ...
                    window.location.replace("http://www.torssfa.info/MasterFiles/SFC_Distance_New.aspx");
                    //$("#block").hide();
                    //$("#access").show();
                } else {

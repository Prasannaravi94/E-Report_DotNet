                ...
                if (dsDCR.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow datarow in dsDCR.Tables[0].Rows)
                    {
                        while (ddate <= Convert.ToInt16(datarow["Activity_Date"].ToString()))
                        {
                            ...
                            TableCell tc_det_day1 = new TableCell();
                            tc_det_day1.BorderStyle = BorderStyle.Solid;
                            tc_det_day1.BorderWidth = 1;
                            tc_det_day1.Width = 50;
                            tc_det_day1.HorizontalAlign = HorizontalAlign.Center;
                            tc_det_day1.BackColor = System.Drawing.Color.White;
                            Literal lit_det_day1 = new Literal();
                            lit_det_day1.Text = sDCR;
                            tc_det_day1.Controls.Add(lit_det_day1);
                            tr_det2.Cells.Add(tc_det_day1);

                            if ((sDCR.Trim() != "L") && (sDCR.Trim() != "LP") && (sDCR.Trim() != "-"))
                            {
                                tot_No_of_Days += 1;
                            }
                            ...
                            {
                                tc_det_day1.BackColor = System.Drawing.ColorTranslator.FromHtml("#eee8aa");
                            }
                            ddate = ddate + 1;
                        }
                    }

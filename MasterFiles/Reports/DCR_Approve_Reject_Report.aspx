<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DCR_Approve_Reject_Report.aspx.cs" Inherits="MasterFiles_Reports_DCR_Approve_Reject_Report" %>
                        ...
                        <div class="col-lg-9">
                            <div align="center">
                                <asp:Label ID="lblHead" runat="server"
                                    Text="DCR Reject/Approve View from" CssClass="reportheader"></asp:Label>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <table width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="gvApproveReject" runat="server" Width="100%" HorizontalAlign="Center"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="#" ItemStyle-Width="30" HeaderStyle-CssClass="stickyFirstRow"
                                                                ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSNo" runat="server" Text='<%#  ((GridViewRow)Container).RowIndex + 1 %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="DCR Date" ItemStyle-Width="70" HeaderStyle-CssClass="stickyFirstRow"
                                                                ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDCRDate" runat="server" Text='<%#Eval("DCR_Date")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Fieldforce Name" ItemStyle-Width="200" HeaderStyle-CssClass="stickyFirstRow"
                                                            ...
                                                            <asp:TemplateField HeaderText="HQ" ItemStyle-Width="100" HeaderStyle-CssClass="stickyFirstRow"
                                                                ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblHQ" runat="server" Text='<%#Eval("Sf_HQ")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Designation" ItemStyle-Width="70" HeaderStyle-CssClass="stickyFirstRow"
                                                                ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDesignation" runat="server" Text='<%#Eval("sf_Designation_Short_Name")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Mode" ItemStyle-Width="60" HeaderStyle-CssClass="stickyFirstRow"
                                                                ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblDCRDate" runat="server" Font-Size="9pt" Text='<%#Eval("Activity_Date")%>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Work Type" ItemStyle-Width="100" HeaderStyle-CssClass="stickyFirstRow"
                                                                ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblWrkType" runat="server" Text='<%#Eval("WorkType_Name")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Reject/Approve/Deviate Release Reason" ItemStyle-Width="200" HeaderStyle-CssClass="stickyFirstRow"
                                                                ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReason" runat="server" Text='<%#Eval("ReasonforRejection")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="Disapproved Date" ItemStyle-Width="90" HeaderStyle-CssClass="stickyFirstRow"
                                                                ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Fieldwork_Pivot.aspx.cs" Inherits="MasterFiles_AnalysisReports_rpt_Fieldwork_Pivot" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(mode, FMonth, FYear, Tmon, Tyr, sfcode, sf_name, SfMGR) {
            popUpObj = window.open("rptMgr_Coverage_Detail_Zoom.aspx?mode=" + mode + "&FMnth=" + FMonth + "&FYear=" + FYear + "&TMonth=" + Tmon + "&TYear=" + Tyr + "&sfcode=" + sfcode + "&sf_name=" + sf_name + "&SfMGR=" + SfMGR,
            "_blank",
        "ModalPopUp_Level1," +
         "0" //+
        //"toolbar=no," +
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="row justify-content-center">
                        <div class="col-lg-2">
                            <br />
                            <div runat="server" id="divSettings" style="cursor: pointer; margin-left: 35px;">
                                        ...
                                        <asp:Panel ID="Panel1" runat="server">
                                            <caption>
                                                <asp:GridView ID="GrdFixation" runat="server" AlternatingRowStyle-CssClass="alt"
                                                    ...
                                                    ShowHeader="False" Style="background-color: white;">

...
//
//
public partial class MasterFiles_AnalysisReports_rpt_Doctors_Coverage_Det : System.Web.UI.Page
{
    //
    #region Variables
    ...
    {       
        ...
        speccode = Request.QueryString["speccode"].ToString();
        specname = Request.QueryString["specname"].ToString();
        ...
        lblHead.Text = "Doctors Coverage Details for " + strFrmMonth + " " + FYear +" ";
    ...
    private void FillReport()
    {
        ...
        string sProc_Name = "";
            ...
            sProc_Name = "Doctors_Coverage_Det_Visit_new";
        ...
        cmd.Parameters.AddWithValue("@spec", speccode);
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "DCR's Recd Upto", "#003300", true);

            //
            int months = (Convert.ToInt32(Request.QueryString["Fyear"].ToString()) - Convert.ToInt32(Request.QueryString["Fyear"].ToString())) * 12 + Convert.ToInt32(Request.QueryString["FMonth"].ToString()) - Convert.ToInt32(Request.QueryString["FMonth"].ToString()); //(Date2.Year - Date1.Year) * 12 + Date2.Month - Date1.Month;
            ...
            for (int i = 0; i <= months; i++)
            {
                ...
                foreach (DataRow dtRow in dsDoctor.Tables[0].Rows)
                {
                    ...
                    AddMergedCells(objgridviewrow2, objtablecell2, 0, iCnt+1, dtRow["ShortName"] + "(" + dtRow["No_of_visit"].ToString() + ")", "#003300", false);
                    ...
                    for (int j = 1; j < iCnt; j++)
                    {
                     ...
                     cat += dtRow["ShortName"].ToString() + '+';
                  AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Total Visit", "#003300", false);
                }
                cat = cat.Remove(cat.Length - 1);
                AddMergedCells(objgridviewrow2, objtablecell2, 0, 0, "Total Doctors in List", "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0,cat + " Drs List", "#003300", false);
                AddMergedCells(objgridviewrow2, objtablecell2, 0, 0, "Total Doctors Visit", "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, cat +" Drs", "#003300", false);
                AddMergedCells(objgridviewrow2, objtablecell2, 0, 0, "Call Avg", "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, cat + " Avg", "#003300", false);
                AddMergedCells(objgridviewrow2, objtablecell2, 0, 3, specname, "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "List", "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Met", "#003300", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Visit", "#003300", false);
                string sTxt = "&nbsp;" + sf.getMonthName(cmonth.ToString()) + "-" + cyear;
                //AddMergedCells(objgridviewrow2, objtablecell2, 2, 0, "NL Drs", "#003300", false);
                AddMergedCells(objgridviewrow, objtablecell, 0, iColSpan + 7, sTxt, "#003300", true);
                cmonth = cmonth + 1;
                if (cmonth == 13)
                {
                    cmonth = 1;

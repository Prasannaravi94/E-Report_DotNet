<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptMissed_Call.aspx.cs" Inherits="MasterFiles_AnalysisReports_rptMissed_Call" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        debugger
        function showMissedDR(sfcode, div_code, fmon, fyr, cmode, vmode, cnt) {
            //popUpObj = window.open("MissedCallReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("MissedDocList.aspx?sfcode=" + sfcode + "&div_code=" + div_code + "&FMonth=" + fmon + "&FYear=" + fyr + "&cMode=" + cmode + "&vMode=" + vmode + "&cnt=" + cnt,
         "_blank",
 "ModalPopUp," +
 "0" //+
 //"toolbar=no," +
...
<body style="overflow-x: scroll;">
    <form id="form1" runat="server">
        <div>
            ...
            <div class="clearfix" style="max-width: 1350px; margin-left: 25px;">
                <div class="row justify-content-center">
                    <div class="col-lg-12">

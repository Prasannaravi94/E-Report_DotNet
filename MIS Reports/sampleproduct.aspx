<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sampleproduct.aspx.cs" Inherits="MIS_Reports_sampleproduct" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        .ddl {
            ...
            border-radius: 4px;
            margin: 2px;
            background-image: url('css/download(2).png');
    ...
    <form id="form1" runat="server">
         <script type="text/javascript">
             ...
             function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, SName) {
                 ...
                 popUpObj = window.open("sampledes.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + SName,
                     "ModalPopUp"//,
                     //"toolbar=no," +
                     //"scrollbars=yes," +
                     //"location=no," +
         ...
         <script type="text/javascript">
             ...
             function showModalPopUpCheck(sf_Code, FDate, TDate, SName) {
                 ...
                 popUpObj1 = window.open("sampleDatewise_Report.aspx?sfcode=" + sf_Code + "&FDate=" + FDate + "&TDate=" + TDate + "&sf_name=" + SName,
                     "ModalPopUp"//,
                     //"toolbar=no," +
                     //"scrollbars=yes," +
                     //"location=no," +
                    ...
                    <div class="col-lg-5">
                        <center>
                            <table>
                                <tr>
                                    <td align="center">
                                        <h2 class="text-center">Sample Despatch - View</h2>
                                    </td>
                                </tr>
                            </table>
                        </center>

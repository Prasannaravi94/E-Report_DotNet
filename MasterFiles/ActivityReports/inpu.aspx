<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="inpu.aspx.cs" Inherits="MasterFiles_ActivityReports_inpu" %>
            ...
            <div class="col-lg-12">
                <center>
                    <table>
                        <tr>
                            <td align="center">
                                <h2 class="text-center">Input Despatch from HQ</h2>
                            </td>
                        </tr>
                    </table>
                </center>
                <center>
                        ...
                        <tr>
                            <td class="style2" align="left" style="padding-bottom: 6px;">
                                <div class="w-100 designation-submit-button text-center clearfix">
                                    ...
                                    <asp:Button ID="LinkButton1" runat="server" Text="Clear List" class="savebutton" OnClick="LinkButton1_Click" OnClientClick="valit()" />
                                </div>
                            </td>
                        </tr>
                    </table>
                    <table>
                                                                        ...
                                                                        <table style="width: 100%; background-color: #f1f5f8;">
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 250px;">
                                                                                    <asp:Label ID="lblgft" Text="Product Name" Font-Bold="true" runat="server"></asp:Label>
                                                                                </td>
                                                                    ...
                                                                    <table>
                                                                        <tr style="width: 100%; border-bottom: 1px solid #DCE2E8; border-right: 1px solid #DCE2E8; border-left: 1px solid #DCE2E8;">
                                                                            <td style="width: 75px; text-align: center;">
                                                                                <asp:Label ID="lblSLNO" runat="server" Text='<%# (Container).ItemIndex +1 %>' Width="75px"></asp:Label>
                                                                            </td>
                                                                            <td style="width: 250px; border-left: none;">
                                                                                <asp:Label ID="lblInput" runat="server" Width="245px" Text='<%# Eval("Gift_Name") %>'></asp:Label>
                                                                                <asp:HiddenField ID="HiddenField2" runat="server" Value='<%# Eval("Gift_Code") %>' />
                                                                            </td>
                                                                            <td style="width: 175px; text-align: center;">
                                                                                <asp:TextBox ID="txtQuantity" runat="server" Width="75px" class="dd"></asp:TextBox>
                        ...
                        <tr>
                            <td colspan="4" align="center" style="padding-right: 100px;">

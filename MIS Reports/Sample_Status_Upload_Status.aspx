<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sample_Status_Upload_Status.aspx.cs" Inherits="MIS_Reports_Sample_Status_Upload_Status" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, SName) {
            ...
            popUpObj = window.open("inputdes.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + SName,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
                    ...
                    <div class="col-lg-5">
                        <center>
                            <table>
                                <tr>
                                    <td align="center">
                                        <h2 class="text-center">Input/Sample</h2>
                                    </td>
                                </tr>
                            </table>
                        </center>
...
<%--                            <div class="single-des clearfix">
                        ...
                        <div class="w-100 designation-submit-button text-center clearfix">
                            <asp:Button ID="btnGo" runat="server" Text="Download" CssClass="savebutton" OnClick="btnGo_Click" />
                        </div>
                    </div>
                </div>
            </div>

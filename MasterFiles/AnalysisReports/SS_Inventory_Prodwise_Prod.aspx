<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SS_Inventory_Prodwise_Prod.aspx.cs" Inherits="MasterFiles_AnalysisReports_SS_Inventory_Prodwise_Prod" %>
...
<head id="Head1" runat="server">
    <title>Secondary Sale - Inventory Productwise</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name) {
            popUpObj = window.open("rpt_SS_Inventory_Prodwise_Prod.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                if (FYear == "--Select--") { alert("Select Year."); $('#ddlFYear').focus(); return false; }
                var FMonth = $('#<%=ddlFMonth.ClientID%> :selected').text();
                if (FMonth == "--Select--") { alert("Select Month."); $('#ddlFMonth').focus(); return false; }
              ...
              <%--  var Year2 = document.getElementById('<%=ddlTYear.ClientID%>').value;
                ...
                showModalPopUp(sf_Code, Month1 , Year1 , Year1 , Month1 , Name);
    ...
    <form id="form1" runat="server">
        ...
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <h2 class="text-center" style="border-bottom:none">Secondary Sale - Inventory Productwise</h2>
                    ...
                    <div class="designation-area clearfix">
                        ...
                        <div class="single-des clearfix">
                         ...
                         <%--   <div style="float: left; width: 45%;">
                                <asp:Label ID="lblFMonth" runat="server" Text="Month " CssClass="label"></asp:Label>
                            ...
                            <div style="float: right; width: 45%;">
                                <asp:Label ID="lblFYear" runat="server" Text="Year " CssClass="label"></asp:Label>

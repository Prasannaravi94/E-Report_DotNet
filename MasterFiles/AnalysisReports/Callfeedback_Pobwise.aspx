<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Callfeedback_Pobwise.aspx.cs" Inherits="MasterFiles_AnalysisReports_Callfeedback_Pobwise" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name) {
            ...
            popUpObj = window.open("rptCallfeedback.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name,
   "ModalPopUp"//,
   //"toolbar=no," +
   //"scrollbars=yes," +
   //"location=no," +
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                <asp:Label ID="lbMode" CssClass="label"
                                    runat="server" Text="Mode"></asp:Label>
                                <asp:DropDownList ID="ddlmode" runat="server" CssClass="nice-select">
                                    <asp:ListItem Value="0" Selected="True" Text="Call feedbackwise"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="w-100 designation-submit-button text-center clearfix">
                                <asp:Button ID="btnSubmit" runat="server" Text="View" CssClass="savebutton" Enabled="false" />
                            </div>
                        </div>
                    </div>
                </div>

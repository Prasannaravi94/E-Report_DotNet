<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MR_Assessment.aspx.cs" Inherits="MIS_Reports_MR_Assessment" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name, div_code) {
            ...
            popUpObj = window.open("rptMR_Assessment.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name + "&div_code=" + div_code,
   "ModalPopUp"//,
   //"toolbar=no," +
   //"scrollbars=yes," +
   //"location=no," +
   ...
   //"top=0"
            ...
            $(popUpObj.document.body).ready(function () {
                ...
                var ImgSrc = "https://s15.postimg.org/vugwraj8r/958ce2b245d631ef45a36e56bd2192af.gif"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                var TMonth = new Date(ToMonYear[0] + '-1-01').getMonth() + 1 == "NaN" ? new Date(ToMonYear[0] + '-1-01').getMonth() + 1 :
                    new Date(ToMonYear[0] + '01, 0001').getMonth() + 1;
                var TYear = ToMonYear[1];
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Field Assessment</h2>

    ...
    public class Designation
    {
        ...
        public DataTable getDesignation_DataTable(string div_code)
        {
            ...
            strQry = " SELECT D.Designation_Code,D.Designation_Short_Name,D.Designation_Name,D.Type, " +
                       ...
                       " case when Type = 1 THEN 'Base Level' ELSE 'Manager' END as Level   " +
        ...
        public DataSet getDesignationEd(string Designation_Code, string div_code)
        {
            ...
            strQry = "Select Designation_Short_Name, Designation_Name, Desig_Color, Type, Division_Code," +
                      " (select COUNT(s.Designation_Code) from Mas_Salesforce_two S where Designation_Code=S.Designation_Code and Designation_Code='" + Designation_Code + "' ) as sf_count " +
        ...
        public bool RecordExist(string Designation_Short_Name, string div_code,string type)
        {
            ...
            try
            {
                ...
                strQry = "SELECT COUNT(Designation_Code) FROM Mas_SF_Designation WHERE Designation_Short_Name='" + Designation_Short_Name + "' and Division_Code = '" + div_code + "' and type='"+ type +"'";
        ...
        public bool dnRecordExist(string Designation_Name, string div_code,string Type)
        {
            ...
            try
            {
                ...
                strQry = "SELECT COUNT(Designation_Code) FROM Mas_SF_Designation WHERE Designation_Name='" + Designation_Name + "' and Division_Code = '" + div_code + "' and type='" + Type + "'";
                int iRecordExist = db.Exec_Scalar(strQry);
        ...
        public int RecordAdd(string Designation_Short_Name, string Designation_Name, string Desig_Color, string type, string div_code)
        {
            ...
            if (!RecordExist(Designation_Short_Name, div_code, type))
            {
                if (!dnRecordExist(Designation_Name, div_code,type))
                {
                    try
                    {
                        DB_EReporting db = new DB_EReporting();
        ...
        public DataSet getDesign_Baselevel_new(string div_code)
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsSF = null;

            strQry = " SELECT Designation_Code,Designation_Short_Name,Designation_Name,Type,Tag_Needed" +
                     " FROM Mas_SF_Designation where Type= 1 and Designation_Active_Flag = 0 and Division_Code = '" + div_code + "' order by Baselevel_SNo";
            try
            {
                dsSF = db_ER.Exec_DataSet(strQry);
        ...
        public DataSet getDesign_Managerlevel_new(string div_code)
        {
            DB_EReporting db_ER = new DB_EReporting();
        ...
        public int Update_BaselevelSno_new(string Designation_Code, string Sno, string div_code, string ChkTag)
        {
            int iReturn = -1;
            //if (!RecordExist(Product_Cat_Code, Product_Cat_SName))
            //{
            try
            {
                ...
                strQry = "UPDATE Mas_SF_Designation " +
                         " SET Baselevel_SNo = '" + Sno + "', " +
                         " LastUpdt_Date = getdate(),Tag_Needed ='" + ChkTag + "' " +
                         " WHERE Designation_Code = '" + Designation_Code + "' and Designation_Active_Flag = 0 and Division_Code = '" + div_code + "'";
        ...
        public int Update_ManagerSno_new(string Designation_Code, string Sno, string div_code, string ChkTag)
        {
            int iReturn = -1;
            //if (!RecordExist(Product_Cat_Code, Product_Cat_SName))
            //{
        ...
        public DataSet getDesignationMGR(string Division_Code)
        {
            ...
            strQry = " SELECT Designation_Short_Name,Designation_Code,TP_Approval_Sys,Tp_Start_Date,Tp_End_Date " +
      " FROM Mas_SF_Designation where [Type]=2 and Division_Code='" + Division_Code + "' and Designation_Active_Flag=0 ";
        ...
        public DataSet getDesignationMR(string Division_Code)
        {
            ...
            strQry = " SELECT Designation_Short_Name,Designation_Code,TP_Approval_Sys,Tp_Start_Date,Tp_End_Date " +
                " FROM Mas_SF_Designation where [Type]=1 and Division_Code='" + Division_Code + "' and Designation_Active_Flag=0  ";
        ...
        public DataSet getDesinationCode_ForDCRSetup(string div_code)
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsDesig = null;
            strQry = "select Designation_Code from Mas_SF_Designation where division_code='" + div_code + "' and Designation_Active_Flag=0";
            try
            {
                dsDesig = db_ER.Exec_DataSet(strQry);
            }
        ...
        public DataSet getDesig_Check(string div_code)
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsDesignation = null;
            strQry = "SELECT Designation_Code,Designation_Short_Name,Designation_Name,Type " +
                     " FROM Mas_SF_Designation where Division_code='" + div_code + "' order by Manager_SNo,Baselevel_SNo ";
            try
            {
                dsDesignation = db_ER.Exec_DataSet(strQry);
            }
        ...
        public DataSet getDesig_code(string sf_code)
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsDesignation = null;
            strQry = "SELECT Designation_Code " +
        ...
        public DataSet getDesignation_Baselevel_Tp(string Division_Code, string Designation_Code)
        {
            DB_EReporting db_ER = new DB_EReporting();
            ...
            strQry = " SELECT Designation_Short_Name,Designation_Code,TP_Approval_Sys, Tp_Start_Date, Tp_End_Date " +
                     " FROM Mas_SF_Designation where Type=1 and Division_Code='" + Division_Code + "' and Designation_Active_Flag=0 and Designation_Code='" + Designation_Code + "' ";
        ...
        public DataSet getDesignation_Manager_Tp(string Division_Code, string Designation_Code)
        {
            DB_EReporting db_ER = new DB_EReporting();
            ...
            strQry = " SELECT Designation_Short_Name,Designation_Code,TP_Approval_Sys,Tp_Start_Date,Tp_End_Date " +
                     " FROM Mas_SF_Designation where Type=2 and Division_Code='" + Division_Code + "' and Designation_Active_Flag=0 and Designation_Code='" + Designation_Code + "' ";
        ...
        public DataSet getDesig_graph(string Designation_Code, string div_code)
        {
            DB_EReporting db_ER = new DB_EReporting();
            ...
            strQry = " SELECT Designation_Code,Designation_Short_Name " +
                     " FROM Mas_SF_Designation " +
                     " WHERE Designation_Code in (" + Designation_Code + ") and Designation_Active_Flag=0 and Division_code='" + div_code + "'";
        ...
        public DataSet getDesignationmsg(string div_code)
        {
            DB_EReporting db_ER = new DB_EReporting();
            ...
            strQry =
                     " SELECT Designation_Code,Designation_Short_Name " +
        ...
        public DataSet getDesignationMGRMailcrn(string Division_Code)
        {
            DB_EReporting db_ER = new DB_EReporting();
            DataSet dsDesignation = null;

            strQry = "SELECT Designation_Short_Name,Designation_Code " +
                     " FROM Mas_SF_Designation where Type=2 and Division_Code='" + Division_Code + "' and Designation_Active_Flag=0 and Designation_Short_Name!='admin'";
            try
            {
                dsDesignation = db_ER.Exec_DataSet(strQry);
            }
        ...
        public DataSet getDesignation_Sys_ApprovalMailcrn(string StrDesgination, string div_code)
        {
            DB_EReporting db_ER = new DB_EReporting();
            ...
            if (StrDesgination == "")
            {
                strQry = " select Designation_Short_Name,Mail_Allowed from Mas_SF_Designation where Type=2 and Division_Code='" + div_code + "' ";
            }
            else
            {
                strQry = " select Designation_Short_Name,Mail_Allowed from Mas_SF_Designation where Designation_Short_Name in ('" + StrDesgination + "') and Division_Code='" + div_code + "' ";
            }

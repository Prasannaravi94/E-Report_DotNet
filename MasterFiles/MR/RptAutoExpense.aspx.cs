                ...
                for (int i = 0; i < t1.Rows.Count; i++)
                {
                   ...
                   // {
                        ...
                        else if ((currCatType.Equals("OS") || currCatType.Equals("OS-EX")) && (prevCatType.Equals("HQ") || prevCatType.Equals("EX")) && (nextCatType.Equals("HQ") || nextCatType.Equals("EX")))
                        {
                            ...
                            if (range > 0)
                            {
                                totFare = rangeDistanceCalc(osDistance, totFare, osDistance);
                            }
                        ...
                        else if ((currCatType.Equals("OS") || currCatType.Equals("OS-EX")) && (nextCatType.Equals("HQ") || nextCatType.Equals("EX") || nextCatType.Equals("NA") || nextCatType.Equals("")))
                        {
                            if ("EX".Equals(osContn))
                            {
                                if (currCatType.Equals("OS") || currCatType.Equals("OS-EX"))

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HO_ID_View_admin.aspx.cs" Inherits="MasterFiles_HO_ID_View_admin" %>
               ...
               <asp:GridView ID="grdHoID" runat="server" Width="85%" HorizontalAlign="Center" 
                     ...
                     <Columns>                
                      ...
                      <%--   <asp:TemplateField  HeaderStyle-ForeColor="white" HeaderText="Reporting To" ItemStyle-HorizontalAlign="Left">
                        ...
                        <asp:HyperLinkField HeaderText="Edit" Text="Edit" HeaderStyle-ForeColor="White" DataNavigateUrlFormatString="HO_ID_Creation_admin.aspx?HO_ID={0}"

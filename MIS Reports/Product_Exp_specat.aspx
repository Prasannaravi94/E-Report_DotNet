...
<head runat="server">
    <title>Speciality/CategoryWise Analysis</title>
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            var value = document.getElementById("rdoType").value;
            ...
            if (value == "0") {
                ...
                if (atLeast > counter) {
                    alert("Please select atleast " + atLeast + " Speciality");
                    return false;
                }
                return true;
            }
                ...
                var CHK = document.getElementById("<%=chkcat.ClientID%>");
                    ...
                    if (atLeast > counter) {
                        alert("Please select atleast " + atLeast + " Category");
                        return false;
                    }
                    return true;
                }
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Speciality/CategoryWise Analysis</h2>
              ...
              <ContentTemplate>--%>
                        ...
                        <div class="designation-area clearfix">
                          ...
                          <img src="../Images/Selective_Mgr.png" />
                            ...
                            <div class="single-des clearfix">
                                <asp:Label ID="lblprod" runat="server" CssClass="label" Visible="false" Text="Product Name"></asp:Label>
                                <asp:DropDownList ID="ddlprod" runat="server" AutoPostBack="true" CssClass="nice-select" Visible="false"
                            ...
                            <div class="single-des clearfix">
                                <div style="float: left; width: 45%;">
                                    ...
                                    <asp:TextBox ID="txtFromMonthYear" runat="server" CssClass="nice-select"></asp:TextBox>
                                </div>
                                <div style="float: right; width: 45%;">
                                    <asp:Label ID="lbltomon" runat="server" Text="To Month-Year" CssClass="label"></asp:Label>
                                    <asp:TextBox ID="txtToMonthYear" runat="server" CssClass="nice-select"></asp:TextBox>
                                </div>
                                <%--                <div style="float: left; width: 45%;">
                            ...
                            <div class="single-des clearfix">
                                <asp:Label ID="lblType" runat="server" Text="Select Mode" CssClass="label"></asp:Label>
                            ...
                            <div class="single-des clearfix">
                                <asp:Label ID="lblspec" runat="server" CssClass="blink_me" Font-Bold="true" Text="No Records" ForeColor="Red" Visible="false"></asp:Label>
                                <asp:CheckBoxList ID="chkspec" CssClass="chkboxLocation" CellPadding="10" RepeatColumns="3" Font-Size="11px" RepeatDirection="vertical" Width="300px" runat="server">
                                </asp:CheckBoxList>
                            </div>
                            <div class="single-des clearfix">
                                <asp:CheckBoxList ID="chkcat" CssClass="chkboxLocation" CellPadding="10" RepeatColumns="3" Font-Size="11px" RepeatDirection="vertical" Width="300px" runat="server">
                                </asp:CheckBoxList>
                            </div>
                        ...
                        <div class="w-100 designation-submit-button text-center clearfix">
                            <br />
                            <asp:Button ID="btnGo" runat="server" Text="View" CssClass="savebutton" OnClientClick="return Validate()"
                                OnClick="btnGo_Click" />
                        </div>
                    </div>
                </div>

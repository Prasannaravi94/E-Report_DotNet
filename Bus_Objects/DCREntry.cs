...
namespace Bus_Objects
{
    public class DCREntry
    {
        ...
        public class Clusters
        {
            ...
            public string Name { get; set; }
            public decimal PM_Visit { get; set; }
            public decimal CM_Visit { get; set; }
            public string Territory_Cat { get; set; }
        }
        ...
        public class DCRSetup
        {
            ...
            public byte FFWiseDelay { get; set; }
            public byte FFWiseDelay_Days { get; set; }

...
public partial class Reports_rptDCRViewApprovedDetails : System.Web.UI.Page
{
    ...
    private void CreateDynamicTable(int imonth, int iyear, string sf_code)
    {
        ...
        tbldetail_main3.Style.Add("border-collapse", "collapse");
        tbldetail_main3.Style.Add("border", "solid 0px Black");
        ...
        tbldetail_main.Style.Add("border", "solid 0px Black");
        ...
        if (dsdoc.Tables[0].Rows.Count > 0)
        {
            ...
            // tc_det_head_SNo.Attributes.Add("Class", "tbldetail_main");
            ...
            foreach (DataRow drdoctor in dsdoc.Tables[0].Rows)
            {
                ...
                //tr_det_sno.Attributes.Add("Class", "tblHead");
        ...
        tblUnLstDoc.Style.Add("border", "solid 0px Black");
    ...
    protected void grdLstDr_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (lblLatlong.Text != "0" && lblLatlong.Text != "-" && lblLatlong.Text != "-")
            {
                ...
                sURL = "Location_Finder.aspx?sf_Name=" + "&SFCode=" + "/" + sf_code + "/" + "&DivID=" + div_code + " &StrDate=" + "/" + dtrowClr_Dr.Rows[index][2].ToString() + "/&Mode=" + "/" + "D" + " ";
            ...
            strProduct_Detail = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Product_Detail"));
            strProduct_Gift = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Gift_Name"));
            Session["strSubArea"] = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "SDP_Name"));
           

            Label lblTime = (Label)e.Row.FindControl("lblTime");
            Label lblListedDr_Name = (Label)e.Row.FindControl("lblProduct_Detail");
            Label lblGift_Name = (Label)e.Row.FindControl("lblGift_Name");
            Label lblActivityRemark = (Label)e.Row.FindControl("lblActivityRemark");
            Label lblCallFeedback = (Label)e.Row.FindControl("lblCallFeedback");

            lblCallFeedback.Text = lblCallFeedback.Text + "( " +"<span style='color:Red'>" + lblActivityRemark.Text +"</span>" + " )";

            TableCell tc_det_prod = new TableCell();
            Literal lit_det_prod = new Literal();
            lit_det_prod.Text = strProduct_Detail.ToString().Replace("~0", "/").Trim();
            lit_det_prod.Text = lit_det_prod.Text.Replace("~", "/").Trim();
            lit_det_prod.Text = lit_det_prod.Text.Replace("$0", "").Trim();
            lit_det_prod.Text = lit_det_prod.Text.Replace("$", "").Trim();
           
            lit_det_prod.Text = "&nbsp;&nbsp;" + lit_det_prod.Text.Replace("#", "  ").Trim();
            if (lit_det_prod.Text.EndsWith("/"))
            {
                lit_det_prod.Text = lit_det_prod.Text.Remove(lit_det_prod.Text.Length - 1);
            }
           
             lblListedDr_Name.Text = lit_det_prod.Text;
            

            Literal lit_det_gift = new Literal();
            lit_det_gift.Text = strProduct_Gift.ToString().Replace("~", "").ToString().Replace("0", "").Trim();
            lblGift_Name.Text = lit_det_gift.Text;
    ...
    protected void GVUnlstDr_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (lblLatlong.Text != "0" && lblLatlong.Text != "-" && lblLatlong.Text != "-")
            {
                ...
                sURL = "Location_Finder.aspx?sf_Name=" + "&SFCode=" + "/" + sf_code + "/" + "&DivID=" + div_code + " &StrDate=" + "/" + dtrowClr_Uld.Rows[index][2].ToString() + "/&Mode=" + "/" + "ULD" + " ";
                hLink.Attributes["onclick"] = "window.open('" + sURL + "','_blank','PopUp',0,'resizable=yes,toolbar=no,menubar=no,status=no,width=1000,height=600,left=0,top=0');";
                hLink.NavigateUrl = "#";
            ...
            strUnProduct_Detail = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Product_Detail"));
            strUnProduct_Gift = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Gift_Name"));
            ...
            Literal lit_det_gift = new Literal();
            lit_det_gift.Text = strUnProduct_Gift.ToString().Replace("~", "").Trim();
            lblGift_Name.Text = lit_det_gift.Text;
    ...
    protected void GVChemist_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (lblLatlong.Text != "0" && lblLatlong.Text != "-" && lblLatlong.Text != "-")
            {
                ...
                sURL = "Location_Finder.aspx?sf_Name=" + "&SFCode=" + "/" + sf_code + "/" + "&DivID=" + div_code + " &StrDate=" + "/" + dtrowClr_Chm.Rows[index][2].ToString() + "/&Mode=" + "/" + "C" + " ";
                hLink.Attributes["onclick"] = "window.open('" + sURL + "','_blank','PopUp',0,'resizable=yes,toolbar=no,menubar=no,status=no,width=1000,height=600,left=0,top=0');";
                hLink.NavigateUrl = "#";
            ...
            strUnProduct_Detail = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Product_Detail"));
            strUnProduct_Gift = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "additional_gift_dtl"));
            ...
            Label lblCallFeedback = (Label)e.Row.FindControl("lblCallFeedback");
                ...
                lblCallFeedback.Text = lblCallFeedback.Text.ToString() + "( " + "<span style='color:Red'>" + lblActivityRemark.Text.ToString() + "</span>" + " )";

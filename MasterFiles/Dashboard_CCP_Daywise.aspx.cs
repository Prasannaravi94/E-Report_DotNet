...
public partial class MasterFiles_CCP_Daywise : System.Web.UI.Page
{
    ...
    {       
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MIS%20Reports/rptTPCCP_Daywise.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&div_code=" + div_code);
        //ifmReviewRep.Attributes.Add("src", "http://" + host + "/MIS%20Reports/rptTPCCP_Daywise.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&div_code=" + div_code);
    }
    #endregion

...
public partial class MasterFiles_Dashboard_Slide_Primary_Sales : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MasterFiles/AnalysisReports/rpt_Primary_Sale_StockistWise_Product.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&Frm_Month=" + cmonth + "&Frm_year=" + cyear + "&To_Month=" + cmonth + "&To_year=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text +  "&div_code=" + div_code + "&selectedValue=" + 4 + "&Stok_code=" + -2 + "&sk_Name=" + "---All---");

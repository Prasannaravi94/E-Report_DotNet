<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manager_Analysis.aspx.cs" Inherits="MasterFiles_AnalysisReports_Manager_Analysis" %>
...
<head runat="server">
    <title>Manager Analysis(HQ wise - Visit)</title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, FrmDate, ToDate, sf_name, div_code) {
            //popUpObj = window.open("MissedCallReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rpt_Manager_Analysis.aspx?sf_code=" + sfcode + "&FrmDate=" + FrmDate + "&ToDate=" + ToDate + "&div_code=" + div_code + "&sf_name=" + sf_name,
 "ModalPopUp"//,
 //"toolbar=no," +
 //"scrollbars=yes," +
 //"location=no," +
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            <%--  $('#btnSubmit').click(function () {
                ...
                showModalPopUp(sf_Code, FrmDate, ToDate, Name, div_code);
            });
        });--%>
    </script>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Manager Analysis(HQ wise - Visit)</h2>
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <asp:PlaceHolder ID="temp" runat="server">
                                            <asp:Label ID="lblFrmDate" runat="server" Text="From Date" CssClass="label"></asp:Label>
                                            <asp:TextBox ID="txtEffFrom" runat="server" CssClass="input" Width="100%"
                                                onkeypress="Calendar_enter(event);"
                                    ...
                                    <div class="col-lg-6">
                                        <asp:Label ID="lblToDate" runat="server" CssClass="label" Text="To Date"></asp:Label>
                                        <asp:TextBox ID="txtToDate" runat="server" CssClass="input" Width="100%"
                                            onkeypress="Calendar_enter(event);"
                                            TabIndex="6"></asp:TextBox>
                                        <asp:CalendarExtender ID="CalendarExtender2" Format="dd/MM/yyyy" TargetControlID="txtToDate" CssClass="cal_Theme1"
                                            runat="server" />
                                    </div>
                                </div>
                            </div>

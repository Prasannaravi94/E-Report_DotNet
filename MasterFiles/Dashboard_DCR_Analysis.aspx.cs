...
public partial class MasterFiles_Dashboard_DCR_Analysis : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MIS%20Reports/DCR_Analysis_Report.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&FYear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&div_code=" + div_code + "&isSelf=" + 1 + "&Is_SamInp=" + 0);
        //ifmReviewRep.Attributes.Add("src", "http://" + host + "/MasterFiles/AnalysisReports/rpt_Review_Report.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&Fyear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&div_code=" + div_code);
    }
    #endregion

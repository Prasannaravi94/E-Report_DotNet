...
public partial class MasterFiles_Input_Despatch : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "//" + host + ":" + port + "/MIS%20Reports/rptInputstatus_New_New.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&Fyear=" + cyear + "&TMonth=" + cmonth + "&Tyear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&Dashboard=" + "1" + "&div_code=" + div_code);
        //ifmReviewRep.Attributes.Add("src", "http://" + host + "/MIS%20Reports/rptInputstatus_New_New.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&Fyear=" + cyear + "&TMonth=" + cmonth + "&Tyear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&div_code=" + div_code);
    }
    #endregion

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Assesment_MR_View.aspx.cs" Inherits="Assesment_MR_View" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <table align="center">
                            <tr>
                                <td>
                                    <asp:Label ID="lblheader" runat="server" Text="MR Assessment" CssClass="reportheader"></asp:Label>
                                </td>
                            </tr>
                        </table>
                        <br />
                            ...
                            <div class="table-responsive" style="scrollbar-width: thin">
                                <asp:GridView ID="grdAssessment" runat="server" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:HyperLinkField HeaderText="view" Text="Click View" DataNavigateUrlFormatString="Assesment_MR.aspx?Sl_No={0}&amp;mode=1"

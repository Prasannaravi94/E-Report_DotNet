...
<body>
    ...
    <div>
        ...
        <center>
            ...
            <div align="center">
                        <asp:Label ID="lblHead" runat="server" Text="Visit Doctor List for the month of "
                       ...
                       <div>
                            <asp:GridView ID="grdDoctor" runat="server" Width="65%" HorizontalAlign="Center"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Listed Doctor Code" ItemStyle-HorizontalAlign="Left"
                                        Visible="false">

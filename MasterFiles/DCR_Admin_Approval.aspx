<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DCR_Admin_Approval.aspx.cs" Inherits="MasterFiles_DCR_Admin_Approval" %>
            ...
            <center>
                <div class="container home-section-main-body position-relative clearfix">
                    <div class="row justify-content-center">
                        <div class="col-lg-11">
                            <h2 class="text-center" style="border-bottom: none">DCR Admin Approval</h2>
                            <div class="designation-reactivation-table-area clearfix">
                                <div class="display-table clearfix">
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdDCR" runat="server" HorizontalAlign="Center" OnPageIndexChanging="grdDCR_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField HeaderText="Approve" DataTextField="Month"
                                                    ...
                                                    <ItemStyle ForeColor="DarkBlue" Font-Bold="False" Width="325px" HorizontalAlign="Left"></ItemStyle>
                                                </asp:HyperLinkField>
                                            </Columns>
                                        </asp:GridView>
                                    </div>

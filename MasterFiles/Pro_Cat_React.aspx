<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pro_Cat_React.aspx.cs" Inherits="MasterFiles_Pro_Cat_React" %>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-11">
                        <br />
                        <h2 class="text-center">Product Category Reactivation</h2>
                        <div class="display-table clearfix">
                            <div class="table-responsive">

                                <asp:GridView ID="grdProCat" runat="server" Width="70%" HorizontalAlign="Center" EmptyDataText="No Records Found"

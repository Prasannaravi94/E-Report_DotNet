    ...
    <ucl:Menu ID="menu1" runat="server" />
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center">
                <div class="col-lg-11">
                    <br />
                    <h2 class="text-center">Chemists Category Reactivation</h2>
                            ...
                            <asp:GridView ID="grdChemCat" runat="server" Width="85%" HorizontalAlign="Center" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Short Name" ItemStyle-HorizontalAlign="Left">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtChem_Cat_SName" runat="server" CssClass="input" Text='<%# Bind("Chem_Cat_SName") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Category Name" ItemStyle-HorizontalAlign="Left">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtChemCatName" CssClass="input" runat="server" MaxLength="100" Text='<%# Bind("Chem_Cat_Name") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>

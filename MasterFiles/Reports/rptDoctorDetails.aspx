...
<head runat="server">
    <title>Doctor Details - Field Force wise</title>
...
<body>
    ...
    <ucl:Menu ID="menu1" runat="server" /> 
        ...
        <table>
            <tr>
                <td align="center">
                    <asp:Label ID="lblHead" runat="server" Text="Doctor Details - Field Force wise" Font-Underline="True" Font-Bold="True"></asp:Label>
                </td>
            </tr>
        </table>
        <br />

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Fixation.aspx.cs"
...
<head runat="server">
    <title>Fixation Wise (By Visit)</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sfname, cmode, Vacant) {
            ...
            popUpObj = window.open("Visit_Fixation_All_In_One_Report.aspx?sf_code=" + sfcode + "&FMonth=" + fmon + "&Fyear=" + fyr + "&TMonth=" + tmon + "&Tyear=" + tyr + "&sf_name=" + sfname + "&cMode=" + cmode + " &Vacant=" + Vacant,
            ...
            $('#btnGo').click(function () {
                ...
                if (ddMdINDEX != 0) {
                    ...
                    if (chkDetail.checked) {
                        showModalPopUp(sf_Code, FMonth, FYear, TMonth, TYear, SName, ddMdINDEX, 0);
                    }
                    else {
                        showModalPopUp(sf_Code, FMonth, FYear, TMonth, TYear, SName, ddMdINDEX, 1);
                    }
                }
            });
        });

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Product_Scheme_Entry_New.aspx.cs" Inherits="MasterFiles_ActivityReports_Product_Scheme_Entry_New" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        ...
                        <div class="w-100 designation-submit-button text-center clearfix">
                            ...
                            <asp:Button ID="btnClear" runat="server" CssClass="savebutton" Width="50px" Text="Clear" OnClick="btnClear_Click" />
                        </div>

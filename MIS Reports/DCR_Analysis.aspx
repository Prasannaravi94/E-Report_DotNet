...
<head runat="server">
    <title>Daily Work Report Summary Analysis</title>
    <%--  <link type="text/css" rel="Stylesheet" href="../../css/style.css" />--%>
    <script type="text/javascript">
        var popUpObj;
        var randomnumber = Math.floor((Math.random() * 100) + 1);
        function showModalPopUp(sfcode, fmon, fyr, sf_name, iSself, Is_SamInp,div_code) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("DCR_Analysis_Report.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&sf_name=" + sf_name + "&isSelf=" + iSself + "&Is_SamInp=" + Is_SamInp+ "&div_code=" + div_code,
    ...
    //"top=0"
            ...
            $(popUpObj.document.body).ready(function () {
                ...
                $(popUpObj.document.body).append('<div><p style="color:orange;"></p></div><div class="preload"> <img src="' + ImgSrc + '"  style=" width:500px; height: 300px;position: fixed;top: 20%;left: 30%;"  alt="" /></div>');
            });
        }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#btnGo').click(function () {
                ...
                //
                try {
                    //if ($('#chkdwn2').prop('checked')) { $('#dropdown').prop('disabled', true); }
                    if ($('#ddlMR').is(':enabled')) {
                        var ddMRindex = $('#ddlMR').find(":selected").index();
                        if (ddMRindex != 0 && ddMRindex != -1) {
                            sf_Code = document.getElementById('<%=ddlMR.ClientID%>').value;
                              SName = $('#<%=ddlMR.ClientID%> :selected').text();
                        }
                    }
                }
                catch (exception) {
                    sf_Code = document.getElementById('<%=ddlFieldForce.ClientID%>').value;
                }
                 var div_code;
                ...
                showModalPopUp(sf_Code, fromMon, fromYear, SName, iSself, Is_SamInp,div_code);
            });
        });
    </script>
    <script type="text/javascript">
        $(document).on('change', '#cbSelf', function () {
            //debugger;
            if ($(this).prop('checked')) {
                $('#ddlMR').css('background-color', 'lightgrey');
                $('#ddlMR').attr('disabled', 'disabled');
                $('#ddlMR').val("0");
            } else {
                $('#ddlMR').css('background-color', 'white');
                $('#ddlMR').removeAttr('disabled');
            }
        });
    </script>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">DCR Analysis</h2>

                        <asp:Label ID="Lblmain" runat="server" SkinID="lblMand" Text="Analysis - DCR"></asp:Label>
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                <asp:CheckBox ID="cbSelf" Text="Individual - Manager Only" runat="server" />
                            </div>
                            <div class="single-des clearfix">
                            ...
                            <div class="single-des clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <asp:Label ID="lblFYear" Width="70px" runat="server" CssClass="label" Text="Year"></asp:Label>
                                        <asp:DropDownList ID="ddlFYear" runat="server" AutoPostBack="false" CssClass="nice-select">
                                        </asp:DropDownList>
                                    </div>--%>
                                </div>
                            </div>
                             <div class="single-des clearfix">
                                <asp:CheckBox ID="ChkSamInp" Text="Sampl/Input" runat="server" />
                            </div>
                        </div>
                        ...
                        <asp:Label ID="lblModelevel" runat="server" Style="text-decoration: underline; font-size: 10pt; font-weight: bold"
                            SkinID="lblMand"></asp:Label>
                        <br />
                        <br />
                        <asp:Table ID="tbl" runat="server" BorderStyle="Solid" BorderWidth="1" Style="border-collapse: collapse; border: solid 0px #999999;"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listeddr_Brd_Map.aspx.cs" Inherits="MasterFiles_MR_ListedDoctor_Listeddr_Brd_Map" %>
...
<head runat="server">
    <title>Listed Doctor - Brand Map</title>
      ...
      <script type="text/javascript">
          $(function () {
              $("[id*=btnSubmit]").click(function () {
                  ...
                  if (hdnvalueee != "1") {
                      if (confirm('Do you want to Tag the Product Brand?')) {
                          return true;
                      }
                      else {
                          return false;
              ...
              $("[id*=btnSubmit]").click(function () {
                  ...
                  if (hdnvalueee == "1") {
                      for (var i = 0, j = 0; i < chklist.length, j < dropdowns.length; i++, j++) {
                          if (chklist[i].checked) {
                              if (dropdowns.item(j).value == "0") {
                                  createCustomAlert("Select Priority");
                                  return false;
                              }
                              ...
                              if (dropdowns.item(j).value != "0") {
                                  ...
                                  if (jQuery.inArray(dropdowns.item(j).value, test2) !== -1) {
                                      createCustomAlert("Same Priority is Not Allowed for Different Product brand");
                                      samecheck = true;
                                      return false;
                      ...
                      if (totCount > hdnvalue) {
                          createCustomAlert("Not Select More than  " + hdnvalue + "  Product Brand");
                          return false;
                      }
                      else {
    ...
    <div>
        ...
        <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <br />
                        <h2 class="text-center" style="border-bottom: none">Listed Doctor - Brand Tag</h2>
                ...
                <br />
                <div class="row justify-content-center">
               <asp:Label ID="lblSelect" Text="Select the Product Brand"  runat="server" visible="false"></asp:Label>
             </div>
                <br />
                            ...
                            <div class="table-responsive" style="scrollbar-width: thin; padding-bottom: 20px;">
                               ...
                               <table align="center" width="100%" cellpadding="1" cellspacing="1" style="border-collapse: collapse">
                                ...
                                <HeaderTemplate>
                                    ...
                                    <asp:Label ID="lblDocVisit" Text="Brand Name" Font-Bold="true" Width="180px" runat="server"></asp:Label>
                                    ...
                                    <asp:Label ID="lbl2" Text="Brand Name" Font-Bold="true" Width="180px" runat="server"></asp:Label>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:CheckBox ID="chkCatName" onclick="ChkFn(this)" Font-Names="Calibri" Width="200px"

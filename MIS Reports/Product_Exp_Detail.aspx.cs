...
public partial class MIS_Reports_Product_Exp_Detail : System.Web.UI.Page
{
    ...
    protected void ddlprod_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlprod.SelectedValue == "-1")
        {
            ...
            //{
            //    dsSalesForce = sf.SalesForceListMgrGet(div_code, ddlFieldForce.SelectedValue.ToString());
            //}
            //else
            //{
    ...
    protected void btnGo_Click1(object sender, EventArgs e)
    {
        ...
        if (ddlFieldForce.SelectedValue.ToString().Contains("MGR") && ddlMR.SelectedIndex == -1)
        {
            toName = ddlFieldForce.SelectedItem.ToString() + "   (All MR)";
        }
        else if (ddlFieldForce.SelectedValue.ToString().Contains("MGR") && ddlMR.SelectedItem.ToString() == "---Select---")
        {
            toName = ddlFieldForce.SelectedItem.ToString() + "   (All MR)";
        }
        else if (ddlFieldForce.SelectedValue.ToString().Contains("MGR") && ddlprod.SelectedItem.ToString().Contains("All"))
        {
            toName = ddlFieldForce.SelectedItem.ToString() + "  (  " + ddlMR.SelectedItem.ToString() + "  )  ";
        }
        else if (ddlFieldForce.SelectedValue.ToString().Contains("MGR") && ddlMR.SelectedValue.ToString() != "")
        {
            toName = ddlFieldForce.SelectedItem.ToString() + "   (All MR)";
        }
        ...
        //int iRet = astp.Audit_Report_Details(Session["sf_code"].ToString(), Session["sf_name"].ToString(),
        //Session["div_code"].ToString(), Session["div_name"].ToString(), Request.ServerVariables["REMOTE_ADDR"].ToString(), ddlFieldForce.SelectedValue.ToString(),
        ...
        int iRet = astp.Audit_Report_Details(Session["sf_code"].ToString(), Session["sf_name"].ToString(),
        Session["div_code"].ToString(), Session["div_name"].ToString(), Request.ServerVariables["REMOTE_ADDR"].ToString(), ddlFieldForce.SelectedValue.ToString(),
        toName, FromTxtDate[0].ToString(), FromTxtDate[1].ToString(), ToTxtDate[0].ToString(), ToTxtDate[1].ToString(), Lblmain.Text);
    }
}
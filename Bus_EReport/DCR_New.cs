    ...
    public class DCR_New
    {
        ...
        public DataSet get_Lst_Trans(string sf_code, string Activity_date)
        {
            ...
            strQry = "select a.Session,a.Session_Code,a.Time,a.Minutes,a.Seconds,a.Trans_Detail_Info_Code,a.Trans_Detail_Name,a.Worked_with_code, " +
                        ...
                        "a.Additional_Gift_Code,a.Additional_Gift_Dtl,a.Activity_Remarks,a. SDP_Name from DCRMain_Temp m, DCRDetail_Lst_Temp  a where " +
        ...
        public int DCRView_Insert(string Trans_SlNo, string Geo_Address)
        {
            int iReturn = -1;
            DB_EReporting db = new DB_EReporting();
            try
            {
                strQry = "update DCRDetail_Lst_Temp set GeoAddrs='" + Geo_Address + "' where trans_Detail_slno='" + Trans_SlNo + "'";

                iReturn = db.ExecQry(strQry);

                strQry = "update DCRDetail_Lst_Trans set GeoAddrs='" + Geo_Address + "' where trans_Detail_slno='" + Trans_SlNo + "'";
        ...
        public int DCRView_Insert_Chemist(string Trans_SlNo, string Geo_Address)
        {
            int iReturn = -1;
            DB_EReporting db = new DB_EReporting();
            try
            {               
                ...
                strQry = "update DCRDetail_CSH_Temp set GeoAddrs='" + Geo_Address + "' where trans_Detail_slno='" + Trans_SlNo + "'";

                iReturn = db.ExecQry(strQry);

                strQry = "update DCRDetail_CSH_Trans set GeoAddrs='" + Geo_Address + "' where trans_Detail_slno='" + Trans_SlNo + "'";
        ...
        public int DCRView_Insert_UnLst(string Trans_SlNo, string Geo_Address)
        {
            int iReturn = -1;
            DB_EReporting db = new DB_EReporting();
            try
            {
                ...
                strQry = "update DCRDetail_UnLst_Temp set GeoAddrs='" + Geo_Address + "' where trans_Detail_slno='" + Trans_SlNo + "'";

                iReturn = db.ExecQry(strQry);

                strQry = "update DCRDetail_UnLst_Trans set GeoAddrs='" + Geo_Address + "' where trans_Detail_slno='" + Trans_SlNo + "'";

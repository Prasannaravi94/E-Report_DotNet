...
public partial class MasterFiles_AnalysisReports_rptMissed_Call_Camp : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            lblHead.Text = "Campaign Missed Call Report From " + strFrmMonth + " " + FYear + " to " + " " + strToMonth + " " + " " + TYear;

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpDoctorPotentialBusinessView1.aspx.cs" Inherits="MasterFiles_ActivityReports_rpDoctorPotentialBusinessView1" %>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="80%" align="center">
                        <asp:Label ID="lblProd" runat="server" Text="Listed Doctor Potential Entry View" CssClass="reportheader"></asp:Label>
                    </td>
                    <td align="right">
                        <table>
                            <tr>
                            ...
                            <div class="single-des clearfix">
                                ...
                                <div style="float: right; width: 70%;">
                                    ...
                                    <asp:RadioButtonList ID="rbtnBased" RepeatDirection="Horizontal" runat="server" AutoPostBack="true"
                                        ...
                                        <asp:ListItem Value="1" Selected="True" Text=" LISTED DOCTOR POTENTIAL VALUE&nbsp;&nbsp;&nbsp;"></asp:ListItem>

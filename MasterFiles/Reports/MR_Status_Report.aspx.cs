...
public partial class Reports_MR_Status_Report : System.Web.UI.Page
{
    ...
    string strStockist = string.Empty;
    ...
    private void FillSalesForce()
    {
        ...
        if (Session["sf_type"].ToString() == "" || Session["sf_type"].ToString() == "3")
        {
            if (rdoMGRState.SelectedValue.ToString() == "0")
            {
                ...
                DataSet DsAudit = ds.SF_Hierarchy(ddlDivision.SelectedValue, ddlFieldForce.SelectedValue.ToString());
                if (DsAudit.Tables[0].Rows.Count > 0)
                {
                    ...
                    dsSalesForce = sf.sp_FieldForce(ddlFieldForce.SelectedValue.ToString(), ddlDivision.SelectedValue.ToString());
                    ...
                    foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
                    {
                        ...
                        strStockist += drFF["sf_code"].ToString() + ",";
                    }
                    Session["Sf_Code_multiple"] = strSf_Code.Remove(strSf_Code.Length - 1);
                    Session["Sf_Code_StrStockist"] = strStockist.Remove(strStockist.Length - 1);
                ...
                foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
                {
                    ...
                    foreach (DataRow drSF in dsRep.Tables[0].Rows)
                    {
                        ...
                        {   
                            ...
                            hyp_det_Terr_Act.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                        ...
                        if (Convert.ToInt32(drSF["DeActive_Territory"].ToString()) > 0)
                        {
                            ...
                            hyp_det_Terr_DeAct.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                        ...
                        if (Convert.ToInt32(drSF["Active_ListedDR"].ToString()) > 0)
                        {
                            ...
                            hyp_det_lst_Act.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                        ...
                        else
                      {
                        ...
                        if (Convert.ToInt32(drSF["DeActive_ListedDR"].ToString()) > 0)
                        {
                            ...
                            hyp_det_lst_DeAct.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                        ...
                        if (Convert.ToInt32(drSF["Active_UnListedDR"].ToString()) > 0)
                        {
                            ...
                            hyp_det_unlst_Act.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                        ...
                        if (Convert.ToInt32(drSF["DeActive_UnListedDR"].ToString()) > 0)
                        {
                            ...
                            hyp_det_unlst_DeAct.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
    ...
    **/
                        ...
                        if (Convert.ToInt32(drSF["Active_Chemists"].ToString()) > 0)
                        {
                            ...
                            hyp_det_chem_Act.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                        ...
                        if (Convert.ToInt32(drSF["DeActive_Chemists"].ToString()) > 0)
                        {
                            ...
                            hyp_det_chem_DeAct.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                        ...
                        if (Convert.ToInt32(drSF["Active_Stockiest"].ToString()) > 0)
                        {
                            ...
                            hyp_det_stok_Act.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                        ...
                        if (Convert.ToInt32(drSF["DeActive_Stockiest"].ToString()) > 0)
                        {
                            ...
                            hyp_det_stok_DeAct.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
    ...
    **/
                ...
                if (Convert.ToInt32(iActiveCount.ToString()) > 0)
                {
                    ...
                    hyp_det_Terr_Act_Total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                ...
                if (Convert.ToInt32(IDActiveCount.ToString()) > 0)
                {
                    ...
                    hyp_det_Terr_DeAct_Total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                ...
                if (Convert.ToInt32(iLstActiveCount.ToString()) > 0)
                {
                    ...
                    hyp_det_Terr_ActLst_Total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                ...
                if (Convert.ToInt32(iLstDActiveCount.ToString()) > 0)
                {
                    ...
                    hyp_det_Terr_DeAvtLst_Total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                ...
                if (Convert.ToInt32(iUnLstActiveCount.ToString()) > 0)
                {
                    ...
                    hyp_det_Terr_ActUnLst_Total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                ...
                if (Convert.ToInt32(iUnLstDActiveCount.ToString()) > 0)
                {
                    ...
                    hyp_det_Terr_DeActUnLst_Total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
    ...
    **/
                ...
                if (Convert.ToInt32(iChemistActiveCount.ToString()) > 0)
                {
                    ...
                    hyp_det_Terr_ActChem_Total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                ...
                if (Convert.ToInt32(iChemistDActiveCount.ToString()) > 0)
                {
                    ...
                    hyp_det_Terr_DeActChem_Total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                ...
                if (Convert.ToInt32(iSockistActiveCount.ToString()) > 0)
                {
                    ...
                    hyp_det_Terr_ActStockist_Total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                ...
                if (Convert.ToInt32(iSockistDActiveCount.ToString()) > 0)
                {
                    ...
                    hyp_det_Terr_DeActStockist_Total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";

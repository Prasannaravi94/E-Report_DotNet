                        ...
                        <div class="designation-reactivation-table-area clearfix">
                            ...
                            <div class="display-table clearfix">
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="grdHoID" runat="server" 
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl_RptTo" runat="server" Text='<%# Bind("Reporting_To_Name") %>'></asp:Label>
                                            ...
                                            <asp:HyperLinkField HeaderText="Edit" Text="Edit" DataNavigateUrlFormatString="HO_ID_Creation.aspx?HO_ID={0}" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <asp:TemplateField HeaderText="Deactivate" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <%--<ControlStyle ForeColor="DarkBlue" Font-Size="XX-Small" Font-Names="Verdana" Font-Bold="True"></ControlStyle>
                                                <ItemStyle ForeColor="DarkBlue" Font-Bold="False"></ItemStyle>--%>
                                                <ItemTemplate>

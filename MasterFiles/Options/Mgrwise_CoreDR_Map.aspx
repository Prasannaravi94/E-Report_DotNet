...
<head runat="server">
    <title>Managerwise Core Doctor Map</title>
    ...
    <ucl:Menu ID="menu1" runat="server" /> 
        ...
        <table width="90%" border="1" bgcolor="#D4D4D4" style="border-style: solid; border-width: thin">
            <tr>
                ...
                <td>
                    <asp:Label ID="lblHead" runat="server" Text="Core Doctor Map" Font-Bold="True" Font-Names="Arial" Font-Size="11px"></asp:Label>
                </td>
                <td align="right">

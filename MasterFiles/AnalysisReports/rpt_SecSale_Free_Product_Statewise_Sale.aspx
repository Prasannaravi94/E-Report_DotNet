<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_SecSale_Free_Product_Statewise_Sale.aspx.cs" Inherits="MasterFiles_AnalysisReports_rpt_SecSale_Free_Product_Statewise_Sale" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../JScript/Service_CRM/SecSale/rpt_Product_State_Sale.js" type="text/javascript"></script>
    ...
    <style type="text/css">
		...
		#tblHQSale{background-color:white;}
    </style>
    <style type="text/css">
        @media print {
            .noPrnCtrl {
                                ...
                                <div id="MainDiv">
                                    ...
                                    <div class="display-reportMaintable clearfix">
                                        <div class="table-responsive" style="scrollbar-width: thin; overflow:inherit">
                                            <div id="divpnl" style="background-color:white">
                                            </div>
                                            <br />
                                            <div id="div_DeAct">
                                            </div>

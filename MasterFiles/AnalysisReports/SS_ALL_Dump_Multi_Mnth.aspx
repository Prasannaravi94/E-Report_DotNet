<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SS_ALL_Dump_Multi_Mnth.aspx.cs" Inherits="MasterFiles_AnalysisReports_SS_ALL_Dump_Multi_Mnth" %>
...
<head runat="server">
    <title>Sales Consolidated </title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
    ...
    <script type="text/javascript">
        function validation() {
            ...
            // Convert both from and to dates to a format that can be compared
            var fromDate = new Date(fromYear, fromMon - 1); // Month is 0-based in JS, so subtract 1
            var toDate = new Date(ToYear, ToMon - 1);
            ...
            if (monthDiff > 2) {
                alert("The Range should not be more than 3 months.");
                return false;
            } else {
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Sales Consolidated </h2>
                    ...
                    BackColor="LightBlue" onclick="btnSubmit_Click" /></center>--%>
                            <asp:LinkButton ID="btnSubmit" runat="server" Font-Size="Medium" Font-Bold="true"
                                Text="Download Excel" OnClientClick="return validation();" OnClick="btnSubmit_Click" />
                        </div>
                    </div>
                </div>
            </div>

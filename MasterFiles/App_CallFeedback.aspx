<%@ Page Language="C#" AutoEventWireup="true" CodeFile="App_CallFeedback.aspx.cs" Inherits="MasterFiles_App_CallFeedback" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnaddnew').click(function () {
                if ($("#txtaddnew").val() == "") { alert("Enter Feedback."); $('#txtaddnew').focus(); return false; }
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="display-table clearfix">
                            <div class="table-responsive" style="scrollbar-width: thin;">
                                <asp:GridView ID="grdFeedback" runat="server" Width="100%" HorizontalAlign="Center" OnRowCreated="grdFeedback_RowCreated"
                                    ...
                                    CssClass="table" OnSelectedIndexChanging="grdFeedback_SelectedIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="More" HeaderStyle-Width="40px">
                                            <FooterTemplate>
                                                <asp:Button ID="btnadd" runat="server" CssClass="savebutton" Width="110px" CausesValidation="true" CommandName="Select" Text="Add Feedback" OnClientClick="GetGridFooterRowvalues()" />
                                        ...
                                        <asp:TemplateField HeaderText="Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="50%">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtfeedback_name" onkeypress="AlphaNumeric_NoSpecialCharshq(event);" runat="server" CssClass="input alignment"  Height="35px" Text='<%# Bind("Feedback_Content") %>'></asp:TextBox>
                                            </ItemTemplate>
                                            <FooterTemplate>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-3" align="center">
                                <asp:Button ID="btnaddnew" runat="server" CssClass="savebutton" Width="110px" Text="Add Feedback" OnClick="btnaddnew_Click" />
                            </div>

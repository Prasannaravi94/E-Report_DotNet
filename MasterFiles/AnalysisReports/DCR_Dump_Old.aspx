<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DCR_Dump.aspx.cs" Inherits="MasterFiles_AnalysisReports_DCR_Dump" %>
...
<head runat="server">
    <title>Daywise Report Dump</title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Daywise Report Dump</h2>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Listeddr_Incl_Deactivate_MGR.aspx.cs" Inherits="MasterFiles_AnalysisReports_rpt_Listeddr_Incl_Deactivate_MGR" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .display-table3rowspan .table tr:first-child td:nth-child(4) {
            position: sticky;
            position: -webkit-sticky;
            top: 0;
            left: 269px;
        ...
        .display-table3rowspan .table tr:nth-child(n+4) td:nth-child(4) {
            position: sticky;
            position: -webkit-sticky;
            z-index: 0;
            background-color: white;

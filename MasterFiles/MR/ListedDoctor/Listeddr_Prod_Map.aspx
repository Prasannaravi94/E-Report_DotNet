...
<body>
        ...
        <center>
            <asp:GridView ID="grdDoctor" runat="server" Width="90%" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ListedDr Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-ForeColor="White" ItemStyle-Width="200px">
                        <ItemTemplate>
    ...
    <br />
    <center>
        <asp:Button ID="btnSubmit" runat="server" Text="Save" CssClass="savebutton" Width="70px"
            Height="25px" OnClick="btnSubmit_Click" />
    </center>
    <div class="div_fixed">
        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="savebutton" Width="70px"

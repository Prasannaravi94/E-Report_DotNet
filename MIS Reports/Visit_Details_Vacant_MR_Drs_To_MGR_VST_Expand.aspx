<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Vacant_MR_Drs_To_MGR_VST_Expand.aspx.cs" Inherits="MIS_Reports_DCR_Analysis_Expand" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .display-reporttable .table tr td {
            text-align: left;
        }
    </style>
</head>
                                ...
                                <div class="table-responsive" style="scrollbar-width: thin;">
                                    <asp:Panel runat="server">
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblMgr_Names" ForeColor="Red" runat="server" Font-Size="14px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GrdJoint" runat="server" AutoGenerateColumns="true"
                                                        ...
                                                        Width="100%" OnSorting="grdDoctor_Sorting"
                                                        OnRowDataBound="GrdArrangeDate_RowDataBound">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblMgr_Name" ForeColor="Red" runat="server" Font-Size="14px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GrdTtl" runat="server" AutoGenerateColumns="true" AllowSorting="true" CssClass="table"
                                        ...
                                        <table width="100%">
                                            <caption>
                                                <asp:GridView ID="GrdUnLst" runat="server" AutoGenerateColumns="true" AllowSorting="true" OnRowDataBound="GrdArrangeDate_RowDataBound" CssClass="table"
                                                    EmptyDataText="No Records Found" GridLines="None" HorizontalAlign="Center" Width="100%" OnSorting="grdDoctor_Sorting">
                                        ...
                                        <table width="100%">
                                            <caption>
                                                <asp:GridView ID="GrdChmst" runat="server" AutoGenerateColumns="true" AllowSorting="true" CssClass="table"
                                                    EmptyDataText="No Records Found" GridLines="None" HorizontalAlign="Center" Width="100%" OnSorting="grdDoctor_Sorting">

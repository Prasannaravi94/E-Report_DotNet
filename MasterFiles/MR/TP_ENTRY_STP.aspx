<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TP_ENTRY_STP.aspx.cs" Inherits="MasterFiles_MR_TP_ENTRY_STP" %>
...
//                   for (i = 2; i < allcnt.length; i++) {
                   for (i = 2; i <= row + 1; i++) {
                       ...
                       if (found == true) {
                           ...
                           if (ddlstp.value == '0') {
                               alert('Select STP for the date of ' + datee);
                               ddlstp.focus();
                               return false;
                           }
                               ...
                               alert("Select Alteast one Chemist for the date of " + datee);                            
                               return false;
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        function disable(row) {
            ...
            document.getElementById('grdTP_ctl' + index + '_ddlstp').value = '0';
            ...
            if (found == true) {
                ...
                $("#grdTP_ctl" + index + "_ddlstp").prop("disabled", false); 
                var hdnweekday = document.getElementById('grdTP_ctl' + index + '_hdnweekday');
                

                document.getElementById('grdTP_ctl' + index + '_ddlstp').value = hdnweekday.value;



             
                if (document.getElementById('grdTP_ctl' + index + '_hdnweekday').value == "MO5") {
                    
                    document.getElementById('grdTP_ctl' + index + '_ddlstp').value = "MO1";
                }

                else if (document.getElementById('grdTP_ctl' + index + '_hdnweekday').value == "TU5") {
                    document.getElementById('grdTP_ctl' + index + '_ddlstp').value = "TU1";
                }
                else if (document.getElementById('grdTP_ctl' + index + '_hdnweekday').value == "WE5") {
                    document.getElementById('grdTP_ctl' + index + '_ddlstp').value = "WE1";
                }

                else if (document.getElementById('grdTP_ctl' + index + '_hdnweekday').value == "TH5") {
                  
                    document.getElementById('grdTP_ctl' + index + '_ddlstp').value = "TH1";
                }

                else if (document.getElementById('grdTP_ctl' + index + '_hdnweekday').value == "FR5") {
                    document.getElementById('grdTP_ctl' + index + '_ddlstp').value = "FR1";
                }

                else if (document.getElementById('grdTP_ctl' + index + '_hdnweekday').value == "SA5") {
                    document.getElementById('grdTP_ctl' + index + '_ddlstp').value = "SA1";
                }


                document.getElementById('grdTP_ctl' + index + '_ddldrfill').value = document.getElementById('grdTP_ctl' + index + '_ddlstp').value;

                document.getElementById('grdTP_ctl' + index + '_ddlchemfill').value = document.getElementById('grdTP_ctl' + index + '_ddlstp').value;

                var ddldrfill = document.getElementById('grdTP_ctl' + index + '_ddldrfill');
                var ddldrfill_text = ddldrfill.options[ddldrfill.selectedIndex].text;

                var ddlchemfill = document.getElementById('grdTP_ctl' + index + '_ddlchemfill');
                var ddlchemfill_text = ddlchemfill.options[ddlchemfill.selectedIndex].text;



                document.getElementById('grdTP_ctl' + index + '_hdndr').value = ddldrfill_text;

                document.getElementById('grdTP_ctl' + index + '_hdnchem').value = ddlchemfill_text;


              

               
              //  $('input[id*=grdTP_ctl' + index + '_ddlstp]').removeAttr("disabled");

            }
            else {
                $("#grdTP_ctl" + index + "_ddlstp").prop("disabled", true);
               // $('input[id*=grdTP_ctl' + index + '_ddlstp]').attr("disabled", "disabled");
   ...
   <%-- <script type="text/javascript">
        ...
        function getselectedTerritory() {
            ...
            $(document).ready(function () {
                $('input[id*=lnkFake]').click(function () {
                    ...
                    alert(teritoryname);
                    $.ajax({
                        url: 'TP_ENTRY_STP.aspx/teritory',
                        dataType: 'json',
                        type: 'post',
    ...
    <script type="text/javascript">
        function ShowModalPopup($x) {
            ...
            ddlstp = document.getElementById("grdTP_ctl" + index + "_ddlstp").value;

            day = document.getElementById("grdTP_ctl" + index + "_lblDay_name").innerHTML;


            document.getElementById("grdTP_ctl" + index + "_terr_name").innerHTML = document.getElementById("grdTP_ctl" + index + "_ddlstp").value;

            $.ajax({
                type: "POST",
                url: "TP_ENTRY_STP.aspx/GetCustomersdr",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                data: JSON.stringify({ "stp_day": ddlstp, "day": day }),
                dataType: "json",
                async: true,
                success: OnSuccess,
                ...
                $.each(customers, function () {
                    ...
                    for (i = 0; i < checkoptions.length; i++) {
                        ...
                        if (savedvalue == '') {
                            ...
                            if (checkoptions[i].parentNode.getElementsByTagName('span')[0].innerHTML != '') {
            ...
            function chem() {
                ...
                $.ajax({
                    type: "POST",
                    url: "TP_ENTRY_STP.aspx/GetCustomerschem",
                    data: '{}',
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({ "stp_day": ddlstp }),
                    dataType: "json",
                    async: true,
                    success: OnSuccess,
                    failure: function (response) {
                    ...
                    $.each(customers, function () {
                        ...
                        for (i = 0; i < checkoptionss.length; i++) {
                            ...
                            if (savedvaluee == '') {
                                ...
                                if (checkoptionss[i].parentNode.getElementsByTagName('span')[0].innerHTML != '') {
                    ...
                    <td align="center">
                        <asp:GridView ID="grdTP" runat="server" Width="60%" HorizontalAlign="Center" AutoGenerateColumns="false" 
                            ...
                            <Columns>
                              ...
                              <asp:TemplateField HeaderText="STP" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                    <asp:HiddenField ID="hdnweekday" runat="server"  Value='<%#  Eval("weekdays") %>' />
                                      
                                        <asp:DropDownList ID="ddlstp" runat="server" SkinID="ddlRequired" Width="150px" CssClass="form-control"
                                            DataSource="<%# Fillstp() %>"  DataTextField="day_plan_name"  onchange="fillvalue(this)"
                                            DataValueField="day_plan_short_name" >
                                        </asp:DropDownList>

                                         <asp:DropDownList ID="ddldrfill" style="display:none" runat="server" SkinID="ddlRequired" Width="150px" CssClass="form-control"
                                            DataSource="<%# Fillstp_drcode() %>"  DataTextField="Dr_Code"
                                            DataValueField="Day_Plan_ShortName" >
                                        </asp:DropDownList>

                                          <asp:DropDownList ID="ddlchemfill" style="display:none" runat="server" SkinID="ddlRequired" Width="150px" CssClass="form-control"
                                            DataSource="<%# Fillstp_chemcode() %>"  DataTextField="Chem_Code"
                                            DataValueField="Day_Plan_ShortName" >
                                        </asp:DropDownList>
...
<%--    <div class="header">
  ...
  <%--  <br />--%>
     <asp:Label ID="lbldd" runat="server" Text="Select Alteast one Doctor and Chemist from selected STP" ForeColor='Red' CssClass="blink_me"></asp:Label>
    <br />

    <asp:Label ID="lblterr" Text="STP :" runat="server"></asp:Label>

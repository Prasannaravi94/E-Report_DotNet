...
using Bus_EReport;
using System.Net;
public partial class MasterFiles_ActivityReports_rpDoctorPotentialBusinessView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Doctor Productwise Potential for " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    private void FillSF()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            tc_DR_Des1.BorderColor = System.Drawing.Color.FromName("#DCE2E8");
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                if (months >= 0)
                {
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = dr.rpListedPotDrBus_value(drFF["sf_code"].ToString(), divcode, cmonth, cyear, basedOn);
                        ...
                        if (tot_dr != "0" && tot_dr != "")
                        {
                            ...
                            hyp_lst_month.Attributes.Add("href", "javascript:showModalPopUp('" + drFF["sf_code"].ToString() + "', '" + drFF["sf_name"] + " - " + drFF["sf_Designation_Short_Name"] + " - " + drFF["sf_hq"] + "', '" + cyear + "', '" + cmonth + "','" + sCurrentDate + "','" + basedOn + "')");
                    ...
                    if (iTotLstCount1 != 0)
                    {
                        ...
                        tc_tot_month12.BorderColor = System.Drawing.Color.FromName("#DCE2E8");
            ...
            if (months >= 0)
            {
                ...
                tc_tot_monthq.BorderColor = System.Drawing.Color.FromName("#DCE2E8");
    ...
    {
        string attachment = "attachment; filename=" + lblHead.Text + ".xls";

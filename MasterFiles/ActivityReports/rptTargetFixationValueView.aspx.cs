...
public partial class MIS_Reports_dcview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Target_Fixation_Valuewise_Entry_for_" + strFMonthName + "_" + FYear + "_" + "To" + "_" + strTMonthName + "_" + TYear;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = objTarget.GetTargetFixationValList(sfCode, divcode);
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsTrans_TarVal = objTarget.TargetFixationValuewise_RecordExist(drFF["Sf_Code"].ToString(), divcode, cyear);

                        if (dsTrans_TarVal.Tables[0].Rows.Count > 0)
                            tot_dr = dsTrans_TarVal.Tables[0].Rows[0].ItemArray.GetValue(cmonth + 3).ToString();

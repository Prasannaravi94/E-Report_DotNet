...
public partial class MIS_Reports_inputissued : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Input Despatch status for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    private void FillSF()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            TableCell tc_DR_Des3 = new TableCell();
            tc_DR_Des3.BorderStyle = BorderStyle.Solid;
            tc_DR_Des3.BorderWidth = 1;
            tc_DR_Des3.Width = 80;
            tc_DR_Des3.RowSpan = 1;
            Literal lit_DR_Des3 = new Literal();
            lit_DR_Des3.Text = "<center>OB</center>";
            tc_DR_Des3.BorderColor = System.Drawing.Color.Black;
            tc_DR_Des3.Attributes.Add("Class", "rptCellBorder");
            tc_DR_Des3.Controls.Add(lit_DR_Des3);
            tr_header.Cells.Add(tc_DR_Des3);
            ...
            lit_DR_Des1.Text = "<center>Input Quantity</center>";
            ...
            TableCell tc_DR_Des2 = new TableCell();
            tc_DR_Des2.BorderStyle = BorderStyle.Solid;
            tc_DR_Des2.BorderWidth = 1;
            tc_DR_Des2.Width = 80;
            tc_DR_Des2.RowSpan = 1;
            Literal lit_DR_Des2 = new Literal();
            lit_DR_Des2.Text = "<center>Issued Quantity</center>";
            tc_DR_Des2.BorderColor = System.Drawing.Color.Black;
            tc_DR_Des2.Attributes.Add("Class", "rptCellBorder");
            tc_DR_Des2.Controls.Add(lit_DR_Des2);
            tr_header.Cells.Add(tc_DR_Des2);

            TableCell tc_DR_Des4 = new TableCell();
            tc_DR_Des4.BorderStyle = BorderStyle.Solid;
            tc_DR_Des4.BorderWidth = 1;
            tc_DR_Des4.Width = 80;
            tc_DR_Des4.RowSpan = 1;
            Literal lit_DR_Des4 = new Literal();
            lit_DR_Des4.Text = "<center>CB</center>";
            tc_DR_Des4.BorderColor = System.Drawing.Color.Black;
            tc_DR_Des4.Attributes.Add("Class", "rptCellBorder");
            tc_DR_Des4.Controls.Add(lit_DR_Des4);
            tr_header.Cells.Add(tc_DR_Des4);
            tbl.Rows.Add(tr_header);
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                HyperLink lit_det_usr = new HyperLink();
                ...
                lit_det_FF.Attributes.Add("href", "javascript:showModalPopUp('" + drFF["sf_code"].ToString() + "', '" + FMonth + "','" + FYear + "','" + TMonth + "','" + TYear + "','" + drFF["sf_name"].ToString() + "')");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.input_quantity_Mr(drFF["sf_code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        dsdoc1 = sf.inputissue_quantity_Mr(drFF["sf_code"].ToString(), divcode, cmonth, cyear, sCurrentDate);

                        if (dsDoc.Tables[0].Rows.Count > 0 || dsdoc1.Tables[0].Rows.Count > 0)
                            tot_dr = dsDoc.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                        is_dr = dsdoc1.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                        if (is_dr == "")
                        {
                            is_dr = "0";
                            iTotLstCount1 += int.Parse(is_dr);
                        }
                        else if (is_dr != "")
                        {
                        ...
                        if (tot_dr == "")
                        {
                            ...
                            //Convert.ToString( iTotLstCount) = "-";
                            //a = iTotLstCount.ToString();
                        }
                ...
                if (iTotLstCount.ToString() == "0")
                {
                    ...
                    hyp_month1.Text = a;
                    //hyp_month1.Text = ViewState["total"].ToString();
                    tc_tot_month1.BorderStyle = BorderStyle.Solid;
                    tc_tot_month1.BorderWidth = 1;
                    tc_tot_month1.BackColor = System.Drawing.Color.White;
                    tc_tot_month1.Width = 200;
                ...
                else if (tot_dr != "")
                {
                    ...
                    hyp_month1.Text = iTotLstCount.ToString();
                    //hyp_month1.Text = ViewState["total"].ToString();
                    tc_tot_month1.BorderStyle = BorderStyle.Solid;
                    tc_tot_month1.BorderWidth = 1;
                    tc_tot_month1.BackColor = System.Drawing.Color.White;
                ...
                if (iTotLstCount1.ToString() == "0")
                {
                    ...
                    tc_tot_month2.HorizontalAlign = HorizontalAlign.Center;
                    ...
                    tr_det.Cells.Add(tc_tot_month2);
                }
                else if (is_dr != "")
                {
                    TableCell tc_tot_month2 = new TableCell();
                    ...
                    hyp_month2.Text = iTotLstCount1.ToString();
                    //hyp_month1.Text = ViewState["total"].ToString();
                    tc_tot_month2.BorderStyle = BorderStyle.Solid;
                    tc_tot_month2.BorderWidth = 1;
                    tc_tot_month2.BackColor = System.Drawing.Color.White;
                ...
                TableCell tc_det_prd1 = new TableCell();

                Literal lit_det_prd1 = new Literal();
                lit_det_prd1.Text = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + "-";
                tc_det_prd1.BorderStyle = BorderStyle.Solid;
                tc_det_prd1.BorderWidth = 1;
                tc_det_prd1.Controls.Add(lit_det_prd1);
                tc_det_prd1.Attributes.Add("Class", "rptCellBorder");
                tr_det.Cells.Add(tc_det_prd1);
            ...
            //        dsDoc = sf.despatch_quantity_Mr(drFF["sf_code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
            ...
            //            ViewState["total"] = iTotLstCount1.ToString();
            //            ////hyp_month1.Text = tot_dr;

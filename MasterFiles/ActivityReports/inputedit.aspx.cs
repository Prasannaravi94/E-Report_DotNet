...
public partial class MasterFiles_ActivityReports_inputedit : System.Web.UI.Page
{
            ...
            if (baseitem.Selected)
            {
                ...
                if (output != "0")
                {
                    ...
                    foreach (DataListItem item in this.gvSampleProducts.Items)
                    {
                        ...
                        rmrks = (item.FindControl("txtremarks") as TextBox).Text;
                        pid = hd.Value;
                        ...
                        if (qnty.Length > 0)
                        {
                            if (Convert.ToInt32(qnty) > 0)
                            {
                                ...
                                objInput.RecordDetailsAddedit(output, baseitem.Value, div_code, giftname, Convert.ToInt32(qnty), pid, rmrks);
                                //qntnt = 0;
                                //Upd = true;
                        ...
                        //if (Convert.ToInt32(dtRow.ItemArray[9]) > 0 && Upd != true)
                        //{
                        //    objInput.RecordDetailsAddinput(output, baseitem.Value, div_code, giftname, Convert.ToInt32(dtRow.ItemArray[9]), pid);

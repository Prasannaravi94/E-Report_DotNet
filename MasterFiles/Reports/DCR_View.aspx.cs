...
public partial class Reports_DCR_View : System.Web.UI.Page
{
    ...
    {
        SalesForce sf = new SalesForce();
        dsSalesForce = sf.UserList_AlphaAll(ddlDivision.SelectedValue.ToString(), "admin", "");
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ddlFieldForce.DataTextField = "sf_name";
            ddlFieldForce.DataValueField = "sf_code";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string sURL = "Rpt_DCR_View.aspx?sf_code=" + ddlMR.SelectedValue + "&div_code=" + div_code + "&cur_month=" + MonthVal.ToString() + "&cur_year=" + YearVal.ToString() +
        ...
        {
            string sURL = "Rpt_DCR_View.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&cur_month=" + MonthVal.ToString() + "&cur_year=" + YearVal.ToString() +
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
        ...
        string[] MonthYearVal = txtMonthYear.Text.Split('-');
        int iRet = astp.Audit_Report_Details(Session["sf_code"].ToString(), Session["sf_name"].ToString(),
        Session["div_code"].ToString(), Session["div_name"].ToString(), Request.ServerVariables["REMOTE_ADDR"].ToString(),
        ddlFieldForce.SelectedValue.ToString(), toName, MonthYearVal[0].ToString(), MonthYearVal[1].ToString(), Monthdata, Yeardata, Lblmain.Text);
    }
}
        ...
        if (ViewState["dt_catg"] != null)
        {
            ...
            if (dtCatg.Rows.Count > 0)
            {
                ...
                foreach (DataRow dataRow in dtCatg.Rows)
                {
                    ...
                    tc_catg.Style.Add("font-weight", "bold");
                    ...
                    tc_catg.Attributes.Add("class", "tbltd");
                    ...
                    txtcatg.Style.Add("font-weight", "bold");
                    txtcatg.Style.Add("text-align", "right");
                    txtcatg.Style.Add("padding-right", "10px");
                    txtcatg.Style.Add("border-radius", "0px");
                    txtcatg.Attributes.Add("class","textbox");
                    txtcatg.Width = 75;
                    txtcatg.Height = 31;
                ...
                tc_catg_total.Style.Add("font-weight", "bold");
                ...
                tc_catg_total.HorizontalAlign = HorizontalAlign.Center;
                tc_catg_total.Attributes.Add("class", "tbltd");
                tc_catg_total.Style.Add("width", "100px");
                tr_header.Cells.Add(tc_catg_total);

                TableCell tc_catg_total_cnt = new TableCell();                
                TextBox txtcatg_total = new TextBox();
                txtcatg_total.Style.Add("font-weight", "bold");
                txtcatg_total.Style.Add("text-align", "right");
                txtcatg_total.Style.Add("padding-right", "10px");
                txtcatg_total.Style.Add("border-radius", "0px");
                txtcatg_total.Attributes.Add("class", "textbox");
                txtcatg_total.Width = 100;
                txtcatg_total.Height = 31;
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if(dtDoctor.Rows.Count  == 0)
            {
                if (multidoc == 0)
                {
                    ...
                    {
                        e.Row.Enabled = true;
                        e.Row.BackColor = e.Row.BackColor = System.Drawing.ColorTranslator.FromHtml("#FFE4B2");
                    }
                    else
                    {

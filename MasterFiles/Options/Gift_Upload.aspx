<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gift_Upload.aspx.cs" Inherits="MasterFiles_Options_Gift_Upload" %>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:Label ID="Label1" runat="server" CssClass="label">1) Sheet Name Must be 'Upl_Gift_Master'</asp:Label>
                            </div>
                            <div class="single-des clearfix">

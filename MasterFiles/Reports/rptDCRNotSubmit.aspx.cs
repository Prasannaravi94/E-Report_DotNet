...
public partial class Reports_rptDCRNotSubmit : System.Web.UI.Page
{
    ...
    protected void GrdDoctor_OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            strNSDays = DataBinder.Eval(e.Row.DataItem, "DCR_Not_Submit_Days").ToString();
            ...
            dsSf = sf1.CheckSFNameVacant_Temp(strSF_Code, Convert.ToInt16(cmonth), Convert.ToInt16(cyear));
    ...
    private void FillSalesForce(int cmonth, int cyear)
    {
        ...
        dsSalesForce = sf.DCR_get_Not_Submit_Date(div_code, SF_code, cmonth.ToString(), cyear.ToString());
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            GrdDCRSubmit.DataSource = dsSalesForce;
            GrdDCRSubmit.DataBind();
        }
    }

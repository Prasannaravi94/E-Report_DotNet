<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SamplePrd_Rxqty.aspx.cs"
    Inherits="MIS_Reports_SamplePrd_Rxqty" %>
...
<head runat="server">
    <title>Sample Product Rx Quantity</title>
    <link type="text/css" rel="Stylesheet" href="../css/rptMissCall.css" />
    <link type="text/css" rel="stylesheet" href="../css/Grid.css" />
    <%--<link type="text/css" rel="stylesheet" href="../css/style.css" />--%>
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name, rdoType, excel) {
            ...
            popUpObj = window.open("rptSamplePrd_Rxqty.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name + "&sample_code=" + cbValue + "&sample_name=" + cbTxt + "&Type=" + rdoType + "&excel=" + excel,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
    ...
    //"top=0"
            ...
            $(popUpObj.document.body).ready(function () {
                ...
                var ImgSrc = "https://s29.postimg.org/9m09r83k7/load.gif"
                $(popUpObj.document.body).append('<div><p style="color:orange;">Loading Please Wait.....</p></div><div class="preload"> <img src="' + ImgSrc + '"  style=" width:750px; height: 300px;position: fixed;top: 20%;left: 15%;"  alt="" /></div>');
            });
            //LoadModalDiv();
        }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                var mode = $('#<%=rdoType.ClientID%> :selected').text();
                if (mode == "--Select--") { alert("Select Mode."); $('#rdoType').focus(); return false; }
                ...
                var rdoType = document.getElementById('<%=rdoType.ClientID%>').value;


                var chk_excel = document.getElementById("chk_excel");
                ...
                showModalPopUp(sf_Code, FMonth, FYear, TMonth, TYear, SName, rdoType, excel);
                //}
                //else {
    ...
    <style type="text/css">
        #excelchk [type="checkbox"]:not(:checked) + label, #excelchk [type="checkbox"]:checked + label {
            padding-left: 1.15em;
        }
    </style>
</head>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Sample Product Rx Quantity</h2>
              ...
              <ContentTemplate>--%>
                        <div class="designation-area clearfix">
                          ...
                          <img src="../Images/Selective_Mgr.png" />
                            ...
                            <div class="single-des clearfix" id="DDdisplay">
                                <div style="float: left; width: 45%">
                            ...
                            <div class="single-des clearfix">
                                <asp:Label ID="lblinput" runat="server" CssClass="label" Text="Select Mode"></asp:Label>
                                <asp:DropDownList ID="rdoType" runat="server" CssClass="nice-select" AutoPostBack="true"
                                    OnSelectedIndexChanged="rdoType_SelectedIndexChanged">
                                    <asp:ListItem Value="-1" Text="--Select--" Selected="True"></asp:ListItem>
                                    <asp:ListItem Value="0" Text="Product wise"></asp:ListItem>
                                    <asp:ListItem Value="1" Text="Brand wise"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="single-des clearfix">
                                <asp:CheckBox ID="chkAll" Text="Select All" runat="server" Font-Bold="true" onclick="checkAll(this);" />

                                <asp:CheckBoxList ID="chksample" CellPadding="10" RepeatColumns="2"
                                    RepeatDirection="vertical"
                                    runat="server">
                                </asp:CheckBoxList>
                            </div>
                            <div class="single-des clearfix" id="excelchk">
                                <asp:Label ID="Label1" runat="server" CssClass="label" Text="Export to Excel"></asp:Label>
                                <asp:CheckBox ID="chk_excel" runat="server" Text="." />
                            </div>
                        </div>
                        <%--</ContentTemplate>
           </asp:UpdatePanel>--%>
    ...
    <script type="text/javascript">
        ...
        $("#chk_excel").click(function () {
            ...
            if (chk_excel.checked) {
                ...
                document.getElementById('lblFMonth').innerHTML = 'Month';
                document.getElementById('lblFYear').innerHTML = 'Year';
            }
            else {
                //$('#lblTMonth').show();
                //$('#ddlTYear').show();
                ...
                document.getElementById('lblFMonth').innerHTML = 'From Month';
                document.getElementById('lblFYear').innerHTML = 'From Year';

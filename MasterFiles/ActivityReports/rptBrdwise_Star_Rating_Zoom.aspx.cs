...
public partial class MasterFiles_AnalysisReports_rptAnalysis_Pob_count_Zoom : System.Web.UI.Page  
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            rating = Request.QueryString["rating"].ToString();
            ...
            lblHead.Text = "Brandwise Star Rating - Doctor wise Report for " + strFrmMonth + " " + FYear;
    ...
    private void FillReport()
    {
        ...
        sProc_Name = "sp_Brdwise_Star_Rating_Drs_Zoom";
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 0, 0, "Duration (Mins)", "#0097AC", true);
            ...
            for (int i = 9; i < e.Row.Cells.Count; i++)
            {
                //added by preethi
                    ...
                    if (e.Row.Cells[i].Text != "0" && e.Row.Cells[i].Text != "" && e.Row.Cells[i].Text != "&nbsp;")
                    {
                        ...
                        hLink.Attributes.Add("onclick", "javascript:showModalPopUp('" + sf_code + "', '" + div_code + "', '" + FMonth + "', '" + FYear + "', '" + Sf_CodeMGR + "','" + prodcode + "','" +Convert.ToString(dtrowClr.Rows[indx][1].ToString()) +"','" + strFieledForceName +"')");

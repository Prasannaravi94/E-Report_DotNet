<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Resigned_User_Status.aspx.cs" Inherits="MasterFiles_Resigned_User_Status" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(FMonth, FYear, TMonth, TYear) {
            ...
            popUpObj = window.open("rptResigned_User_Status.aspx?FMonth=" + FMonth + "&FYear=" + FYear + "&TMonth=" + TMonth + "&TYear=" + TYear,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Resigned User Status</h2>

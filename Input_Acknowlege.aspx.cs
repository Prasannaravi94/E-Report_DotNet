...
public partial class Input_Acknowlege : System.Web.UI.Page
{
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            if (ds.Tables[0].Rows[0]["Sam_Inp_Restrict_Days"].ToString() != null)
            {
                ...
                SqlCommand cmd2 = new SqlCommand(" select  a.Trans_sl_No, Created_Date, Updated_Date, case when  DATEADD(day, " + dys + ", Created_Date) < getdate() then 'True' else 'False' end flag, " +
                                                 " case when  DATEADD(day, " + dys + ", Updated_Date) < getdate() then 'True' else 'False' end flag2 from [dbo].[Trans_Input_Despatch_Head] a where " +
    ...
    private void Fillinput()
    {
        ...
        using (SqlConnection con = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Ereportcon"].ConnectionString))
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.CommandText = "select a.Trans_sl_No,b.Gift_Name,b.Despatch_Qty,b.Despatch_Actual_qty,a.Trans_month_year," +
                " b.Received_Flag,a.Trans_Month,a.Trans_Year from [dbo].[Trans_Input_Despatch_Head] a,[dbo].[Trans_Input_Despatch_Details] b " +
                 ...
                 " and  b.Received_Flag is null  and (a.Trans_Month=Month(GetDate())-1  or a.Trans_Month=Month(GetDate()) or a.Trans_Month=Month(Getdate())+1) order by Trans_Month";
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    ...
                    if (da.Tables[0].Rows.Count > 0)
                    {
                        ...
                        // string month = da.Tables[0].Rows[0]["Trans_month_year"].ToString();
                        ...
                        if (month != "")
                        {
                           ...
                           // Trans_month_year = Trans_month.Month.ToString() + "-" + Trans_month.Day.ToString() + "-" + Trans_month.Year.ToString();
                            ...
                            lblipmonth.Text = strFrmMonth + " " + year.ToString();
                        }  
                    }
                }
                ...
                //cmd.CommandText = "select a.Trans_sl_No,b.Gift_Name,b.Despatch_Qty,b.Despatch_Actual_qty,a.Trans_month_year," +
                //" b.Received_Flag,a.Trans_Month,a.Trans_Year,b.productc from [dbo].[Trans_Input_Despatch_Head] a,[dbo].[Trans_Input_Despatch_Details] b " +
                // " where a.Trans_sl_No=b.Trans_sl_No and  a.sf_code='" + sf_code + "'  and a.Division_Code ='" + div_code + "' " +
                // " and  b.Received_Flag is null  and (a.Trans_Month=Month(GetDate())-1  or a.Trans_Month=Month(GetDate()) or a.Trans_Month=Month(Getdate())+1) order by Trans_Month";


                cmd.CommandText = " select * from(select *, DENSE_RANK() OVER ( ORDER BY ord ) row_no from " +
                " (select  a.Trans_sl_No,b.Gift_Name,b.Despatch_Qty,b.Despatch_Actual_qty,a.Trans_month_year, " +
               " b.Received_Flag,b.productc,b.upl_sl_no,a.Trans_Month,a.Trans_Year,'1' ord from  [dbo].[Trans_Input_Despatch_Head] a, " +
               " [dbo].[Trans_Input_Despatch_Details] b where a.Trans_sl_No=b.Trans_sl_No  " +
               " and  a.sf_code='" + sf_code + "' and  b.Received_Flag is null and  a.Division_Code='" + div_code + "' " +
               " and a.Trans_Month=Month(Getdate())-1  " +
               " union all " +
               " select  a.Trans_sl_No,b.Gift_Name,b.Despatch_Qty,b.Despatch_Actual_qty,a.Trans_month_year, " +
               " b.Received_Flag,b.productc,b.upl_sl_no,a.Trans_Month,a.Trans_Year,'2' ord from  [dbo].[Trans_Input_Despatch_Head] a, " +
               " [dbo].[Trans_Input_Despatch_Details] b where a.Trans_sl_No=b.Trans_sl_No  " +
               " and  a.sf_code='" + sf_code + "' and  b.Received_Flag is null and  a.Division_Code='" + div_code + "'  " +
               " and a.Trans_Month=Month(Getdate()) " +
               " union all " +
               " select  a.Trans_sl_No,b.Gift_Name,b.Despatch_Qty,b.Despatch_Actual_qty,a.Trans_month_year, " +
               " b.Received_Flag,b.productc,b.upl_sl_no,a.Trans_Month,a.Trans_Year,'3' ord from  [dbo].[Trans_Input_Despatch_Head] a, " +
               " [dbo].[Trans_Input_Despatch_Details] b where a.Trans_sl_No=b.Trans_sl_No  " +
               " and  a.sf_code='" + sf_code + "' and  b.Received_Flag is null and  a.Division_Code='" + div_code + "' and " +
               " a.Trans_Month=Month(Getdate())+1)as dd) as ddd where row_no=1 ";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Ereportcon"].ConnectionString))
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
              ...
              " [dbo].[Trans_Input_Despatch_Details] b where a.Trans_sl_No=b.Trans_sl_No  " +
              " and  a.sf_code='" + sf_code + "' and  b.Received_Flag is null and  a.Division_Code='" + div_code + "' " +
              " and a.Trans_Month=Month(Getdate())-1 and a.Trans_Year=YEAR(GETDATE()) " +
              " union all " +
              " select  a.Trans_sl_No,b.Gift_Name,b.Despatch_Qty,b.Despatch_Actual_qty,a.Trans_month_year, " +
              " b.Received_Flag,b.productc,b.upl_sl_no,a.Trans_Month,a.Trans_Year,'2' ord from  [dbo].[Trans_Input_Despatch_Head] a, " +
              " [dbo].[Trans_Input_Despatch_Details] b where a.Trans_sl_No=b.Trans_sl_No  " +
              " and  a.sf_code='" + sf_code + "' and  b.Received_Flag is null and  a.Division_Code='" + div_code + "'  " +
              " and a.Trans_Month=Month(Getdate()) and a.Trans_Year=YEAR(GETDATE())" +
              " union all " +
              " select  a.Trans_sl_No,b.Gift_Name,b.Despatch_Qty,b.Despatch_Actual_qty,a.Trans_month_year, " +
              " b.Received_Flag,b.productc,b.upl_sl_no,a.Trans_Month,a.Trans_Year,'3' ord from  [dbo].[Trans_Input_Despatch_Head] a, " +
              " [dbo].[Trans_Input_Despatch_Details] b where a.Trans_sl_No=b.Trans_sl_No and a.Trans_Year=YEAR(GETDATE()) " +
              " and  a.sf_code='" + sf_code + "' and  b.Received_Flag is null and  a.Division_Code='" + div_code + "' and " +
              " a.Trans_Month=Month(Getdate())+1)as dd) as ddd where row_no=1 ";
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    ...
                    if (da.Tables[0].Rows.Count > 0)
                    {
                        ...
                        //lblipmonth.Text = Trans_month_year;
                       // lblipmonth.Text = month;

                    }
                }
            }
        }
        foreach (GridViewRow gridRow in grdinput.Rows)
        {
            ...
            string input;
            AdminSetup adm = new AdminSetup();
            Label lblgiftname = (Label)gridRow.Cells[2].FindControl("lblinputname");
            Label lbldespatchiput = (Label)gridRow.Cells[2].FindControl("lbldespatchiput");

            TextBox txtreceivedqty = (TextBox)gridRow.Cells[3].FindControl("txtreceivedqty");

            Label lblcode = (Label)gridRow.Cells[4].FindControl("lblcode");
            Label lblnum = (Label)gridRow.Cells[5].FindControl("lblnum");

            DataSet dsInput1 = adm.getinput_AsonDate(sf_code, div_code, lblcode.Text);


            iReturn = adm.updateinput(sf_code, div_code, lbldespatchiput.Text, txtreceivedqty.Text, month, lblcode.Text,lblnum.Text);
            ...
            if (iReturn > 0)
            {
              ...
              if (dsInput1.Tables[0].Rows.Count > 0)
                {
                    if (dsInput1.Tables[0].Rows[0]["Gift_Code"].ToString() == lblcode.Text)
                    {
                        int tot_Sample = Convert.ToInt32(dsInput1.Tables[0].Rows[0]["InputQty_AsonDate"].ToString()) + Convert.ToInt32(txtreceivedqty.Text);
                        //If Already the Product There just Increment the qty as(inhand+Uploaded)
                        iReturn2 = adm.UpdateInput_AS_ON_Date(sf_code, div_code, tot_Sample, lblcode.Text);
                    }
                    //input = dsInput1.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                    //input_qty = Convert.ToInt32(input);
                    //des_qty = Convert.ToInt32(lbldespatchiput.Text);
                    //actual_qty = Convert.ToInt32(txtreceivedqty.Text);
                    //if (input_qty == actual_qty)
                    //{
                    //    inputason = input_qty;
                    //    iReturn = adm.UpdateInput_AS_ON_Date(sf_code, div_code, inputason, lblcode.Text);
                    //}
                    //else if ((input_qty < actual_qty) || (des_qty < actual_qty))
                    //{
                    //    inputason = input_qty + (actual_qty - des_qty);
                    //    iReturn = adm.UpdateInput_AS_ON_Date(sf_code, div_code, inputason, lblcode.Text);
                    //}
                    //else
                    //{

                    //    inputason = input_qty - (des_qty - actual_qty);
                ...
                {
                    iReturn2 = adm.InsertInput_AS_ON_Date(sf_code, div_code, txtreceivedqty.Text, lblcode.Text, lblgiftname.Text);
                }

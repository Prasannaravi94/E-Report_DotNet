...
public partial class MasterFiles_ActivityReports_rptTargetVsSales : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        sProc_Name = "Target_Vs_Sale_Hq_New_Primary";
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            for (int i = 0; i <= months1; i++)
            {
                ...
                AddMergedCells(objgridviewrow, objtablecell, 0, 5, sTxt, "#0097AC", true);
                ...
                AddMergedCells(objgridviewrow2, objtablecell, 2, 1, "Achieve (%)", "#0097AC", false);
                ...
                for (int l = 3, j = 1; l < e.Row.Cells.Count; l++, j++)
                {
                    ...
                    if (j % 5 == 2)
                    {
                        if (e.Row.Cells[l].Text != "")
                            first = Convert.ToDouble(Math.Round(double.Parse(e.Row.Cells[l].Text), 0).ToString());
                    }
                    ...
                    {
                        if (e.Row.Cells[l].Text != "")
                            second = Convert.ToDouble(Math.Round(double.Parse(e.Row.Cells[l].Text), 0).ToString());
                    }
                    ...
                    else if (j % 5 == 0)
                    {
                        ...
                        //  e.Row.Cells[l].Text = "0";


                        e.Row.Cells[l].Text = (second / first * 100).ToString();
                        if (e.Row.Cells[l].Text != "")
                            e.Row.Cells[l].Text = Math.Round(double.Parse(e.Row.Cells[l].Text), 2).ToString();

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAutoExpense_RowWise_Anthem.aspx.cs" Inherits="MasterFiles_MR_RptAutoExpense" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Place of Work" ItemStyle-HorizontalAlign="Left">
                                     ...
                                     <asp:TemplateField HeaderText="Fare</br>(in Rs/-)" ItemStyle-HorizontalAlign="Left">
                                        ...
                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="#9AA3A9"></HeaderStyle>
                                        <ItemTemplate><asp:TextBox ID="txtFare" onkeyup="onFareChange(this);" visible="false" width="30" runat="server" Text='<%# Bind("Fare") %>'></asp:TextBox><asp:Label ID="lblFare" runat="server" Text='<%# Bind("Fare") %>'></asp:Label><asp:HiddenField ID="fareHidden" runat="server" Value='<%# Bind("Fare") %>' /></ItemTemplate>
                                    </asp:TemplateField>
        ...
        if ("NA-FA" != type && "AS-FA" != type && "AS-FE" != type && "AE-FA" != type) {
            ...
            if ("FA" == type || "FF" == type || "FD" == type) {
                if ( $To[2] != '' && $To[2]!=null) {
                    ...
                    onAllowTypeComboChange($R1, 'true', $To[1], $To[2]); 
                }
                else {
...
//        }
        ...
        $R1.cells[7].children[0].innerHTML = parseFloat(parseFloat($Dis));
        $R1.cells[7].children[1].value = parseFloat(parseFloat($Dis));
    ...
    function onAllowTypeComboChange($e, flag, type,Expallwcat) {
        var $R;
        var allType = $e.value;
        //alert(flag+" :: "+$e);
        if (flag == 'false') {
        ...
        if (allType == "EX") {
            ...
            $R.cells[5].children[0].innerHTML = ossm;
            $R.cells[5].children[1].value = ossm;
        }
        else if (Expallwcat="NM" &&(allType == "OS" || allType == "OS-EX")) {
            $R.cells[5].children[0].innerHTML = osnm;
            $R.cells[5].children[1].value = osnm;
        }
        else if (allType == "OS" || allType == "OS-EX") {
            $R.cells[5].children[0].innerHTML = os;
            $R.cells[5].children[1].value = os;

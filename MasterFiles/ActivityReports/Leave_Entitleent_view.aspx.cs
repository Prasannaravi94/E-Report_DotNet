...
public partial class MasterFiles_ActivityReports_Leave_Entitleent_view : System.Web.UI.Page
{
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        //                sURL = "rptLeave_DCR_Status.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString();
        //            //}
        //            //else
        //            //{
    ...
    {
      //  ddlTYear.SelectedValue = ddlFYear.SelectedValue;
    }
}
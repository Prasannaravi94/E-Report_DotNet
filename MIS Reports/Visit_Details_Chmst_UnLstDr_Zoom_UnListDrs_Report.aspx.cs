...
public partial class MIS_Reports_Visit_Details_Chmst_UnLstDr_Zoom_UnListDrs_Report : System.Web.UI.Page
{
    #region variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "UnListed Doctor Visit For  - " + FMonth + " " + FYear;
    ...
    private void FillReport()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("visit_details_Chmst_UnLst_Drs_Seen", con);

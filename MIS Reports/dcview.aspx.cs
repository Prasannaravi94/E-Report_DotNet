...
public partial class MIS_Reports_dcview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Listed Doctor Business Entry for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.doctorbusentry_value(drFF["sf_code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            if (tot_dr != "")
                            {
                                ...
                                iTotLstCount1 += (Decimal.Parse(tot_dr)).ToString();
                                iTotLstCount2 += (Decimal.Parse(tot_dr)).ToString();
                            }

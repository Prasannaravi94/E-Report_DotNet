...
public partial class MasterFiles_frmExp_Consolidated_View : System.Web.UI.Page
{
    ...
    protected void monthdisable(object sender, EventArgs e)
    {
        DelaySystemDisable();
    }
    ...
    private void FillYear()
    {
        ...
        if (dsTP.Tables[0].Rows.Count > 0)
        {
            ...
            for (int k1 = Convert.ToInt16(dsTP.Tables[0].Rows[0]["Year"]); k1 <= DateTime.Now.Year + 1; k1++)
            {
                ddlToYear.Items.Add(k1.ToString());

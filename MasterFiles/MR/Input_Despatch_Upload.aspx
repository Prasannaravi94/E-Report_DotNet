<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Input_Despatch_Upload.aspx.cs" Inherits="MasterFiles_Options_Input_Despatch_Upload" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
                            ...
                            <div class="single-des clearfix">
                             ...
                             <div class="single-des clearfix">
                                        ...
                                        <asp:RadioButtonList ID="rdochksave" runat="server" RepeatDirection="Horizontal">
                                            <%--<asp:ListItem Value="1">OverWite with Existing Records</asp:ListItem>--%>
         ...
         <table>
                ...
                <tr><td><b><u><font color="Blue">Input Upload Instruction</font></u></b></td></tr>
                <tr><td>1. &nbsp; Click the "Download Here" link in the Screen and Download the Excel file for "Input - Upload".</td></tr>
                <tr><td>2. &nbsp; After Downloading the Excel, the Mandatory Field is marked as "Yellow" Color in the Relevant Column.</td></tr>
                <tr><td>3. &nbsp; The User has to Fill the Employee ID, Input Code and Input Qty ( Qty. will be Numeric).</td></tr>
                <tr><td>4. &nbsp; Employee Code is Available in the "Field Force Master" and Input Code is Available in the "Input Master".</td></tr>
                <tr><td>5. &nbsp; The User should Upload the "Inputs / Gifts / Product Reminders" on Monthwise. For Single Month Multiple times also can Upload.</td></tr>

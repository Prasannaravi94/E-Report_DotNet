...
public partial class MasterFiles_MGR_ListedDR_Add_Approval : System.Web.UI.Page
{
    ...
    private void FillDoc()
    {
        ...
        dsDoc = LstDoc.getListedDr_Add_approve_One(sQryStr);
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdDoctor.Rows)
        {
            ...
            {             
                ...
                iReturn = LstDoc.Add_Approve_Temp(sQryStr, ListedDR, 0, 2, Session["sf_name"].ToString());
                if (iReturn > 0)
                {
    ...
    protected void btnReject_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdDoctor.Rows)
        {
            ...
            if ((bCheck == true))
            {
                ...
                ListedDR LstDoc = new ListedDR();             
               iReturn = LstDoc.Reject_Approve_One(sQryStr, ListedDR, 4, 2, Session["sf_name"].ToString());
               // iReturn = LstDoc.Reject_Approve_Temp(sQryStr, ListedDR, 4, 2, Session["sf_name"].ToString());
            }
            else
            {
                //menu1.Status = "Enter all the values!!";

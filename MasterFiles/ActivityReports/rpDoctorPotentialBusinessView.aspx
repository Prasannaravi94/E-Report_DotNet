<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpDoctorPotentialBusinessView.aspx.cs" Inherits="MasterFiles_ActivityReports_rpDoctorPotentialBusinessView" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Doctor_Productwise_Business_FieldForce</title>
    <meta charset="utf-8">
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, sf_name, cyear, cmonth, sCurrentDate, basadOn) {
            popUpObj = window.open("rpDoctorPotentialBusinessView1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&sCurrentDate=" + sCurrentDate + "&MR=0&FMonth=&FYear=&TMonth=&TYear=&basedOn=" + basadOn,
                     "_blank",
                    "ModalPopUp," +
                    "toolbar=no," +
                    "scrollbars=yes," +
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="80%" align="center">
                        <asp:Label ID="lblHead" runat="server" Text="Listed Doctor - Product Business View" CssClass="reportheader"></asp:Label>
                    </td>
                    <td align="right">
                        <table>
                            <tr>

...
public partial class MasterFiles_AnalysisReports_ManagerCovrg_Analysis : System.Web.UI.Page
{
        ...
        if (!Page.IsPostBack)
        {
            ...
            else if (Session["sf_type"].ToString() == "" || Session["sf_type"].ToString() == "3")
            {
               ...
               (UserControl_MenuUserControl)LoadControl("~/UserControl/MenuUserControl.ascx");
                ...
                ddlFieldForce.Items.Insert(1, new ListItem("---Select the Fieldforce ---", "1"));
    ...
    {
        string[] FromMonYrsSplit = txtFromMonthYear.Text.Split('-');
        string[] ToMonYrsSplit = txtToMonthYear.Text.Split('-');

        int FYear = Convert.ToInt32(DateTime.Parse(FromMonYrsSplit[0]));//To Month
        int TYear = Convert.ToInt32(DateTime.Parse(FromMonYrsSplit[1]));//To Year
        int FMonth = Convert.ToInt32(ToMonYrsSplit[0]);//From Month
        int TMonth = Convert.ToInt32(ToMonYrsSplit[1]);//From Month
        ...
        else
        {
            ...
            if (FYear <= TYear)
            {
                ...
                if (ddlFieldForce.SelectedIndex > 0)
                {
                    ...
                    //sURL = "rptManagerCovrg_Analysis.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString();
    ...
    //                objDes.Designation_Name = Des["sf_name"].ToString();
    //                objDes.Designation_Code = Des["sf_code"].ToString();
    //                objDel.Add(objDes);
    //            }
    ...
    public static string BindDropdownlist()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            foreach (DataRow Des in dsSalesForce.Tables[0].Rows)
            {
                ...
                objst.ID = Des["sf_code"].ToString();
                objst.Name = Des["sf_name"].ToString();
                liststudent.Add(objst);

...
public partial class MIS_Reports_rptProduct_Priority_Wise1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblProd.Text = "Product Prioritywise for" + "<span style='color:#0077FF'> " + "(" + Prod_Name + ")" + "</span>" + "<br />" + " Listed Doctor Details for the Month of " + "" + strMonthName + "" + " " + Year + "";
    ...
    private void FillDr()
    {
        ...
        {
            lblname.Text = sf_name;
            dsDr = dr.getDr_Pro_Priority(div_code, sf_code, Convert.ToInt16(Year), Convert.ToInt16(Month), Convert.ToInt16(Prod), sCurrentDate, type, Convert.ToInt16(Priority));
        }
        else
        {
            ...
            dsDr = dr.getDr_Pro_Priority_total(div_code, Sf_Code_multiple, Convert.ToInt16(Year), Convert.ToInt16(Month), Convert.ToInt16(Prod), sCurrentDate, Convert.ToInt16(Priority));

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptInputstatus_New_New_DCR.aspx.cs" Inherits="MIS_Reports_rptInputstatus_New_New_DCR" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td width="80%" align="center">
                    <asp:Label ID="lblProd" runat="server" Text="Input Despatch Status" ForeColor="#794044" Font-Names="Verdana" Font-Size="14px" Font-Underline="true" Font-Bold="true"></asp:Label>
                </td>
                <td align="right">
                               ...
                               AllowSorting="True" RowStyle-Wrap="false">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Gift_Code" ItemStyle-HorizontalAlign="Left" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblGift_Code" runat="server" Width="10px" Text='<%#Eval("Gift_Code")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Input Name" ItemStyle-HorizontalAlign="Left">
                                     ...
                                     <asp:TemplateField HeaderText="Closing Balance" ItemStyle-HorizontalAlign="right">
                                        <ItemTemplate>
                                            <asp:Label ID="lblclosing" runat="server" Width="50px" Text='<%# Bind("closing") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

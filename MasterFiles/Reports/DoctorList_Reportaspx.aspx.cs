...
public partial class Reports_DoctorList_Reportaspx : System.Web.UI.Page
{
    ...
    private void FillSalesForce()
    {
        ...
        if (Session["sf_type"].ToString() == "" || Session["sf_type"].ToString() == "3")
        {
            if (rdoMGRState.SelectedValue.ToString() == "0")
            {
                ...
                {
                    dsSalesForce = sf.sp_UserListMr_Doc_List_View(ddlFieldForce.SelectedValue.ToString(), ddlDivision.SelectedValue.ToString(), rdoType.SelectedValue.ToString(), iVacant);
        ...
        if (Session["sf_type"].ToString() == "" || Session["sf_type"].ToString() == "3")
        {
            dsDoctor = dr.getDocCat_View(ddlDivision.SelectedValue.ToString());
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            //int iCount = 0;
            if (Session["sf_type"].ToString() == "" || Session["sf_type"].ToString() == "3" && rdoMGRState.SelectedValue == "0")
            {
    ...
    protected void GrdDoctor_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                for (int i = 5; i < dsSalesForce.Tables[0].Columns.Count; i++)
                {
                    //String header = GrdDoctor.Columns[i].HeaderText;
                        ...
                        if (cellText != "0")
                    {
                        ...
                        e.Row.Cells[i].Controls.Add((Control)lb);
                        //lb.PostBackUrl = "rptDoctorCategory.aspx?div=" + div_code + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&cat_code=" + dsSalesForce.Tables[0].Columns[i] + "&type=" + rdoMGRState.SelectedValue.ToString() + "&sf_code=" + e.Row.Cells[0].Text;

                        sURL = "rptDoctorCategory.aspx?div=" + ddlDivision.SelectedValue + "&sf_name=" + e.Row.Cells[2].Text + "&cat_code=" + dsSalesForce.Tables[0].Columns[i] + "&type=" + rdoType.SelectedValue.ToString() + "&sf_code=" + e.Row.Cells[1].Text;
                        lb.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                        lb.NavigateUrl = "#";
                ...
                Table gridTable = (Table)GrdDoctor.Controls[0];

                if ((e.Row.DataItem as DataRowView)["State_Name"].ToString() != CurrentCategory)
                {
                    ...
                    headerCell.ColumnSpan = GrdDoctor.Columns.Count;
                    headerCell.Text = (e.Row.DataItem as DataRowView)["State_Name"].ToString();
                    CurrentCategory = (e.Row.DataItem as DataRowView)["State_Name"].ToString();
    ...
    private void CreateDynamicTable(int tblRows, int tblCols)
    {
        ...
        if (ViewState["dsSalesForce"] != null)
        {
            ...
            //if (Session["sf_type"].ToString() == "1")
            //{
            //    tr_header.BackColor = System.Drawing.Color.FromName("#336699");
            //}
            //else if (Session["sf_type"].ToString() == "2")
            //{
            //    tr_header.BackColor = System.Drawing.Color.FromName("#005C5C");
            //}
            ...
            //if (Session["sf_type"].ToString() == "1")
            //{
            //    tr_catg.BackColor = System.Drawing.Color.FromName("#336699");
            //}
            //else if (Session["sf_type"].ToString() == "2")
            //{
            //    tr_catg.BackColor = System.Drawing.Color.FromName("#005C5C");
            //}
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                if (rdoMGRState.SelectedValue == "0")
                {
                ...
                foreach (DataRow dataRow in dsDoctor.Tables[0].Rows)
                {
                    ...
                    else
                    {
                        ...
                        hyp_catg_det_name.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                ...
                if (iTotal_FF > 0)
                    ...
                    else
                    {
                        ...
                        hyp_FF_det_total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
            ...
            if (Session["sf_type"].ToString() != "1")
            {
                ...
                foreach (DataRow dataRow in dsDoctor.Tables[0].Rows)
                {
                    ...
                    if (iTotal_Catg[i] > 0)
                        ...
                        else
                        {
                            ...
                            hyp_catg_det_total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                ...
                hyp_tot_catg_det_total.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
    ...
    protected void GVMissedCall_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            {
                dsDoctor = (DataSet)ViewState["dsDoctor"];
                StrddlValue = "Category";
            }
            else if (rdoType.SelectedValue.ToString().Trim() == "1")
            {
                dsDoctor = (DataSet)ViewState["dsSpec"];
                StrddlValue = "Speciality";
            }
            else if (rdoType.SelectedValue.ToString().Trim() == "2")
            {
                dsDoctor = (DataSet)ViewState["dsClass"];
            ...
            if (dsDoctor.Tables[0].Rows.Count > 0)
            {
                ...
                AddMergedCells(objgridviewrow, objtablecell, 0, "User Name", "#F1F5F8", true, "");
                AddMergedCells(objgridviewrow, objtablecell, dsDoctor.Tables[0].Rows.Count, StrddlValue, "#F1F5F8", true, "");
                objGridView.Controls[0].Controls.AddAt(0, objgridviewrow);

                for (int i = 0; i < dsDoctor.Tables[0].Rows.Count; i++)
                {
                    TableCell objtablecell2 = new TableCell();
                    AddMergedCells(objgridviewrow2, objtablecell2, 0, dsDoctor.Tables[0].Rows[i]["Doc_Cat_SName"].ToString(), "#F1F5F8", false, "");
                    //AddMergedCells(objgridviewrow2, objtablecell2, 0, "Missed.Drs", System.Drawing.Color.LightBlue.Name, false);                
                }
                AddMergedCells(objgridviewrow, objtablecell, 0, "Total", "#F1F5F8", true, "");
                objGridView.Controls[0].Controls.AddAt(0, objgridviewrow);
    ...
    {
        Session["rdoState"] = rdoMGRState.SelectedValue;
        if (rdoMGRState.SelectedValue.ToString() == "0")
        {
    ...
    //        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/MIS Reports/rdlFile/rptDocView.rdlc");
    //        Zafodo_NetDataSet dszofodo = new Zafodo_NetDataSet();
    //        SqlConnection con = new SqlConnection(strConn);
    //        con.Open();
    //        SqlDataAdapter sqlDataAdapter = new SqlDataAdapter();
    //        SqlCommand command = new SqlCommand("sp_DCR_View", con);

    //        command.CommandType = CommandType.StoredProcedure;
    //        //command.Parameters.Add("@userid", txtUser.Text);
    //        command.Parameters.Add("@div_code", div_code);
    //        command.Parameters.Add("@sf_code", ddlFieldForce.SelectedValue);
    ...
    protected void AddMergedCells(GridViewRow objgridviewrow, TableCell objtablecell, int colspan, string celltext, string backcolor, bool bRowspan, string Width)
    {
        ...
        //objtablecell.Attributes.Add("Class", "GrdWidth");

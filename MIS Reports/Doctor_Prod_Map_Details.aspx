<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Doctor_Prod_Map_Details.aspx.cs" Inherits="MIS_Reports_Doctor_Prod_Map_Details" %>
...
<head id="Head1" runat="server">
    ...
    <title id="Title1" runat="server">Doctor - Product Map Details</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <asp:Panel ID="pnlContents" runat="server" Width="99%">
                            <div align="center">
                                <asp:Label ID="lblHead" runat="server" Text="Doctor - Product Map Details" CssClass="reportheader"></asp:Label>
                                <br />
                                <br />

...
<head runat="server">
    <title>Bulk Edit - Doctor Class</title>
      <style type="text/css">
            .modal
    {
        position: fixed;
    ...
    <ucl:Menu ID="menu1" runat="server" />
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center">
                <div class="col-lg-11">
                    <br />
                    <h2 class="text-center">Bulk Edit - Doctor Class</h2>
...
<%--                                        <ControlStyle Width="90%"></ControlStyle>
                                    ...
                                    <asp:TemplateField HeaderText="Short Name" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtDoc_Cat_SName" onkeypress="AlphaNumeric_NoSpecialChars(event);"
                                                MaxLength="6" runat="server" CssClass="input" Text='<%# Bind("Doc_ClsSName") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Class Name" ItemStyle-Width="200px">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtDocCatName" Width="190px" onkeypress="AlphaNumeric_NoSpecialChars(event);"
                                                 CssClass="input" runat="server" MaxLength="100" Text='<%# Bind("Doc_ClsName") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>

    ...
    private void dynamicCreateTable()
    {
        ...
        if (strType == "1")
        {
            ...
            if (dsdoc.Tables[0].Rows.Count > 0)
            {
                ...
                lit_det_head_Territory.Text = "Territory";
                ...
                foreach (DataRow drdoctor in dsdoc.Tables[0].Rows)
                {
                    ...
                    lit_det_spec.Text = drdoctor["Doc_Spec_shortname"].ToString();
                    ...
                    lit_det_catg.Text = drdoctor["Doc_cat_shortname"].ToString();
        ...
        else if (strType == "2")
        {
            ...
            tbldetailChe.Style.Add("width", "100%");
            ...
            if (dsdoc.Tables[0].Rows.Count > 0)
            {
                ...
                lit_det_head_Chem.Text = "Chemists Name";
                ...
                //tc_det_head_catg.BorderWidth = 1;
                Literal lit_det_head_catg = new Literal();
                lit_det_head_catg.Text = "Territory";
                //tc_det_head_catg.Attributes.Add("Class", "tblHead");
                tc_det_head_catg.Controls.Add(lit_det_head_catg);
                tr_det_head.Cells.Add(tc_det_head_catg);
        ...
        else if (strType == "3")
        {
            ...
            tbldetailStock.GridLines = GridLines.None;
            //tbldetailStock.Width = 1000;
            tbldetailStock.Style.Add("width", "100%");
            tbldetailStock.Attributes.Add("class", "table");
            ...
            if (dsdoc.Tables[0].Rows.Count > 0)
            {
                ...
                //tc_det_head_doc.BorderWidth = 1;
                Literal lit_det_head_doc = new Literal();
                lit_det_head_doc.Text = "Stockiest Name";
                //tc_det_head_doc.Attributes.Add("Class", "tblHead");
                tc_det_head_doc.Controls.Add(lit_det_head_doc);
        ...
        else if (strType == "4")
        {
            ...
            tbldetailUnLstDoc.GridLines = GridLines.None;
            //tbldetailUnLstDoc.Width = 1000;
            tbldetailUnLstDoc.Style.Add("width", "100%");
            tbldetailUnLstDoc.Attributes.Add("class", "table");
            ...
            if (dsdoc.Tables[0].Rows.Count > 0)
            {
                ...
                lit_det_head_Terr.Text = "Territory";

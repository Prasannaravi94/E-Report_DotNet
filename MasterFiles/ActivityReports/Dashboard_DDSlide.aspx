<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard_DDSlide.aspx.cs" MasterPageFile="~/Admin.master" EnableEventValidation="false"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css"
        ...
        crossorigin="anonymous" />
    <link href="//cdn.datatables.net/1.10.16/css/dataTables.bootstrap.min.css"
        rel="stylesheet" />
    ...
    <script src="../../JsFiles/jquery-1.10.1.js" type="text/javascript"></script>
        ...
        $(function () {
            $('#ctl00_MainContent_btnExcel').click(function () {
                var url = 'data:application/vnd.ms-excel,' + encodeURIComponent($('#ctl00_MainContent_pnlContents').html())
                location.href = url
                return false
            })
         })
    ...
    <style type="text/css">
        ...
        #main > div > div > div > div > div:nth-child(2) > div > div > div:nth-child(1) > div > div > div > span:nth-child(4) {
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="text-align:right">
            <asp:Button ID="btnExcel" runat="server" Text="Excel" Font-Names="Verdana" Font-Size="10px"
             BorderColor="Black" BorderStyle="Solid" BorderWidth="1" Height="25px" Width="60px" OnClientClick="DownloadExcel()"/>
            </div>
     <asp:Panel ID="pnlContents" runat="server" Width="100%">
    <asp:UpdatePanel ID="upAdmDashboard" runat="server">
        <ContentTemplate>
            <asp:HiddenField ID="hdnbtnClicked" runat="server"></asp:HiddenField>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-sm">
                                            <center>
                                                ...
                                                <asp:CheckBox ID="rblBasedOn" runat="server" Text="Product" width="100px" />
                                            </center>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 col-sm-4">
                                                                    <asp:DropDownList ID="ddlSrch" runat="server" SkinID="ddlRequired" AutoPostBack="true"
                                                                        ...
                                                                        <asp:ListItem Text="Sub Division" Value="8"></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </div>
                                                                <div class="col-md-4 col-sm-4">
    ...
    <script type="text/javascript" src="//code.jquery.com/jquery-3.3.1.min.js" integrity="sha256-FgpCb/KJQlLNfOu91ta32o/NMZxltwRo8QtmkMRdAu8="
        crossorigin="anonymous"></script>
    <script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js"
    ...
    <script type="text/javascript" type="text/javascript" src="//cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"></script>
    <script type="text/javascript" type="text/javascript" src="//cdn.datatables.net/responsive/2.2.3/js/dataTables.responsive.min.js"></script>
    <script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
    <script type="text/javascript" type="text/javascript" src="//malsup.github.io/jquery.blockUI.js"></script>

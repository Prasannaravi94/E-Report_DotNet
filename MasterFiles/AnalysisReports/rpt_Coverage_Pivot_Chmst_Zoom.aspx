<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Coverage_Pivot_Chmst_Zoom.aspx.cs"
    Inherits="MasterFiles_AnalysisReports_rpt_Coverage_Pivot_Chmst_Zoom" %>
            ...
            <div class="col-lg-12">
                <div class="row justify-content-center">
					...
					<center>
                        ...
                        <br />
                        <asp:Label ID="LblForceName" runat="server" Font-Bold="True" CssClass="reportheader" ForeColor="#696d6e" Font-Size="18px"></asp:Label>
						</center>
                    </div>
                    <div class="col-lg-3">
                        <br />
                            ...
                            <div class="display-Approvaltable clearfix">
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GrdFixation" runat="server" AlternatingRowStyle-CssClass="alt"
                                        ...
                                        ShowHeader="False" Width="100%" OnRowDataBound="GrdFixation_RowDataBound" Style="background-color: white;">
                                        <Columns>
                                        </Columns>

...
public partial class samplemr : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //lblHead.Text = "Sample Despatch View for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
        ...
        {
            //FillProd();
            lblProd.Text = "Sample Despatch Status for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    private void CreateDynamicTable()
    {
        ...
        //foreach (string prd in Product_Code)
        //{
        dsDr = dr.getdespatch_status(div_code, sf_code, sCurrentDate);
        ...
        if (dsDr.Tables[0].Rows.Count > 0)
        {
            ...
            tc_det_head_Territory.Width = 30;
            ...
            tr_det_head.Cells.Add(tc_DR_Des2);
            ...
            foreach (DataRow drdoctor in dsDr.Tables[0].Rows)
            {
                ...
                tc_det_dr_hq.Visible = false;
                Literal lit_det_dr_hq = new Literal();
                lit_det_dr_hq.Text = drdoctor["productc"].ToString();
                ...
                string productid = lit_det_dr_hq.Text;
                ...
                tr_det_sno.Cells.Add(tc_det_dr_qua);
                 ...
                 TableCell tc_det_dr_qua1 = new TableCell();
                Literal lit_det_dr_qua1 = new Literal();
                lit_det_dr_qua1.Text =  drdoctor["Productsaleunit"].ToString();
                tc_det_dr_qua1.HorizontalAlign = HorizontalAlign.Center;
                tc_det_dr_qua1.VerticalAlign = VerticalAlign.Middle;
                tc_det_dr_qua1.Attributes.Add("Class", "tblRow");
                tc_det_dr_qua1.BorderStyle = BorderStyle.Solid;
                tc_det_dr_qua1.BorderWidth = 1;
                tc_det_dr_qua1.Controls.Add(lit_det_dr_qua1);
                tr_det_sno.Cells.Add(tc_det_dr_qua1);
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.despatch_quantity_status(sf_code, div_code, cmonth, cyear, sCurrentDate, productid);
                        dsdoc1 = sf.issue_quantity_status(sf_code, div_code, cmonth, cyear, sCurrentDate, productid);
                ...
                if (iTotLstCount.ToString()=="0")
                {
                    ...
                    tc_tot_month1.Attributes.Add("style", "font-weight:bold;");
                    tc_tot_month1.Attributes.Add("Class", "rptCellBorder");
                    tr_det_sno.Cells.Add(tc_tot_month1);
                }
                else if (tot_dr != "")
                {
                    TableCell tc_tot_month1 = new TableCell();
                ...
                if (iTotLstCount1.ToString() == "0")
                {
                    ...
                    tr_det_sno.Cells.Add(tc_tot_month2);
                    //

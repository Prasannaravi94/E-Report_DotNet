...
public partial class MasterFiles_Review_Report : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MasterFiles/AnalysisReports/rpt_Review_Report.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&Fyear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&Dashboard=" + "1" + "&div_code=" + div_code);

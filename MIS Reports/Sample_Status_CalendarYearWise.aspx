<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sample_Status_CalendarYearWise.aspx.cs" Inherits="MIS_Reports_Sample_Status_CalendarYearWise" %>
...
<body class="bodycolor">
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <tr>
                                <td align="center">
                        <h2 class="text-center">Sample Status Financial Year Wise</h2></td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                           </tr>
                                    ...
                                    <asp:GridView ID="grdDespatch" runat="server" AlternatingRowStyle-CssClass="alt"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Sample ERP Code" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblprd_erp" runat="server" Text='<%#Eval("Sample_Erp_Code")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Issued Qty" ItemStyle-HorizontalAlign="right">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblissued" runat="server" Text='<%# Bind("Sample_Issued") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

...
public partial class MasterFiles_AllowanceFixation : System.Web.UI.Page
{
    ...
    private void BindSelectedValue()
    {
        ...
        if (dsExp.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = 0; i < wrkType_dt.Columns.Count; i++)
            {
                ...
                grdWTAllowance.Columns[31 + i].Visible = true;
                grdWTAllowance.Columns[31 + i].HeaderText = wrkType_dt.Columns[i].ColumnName;
            }
        ...
        if (dsExp.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = 0, j = 0; i < dt.Columns.Count; i++)
            {
                ...
                grdWTAllowance.Columns[21 + i].Visible = true;
                grdWTAllowance.Columns[21 + i].HeaderText = dt.Columns[i].ColumnName;
            }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            foreach (GridViewRow gridRow in grdWTAllowance.Rows)
            {
                ...
                TextBox txtosbill = (TextBox)gridRow.FindControl("txtosbill");
                TextBox txtlocal = (TextBox)gridRow.FindControl("txtlocal");
    ...
    private void fillgrid_desig()
    {
        foreach (GridViewRow grd in grdWTAllowance.Rows)
        {
            ...
            TextBox txtosbill = (TextBox)grd.FindControl("txtosbill");
            TextBox txtlocal = (TextBox)grd.FindControl("txtlocal");
            ...
            if (ddldesig.SelectedItem.Text != null && dd2cat.SelectedItem.Text != null && dd3sts.SelectedItem.Text != null)
            {
                ...
                if (lblDesignation.Text == ddldesig.SelectedItem.Text && lblCat.Text == dd2cat.SelectedItem.Text && lblSts.Text == dd3sts.SelectedItem.Text)
                {
                    ...
                    txtosbill.Text = txtlmt.Text;
                    txtlocal.Text = txtlclcon.Text;
                    //}
                    //if (txtspecHQ.Text == "")
                    //{

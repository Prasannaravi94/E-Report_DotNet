<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="Brdwise_Star_Rating.aspx.cs"
...
<head runat="server">
    <title>Brandwise Star Rating</title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(hdnSf_Code, hdnSf_Name, fmon, fyr, mode, selValues) {
            ...
            //alert(selValues);
            popUpObj = window.open("rptBrdwise_Star_Rating.aspx?Sf_Code=" + hdnSf_Code + "&Sf_Name=" + hdnSf_Name + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + "&mode=" + mode + "&selValues=" + selValues,
                       "ModalPopUp",
                       "toolbar=no," +
                       "scrollbars=yes," +
                       "location=no," +
        ...
        <ContentTemplate>--%>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Brandwise Star Rating</h2>
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:DropDownList ID="ddlmode" runat="server" SkinID="ddlRequired" AutoPostBack="true" OnSelectedIndexChanged="ddlmode_SelectedIndexChanged">
                                    <asp:ListItem Value="0" Text="---Select---"></asp:ListItem>
                          ...
                          <asp:CheckBoxList ID="CheckBoxList1" Width="85%" Font-Size="8pt" runat="server"
                                ...
                                <asp:CheckBoxList ID="cblProductList" ClientIDMode="Static" Width="85%" Font-Size="8pt" runat="server"
                                    RepeatColumns="4" DataTextField="Ch_Name" DataValueField="Ch_Code" CssClass="chkChoice">
                                </asp:CheckBoxList>
                            </div>

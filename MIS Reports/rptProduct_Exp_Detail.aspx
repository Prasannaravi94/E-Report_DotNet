...
<head runat="server">
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, sf_name, cyear, cmonth, Prod_Name, Prod, sCurrentDate,mode ,div_code) {
            popUpObj = window.open("rptProduct_Exp_Detail1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod + "&sCurrentDate=" + sCurrentDate + "&type=1" + "&mode=" + mode + "&div_code=" + div_code,
       "_blank",
      "ModalPopUp" //+
      //"toolbar=no," +
      //"scrollbars=yes," +
      ...
      //"top=0"
        ...
        function show(sfcode, sf_name, cyear, cmonth, Prod_Name, Prod, sCurrentDate, div_code, modee) {

            popUpObj = window.open("rptProduct_Exp_Detail1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod + "&sCurrentDate=" + sCurrentDate + "&type=2" + "&div_code=" + div_code + "&modee=" + modee,
       "_blank",
      "ModalPopUp" //+
      //"toolbar=no," +
      //"scrollbars=yes," +
      ...
      //"top=0"
        ...
        function showModal(sfcode, sf_name, Prod_Name, Prod, div_code) {
            popUpObj = window.open("rptProduct_Exp_Detail1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod + "&div_code=" + div_code,
       "_blank",
      "ModalPopUp"// +
      //"toolbar=no," +
      //"scrollbars=yes," +

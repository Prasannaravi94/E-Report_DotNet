<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DCR_NotSubmit.aspx.cs" Inherits="Reports_DCR_NotSubmit" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                showModalPopUp(ddlFieldForceValue, Month1, Year1)
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Not Submitted DCR Dates</h2>

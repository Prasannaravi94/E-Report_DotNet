...
public partial class MasterFiles_Single_Dr_Analysis : System.Web.UI.Page
{
    ...
    private void FillManagers()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            ddlFieldForce.Items.Insert(0, new ListItem("--Select FieldForce--", ""));
        }
    }
    #endregion
    ...
    private void FillReport()
    {
        ...
        if (ddlDr.SelectedValue != "0"
            && ddlDr.SelectedValue != "")
        {
            ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MasterFiles/AnalysisReports/rptSingle_Dr_Analysis.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&Frm_Month=" + cmonth + "&Frm_year=" + cyear + "&To_Month=" + cmonth + "&To_year=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&drcode=" + ddlDr.SelectedValue + "&Dashboard=" + "1" + "&div_code=" + div_code);
            //ifmReviewRep.Attributes.Add("src", "http://" + host + "/MasterFiles/AnalysisReports/rptSingle_Dr_Analysis.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&Frm_Month=" + cmonth + "&Frm_year=" + cyear + "&To_Month=" + cmonth + "&To_year=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&drcode=" + ddlDr.SelectedValue + "&div_code=" + div_code);
        }
        else
        {
            ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MasterFiles/NothingToDisplay.aspx");
            //ifmReviewRep.Attributes.Add("src", "http://" + host + "/MasterFiles/NothingToDisplay.aspx");
        }
    }
    #endregion

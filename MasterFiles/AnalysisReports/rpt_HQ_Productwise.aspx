<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_HQ_Productwise.aspx.cs" Inherits="MasterFiles_AnalysisReports_rpt_HQ_Productwise" %>
                    ...
                    <div align="center">
                        ...
                        <asp:Label ID="LblForceName" runat="server" Font-Bold="True" Font-Names="Verdana"
                            Font-Size="9pt"></asp:Label>
                               <br />
                           <br />
                        <asp:Label ID="lblprod" runat="server" Font-Bold="True" Font-Names="Verdana"
                            Font-Size="9pt"></asp:Label>
                    </div>
                    <br />

...
public partial class MasterFiles_DynamicDashboard_DrillDown_UnLIstedDoctors : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Request.QueryString["measureby"] != null && Request.QueryString["viewby"] != null && Request.QueryString["splitby"] != null && Request.QueryString["sfcode"] != null && Request.QueryString["sfname"] != null && Request.QueryString["viewquery"] != null && Request.QueryString["splitquery"] != null && Request.QueryString["viewbyname"] != null)
            {
                ...
                Captions.Add(new CaptionData { Value = "Un Listed Doctors" });
                ...
                string qrySelects = "SELECT " +
                    ...
                    "Mas_UnlistedDr.UnListedDr_Name AS DoctorName," +
                ...
                string qryJoins = "LEFT JOIN Mas_Doctor_Speciality ON Mas_Doctor_Speciality.Doc_Special_Code = Mas_UnlistedDr.Doc_Special_Code " +
                    " LEFT JOIN Mas_Doctor_Category ON Mas_Doctor_Category.Doc_Cat_Code = Mas_UnlistedDr.Doc_Cat_Code " +
                    " LEFT JOIN Mas_Doc_Class ON Mas_Doc_Class.Doc_ClsCode = Mas_UnlistedDr.Doc_ClsCode " +
                    " LEFT JOIN Mas_Territory_Creation ON Mas_Territory_Creation.Territory_Code = Mas_UnlistedDr.Territory_Code " +
                    " LEFT JOIN Mas_Salesforce ON Mas_Salesforce.sf_code = Mas_UnlistedDr.sf_code ";
                string qryWhere = " WHERE Mas_UnlistedDr.UnListedDr_Active_Flag = '0' AND Mas_UnlistedDr.sf_code IN(" + Sfcodes + ") AND Mas_UnlistedDr.division_code = '" + DivisionCode + "'";
                ...
                switch (Request.QueryString["viewby"])
                {
                    ...
                    case "subdivision":
                        ...
                        qryWhere += " AND CHARINDEX(',' + CAST(mas_subdivision.subdivision_code AS VARCHAR) + ',', ',' + Mas_Salesforce.subdivision_code + ',') > 0 AND Mas_UnlistedDr.Sf_Code = Mas_Salesforce.Sf_Code ";
                    ...
                    case "state":
                        ...
                        qryWhere += " AND Mas_Salesforce.State_Code=Mas_State.State_Code AND Mas_UnlistedDr.Sf_Code = Mas_Salesforce.Sf_Code ";
                        break;
                ...
                switch (Request.QueryString["splitby"])
                {
                    case "speciality":
                        ...
                        qryWhere += " AND Mas_Doctor_Speciality.Doc_Special_Active_Flag = '0' AND Mas_Doctor_Speciality.Doc_Special_Code ='" + Request.QueryString["splitquery"] + "'";
                        break;
                    case "category":
                        Captions.Add(new CaptionData { Label = "Category", Value = Request.QueryString["splitbyname"] });
                        qryWhere += " AND Mas_Doctor_Category.Doc_Cat_Active_Flag = '0' AND Mas_Doctor_Category.Doc_Cat_Code ='" + Request.QueryString["splitquery"] + "'";
                        break;
                    case "class":
                        Captions.Add(new CaptionData { Label = "Class", Value = Request.QueryString["splitbyname"] });
                        qryWhere += " AND Mas_Doc_Class.Doc_Cls_ActiveFlag = '0' AND Mas_Doc_Class.Doc_ClsCode ='" + Request.QueryString["splitquery"] + "'";
                        break;

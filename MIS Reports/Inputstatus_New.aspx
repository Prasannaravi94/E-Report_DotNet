<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Inputstatus_New.aspx.cs" Inherits="MIS_Reports_Inputstatus_New" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name, div_code) {
            ...
            popUpObj = window.open("rptInputstatus_New_New.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name + "&div_code=" + div_code,
   "ModalPopUp"//,
   //"toolbar=no," +
   //"scrollbars=yes," +
   //"location=no," +
                    ...
                    <div class="col-lg-5">
                        <center>
                            <table>
                                <tr>
                                    <td align="center">
                                        <h2 class="text-center">Input Despatch - Status</h2>
                                    </td>
                                </tr>
                            </table>
                        </center>

...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnGo").click(function (e) {
                ...
                if (Validation() === true) {
                    ...
                    var Stockiest = $('#<%=ddlStockiest.ClientID%> :selected').text();
                    if (Stockiest == "---Select Clear---") { alert("Select Stockiest Name."); $('#ddlStockiest').focus(); return false; }
                    ...
                    var ddlStockiest = document.getElementById('<%=ddlStockiest.ClientID%>').value;
                    ...
                    if (str.includes("MR") == true) {
                        ...
                        // $("#lblMsg").text("Work is Going On...");
                        showModalPopUp(ddlFName, Month1, Year1, Month2, Year2, ddlStockiest, rdolstrpt)
                    }
                    else {
        ...
        function Validation() {
            ...
            var ddl_Stockist = $("#ddlStockiest :selected").text();
            ...
            if (ddl_Stockist == "---Select---") {

                createCustomAlert("Please Select Stockiest");
                $("#ddlStockiest").focus();
                return false;
            }
            else if (ddl_FMonth == "--Select--") {
            ...
            <table border="0" cellpadding="3" cellspacing="3" align="center">
                <tr>
                    ...
                    <td align="left" class="stylespc">
                        ...
                        SkinID="ddlRequired" onselectedindexchanged="ddlFieldForce_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="lblStockiest" runat="server" Text="Stockiest" SkinID="lblMand" Height="19px" Width="100px"></asp:Label>
                    </td>
                    <td align="left" class="stylespc">
                ...
                <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="lblrptType" runat="server" Text="Report Type" SkinID="lblMand" Height="19px" Width="100px"></asp:Label>
                    </td>
                    <td align="left" class="stylespc">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:Button ID="btnGo" runat="server" Text="Go" CssClass="savebutton" 
                         Width="60px" Height="25px" OnClientClick="if(!Validation()) return false;" />
                    </td>
                </tr>
            </table>
            <br />

            <asp:Label ID="lblMsg" runat="server" Text="" style="color:Red;font-size:14px;"></asp:Label>

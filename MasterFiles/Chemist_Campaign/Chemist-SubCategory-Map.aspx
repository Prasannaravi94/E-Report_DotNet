...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chemist-SubCategory-Map.aspx.cs" Inherits="MasterFiles_Chemist_Campaign_Chemist_SubCategory_Map" EnableEventValidation="false" %>
...
<script type="text/javascript">
    function ChkFn(x) {
        aid = x.id.split('_');
        y = document.getElementById('grdChemist_' + aid[1] + '_grdCampaign_' + aid[3] + '_chkCatName')
        if (x.checked == true)
            document.getElementById('grdChemist_' + aid[1] + '_Che_SubCatName').innerHTML += y.parentNode.getElementsByTagName('label')[0].innerHTML + ', '
        else
            document.getElementById('grdChemist_' + aid[1] + '_Che_SubCatName').innerHTML = document.getElementById('grdChemist_' + aid[1] + '_Che_SubCatName').innerHTML.replace(y.parentNode.getElementsByTagName('label')[0].innerHTML + ', ', '')
    }
...
<body class="bodycolor">
    <form id="form2" runat="server">
        ...
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <center>
                        <table>
                            <tr>
                                <td align="center">
                                    <h2 class="text-center">Chemist - Campaign Map</h2>
                                </td>
                            </tr>
                        </table>
                    </center>
                    <div class="designation-area clearfix">
                        ...
                        <asp:Label ID="lblMR" runat="server" Text="Base Level" SkinID="lblMand" ></asp:Label>
             <asp:DropDownList ID="ddlMR" runat="server" SkinID="ddlRequired"
                        ...
                        <div class="single-des clearfix">
                            ...
                            <asp:DropDownList ID="ddlSrch" runat="server" CssClass="nice-select" AutoPostBack="true"
                              ...
                              <%--  <asp:ListItem Text="Doctor Speciality" Value="2"></asp:ListItem>
                                ...
                                <asp:ListItem Text=" Territory" Value="6"></asp:ListItem>
                               <asp:ListItem Text=" Name" Value="7"></asp:ListItem>--%>
                            </asp:DropDownList>
                        </div>
                        <div class="single-des clearfix">
                    ...
                    <div class="w-100 designation-submit-button text-center clearfix">
                     ...
                     <div class="single-des clearfix">
                       <asp:Panel ID="Pnldiv" runat="server" Visible="false" >
                           <asp:Label runat="server" CssClass="blink_me label" Style="font-size: 18px; color: red; font-weight: bold;">  Click "+" Symbol and Tag the Campaign and Enter Mobile No then Press Final Submit </asp:Label>
                           </asp:Panel>
                       </div>
                </div>
                    ...
                    <div class="designation-reactivation-table-area clearfix">
                        ...
                        <div class="display-table clearfix">
                            <div class="table-responsive" style="scrollbar-width: thin; max-height: 700px;">
                                <asp:GridView ID="grdChemist" runat="server" AlternatingRowStyle-CssClass="alt"
                                ...
                                <ItemTemplate>
                                <asp:CheckBox ID="chkCatName" onclick="ChkFn(this)" Font-Names="Calibri" Font-Size="Small" runat="server" Text='<%# Eval("chm_campaign_name") %>' />
                                <asp:Label ID ="cbSubCat" runat="server" Text='<%# Eval("Chm_campaign_code") %>' Visible="false" />
                                </ItemTemplate>
                                </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
            ...
            <ItemTemplate>
            <asp:Label ID="lblDrcode" runat="server" Text='<%# Eval("Chemists_Code") %>'></asp:Label>
            </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Chemist Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-ForeColor="Black">
            <ItemTemplate>
            <asp:Label ID="lblDrName" runat="server" Text='<%# Eval("Chemists_Name") %>'></asp:Label>
            </ItemTemplate>
            </asp:TemplateField>
          
                <asp:BoundField  DataField="territory_Name" HeaderText="Territory" ItemStyle-HorizontalAlign="Left" HeaderStyle-ForeColor="Black"  />
                           <asp:TemplateField HeaderText="Mobile No" ItemStyle-HorizontalAlign="Left">
                   <ItemTemplate>
                             <asp:TextBox ID="txtChemists_Phone" runat="server" Text='<%#Eval("Chemists_Mobile") %>'></asp:TextBox>
                     </ItemTemplate>
                    </asp:TemplateField>
                  <asp:TemplateField HeaderText="Mapped Campaign" ItemStyle-HorizontalAlign="Left">
                  <ItemTemplate>
                  <asp:Label ID ="Che_SubCatName" runat="server"  Text='<%#Eval("chm_campaign_name") %>' ></asp:Label>
                  </ItemTemplate>
                  </asp:TemplateField>

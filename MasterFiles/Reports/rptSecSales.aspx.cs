...
public partial class MasterFiles_Reports_rptSecSales : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblText.Text = lblText.Text + sf_name + "</br>" + " between " + getMonthName(FMonth) + " - " + FYear + " and " + getMonthName(TMonth) + " - " + TYear;
    ...
    private void GenerateReport()
    {
        ...
        DataSet dsProd = ss.getProduct(div_code, state_code, SelDate, sub_code);
        ...
        if (dsProd.Tables[0].Rows.Count > 0)
        {
            if (stock_code != 999)
            {
                ...
                {
                    lit_stock_name.Text = " &nbsp; &nbsp; <b> Stockiest Name : <span style='color:red'>" + dsStock.Tables[0].Rows[0].ItemArray.GetValue(1).ToString() + "</span></b>";
                }
            ...
            else
            {
                ...
                //Stockist stk = new Stockist();
                dsStock = ss.getStockiestDet(sf_code, div_code);
                if (dsStock.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow dstRow in dsStock.Tables[0].Rows)
                    {
                        ...
                        tc_stock_name.ColumnSpan = 4;
                        Literal lit_stock_name = new Literal();
                        lit_stock_name.Text = " &nbsp; &nbsp; <b> Stockiest Name : <span style='color:red'>" + dstRow["Stockist_Name"].ToString() + "</span></b>";
                        tc_stock_name.Attributes.Add("Class", "Backcolor");
                        tc_stock_name.Controls.Add(lit_stock_name);
                        tr_stock_header.Cells.Add(tc_stock_name);
                        tbl.Rows.Add(tr_stock_header);
    ...
    private void PopulateSecSales(DataSet dsProd, int stock_code)
    {
        try
        {
            ...
            // tr_header.BackColor = System.Drawing.Color.DarkSeaGreen;
            tr_header.BackColor = System.Drawing.ColorTranslator.FromHtml("#1f9bad");
            tr_header.ForeColor = System.Drawing.Color.White;
            tr_header.Attributes.Add("Class", "Backcolor");

            TableCell tc_SNo = new TableCell();
            tc_SNo.BorderStyle = BorderStyle.Solid;
            // tc_SNo.BackColor = System.Drawing.Color.DarkSeaGreen;
            tc_SNo.BackColor = System.Drawing.ColorTranslator.FromHtml("#1f9bad");
            ...
            if (dsSecSales.Tables[0].Rows.Count > 0)
            {
                ...
                foreach (DataRow dRow in dsSecSales.Tables[0].Rows)
                {
                    ...
                    //  tc_qty.BackColor = System.Drawing.Color.DarkSeaGreen;
                    tc_qty.BackColor = System.Drawing.ColorTranslator.FromHtml("#1f9bad");
                    tc_qty.ForeColor = System.Drawing.Color.White;
                    ...
                    // tc_val.BackColor = System.Drawing.Color.DarkSeaGreen;
                    tc_val.BackColor = System.Drawing.ColorTranslator.FromHtml("#1f9bad");
                    tc_val.ForeColor = System.Drawing.Color.White;
            ...
            int sqty = 0;
            double sval = 0.00;
            string[] arrqty = new string[800];
            string[] arrval = new string[800];
            ...
            foreach (DataRow dataRow in dsProd.Tables[0].Rows)
            {
                ...
                if (Calc_Rate == "R")
                {
                    lit_det_prod_rate.Text = "&nbsp;" + dataRow["Retailor_Price"].ToString();
                    P_Rate = Convert.ToDouble(dataRow["Retailor_Price"].ToString());
                }
                else if (Calc_Rate == "M")
                {
                    lit_det_prod_rate.Text = "&nbsp;" + dataRow["MRP_Price"].ToString();
                    P_Rate = Convert.ToDouble(dataRow["MRP_Price"].ToString());
                }
                else if (Calc_Rate == "D")
                {
                    lit_det_prod_rate.Text = "&nbsp;" + dataRow["Distributor_Price"].ToString();
                    P_Rate = Convert.ToDouble(dataRow["Distributor_Price"].ToString());
                }
                else if (Calc_Rate == "N")
                {
                    lit_det_prod_rate.Text = "&nbsp;" + dataRow["NSR_Price"].ToString();
                    P_Rate = Convert.ToDouble(dataRow["NSR_Price"].ToString());
                }
                else if (Calc_Rate == "T")
                {
                    lit_det_prod_rate.Text = "&nbsp;" + dataRow["Target_Price"].ToString();
                    P_Rate = Convert.ToDouble(dataRow["Target_Price"].ToString());
                }
                ...
                foreach (DataRow dRow in dsSecSales.Tables[0].Rows)
                {
                    ...
                    //{
                    //    //dsReport = ss.getrptvalues_clbal(div_code, sf_code, stock_code, TMonth, TYear, dataRow["Product_Detail_Code"].ToString(),P_Rate, Convert.ToInt16(dRow["Sec_Sale_Code"].ToString()));

                    //    dsReport = ss.getrptvalues(div_code, sf_code, stock_code, FMonth, FYear, TMonth, TYear, dataRow["Product_Detail_Code"].ToString(), P_Rate, Convert.ToInt16(dRow["Sec_Sale_Code"].ToString()));
                    //}
                    //else
                    //{
                    //    dsReport = ss.getrptvalues(div_code, sf_code, stock_code, FMonth, FYear, TMonth, TYear, dataRow["Product_Detail_Code"].ToString(), P_Rate, Convert.ToInt16(dRow["Sec_Sale_Code"].ToString()));
                    ...
                    string Sec_F_Code = string.Empty;

                    string Sec_Code_F = string.Empty;
                    ...
                    //if (Sec_Name == "Receipt" || Sec_Name == "Sale")
                    //{
                    //   Sec_F_Code = Sec_F_Code + Sec_Code + ",";                      

                    //}

                    //Sec_Code_F = Sec_F_Code.TrimEnd(',');
                    ...
                    if (FYear == TYear)
                    {
                        ...
                        if (FMonth <= TMonth)
                        {
                            ...
                            while (C_Month <= TMonth)
                            {
                                Sec_Code_F = "";
                                Sec_F_Code = "";

                                string SecSale_N = dRow["Sec_Sale_Name"].ToString();

                                if (SecSale_N == "Closing Balance" || SecSale_N == "Opening Balance")
                                {
                                    for (int i = 0; i < dsSecSales.Tables[0].Rows.Count; i++)
                                    {
                                        string Sec_Code = dsSecSales.Tables[0].Rows[i]["Sec_Sale_Code"].ToString();
                                        string Sec_Name = dsSecSales.Tables[0].Rows[i]["Sec_Sale_Name"].ToString();

                                        if (Sec_Name == "Receipt" || Sec_Name == "Receipt Qty" || Sec_Name == "Sale" || Sec_Name == "Sales" || Sec_Name == "Sale Qty")
                                        {
                                            Sec_F_Code = Sec_F_Code + Sec_Code + ",";
                                        }
                                    ...
                                    DataSet dsRS_Qty = ss.Get_Sec_Sale_Receipt_Qty(div_code, sf_code, stock_code, C_Month, C_Year, dataRow["Product_Detail_Code"].ToString(), Sec_Code_F);

                                    //  int cnt=Convert.ToInt32(dsRS_Qty.Tables[0].Rows.Count);
                                    // string[] arrQty = new string[cnt];

                                    string arr_Qty = string.Empty;

                                    if (dsRS_Qty.Tables[0].Rows.Count > 0)
                                    {

                                        for (int Qty = 0; Qty < dsRS_Qty.Tables[0].Rows.Count; Qty++)
                                        {
                                            //Qty_Val = Convert.ToInt32(dsRS_Qty.Tables[0].Rows[Qty]["Sec_Sale_Qty"].ToString());

                                            arr_Qty = arr_Qty + dsRS_Qty.Tables[0].Rows[Qty]["Sec_Sale_Qty"].ToString() + ",";
                                        }

                                        string A_QtyVal = arr_Qty.TrimEnd(',');

                                        string[] values = A_QtyVal.Split(',');



                                        //  if (arrQty[0] == arrQty[1])
                                        //  {
                                        //Qty_Val_1 = Convert.ToInt32(values[0]);
                                        //Qty_Val_2 = Convert.ToInt32(values[1]);

                                        if (values[0] == "0" && values[1] == "0")
                                        {
                                            DataSet dsSec_Qty = ss.Get_Sec_Sale_Qty(div_code, sf_code, stock_code, C_Month, C_Year, dataRow["Product_Detail_Code"].ToString(), dRow["Sec_Sale_Code"].ToString());

                                            if (dsSec_Qty.Tables[0].Rows.Count > 0)
                                            {
                                                Sec_Qty = Convert.ToInt32(dsSec_Qty.Tables[0].Rows[0]["Sec_Sale_Qty"].ToString());

                                                //  Session["Qty_Val"] = Sec_Qty;

                                                Sec_Cnt = 1;

                                                if (Qty_Val_2 == 1)
                                                {
                                                    Qty_Val = Convert.ToInt32(Session["Qty_Val"]) + Sec_Qty;
                                                }
                                                else if (Qty_Val_1 == 1)
                                                {
                                                    Qty_Val = Convert.ToInt32(Session["Qty_Val_1"]) + Sec_Qty;
                                                }
                                                else
                                                {
                                                    Qty_Val = Sec_Qty;
                                        ...
                                        else
                                        {
                                            ...
                                            if (Sec_Cnt > 0)
                                            {
                                                ...
                                                if (dsSec_Qty.Tables[0].Rows.Count > 0)
                                                {
                                                    ...
                                                    Qty_Val = Qty_Val + Sec_Qty;

                                                    Session["Qty_Val_1"] = Qty_Val;
                                            ...
                                            else
                                            {
                                                ...
                                                if (dsSec_Qty.Tables[0].Rows.Count > 0)
                                                {
                                                    ...
                                                    //Qty_Val = Convert.ToInt32(Session["Qty_Val"]);                                               

                                                    Qty_Val = Qty_Val + Sec_Qty;

                                                    Session["Qty_Val"] = Qty_Val;
                    ...
                    Val = Convert.ToDouble(Qty_Val * P_Rate);

                    DataSet dsReport = new DataSet();

                    DataTable dt = new DataTable("TblSecSaleQty_Val");
    ...
    private void PopulateSecSales_Month(DataSet dsProd, int stock_code)
    {
        ...
        int sqty = 0;
        double sval = 0.00;
        string[] arrqty = new string[500];
        string[] arrval = new string[500];
        ...
        foreach (DataRow dataRow in dsProd.Tables[0].Rows)
        {
            ...
            for (curindex = 0; curindex < monthdiff; curindex++)
            {
                ...
                foreach (DataRow dRow in dsSecSales.Tables[0].Rows)
                {
                    ...
                    dsReport = ss.getrptvalues(div_code, sf_code, stock_code, curmonth, curyear, curmonth, curyear, dataRow["Product_Detail_Code"].ToString(), P_Rate, Convert.ToInt16(dRow["Sec_Sale_Code"].ToString()));

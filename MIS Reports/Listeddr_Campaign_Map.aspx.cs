...
public partial class MIS_Reports_Listeddr_Campaign_Map : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dsDoctor = dc.drsCampaignMap(sf_code);
        DataTable prod = dc.drsCampaignMap_Details(sf_code,Div_code);
        ...
        if (mainTable.Rows.Count > 0)
        {
            ...
            {
                String filter = "ListedDrCode='" + row["ListedDrCode"].ToString() + "'";

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Stock_Product_View.aspx.cs" Inherits="rpt_Stock_Product_View" %>
                        ...
                        <div class="designation-reactivation-table-area clearfix">
                            ...
                            <div class="display-table clearfix">
                                <div class="table-responsive" style="scrollbar-width: thin; max-height: 700px;">
                                    <asp:GridView ID="GrdSale" runat="server" AlternatingRowStyle-CssClass="alt"
                                        AutoGenerateColumns="true" CssClass="table" EmptyDataText="No Records Found"
                                        GridLines="None" HorizontalAlign="Center" OnRowCreated="GrdSale_RowCreated"
                                        OnRowDataBound="GrdSale_RowDataBound" ShowHeader="False" Width="100%">
                                        <Columns>
                                        </Columns>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sampledesDatewiseZoom.aspx.cs" Inherits="MIS_Reports_sampledesDatewiseZoom" %>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="80%" align="center">
                        <asp:Label ID="lblProd" runat="server" Text="Sample Despatch View" CssClass="reportheader"></asp:Label>
                    </td>
                    <td align="right">
                        <table>
                            <tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <asp:Label ID="lblname" runat="server" Font-Size="14px" CssClass="label"></asp:Label>
                                    </td>

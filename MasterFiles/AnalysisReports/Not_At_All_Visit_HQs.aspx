<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Not_At_All_Visit_HQs.aspx.cs"
    Inherits="MasterFiles_AnalysisReports_Not_At_All_Visit_HQs" %>
...
<head runat="server">
    <title>Not at All Visit HQs</title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, sf_name, mode) {
            ...
            popUpObj = window.open("rpt_Not_At_All_Visit_HQs.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + " &mode=" + mode,
 "ModalPopUp"//,
 //"toolbar=no," +
 //"scrollbars=yes," +
 //"location=no," +
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Not at All Visit HQs</h2>

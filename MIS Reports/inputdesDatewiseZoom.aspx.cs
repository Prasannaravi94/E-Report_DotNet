...
public partial class MIS_Reports_inputdesDatewiseZoom : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //FillProd();
            lblProd.Text = "Input Despatch View for the Period of " + FDate + " " + TDate + " ";
    ...
    private void CreateDynamicTable()
    {
        ...
        dsDr = dr.getinput_productname_Datewise(div_code, sf_code, FromDate, ToDate);

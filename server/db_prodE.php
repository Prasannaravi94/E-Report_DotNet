...
case "table/list":
	...
	case "doctor_business_entry":
			...
			if($DBdata['Detail_No']!= 0)
			{
				$sql2 = "delete from Trans_DCR_BusinessEntry_Details where Trans_sl_No = '".$DBdata['Detail_No']."'";
				$sql1 = "delete from Trans_DCR_BusinessEntry_Head where Trans_sl_No = '".$DBdata['Detail_No']."'";
			} 
			$sql = "select isnull(max(Trans_sl_No),0)+1 sl_no from Trans_DCR_BusinessEntry_Head";
			$tr = performQuery($sql);
            $trans_slh = $tr[0][sl_no];

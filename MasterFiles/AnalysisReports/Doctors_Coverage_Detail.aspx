<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Doctors_Coverage_Detail.aspx.cs" Inherits="MasterFiles_AnalysisReports_Doctors_Coverage_Detail" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, sf_name, Vacant,sname,scode) {
            //popUpObj = window.open("MissedCallReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rpt_Doctors_Coverage_Det.aspx?sf_code=" + sfcode + "&FMonth=" + fmon + "&Fyear=" + fyr + "&sf_name=" + sf_name + " &Vacant=" + Vacant + " &specname=" + sname + " &speccode=" + scode,
  "ModalPopUp" //,
  //"toolbar=no," +
  //"scrollbars=yes," +
  //"location=no," +
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                var sname = $('#<%=ddlspcl.ClientID%> :selected').text();
                 var scode = document.getElementById('<%=ddlspcl.ClientID%>').value;
                var chkDetail = document.getElementById("chkDetail");
                if (chkDetail.checked) {
                    showModalPopUp(sf_Code, Month1, Year1, Name, 0, sname,scode);
                }
                else {
                    showModalPopUp(sf_Code, Month1, Year1, Name, 1, sname,scode);
                }
            });
        });
    </script>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Doctors Coverage Detail</h2>
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <asp:TextBox ID="txtMonthYear" runat="server" CssClass="nice-select" ReadOnly="true"></asp:TextBox>
                              ...
                              <div class="single-des clearfix">
                             <asp:Label ID="Label3" runat="server" Text="Speciality" CssClass="label"></asp:Label>
                              <asp:DropDownList ID="ddlspcl" runat="server" CssClass="nice-select" >
                                                    </asp:DropDownList>
                                  </div>
                            <div class="single-des clearfix">

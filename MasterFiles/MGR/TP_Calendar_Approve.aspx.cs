...
public partial class MasterFiles_MGR_TP_Calendar_Approve : System.Web.UI.Page
{
    ...
    private void FillTourPlan()
    {
        ...
        //    div_grdTP_Calander.Visible = true;
        //    div_grdTP.Visible = false;
        //    div_grdTP_Calander1.Visible = false;
        ...
        //    //btnHome.Visible = true;
        //    grdTP.Visible = true;
        //    div_grdTP.Visible = true;
        //    div_grdTP_Calander.Visible = false;
        //    div_grdTP_Calander1.Visible = false;
        //    grdTP.DataSource = dsTP;
        //    grdTP.DataBind();
        //}
    ...
    protected void grdTP_Calander_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        grdTP_Calander.PageIndex = e.NewPageIndex;
        FillTourPlan();
    }
}
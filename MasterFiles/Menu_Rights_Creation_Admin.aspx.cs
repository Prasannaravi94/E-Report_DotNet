...
public partial class MasterFiles_Menu_Rights_Creation_Admin : System.Web.UI.Page
{
    ...
    private void fillRights()
    {
        ...
        {
            Fill_MGR_Rights(HO_ID, div_code);
        }
        else
        {
    ...
    private void Fill_MGR_Rights(string HO_ID, string div_code)
    {
        UserLogin dv = new UserLogin();

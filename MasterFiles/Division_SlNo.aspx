...
<body >
    ...
    <ucl:Menu ID="menu1" runat="server" /> 
      ...
      <%--<table width="80%">
        <tr>
            <td style="width:9.2%" />
            <td class="style3">
                <asp:Button ID="btnNew" runat="server" CssClass="savebutton" Text="Add" Width="60px" Height="25px" onClick="btnNew_Click" />
            </td>
            <td></td>
        </tr>
      </table>--%>
    ...
    <br />
        <center>
            <asp:Button ID="btnSubmit" runat="server" Text="Generate - Sl No" Width="110px" Height="25px" CssClass="savebutton" OnClick="btnSubmit_Click" />
            <asp:Button ID="btnClear" runat="server" Width="60px" Height="25px" Text="Clear" CssClass="savebutton" OnClick="btnClear_Click" />
        </center>

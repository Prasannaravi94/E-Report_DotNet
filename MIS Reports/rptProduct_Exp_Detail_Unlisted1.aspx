<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptProduct_Exp_Detail_Unlisted1.aspx.cs" Inherits="MIS_Reports_rptProduct_Exp_Detail_Unlisted1" %>
                ...
                <div class="col-lg-12">
                    <asp:Panel ID="pnlContents" runat="server" Width="100%">
                        <div align="center">
                            ...
                            <br />
                            <br />
                            <asp:Label ID="lblfieldname" runat="server" Font-Size="18px" Text="Fieldforce Name:" CssClass="label"></asp:Label>
                                ...
                                <asp:GridView ID="grdDr" runat="server" Width="100%" HorizontalAlign="Center" EmptyDataText="No Records Found"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ListedDrCode" ItemStyle-HorizontalAlign="Left" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDrCode" runat="server" Width="120px" Text='<%#Eval("unListedDrCode")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Doctor Name" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDrName" runat="server" Width="150px" Text='<%# Bind("unListedDr_Name") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

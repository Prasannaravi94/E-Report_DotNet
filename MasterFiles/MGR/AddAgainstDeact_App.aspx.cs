...
public partial class MasterFiles_MGR_AddAgainstDeact_App : System.Web.UI.Page
{
    ...
    private void FillDoc()
    {
        ...
        dsDoc = LstDoc.getListedDr_addAgainst_One(sQryStr);
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdDoctor.Rows)
        {
           ...
           // DataRow[] DataRow = dsDoc.Tables[0].Select("SLVNo=" + slvno);
            DataRow[] DataRow = dsDoc.Tables[0].Select("SLVNo='" + slvno.ToString() + "'");
            //dt = result.
            ...
            if ((bCheck == true))
            {
                foreach(DataRow dr in DataRow)
                {
                    ...
                    {
                        iReturn = LstDoc.Add_Against_Approve_Temp(sQryStr, dr["ListedDrCode"].ToString(), iflag, 2, Session["sf_name"].ToString());
                    ...
                    else if (iflag == 1)
                    {
                       ...
                       iReturn = LstDoc.ApproveAddDeact1(sQryStr, dr["ListedDrCode"].ToString(), iflag, Session["sf_name"].ToString(), slvno);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SS_Stockist_HQWise.aspx.cs" Inherits="MasterFiles_AnalysisReports_SS_Stockist_HQWise" %>
...
<head id="Head1" runat="server">
    <title>Secondary Sales - All Stockist Wise</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name) {
            popUpObj = window.open("Rpt_SS_Stockist_HQWise.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
    ...
    <form id="form1" runat="server">
        ...
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <h2 class="text-center" style="border-bottom: none">Secondary Sales - All Stockist Wise</h2>

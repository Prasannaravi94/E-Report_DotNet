...
public partial class MasterFiles_AnalysisReports_Campaign_Dump : System.Web.UI.Page
{
    ...
    {
        DataSet dsdes = new DataSet();
        strQry = "select Designation_Code,Designation_Short_Name from mas_sf_designation where division_code='" + div_code + "' and Designation_Active_Flag=0 and type=2 and Tag_Needed=1 " +
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("Campaign_dr_Visit_Dump", con);
     ...
     //   ds.Tables[0].Columns.Remove("sf_code1");
      ...
      //  ds.Tables[0].Columns.Remove("Trans_Detail_Info_Code");
        ...
        for (int iCol = 0; iCol < countCol; iCol++)
        {
            ...
            if (col.ColumnName != "sno" && col.ColumnName != "sf_name" && col.ColumnName != "ListedDr_Name" && col.ColumnName != "Cat" && col.ColumnName != "Spec" && col.ColumnName != "Camp" && col.ColumnName != "Rcpa Potential" && col.ColumnName != "Rcpa Yield" && col.ColumnName != "Joint Work" && col.ColumnName != "Territory_code" && col.ColumnName != "sf_HQ" && col.ColumnName != "sf_Designation" && col.ColumnName != "Emp Code" && col.ColumnName != "Doctor mobile No" && col.ColumnName != "Input Given Date" && col.ColumnName != "Input Name" && col.ColumnName != "Input Qty")
            {
        ...
        Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "Campaign_Dump.xls"));
        ...
        //httpResponse.AddHeader("content-disposition", "attachment;filename=\"Campaign_Dump.xlsx\"");

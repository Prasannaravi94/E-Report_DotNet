<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard_TargetversusSales.aspx.cs" Inherits="MasterFiles_Dashboard_TargetversusSales"
...
<body>
    ...
    <script> 
        $('iframe#ifmReviewRep').load(function () {
            $("#ifmReviewRep").contents().find("#btnPrint").hide(); 
            $("#ifmReviewRep").contents().find("#btnExcel").hide();
            $("#ifmReviewRep").contents().find("#btnClose").hide();
        });
    </script>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpChemistProductwiseBusinessView.aspx.cs" Inherits="MIS_Reports_dcview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Chemist_Productwise_Business_FieldForce</title>
    <meta charset="utf-8">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, sf_name, cyear, cmonth, sCurrentDate) {
            popUpObj = window.open("rpChemistProductwiseBusinessView1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&sCurrentDate=" + sCurrentDate + "&MR=0&FMonth=&FYear=&TMonth=&TYear=",
                     "_blank",
                    "toolbar=no," +
                    "scrollbars=yes," +
                    "location=no," +
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="80%" align="center">
                        <asp:Label ID="lblHead" runat="server" Text="Chemist Productwise Business View" CssClass="reportheader"></asp:Label>
                    </td>
                    <td align="right">
                        <table>
                            <tr>

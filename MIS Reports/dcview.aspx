<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dcview.aspx.cs" Inherits="MIS_Reports_dcview" %>
...
<link type="text/css" rel="stylesheet" href="../../css/repstyle.css" />
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, sf_name, cyear, cmonth, sCurrentDate) {
            popUpObj = window.open("dcview1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&sCurrentDate=" + sCurrentDate,
     "_blank",
    "ModalPopUp," +
    "toolbar=no," +
    "scrollbars=yes," +
        ...
        <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                    ...
                    <asp:Label ID="lblHead" Text="Doctor Busniness Entry View" SkinID="lblMand" 

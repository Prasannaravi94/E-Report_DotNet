...
<body>
     ...
     <%--<ucl:Menu ID="menu1" runat="server" /> --%>
        ...
        <div class="container home-section-main-body position-relative clearfix">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-11">
                    <h2 class="text-center" style="border-style: none;">Hospital DeActivate</h2>
                                        ...
                                        <td colspan="2" align="center">
                                            <asp:GridView ID="grdHospital" runat="server" Width="100%" HorizontalAlign="Center"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="45px">
                                                        <HeaderTemplate>
    ...
    <div class="div_fixed">
         <asp:Button ID="btnSave" runat="server" Text="De-Activate" CssClass="savebutton" onclick="btnSave_Click" Visible="false" />
    </div>    

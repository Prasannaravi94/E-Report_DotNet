...
<script type="text/javascript">
    function SessionExpireAlert(timeout) {
        ...
        setTimeout(function () {
            window.location.replace("http://sansfa.in/");
        }, timeout);
    };
        ...
        <header class="header-area clearfix">
                        ...
                        <asp:Label ID="lblTerritory" Text="Territory" runat="server"></asp:Label></a></li>--%>
                                            ...
                                            <li id="ulliApp" runat="server" visible="false" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Approvals </a>
                                                <ul id="ululApp" runat="server" class="dropdown-menu">
                                                    <li id="liIn7" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/MGR/ListedDR_Add_Approve.aspx" onclick="ShowProgress();">Listed Dr Addition</a></li>
                                                    <li id="liIn8" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/MGR/ListedDR_DeActivate_Approve.aspx" onclick="ShowProgress();">Listed Dr DeActivation</a></li>
                                                    <li id="liIn9" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/MGR/TP_Approve.aspx" onclick="ShowProgress();">TP Approval</a></li>
                                ...
                                onclick="ShowProgress();">CCP View</a></li>--%>
                                            ...
                                            <li id="ulliExpMgr" runat="server" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Expense </a>
                                                <ul id="ululExpMgr" runat="server" class="dropdown-menu">
                                                    ...
                                                    <li id="li2" runat="server" visible="false"><a class="dropdown-item" href="../../../../MasterFiles/Reports/RptAutoExpense_Approve_View.aspx" onclick="ShowProgress();">Actual Expense View</a></li>
                           ...
                           Approval</a></li>--%>
                                        ...
                                        <%--    <li id="ulliDocBus" class="dropdown-submenu" runat="server"  visible="false"><a class="dropdown-item dropdown-toggle" href="#">Doctor Business Productwise </a>
                                                    <ul id="ululDocBus" class="dropdown-menu" runat="server" visible="false">
                                            ...
                                            <li id="ulliInDes" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Input Despatch </a>
                                                    ...
                                                    <ul id="ulsampleedit" class="dropdown-menu" runat="server">
                                                         ...
                                                         <li id="Lisaedit" runat="server" visible="false"><a class="dropdown-item" href="../../../../MIS Reports/Sample_Input_Modify_MRWise.aspx"
                                        ...
                                        <ul runat="server" id="ul_Mis" class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            ...
                                            <li id="ulliDoc" runat="server" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Field Force Master </a>
                                                <ul id="ululDoc" runat="server" class="dropdown-menu">
                                                    ...
                                                    <li id="li8" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Reports/MR_Status_Report.aspx" onclick="ShowProgress();">Doctors and Chemists Master</a></li>
                                                </ul>
                                            </li>
                                            <li id="Li15" runat="server" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Field Work Analysis </a>
                                                <ul id="ul7" runat="server" class="dropdown-menu">
                                                    <li id="li16" runat="server"><a class="dropdown-item" href="../../../../MIS Reports/DCR_Analysis.aspx" onclick="ShowProgress();">Daily Work Report Summary</a>
                                                    </li>
                                                    <li id="liMgrMis3" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Reports/CallAverage.aspx" onclick="ShowProgress();">Drs Met/Visit and Call Average Report</a></li>
                                                      <li id="liMis8" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Analysis_Pob_count.aspx"
                                                        ...
                                                        <li id="li29" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Analysis_Pob_count_Periodically.aspx"
                                            ...
                                            <li id="liMgrMis5" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Missed_Call.aspx" onclick="ShowProgress();">Missed Call Report</a></li>
                                                    <li id="li17" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Mgr_Coverage.aspx"
                                                        onclick="ShowProgress();">Manager - HQ Wise Visit Coverage Analysis</a></li>
                                                    <li id="li18" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Coverage_Analysis.aspx"
                                                        onclick="ShowProgress();">Coverage Analysis 1</a></li>
                                                    <li id="li19" runat="server" visible="false"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Coverage_Analysis_2.aspx" onclick="ShowProgress();">Coverage Analysis 2</a></li>
                                                    <li id="li20" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/JointWk_Analysis.aspx"
                                                        onclick="ShowProgress();">Joint Work Analysis</a></li>
                                                    <li id="li22" runat="server" visible="false"><a class="dropdown-item" href="../../../../MIS Reports/Visit_Month_Vertical_Wise.aspx" onclick="ShowProgress();">Visit Analysis</a></li>
                                                    <%--   <li id="liVstGlnce" runat="server"><a href="../../../../MIS Reports/Visit_Analysis_At_A_Glance.aspx" onclick="ShowProgress();">
                                Visit At A Glance</a></li>--%>
                                    ...
                                    <li id="lis10" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/SecondarySale_Multi_Mnth_Dump.aspx"
                                             ...
                                             <li id="Li25" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Review Slides(as on Date)</a>
                                                <ul id="ul8" class="dropdown-menu" runat="server">
                                                     ...
                                                     <li id="li32" runat="server"><a class="dropdown-item" href="../../../../MIS Reports/Fully_Operative_Report.aspx"
                                                            onclick="ShowProgress();">Fully Operative</a> </li>
                                                    <li id="li26" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Primary_Sale_StockistWise_Product.aspx" onclick="ShowProgress();">Primary Sale</a> </li>
                                                    <li id="li27" runat="server" visible="false"><a class="dropdown-item" href="../../../../MIS Reports/samplestatus_new.aspx" onclick="ShowProgress();">Samples Status Report for a Month</a> </li>
                                                    <li id="li28" runat="server" visible="false"><a class="dropdown-item" href="../../../../MIS Reports/inputstatus_new.aspx" onclick="ShowProgress();">Inputs Status Report for a Month</a> </li>
                                          ...
                                          <li id="ullicore" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">MVD </a>
                                                    <ul id="ul9" class="dropdown-menu" runat="server">
                                                        ...
                                                        <li id="li30" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Core_drs_Status.aspx"
                                                            onclick="ShowProgress();">Status</a></li>
                                                        <li id="li31" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Core_drs_Speclty_wise.aspx"
                                           ...
                                           <li id="ulliMgrSS" runat="server" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Sales Analysis </a>
                                                <ul id="ululSS" runat="server" class="dropdown-menu">
                                                   ...
                                                   <li id="li23" runat="server" visible="true"><a class="dropdown-item" href="../../../MasterFiles/AnalysisReports/Primary_Stk_Bill_View.aspx"
                                                        onclick="ShowProgress();">Primary Sales Stockistswise</a></li>
                                                    <li id="li24" runat="server" visible="true"><a class="dropdown-item" href="../../../MasterFiles/AnalysisReports/Primary_Product_Bill_View.aspx"
                                                        onclick="ShowProgress();">Primary Sales Productwise</a></li>
                                                </ul>
                                            </li>


                                            <li id="ulliSamIn" runat="server" visible="false" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Sample / Input </a>
                                            ...
                                            <li id="ullitpExp" runat="server" visible="false" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Exception </a>
                                                <ul id="ulultpExp" runat="server" class="dropdown-menu">
                                                    <li id="liMgrMis26" runat="server"><a class="dropdown-item" href="../../../../MIS Reports/TP_Deviation.aspx" onclick="ShowProgress();">Tour Plan -Baselevel</a>
                                                    </li>
                                            ...
                                            <li id="ulliBill" runat="server" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Primary Bill </a>
                                                <ul id="ululBil" runat="server" class="dropdown-menu">
                                                    <li id="lib1sst" runat="server" visible="false"><a class="dropdown-item" href="../../../MasterFiles/AnalysisReports/Primary_Stk_Bill_View.aspx"
                                                        onclick="ShowProgress();">Stockist View</a></li>
                                                    <li id="lib2ppt" runat="server" visible="false"><a class="dropdown-item" href="../../../MasterFiles/AnalysisReports/Primary_Product_Bill_View.aspx"
                                            ...
                                            <li id="ulliDump" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Dump </a>
                                                    <ul id="ululDump" class="dropdown-menu" runat="server">
                                                        ...
                                                        <li id="li33" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Campaign_Dump.aspx"
                                                       ...
                                                       <li id="input_Dump" runat="server"><a class="dropdown-item" href="../../../../MIS Reports/SampleGift_details_exel.aspx"
                                                        onclick="ShowProgress();">Input-Issued Excel Download</a></li>
                                                              ...
                                                              <li id="li42" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Listeddr_Dump.aspx"
                                             ...
                                             <li id="Likpikra" class="dropdown-submenu" visible="false" runat="server"><a class="dropdown-item dropdown-toggle" href="#">KRA/KPI </a>
           ...
           <li id="liKKRasm14" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/EffortVsSales_Wok_Analysis.aspx"
                        ...
                        onclick="ShowProgress();">Release - Missing Dates / Delay </a></li>   --%>
                                            ...
                                            <li id="Li40" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/ActivityReport.aspx" onclick="ShowProgress();">Activity Report</a></li>
                                        </ul>
                                    </li>

...
<head runat="server">
    <title>Transfer Doctor Speciality</title>
    ...
    <div>
        ...
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <br />
                    <h2 class="text-center">Transfer Doctor Speciality</h2>
                    <div class="designation-area clearfix">
                        <div class="single-des clearfix">
                            <asp:Label ID="lblTrans_From" runat="server" CssClass="label">Transfer From<span style="Color:Red;padding-left:5px;">*</span></asp:Label>
                        ...
                        <div class="single-des clearfix">
                            <asp:Label ID="lblTrans_To" runat="server" CssClass="label">Transfer To<span style="Color:Red;padding-left:5px;">*</span></asp:Label>
                    ...
                    <center>
                        <asp:Panel ID="pnlCount" runat="server" Visible="false">
                            <asp:Table ID="Table1" runat="server" BorderStyle="Solid" Width="300px" BorderWidth="1" CssClass="clp"
                                ...
                                <asp:TableHeaderRow>
                                    <asp:TableHeaderCell ColumnSpan="2"  BorderStyle="Inset">
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell BorderStyle="Inset" Width="80px" HorizontalAlign="Center">
                                        <asp:Label ID="lblUndrcount" runat="server" CssClass="label"></asp:Label>
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                            <br />
                            <asp:Button ID="btnConfirm" runat="server" Text="Confirm to Transfer" Width="145px" CssClass="savebutton" OnClientClick="return confirm('Do you want to Transfer Speciality?') &&  confirm('Are you sure want to Transfer?');"

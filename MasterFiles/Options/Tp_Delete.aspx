<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tp_Delete.aspx.cs" Inherits="MasterFiles_Options_Tp_Delete" %>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <br />
                        <h2 class="text-center" id="hHeading" runat="server">TP Del<asp:LinkButton ID="lnk" ForeColor="#292a34" runat="server" Text="e" OnClick="lnk_Click"></asp:LinkButton>te</h2>
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <asp:Label ID="lblYear" runat="server" CssClass="label">Year</asp:Label>
                                        <asp:DropDownList ID="ddlYear" CssClass="custom-select2 nice-select" runat="server"></asp:DropDownList>
                                        <%--<asp:TextBox ID="txtMonthYear" runat="server" CssClass="nice-select" ReadOnly="true"></asp:TextBox> onclick="ShowgridData()" --%>
                                    </div>
                                    <%--<div class="col-lg-6">
                            ...
                            <div class="single-des clearfix">
                                <asp:Label ID="lblMonth" runat="server" CssClass="label" Width="100%">Month</asp:Label>
                                <asp:DropDownList ID="ddlMonth" runat="server" CssClass="custom-select2 nice-select" AutoPostBack="true" OnSelectedIndexChanged="ddlMonth_SelectedIndex">
                                    <asp:ListItem Value="0" Text="---Select---"></asp:ListItem>
                        ...
                        <div class="w-100 designation-submit-button text-center clearfix">
                            <asp:Button ID="btnhiddenGo" runat="server" Text="Go" CssClass="savebutton" OnClick="btnhiddenGo_Click" Visible="false"  />
                            <br />
                    ...
                    <div class="col-lg-11">
                        ...
                        <div class="w-100 designation-submit-button text-center clearfix">
                            <asp:Button ID="btnhiddenSubmit" runat="server" Text="TP Delete" CssClass="savebutton"
                                 Visible="false" OnClick="btnhiddenSubmit_Click" />
                            <br />

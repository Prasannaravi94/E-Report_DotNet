...
public partial class MasterFiles_AnalysisReports_rpt_Primary_StK_Bill_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        GrdFixation_View.Visible = false;
        lblheadView.Visible = false;
        if (Mode == "2" || Mode == "4")
        {
        ...
        {
            lblHead.Text = "Primary Stockistwise ";
        }
        else
        {
    ...
    private void FillReport()
    {
        ...
        {
            sProc_Name = "Primary_Sale_Stockist_HQwise";
        }
        else if (Mode == "3")
        {
            sProc_Name = "TargetVsPrimary_HQwise_New";
        }
        else if (Mode == "4")
        {
            sProc_Name = "SP_HQwise_FF";
        }
    ...
    protected void GrdFixation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            else if (Mode == "2")
            {
                ...
                if (dtrowClr.Rows[indx][7].ToString() != e.Row.Cells[5].Text)
                {

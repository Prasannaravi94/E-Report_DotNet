                        ...
                        <div class="col-lg-6">
                            <div class="designation-area clearfix">
                                ...
                                <div class="single-des clearfix">
                                    ...
                                    <br />
                                    <asp:Label ID="Label1" runat="server" CssClass="label">1) Sheet Name Must be 'UPL_Chemist_Master'</asp:Label>
                                    <br />
                                    <asp:Label ID="Label2" runat="server" CssClass="label">2) Category Name and Specialty Name Must be Match Our Website</asp:Label>
                                    <br />
                                    <asp:Label ID="Label3" runat="server" CssClass="label">3) DOB & DOW Must 'MM/DD/YYYY' Format</asp:Label>
                                    <br />
                                    <asp:Label ID="Label4" runat="server" CssClass="label">4) Don't Do Any Special Formats in the Excel File</asp:Label>
                                </div>
                                <div class="single-des clearfix">

...
public partial class MasterFiles_AnalysisReports_rpt_Primary_Prod_Cum_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Primary Uploadwise From " + strFrmMonth + " " + FYear + " to " + " " + strToMonth + " " + " " + TYear;
       ...
       private void FillReport()
    {
        ...
        sProc_Name = "Primary_Product_View_Cum";

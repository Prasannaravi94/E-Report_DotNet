...
public partial class MasterFiles_AnalysisReports_rpt_SecondarySale_Multi_Mnth : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            lblHead.Text = "Secondary Sale Product Wise for the Period of  " + strFrmMonth + " " + FYear + "  To  " + strToMonth + " " + TYear;
        }
        else if (Mode == "5")
        {
            lblHead.Text = "Secondary Sale Product Wise - NRV Comparision for the Period  of  " + strFrmMonth + " " + FYear + "  To  " + strToMonth + " " + TYear;
        }
    ...
    private void FillReport()
    {
        ...
        {
            Proce_Name = "SecondarySale_MultiMnth_GrpBrandProductwise_P";
        }
        else if (Mode == "5")
        {
            Proce_Name = "SecondarySale_MultiMnth_GrpBrandProductwise_P_New";
        }

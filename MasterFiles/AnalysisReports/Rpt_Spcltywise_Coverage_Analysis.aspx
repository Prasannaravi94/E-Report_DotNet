<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_Spcltywise_Coverage_Analysis.aspx.cs" EnableEventValidation="false"
    Inherits="MasterFiles_AnalysisReports_Rpt_Spcltywise_Coverage_Analysis" %>
...
<script type="text/javascript">
    ...
    function showModalPopUp(sf_code, FMonth, FYear, Tmon, Tyr, Sf_Name, Spclty_Code, Spclty_Name) {
        popUpObj = window.open("ViewDetails_DrWise_Report.aspx?sf_code=" + sf_code + "&FMnth=" + FMonth + "&FYear=" + FYear + "&TMonth=" + Tmon + "&TYear=" + Tyr + "&sf_name=" + Sf_Name + "&Spclty_Name=" + Spclty_Name + "&Spclty_Code=" + Spclty_Code + "&cTyp_cd=0&typ=0&cMode=6&HQ_Code=",
        "_blank",
    "ModalPopUp_Level1," +
     "0" //+
    //"toolbar=no," +

...
namespace Bus_EReport
{
    public class DCREntryBL 
    {
        ...
        public List<DCREntry.Clusters> gethalf_Daywrk(string Divcode)
        {
            ...
            try
            {
                WrkTys = DL.gethalf_Daywrk(Divcode);
            }
            catch { throw; }
            finally { DL = null; }
            return WrkTys;
        ...
        public string getProdsJSON(string SFCode, int SampleValid)
        {
            ...
            try
            {
                Prods = DL.getProdsJSON(SFCode, SampleValid);
            }
            catch { throw; }
            finally { DL = null; }
            return Prods;
        ...
        public string getInputJSON(string SFCode, DateTime Dt, int InputValid)
        {
            ...
            try
            {
                inputs = DL.getInputJSON(SFCode, Dt, InputValid);
            }
            catch { throw; }
            finally { DL = null; }
            return inputs;
        ...
        public string getProdFeedBkJSON(int div)
        {
            ...
            try
            {
                feedBks = DL.getProdFeedBkJSON(div);
            }
            catch { throw; }
            finally { DL = null; }
            return feedBks;
        ...
        //gowsi start
        public string SaveDCRTemp1(DCREntry.DCRDatas HeadDta,string selvalues)
        {
            string ARCd = "";
            DCREntryDL DL = new DCREntryDL();
            try
            {
                ARCd = DL.SaveDCRTemp1(HeadDta, selvalues);
        ...
        public string getDCRDetailsTrans(string SF, DateTime Dt)
        {
            string DCRJSON = "";
            DCREntryDL DL = new DCREntryDL();
            try
            {
                DCRJSON = DL.getDCRDetails_Trans(SF, Dt);
        ...
        public DCREntry.TPBaseDCR get_TPBaseDCR(string SFCode, DateTime Dt)
        {
            ...
            try
            {
                SFDets = DL.get_TPBaseDCR(SFCode, Dt);
            }
            catch { throw; }
            finally { DL = null; }
            return SFDets;
        ...
        public List<DCREntry.Clusters> getClustFilter(string SFCode, DateTime Dt)
        {
            ...
            try
            {
                Twns = DL.getClustFilter(SFCode, Dt);
            }
            catch { throw; }
            finally { DL = null; }
            return Twns;
        ...
        public string SaveDeviate(string Sf_Code, string Activity_Date, string Div_Code, string Dev_Reason, string TP_Area, string TP_Worktype, string SF_Name, int TPDCR_MGRAppr, string sTerritory_Code)
        {
            ...
            try
            {
                Deviate = DL.SaveDeviate(Sf_Code, Activity_Date, Div_Code, Dev_Reason, TP_Area, TP_Worktype, SF_Name, TPDCR_MGRAppr, sTerritory_Code);
            }
            catch { throw; }
            finally { DL = null; }
            return Deviate;
        ...
        public Boolean Sample_Input_Update(string SFCode, string Code, int Mode)
        {
            ...
            try
            {
                Flag = DL.Sample_Input_Update(SFCode, Code, Mode);
            }
            catch { throw; }
            finally { DL = null; }
            return Flag;

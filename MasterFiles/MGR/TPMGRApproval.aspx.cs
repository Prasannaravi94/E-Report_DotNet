...
public partial class MasterFiles_MGR_TPMGRApproval : System.Web.UI.Page
{
    ...
    private void FillManager()
    {
        ...
        dsTP = tp_New.get_TP_Active_Date_New(sf_Code);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0 || dsSalesForce.Tables[1].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                tr_det.Cells.Add(tc_det_sf_Approved);
                    ...
                    if (dsStatus.Tables[0].Rows.Count > 0 && dsStatus.Tables[0].Rows[0][2].ToString() != "0")
                    {
                        if (dsStatus.Tables[0].Rows[0][1].ToString() == "Prepared & Not Approved")
                        {
                            lit_det_sf_doj.Text = "&nbsp;" + "<span  style='color:blue;font-weight:bold'>" + dsStatus.Tables[0].Rows[0][1].ToString() + "</span>";

                        }
                        else
                        {
                            lit_det_sf_doj.Text = "&nbsp;" + "<span  style='color:Green'>" + dsStatus.Tables[0].Rows[0][1].ToString() + "</span>";
                        }
                    ...
                    if (lit_det_sf_doj.Text.Trim() == "&nbsp;" + "<span  style='color:blue;font-weight:bold'>" + "Prepared & Not Approved" + "</span>")
                    {                        

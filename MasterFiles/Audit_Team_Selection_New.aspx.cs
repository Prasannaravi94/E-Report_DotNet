...
public partial class MasterFiles_Audit_Team_Selection_New : System.Web.UI.Page
{
    #region "Declaration"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblTitle.Text = sfname + " - " + this.Page.Title;
    ...
    private void FillUserList()
    {
        ...
        if (dsmgr.Tables[0].Rows.Count > 0)
        {
           ...
           // dtUserList = sf.getUserList_Managers_Audit_new(div_code, dsmgr.Tables[0].Rows[0].ItemArray.GetValue(0).ToString(), 0, sMgr);

            dtUserList = sf.getUserList_Managers_Audit_new_Dev(div_code, dsmgr.Tables[0].Rows[0].ItemArray.GetValue(0).ToString(), 0, sMgr);
    ...
    protected void chksf_CheckedChanged(object sender, EventArgs e)
    {
        ...
        SalesForce sf = new SalesForce();
        //dsUserList = sf.UserList(div_code, lblsfCode.Text);
        dsUserList = sf.UserList_New(div_code, lblsfCode.Text);

        HtmlGenericControl outsideDiv = (HtmlGenericControl)Page.FindControl("divPrc");
        outsideDiv.Attributes.Add("class", "dsp-Process");
        ...
        FillgridColor();
        //outsideDiv.Attributes.Remove("class");
        outsideDiv.Attributes.Add("class", "ProcessMsg modalDialog rmv-Process");
    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (iReturn > 0)
        {
            ...
            //FillAuditTeam();
            //FillgridColor();
            ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>alert('Updated Successfully');window.location='../../MasterFiles/Audit_Team.aspx';</script>");
        }
    }

...
<head runat="server">
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name, modee) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rptsampleproduct_details.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name + "&modee=" + modee,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
        ...
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                if ((frmMonth <= toMonth && parseInt(frmYear) === parseInt(toYear)) || (parseInt(frmYear) < parseInt(toYear) && (frmMonth <= toMonth || frmMonth >= toMonth))) {
                    showModalPopUp(sf_Code, FMonth, FYear, TMonth, TYear, SName, modee);
                }
                else {
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Sample Details</h2>

                        <asp:Label ID="Lblmain" Visible="False" runat="server" SkinID="lblMand" Text="Sample Issued Fieldforce"></asp:Label>
                          ...
                          <img src="../Images/Selective_Mgr.png" />
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:DropDownList ID="ddlmode" runat="server" CssClass="nice-select">
                                    <asp:ListItem Value="0" Text="---Select---"></asp:ListItem>
                                    <asp:ListItem Value="1" Selected="True" Text="Sample Issued - Fieldforcewise"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="Campaign Drs - Sample Details"></asp:ListItem>
                                </asp:DropDownList>
                            </div>

...
<head runat="server">
    <title>Manager - SFC Updation</title>
...
<td>                   
        ...
        <br />
        <center>
            <asp:Button ID="btnSF" runat="server" Width="30px" Height="25px" Text="Go" Visible="false" CssClass="savebutton"
                OnClick="btnSF_Click" />
        </center>
        <br />
       <center>
      ...
      <asp:Panel ID="pnlContents" runat="server" Width="100%">
            <table width="70%" align="center">
                <tbody>
                    <tr>
                        <td align="center">
                            <asp:GridView ID="grdDist" runat="server" Width="80%" HorizontalAlign="Center"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="MGR Category" ItemStyle-HorizontalAlign="Left">
                                        ...
                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblSFTypeMGR" runat="server" Text='<%#Eval("Type_name")%>'></asp:Label>
                                            <asp:HiddenField ID="hidmgrcode" runat="server" Value='<%# Bind("type_code") %>' />
                                    ...
                                    <asp:TemplateField HeaderText="Distance One Way</br>MR HQ-</br>MR Terr" ItemStyle-HorizontalAlign="Left">
                                        <ControlStyle Width="90%"></ControlStyle>
                                        <ItemStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black" HorizontalAlign="Left">
                                        </ItemStyle>
                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtdist" runat="server" Width="20px" Text='<%#Bind ("Dist")%>' MaxLength="5" onkeypress="CheckNumeric(event);"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Return To</br>Mgr HQ</br>One way" ItemStyle-HorizontalAlign="Left">
                                        <ControlStyle Width="90%"></ControlStyle>
                                        <ItemStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black" HorizontalAlign="Left">
                                        </ItemStyle>
                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtdistRtn" runat="server" Width="20px" Text='<%#Bind ("Rtn_HQ")%>' MaxLength="5" onkeypress="CheckNumeric(event);"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:Button ID="btnSave" Text="Save" Width="70px" CssClass="savebutton" runat="server" Visible="false" OnClick="btnSave_Click"/>
                    </td>
                </tr>

...
//Added by Preethi
public partial class MasterFiles_Dashboard_Listeddr_Prod_Map_New : System.Web.UI.Page 
{
    #region Declaration
    ...
    private void FillDoc()
    {
       ...
       DataSet dsListedDR = LstDoc.getListedDr_for_Mapp(ddlFieldForce.SelectedValue.ToString(), div_code);
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MasterFiles/MR/ListedDoctor/Listeddr_Prod_Map_New.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&monthId=" + "" + "&yearId=" + "" + "&divCode=" + div_code + "&sf_type=" + sf_type + "&Dr_Code=" + ddldr.SelectedValue.ToString() + "&Dr_Name=" + ddldr.SelectedItem.ToString() + "&sfname=" + ddlFieldForce.SelectedItem.Text);
    }
    #endregion

...
public partial class MIS_Reports_rptListeddrCamp_View : System.Web.UI.Page
{
    ...
    private void CreateDynamicTable()
    {
        ...
        if (sf_code.Contains("MR"))
        {
            dtRP = camp.Get_Camp_MR_Single(sf_code, div_code, strCamp_code.Trim());
        }
        else
        {
            dtRP = camp.Get_Camp_MR(sf_code, div_code, strCamp_code.Trim());
        }
        ...
        else
        {
                ...
                lit_det_SNo.Text = "<center> <b> No Campaign Doctors Found... </b> </center>";

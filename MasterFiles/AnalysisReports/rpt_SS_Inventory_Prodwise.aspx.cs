...
public partial class MasterFiles_AnalysisReports_rpt_SS_Inventory_Prodwise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            lblHead.Text = "Secondary Sale - Inventory Stockistwise From " + strFrmMonth + " " + FYear + " to " + " " + strToMonth + " " + " " + TYear;
    ...
    private void FillReport()
    {
        ...
        sProc_Name = "SecSale_Inventory_Productwise_P";
        ...
        dsts.Tables[1].Columns.Remove("Hq1");
        dsts.Tables[1].Columns.Remove("Stockist_Code1");
        dsts.Tables[1].Columns.Remove("Stockist_Code2");
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            if (months1 >= 0)
            {
                ...
                for (int j = 1; j <= months1 + 1; j++)
                {
                    ...
                    AddMergedCells(objgridviewrow2, objtablecell2, 0, "Sec Sales Value", "#0097AC", false);
    ...
    protected void GrdFixation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string Sale = (e.Row.Cells[e.Row.Cells.Count - 1].Text).ToString();
            if (Sale != "" && !Sale.Contains("-") && Sale != null && Sale != "&nbsp;")
            {

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChemistCamp_View.aspx.cs" Inherits="MIS_Reports_ChemistCamp_View" %>
...
<head runat="server">
    <title>Campaign Chemist - View</title>
    <style type="text/css">
        td.stylespc {
            padding-bottom: 5px;
            padding-right: 5px;
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name, campcode, campname) {
            ...
            popUpObj = window.open("rpt_Chemist_Campaign_View_FF.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name + " &camp_code=" + campcode + " &campaign=" + campname,
  "ModalPopUp"//,
  //"toolbar=no," +
  //"scrollbars=yes," +
  //"location=no," +

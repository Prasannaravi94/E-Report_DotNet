<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSampleGift_details.aspx.cs"
    Inherits="MIS_Reports_rptSampleGift_details" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, sf_name, cyear, cmonth, sCurrentDate) {
            popUpObj = window.open("rptSampleGift_details1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&sCurrentDate=" + sCurrentDate,
     "_blank",
    "ModalPopUp" //+
    //"toolbar=no," +
    //"scrollbars=yes," +
    ...
    <form id="form1" runat="server">
            ...
            <table width="100%">
                <tr>
                    ...
                    <%--  <td width="80%" align="center">
                        <asp:Label ID="lblHead" Text="Input Details" SkinID="lblMand" Font-Bold="true" Font-Underline="true"
        ...
        <div class="container home-section-main-body position-relative clearfix" style="max-width: 1350px;">
            <div class="row justify-content-center">
                ...
                runat="server"></asp:Label>--%>
                                <asp:Label ID="lblHead" Text="Input Details" CssClass="reportheader"
                                    runat="server"></asp:Label>
                            </div>
                            <br />
                            <br />

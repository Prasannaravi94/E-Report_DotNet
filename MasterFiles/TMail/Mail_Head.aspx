...
<head runat="server">
    ...
    <script type="text/javascript">
        function PrintGridData() {
            var prtGrid = document.getElementById('<%=pnlViewInbox.ClientID %>');
            prtGrid.border = 1;
                                                ...
                                                <table style="border-collapse: collapse;" class="Header">
                                                    <tr>
                                                        ...
                                                        <td valign="middle" id="tdInbox" style="height: 18px; width: 110px; border-style: solid;
                                                            ...
                                                            <asp:ImageButton ID="ImgInbox" runat="server" CssClass="savebutton" Width="20px" Height="20px"
                                                        ...
                                                        <td valign="middle" id="tdCompose" style="height: 18px; width: 110px; border-style: solid;
                                                            ...
                                                            <span style="cursor: hand; width: 100%"><span class="itemImage" style="width: 20px;">
                                                             <asp:ImageButton ID="ImgCompose" runat="server" CssClass="savebutton" Width="20px" Height="20px"
                                                        ...
                                                        <td valign="middle" id="tdSent" style="height: 18px; width: 120px; border-style: solid;
                                                            ...
                                                            <span style="cursor: hand; width: 100%"><span class="itemImage" style="width: 20px;">
                                                              <asp:ImageButton ID="ImgSent" runat="server" CssClass="savebutton" Width="20px" Height="20px"
                                                        ...
                                                        <td valign="middle" id="tdViewed" style="height: 18px; width: 95px; border-style: solid;
                                                            ...
                                                            <span style="cursor: hand; width: 100%"><span class="itemImage">
                                                              ...
                                                              <asp:ImageButton ID="ImgView" runat="server" CssClass="savebutton" Width="20px" Height="20px"
                                                        ...
                                                        <td valign="middle" id="tdHome" runat="server" style="height: 18px; width: 95px; border-style: solid;
                                                            border-width: 0px;" onmouseover="this.style.borderWidth='0.5px';"
                                                            onmouseout="this.style.borderWidth='0px';" nowrap class="print" >
                                                            <span style="cursor: hand; width: 100%"><span class="itemImage ">
                                                            <asp:ImageButton ID="imgHome" ToolTip="Goto Home" runat="server" CssClass="savebutton" Width="20px" Height="20px"
                                                                ...
                                                                <div class="DcrDispHPadFix" style="border-width: 1px; width: 99.2%">
                                                                    <table width="100%" id="tmp" align="Center">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:ImageButton ID="imgSearch" runat="server" CssClass="savebutton" Width="20px" Height="20px"
                ...
                <div class="DcrDispHPadFix" style="border-width: 0px; width: 100%; margin-left: 0px">
                    <table width="100%" height="20px" id="Table3" align="Center" border="0" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td class='print' style='cursor: hand; border-style: solid;  border-width: 0px;
                                width: 70px;' valign='middle' onclick='tkPrn()' id='Td8' title='Print Mail'>
                                 <asp:LinkButton Width="30px" Style="cursor: hand; background: url('../../images/print.gif') left center no-repeat;
                                    text-decoration: none; padding: 0em 1.3em;" ID="LinkButton2" Font-Names="Verdana"
                                    ForeColor="#004000" Font-Size="10px" runat="server" OnClientClick="PrintGridData()">
                ...
                <asp:Panel ID="pnlViewMailInbox" runat="server" BackColor="LightGrey" Height="500px"
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:Label ID="LblUser" runat="server" Text="User" Style="text-transform: capitalize;
                                    font-size: 9px; text-align: left; margin-top: 0px" Font-Bold="True" Font-Names="Verdana">
                                </asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table width="100%" cellpadding="0" cellspacing="0" style="height: 85px">
                        ...
                        <tr style="width: 50px">
                         ...
                         <tr style="width: 50px">
                            <td style="width: 25px">
                                <asp:Label ID="lblRead" runat="server" Text="&nbsp;Read Date" Font-Size="X-Small"></asp:Label>
                            </td>
                            <td width="10px">
                                :
                            </td>
                            <td>
                                <asp:Label ID="lblReadDate" runat="server" Font-Size="X-Small"></asp:Label>
                            </td>
                        </tr>
                        <tr>

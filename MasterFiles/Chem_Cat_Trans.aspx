    ...
    <ucl:Menu ID="menu1" runat="server" />
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <br />
                    <h2 class="text-center">Transfer Chemists Category</h2>
                    ...
                    <center>
                        ...
                        <asp:Button ID="btnTransfer" runat="server" CssClass="savebutton" Width="140px" Text="Transfer - Category" OnClick="btnTransfer_Click" />
                    </center>
                    <br />
                    <center>
                            ...
                            <asp:Table ID="Table1" runat="server" BorderStyle="Solid" Width="300px" BorderWidth="1" CssClass="clp"
                                ...
                                <asp:TableHeaderRow>
                                    <asp:TableHeaderCell ColumnSpan="2">
                                        <asp:Label ID="lbltrans" runat="server" Text="Transaction Available" Font-Names="Verdana" Font-Bold="true" Font-Size="12px" ForeColor="Black"></asp:Label>
                                    </asp:TableHeaderCell>
                                </asp:TableHeaderRow>
                                <asp:TableRow>
                                    <asp:TableCell BorderStyle="Inset" Width="80px" HorizontalAlign="Left">
                                        <asp:Label ID="lblListed" runat="server" Text="Chemists Count" CssClass="label"></asp:Label>
                                    </asp:TableCell>
                                    <asp:TableCell BorderStyle="Inset" Width="80px" HorizontalAlign="Center">
                                        <asp:Label ID="lblDrcount" runat="server" CssClass="label"></asp:Label>
                                    </asp:TableCell>
                                </asp:TableRow>

                            </asp:Table>
                            <br />
                            <asp:Button ID="btnConfirm" runat="server" Text="Confirm to Transfer" Width="140px" CssClass="savebutton" OnClientClick="return ConfirmMessage()"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Geo_ShowMap.aspx.cs" Inherits="MasterFiles_Geo_ShowMap" EnableEventValidation="false" %>
...
<body>
    ...
    <asp:GridView ID="GVMap" runat="server" Width="0px" Height="0px" HorizontalAlign="Center" BorderWidth="1" 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="#"  HeaderStyle-BorderWidth="1"
                        ...
                        <asp:TemplateField HeaderText="Doctor name"  HeaderStyle-BorderWidth="1"
                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox ID="txtQty" runat="server" Font-Size="9pt" Text='<%#Eval("listeddr_Name")%>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="lat"  HeaderStyle-BorderWidth="1"
                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox ID="lat" runat="server" Font-Size="9pt" Text='<%#Eval("lat")%>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Address" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox ID="GeoAddrs" runat="server" Font-Size="9pt" Text='<%#Eval("listeddr_address1")%>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="long"  HeaderStyle-BorderWidth="1"
                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="Date"  HeaderStyle-BorderWidth="1"
                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox ID="Activity_Date" runat="server" Font-Size="9pt" Text='<%#Eval("ListedDr_Created_Date", "{0:dd/MM/yyyy}")%>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="test"  HeaderStyle-BorderWidth="1"
                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox ID="Activity_Date1" runat="server" Font-Size="9pt" Text="test"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>

...
public partial class MasterFiles_Dashboard_Visit_At_a_glance : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MIS%20Reports/Visit_Details_At_a_Glance_Report.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&FYear=" + cyear + "&TMonth=" + cmonth + "&TYear=" + cyear + " &sf_name=" + ddlFieldForce.SelectedItem.Text + "&div_code=" + div_code + "&cMode=" + -1 + "&modewise=" + 1);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_lstdrwise_Remarks.aspx.cs" Inherits="MasterFiles_AnalysisReports_rpt_lstdrwise_Remarks" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <asp:Panel ID="pnlContents" runat="server">
                            <div align="center">
                                <asp:Label ID="lblHead" runat="server" Text="ListedDr - Call Feedbackwise for the month of "></asp:Label>
                                <br />

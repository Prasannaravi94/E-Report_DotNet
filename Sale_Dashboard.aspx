<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sale_Dashboard.aspx.cs" Inherits="Sale_Dashboard" %>
...
<head runat="server">
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          ...
          $.ajax({
              type: "POST",
              url: "Sale_Dashboard.aspx/" + function_name,
              data: jsonData,
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="4" align="center">
            <tr>
                <td align="right" colspan="2">
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="btnHome" runat="server" Width="150px" Height="30px" Text="Goto Home Page"
                        CssClass="roundCorner" OnClick="btnHomepage_Click" BackColor="Green" ForeColor="White" />
                    &nbsp;&nbsp;
                    <asp:Button ID="btnLogout" runat="server" Width="90px" Height="30px" Text="Logout"
                        CssClass="roundCorner" OnClick="btnLogout_Click" BackColor="Red" ForeColor="White" />
                </td>
            </tr>
            <tr>
                <td colspan="2">

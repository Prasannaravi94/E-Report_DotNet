...
public partial class MasterFiles_Options_SecSales_SecSales_Stockist_Edit_PrevMnth : System.Web.UI.Page
{
        ...
        try
        {
            ...
            using (SqlConnection connection = new SqlConnection(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["Ereportcon"].ConnectionString))
            {
                ...
                try
                {
                        ...
                        if (chkSaleEntry.Checked)
                        {
                            ...
                            if (lblMonth_num.Text != "" && lblYear.Text != "")
                            {
                                ...
                                //{
                                    ...
                                    command.CommandText =
                                " update Trans_SS_Entry_Head set Status=2 where Stockiest_Code='" + ddlStk.SelectedValue.ToString() + "' and Month='" + lblMonth_num.Text + "' and Year='" + lblYear.Text + "' ";
                    ...
                    ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>alert('Secondary Sales Edit request(s) have been Edited successfully');</script>");

...
public partial class Reports_TP_View_Report : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string sURL = "rptTPView.aspx?sf_code=" + ddlFieldForce.SelectedValue.ToString() + "&cur_month=" + MonthVal.ToString() + "&cur_year=" + YearVal.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString() + "&level=" + rdoHypLevel.SelectedValue.ToString();
        ...
        {
            string sURL = "rptTPView.aspx?sf_code=" + ddlFieldForce.SelectedValue.ToString() + "&cur_month=" + MonthVal.ToString() + "&cur_year=" + YearVal.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString() + "&level=-1";
            string newWin = "window.open('" + sURL + "',null,'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=1000,height=800,left=100,top=100');";
            ClientScript.RegisterStartupScript(this.GetType(), "pop", newWin, true);
        }
    }

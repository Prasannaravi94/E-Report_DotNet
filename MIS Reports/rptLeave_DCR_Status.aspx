<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptLeave_DCR_Status.aspx.cs"
    Inherits="MIS_Reports_rptLeave_DCR_Status" %>
                    ...
                    <tr>
                        ...
                        <td align="left">
                           ...
                           <%-- <table width="100px">
                                <tr>--%>
                                    <td>
                                        <asp:CheckBox ID="chkdatewise" runat="server" AutoPostBack="true" CssClass="chkdatewise"
                                            OnCheckedChanged="chkdatewise_CheckedChanged" />
                                        <asp:Label ID="lbldatewise" Text="Date Wise" runat="server" Font-Bold="true"></asp:Label>
                                    </td>
                                    <td>
                                        <div id="testImg">
                                            <img id="Img1" alt="" src="~/Images/dots.gif" style="height:50px" runat="server" /><span
                            ...
                            <%-- </ContentTemplate>
                             <Triggers>
          <asp:PostBackTrigger ControlID="chkdatewise" />
      </Triggers>

...
public partial class MasterFiles_Distance_Fixation : System.Web.UI.Page
{
    ...
    private void GetHQ()
    {
        ...
        {
            lblFieldName.Text = "<span style='font-weight: bold;'>Field Force Name:-</span>" +
            ...
            lblTerrritory.Text = "<span style='font-weight: bold;'>HQ Name:-</span>" +
    ...
    private void getOSEx_Dist1()
    {
        ...
        foreach (DataRow row in mainTable.Rows)
        {
            ...
            if (rows.Length > 0)
            {
                ...
                row["Rtn_to_hq_dist"] = rows[0]["Rtn_to_hq_dist"];
            }
        }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdEX.Rows)
        {
            ...
            if (EX_Distance != "" && catCode != null)
            {
                ...
                iReturn = dist.addOrUpdate(ddlFieldForce.SelectedValue, EX_Distance, toCode.Value, frmCode.Value, catCode.Value);
            }
        }
        foreach (GridViewRow gridRow in grdOS.Rows)
        {
            ...
            {
                iReturn = dist.addOrUpdate(ddlFieldForce.SelectedValue, OS_Distance, toCode.Value, frmCode.Value, catCode.Value);
            }
        }
        ...
        {           
            ...
            if (OSEX_Distance != "")
            {
                iReturn = dist.addOrUpdate(ddlFieldForce.SelectedValue, OSEX_Distance, toCode.Value, frmCode.Value, catCode.Value);

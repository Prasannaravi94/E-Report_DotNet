<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrBusinessProductDump.aspx.cs" Inherits="MasterFiles_AnalysisReports_DrBusinessProductDump" %>
...
<head runat="server">
    <title>Doctor Product Business Dump</title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Doctor Product Business Dump</h2>
                        ...
                        <div style="float: right; width: 45%">
                           <asp:LinkButton ID ="btnCSV" runat ="server" Font-Size="Medium" Font-Bold="true"
                    Text ="Download CSV" OnClick ="btnCSV_Click" />

...
public partial class MasterFiles_AnalysisReports_rpt_Consolidated_Report_Zoom : System.Web.UI.Page 
{
    ...
    private void FillReport()
    {
        ...
        DCR dcc = new DCR();
         ...
         //if (mode == "5")
        {
            sProc_Name = "Consolidated_Report_Zoom"; //rpt_Fieldwork_Pivot
            ...
            dsts.Tables[0].Columns.Remove("visitType");
            dsts.Tables[0].Columns.Remove("Counts");
        }
    ...
    protected void LinkBtn_Click(object sender, EventArgs e)
    {
        ...
        //if ((lblMonthExc.Text) == "Territory")
        {
            //if (mode == "5")
            {
                sProc_Name = "Consolidated_Report_Zoom";  //rptMgr_Coverage_Detail
                SqlCommand cmd = new SqlCommand(sProc_Name, con);
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            if (mode == "5")
            {
                AddMergedCells(objgridviewrow, objtablecell, 2, 0, "Joint Wrk Visit Date", "#0097AC", true);
            }
    ...
    protected void GrdFixation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string Rowcount_FW = string.Empty;
            int numberOfElements_FW = 0;
                Rowcount = e.Row.Cells[6].Text;
                Rowcount_FW = e.Row.Cells[7].Text;
                ...
                if (Rowcount_FW != "" && Rowcount_FW != "-" && Rowcount_FW != "&nbsp;")
                {
                    count_FW = count_FW + "," + Rowcount_FW;
                }
            ...
            int numberOfElements = counts.Count();
             //num = num + (numberOfElements_FW - 1);

            counts_FW = count_FW.Split(',');
            //numberOfElements_FW = counts_FW.Distinct().Count();
            numberOfElements_FW = counts_FW.Count();
            ...
            if (dtrowClr.Rows.Count - 1 != indx)
            {
                ...
                Tot_Count_FW = Tot_Count_FW + (numberOfElements_FW - 1);
            }
            ...
            if (e.Row.Cells[1].Text == "zzy") //if (e.Row.RowIndex == dtrowClr.Rows.Count - 1)
            {
                ...
                e.Row.Cells[1].Text = "Total Count :";
                e.Row.Cells[2].Text = (Tot_Count).ToString();
                e.Row.Cells[3].Text = (Tot_Count_FW).ToString();

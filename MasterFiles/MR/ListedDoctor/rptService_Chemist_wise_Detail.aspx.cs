...
public partial class MasterFiles_MR_ListedDoctor_rptService_Chemist_wise_Detail : System.Web.UI.Page
{
    #region
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblHead.Text = "Chemistswise Service Detail " + strFrmMonth + " " + Year;
    ...
    private void FillReport_1()
    {
        ...
        if (sf_code.Contains("MGR"))
        {
            ...
            sProc_Name = "SP_Get_Chemistwise_EntryDetail_Anlysis";
            ...
            GrdFixation.FooterRow.Cells[0].ColumnSpan = 8;
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 0, "Chemists Name", "#0097AC", true);
            AddMergedCells(objgridviewrow, objtablecell, 0, "Contact", "#0097AC", true);
            AddMergedCells(objgridviewrow, objtablecell, 0, "Address", "#0097AC", true);
            AddMergedCells(objgridviewrow, objtablecell, 0, "Phone", "#0097AC", true);

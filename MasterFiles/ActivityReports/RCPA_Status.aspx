<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RCPA_Status.aspx.cs" Inherits="MasterFiles_ActivityReports_RCPA_Status" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name) {
            ...
            popUpObj = window.open("rptRCPA_Status.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name,
   "ModalPopUp"//,
   //"toolbar=no," +
   //"scrollbars=yes," +
   //"location=no," +
                    ...
                    <div class="col-lg-5">
                        <center>
                            <table>
                                <tr>
                                    <td align="center">
                                        <h2 class="text-center">RCPA - Status</h2>
                                    </td>
                                </tr>
                            </table>
                        </center>

...
public partial class MasterFiles_MR_ListedDoctor_rptListedDr_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["mgr_code"] != null)
        {
           ...
           // dsDoctor = dc.getDoctorMgr_list_view(Request.QueryString["mgr_code"].ToString());
            dsDoctor = dc.getDoctorMgr_list_view_New(Request.QueryString["mgr_code"].ToString());
        ...
        {
            Doctor dc = new Doctor();
            //dsDoctor = dc.getDoctorCategory_list_View(sf_code, catg, terr_code.Trim(), type, div_code);
            dsDoctor = dc.getDoctorCategory_list_View_New(sf_code, catg, terr_code.Trim(), type, div_code);
    ...
    protected void grdDoctor_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            if (dsTerritory.Tables[0].Rows.Count > 0)
            {
              //  e.Row.Cells[14].Text = dsTerritory.Tables[0].Rows[0]["wrk_area_Name"].ToString();

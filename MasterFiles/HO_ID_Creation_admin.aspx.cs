...
public partial class MasterFiles_HO_ID_Creation_admin : System.Web.UI.Page
{
    ...
    private void FillDiv()
    {
        ...
        else
        {
            ...
            chkDivision.DataSource = dsDivision;
            chkDivision.DataBind();
            ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>alert('Please Create Division for the HO User');</script>");
        }
    }

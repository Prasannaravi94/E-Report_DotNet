...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <table>
            <tr>
                <td align="center" style="color:#8A2EE6;font-family:Verdana;font-weight:bold;text-transform: capitalize; font-size: 14px;
                                        text-align: center;">
                    <asp:Label ID="lblHead" runat="server" Text="Doctor Business Entry" Font-Underline="True"
    ...
    <center>
        <table>
                ...
                <td colspan="4" class="stylespc">
                    <table class="mGrid" border="0" style="border-collapse: collapse">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnProdGo" runat="server" Text="Go" CssClass="savebutton" OnClientClick="ValidateProducts();return false;" />
                                <asp:Button ID="btnHdnProd" runat="server" Text="Hidden" OnClick="btnProdGo_Click"
                                    CssClass="savebutton" Style="display: none;" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td colspan="4">
                    <%--<asp:Button ID="btnAdd" runat="server" Text="Add To List" OnClientClick="SubmitForm();return false;"
                        CssClass="savebutton" />
                    <asp:Button ID="btnHdn" runat="server" Text="Hidden" OnClick="btnAdd_Click" CssClass="savebutton"
                        Style="display: none;" />--%>
            ...
            <tr>
                <td colspan="4">
                    <asp:GridView ID="gvDoctorBusiness" runat="server" AutoGenerateColumns="false" OnRowCommand="gvDoctorBusiness_RowCommand"
                        ...
                        CssClass="mGrid">
                        <Columns>
                            <asp:TemplateField HeaderText="Doctor Name" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Speciality" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
            ...
            <tr>
                <td colspan="2">
                    <asp:Button ID="btnSave" runat="server" Width="120px" Text="Draft Save" CssClass="savebutton"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductBulkCreate.aspx.cs"
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkAll1(obj2) {
            ...
            var Chksub = document.getElementById('<%=CheckBoxList1.ClientID %>').getElementsByTagName('input');
            ...
            if (grid != null) {
                ...
                for (i = 2; i < Inputs.length; i++) {
                    if (Inputs[i].type == 'text') {
                        ...
                        if (productName.value != '' || Description.value != '' || Sale.value != '' || group.value != '0' || category.value != '0' || brand.value != '0') {
                            isEmpty = true;
                        }
        ...
        <div>
            ...
            <div class="home-section-main-body position-relative clearfix">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12">
                        <h2 class="text-center">Quick Add - Product Detail</h2>
                        <div class="designation-reactivation-table-area clearfix">
                            <div class="display-table clearfix" align="center">
                                <div class="table-responsive overflow-x-none" align="center" style="scrollbar-width: thin;">

                                    <asp:GridView ID="grdProduct" runat="server" Width="100%" HorizontalAlign="Center" OnRowCreated="grdProduct_RowCreated"
                                        AutoGenerateColumns="false" AllowPaging="True" PageSize="10" GridLines="None"
                                        CssClass="table" PagerStyle-CssClass="gridview1" OnRowDataBound="grdProduct_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Product Code" Visible="false" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">

                                                <ItemTemplate>
                                                    <asp:TextBox ID="Product_Detail_Code" runat="server" onkeypress="AlphaNumeric_NoSpecialChars(event);" CssClass="input" MaxLength="20" Width="60px" Height="40px"
                                            ...
                                            <asp:TemplateField HeaderText="Product Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Product_Detail_Name" runat="server" onkeypress="AlphaNumeric_NoSpecialChars(event);" CssClass="input" MaxLength="50" Width="110px" Height="40px"
                                            ...
                                            <asp:TemplateField HeaderText="Product Description" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Product_Description" CssClass="input" onkeypress="AlphaNumeric_NoSpecialChars(event);" runat="server" Width="110px" Height="40px"
                                                        Text='<%#Eval("descr")%>'></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Sale Unit" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Product_Sale_Unit" CssClass="input" runat="server" Width="60px" Height="40px"
                                                        MaxLength="15" onkeypress="AlphaNumeric(event);" Text='<%#Eval("sale_unit")%>'></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Group" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="Product_Group" runat="server" Width="120px" CssClass="nice-select"
                                            ...
                                            <asp:TemplateField HeaderText="Category" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="Product_Cat_Code" runat="server" Width="120px" CssClass="nice-select"
                                            ...
                                            <asp:TemplateField HeaderText="Brand" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="Product_Brd_Code" runat="server" Width="120px" CssClass="nice-select"
                                            ...
                                            <asp:TemplateField HeaderText="State" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:UpdatePanel ID="updatepanel2" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtstate" runat="server" Text="ALL" CssClass="input" Width="110px" Height="40px"></asp:TextBox>
                                                            ...
                                                            <asp:Panel ID="Panel2" runat="server"
                                                                BorderWidth="1px" BorderColor="#d1e2ea" Direction="LeftToRight" BackColor="#f4f8fa" Style="display: none; border-radius: 8px; overflow-x: auto; height: 250px; scrollbar-width: thin">
                                        ...
                                        <asp:Button ID="Button2" Style="font-family: Verdana; font-size: 7pt; font-weight:bold; width: 25px; background-color:Yellow; 
                                            color: Black; margin-top: -1px;" Text="X" runat="server" OnClick="btnClose_Click"  OnClientClick="HidePopup();" />
                                                                ...
                                                                <asp:CheckBoxList ID="Chkstate" runat="server" CssClass="gridcheckbox" Width="110px"
                                                                    DataTextField="StateName" DataValueField="State_Code" AutoPostBack="True"
                                                                    OnSelectedIndexChanged="Chkstate_SelectedIndexChanged" onclick="checkAll(this);">
                                                                </asp:CheckBoxList>
                                            ...
                                            <asp:TemplateField HeaderText="Sub Division" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:UpdatePanel ID="updatepanel1" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="TextBox1" runat="server" Text="ALL" CssClass="input" Width="145px" Height="40px"></asp:TextBox>
                                                            ...
                                                            <asp:Panel ID="Panel1" runat="server" BorderWidth="1px" BorderColor="#d1e2ea" Direction="LeftToRight" BackColor="#f4f8fa" Style="display: none; border-radius: 8px; overflow-x: auto; height: 150px; scrollbar-width: thin">
                                                                <%--   <div style="height:15px; position:relative; background-color: #4682B4; 
                                        text-transform: capitalize; width:100%; float: left" align="right">
                                        <asp:Button ID="btnsubdiv" Style="font-family: Verdana; font-size: 7pt; font-weight:bold; width: 25px; background-color: Yellow; 
                                            Color: Black; margin-top: -1px;" Text="X" runat="server" OnClick="btnClose_Click"  OnClientClick="HidePopup();" />
                                                                ...
                                                                <asp:CheckBoxList ID="CheckBoxList1" runat="server" Width="145px" CssClass="gridcheckbox"
                            ...
                            <div class="w-100 designation-submit-button text-center clearfix">
                                ...
                                <asp:Button ID="btnClear" CssClass="resetbutton" runat="server"  Text="Clear" OnClick="btnClear_Click" />
                            </div>
                        </div>
                    </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Single_Dr_Analysis.aspx.cs" Inherits="MasterFiles_AnalysisReports_Single_Dr_Analysis" EnableEventValidation="false" %>
...
<head runat="server">
    <title>Single Doctor Analysis</title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp_Miss(sfcode, fmon, fyr, tyear, tmonth, sf_name, drcode, div_code) {

            popUpObj = window.open("rptSingle_Dr_Analysis.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name + " &drcode=" + drcode + " &div_code=" + div_code,
        "ModalPopUp"//,
        //"toolbar=no," +
        //"scrollbars=yes," +
        //"location=no," +
        ...
        //"top=0"
            ...
            $(popUpObj.document.body).ready(function () {
                ...
                var ImgSrc = "https://s29.postimg.org/5mb80p12v/loading-red-spot.gif"

                // var ImgSrc = "https://s9.postimg.org/lr9knv0of/loading_Square.gif";


                $(popUpObj.document.body).append('<div><p style="color:red;">Loading Please Wait ....</p></div><div class="preload"> <img src="' + ImgSrc + '"  style=" width:400px; height: 400px;position: fixed;top: 10%;left: 10%;"  alt="" /></div>');
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                var drname = $('#<%=ddldoctor.ClientID%> :selected').text();
                if (drcode == "---Select---") { alert("Select Doctor Name."); $('#ddldoctor').focus(); return false; }
                ...
                <%--var Year2 = document.getElementById('<%=ddlToYear.ClientID%>').value;
                var Month2 = document.getElementById('<%=ddlToMonth.ClientID%>').value;--%>
                var drcode = document.getElementById('<%=ddldoctor.ClientID%>').value;
                ...
                showModalPopUp_Miss(sf_Code, fromMon, fromYear, ToYear, ToMon, Name, drcode, div_code);
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Single Doctor Analysis</h2>
                        ...
                        <div class="designation-area clearfix">
                            <div class="single-des clearfix">
                                ...
                                <asp:DropDownList ID="ddlFieldForce" runat="server" CssClass="custom-select2 nice-select" Width="100%"
                                    AutoPostBack="true" OnSelectedIndexChanged="ddlFieldForce_SelectedIndexChanged" onchange="showLoader('Search')">
                                </asp:DropDownList>
                            ...
                            <div class="single-des clearfix">
                                <asp:Label ID="lblDr" runat="server" Text="Doctor Name" CssClass="label"></asp:Label>

                                <asp:DropDownList ID="ddldoctor" runat="server" CssClass="custom-select2 nice-select" Width="100%">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <div style="float: right; width: 45%">
                                    <asp:Label ID="lblToMoth" runat="server" Text="To Month-Year" CssClass="label"></asp:Label>

...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <table>
            <tr>
                <td align="center">
                    <asp:Label ID="lblHead" runat="server" Text="Doctor Business Status" Font-Underline="True"
        ...
        <table>
            ...
            <tr>
                <td colspan="4" align="center">
                    <asp:Button ID="btnGo" runat="server" Text="Go" CssClass="savebutton" OnClientClick="return SubmitForm()" 
                        onclick="btnGo_Click" />
                </td>
            </tr>
            <tr>

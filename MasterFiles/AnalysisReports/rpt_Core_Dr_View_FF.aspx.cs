...
public partial class MasterFiles_AnalysisReports_rpt_Core_Dr_View_FF : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "MVD - View For " + "<span style='color:Red'>" + sfname + "</span>" + "  - For The Month Of  : " + "<span style='color:Blue'>" + strFMonthName + " " + FYear + "</span>" + " To " + "<span style='color:Blue'>" + strTMonthName + " " + " " + TYear + "</span>";
    ...
    private void FillSample_Prd()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("Core_DR_View", con);
        ...
        //dsts.Tables[0].Columns.Remove("Fieldforce_Name");
        //   dsts.Tables[0].Columns.Remove("ListedDrCode");
        //dsts.Tables[0].Columns.Remove("sf_code");
        dsts.Tables[0].Columns.Remove("ListedDrCode1");
        //dsts.Tables[0].Columns.Remove("ListedDrCode1");
       // dsts.Tables[0].Columns.Remove("ListedDrCode1");
        //dsts.Tables[0].Columns.Remove("OrderNO");
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            //  AddMergedCells(objgridviewrow, objtablecell, 0, "Campaign", "#0097AC", true);
            ...
            if (months1 >= 0)
            {
                ...
                for (int j = 1; j <= months1 + 1; j++)
                {
                    ...
                    AddMergedCells(objgridviewrow, objtablecell, (dsDes.Tables[0].Rows.Count + 1) * 2, sTxt, "#0097AC", true);
                    ...
                    AddMergedCells(objgridviewrow3, objtablecell3, 0, "Count", "#0097AC", false);
                    AddMergedCells(objgridviewrow3, objtablecell3, 0, "Date", "#0097AC", false);
                    AddMergedCells(objgridviewrow2, objtablecell2, 2, dsDesss.Tables[0].Rows[0]["Designation_Short_Name"].ToString(), "#0097AC", true);

                    if (dsDes.Tables[0].Rows.Count > 0)
                    {
                        for (int k = 0; k < dsDes.Tables[0].Rows.Count; k++)
                        {
                            AddMergedCells(objgridviewrow2, objtablecell2, 2, dsDes.Tables[0].Rows[k]["Designation_Short_Name"].ToString(), "#0097AC", true);
                    ...
                    // AddMergedCells(objgridviewrow, objtablecell, 0, "Work With", "#0097AC", true);
                    cmonth1 = cmonth1 + 1;
                    if (cmonth1 == 13)
                    {
                        cmonth1 = 1;
    ...
    protected void GrdFixation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            for (int s = 0; s < dtrowdt.Rows.Count; s++)
            {
                ...
                {
                    for (int i = 15, m = 1; i < e.Row.Cells.Count; i++)
                    {

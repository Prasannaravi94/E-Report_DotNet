...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        //                    alert("cur_close_bal_cntrl_id :" + $("#" + close_bal_cntrl_id).val());
        ...
        //                                alert("clsbalqty :" + $("#" + close_bal_cntrl_id).val());
    ...
    <script type="text/javascript">
        function qtychange(e) {
            ...
            var pls_cntrl_id = cls_cntrl_id;
            var hid_plusopr = $("#hidPlus").attr('id');
            var hid_plusopr_Val = $("#hidPlus").val();

            var plus_cntrl_id = pls_cntrl_id + hid_plusopr_Val + "_txtSecSale";
            var plus_bal_pos = hid_plusopr_Val;
            var plusbal = $("#" + plus_cntrl_id).attr('id');
            ...
            var hid_opr_plus_cntrl_id;     // operator
            var hid_cur_opr_plus_cntrl_id; // opertor
            var val_plus_cntrl_id = pls_cntrl_id + hid_plusopr_Val + "_txtval";

            var val_plusbal = $("#" + val_plus_cntrl_id).attr('id');

            var pls_pos = hid_plusopr_Val;
            var plusbalqty = 0;
            ...
            if (plusbal != null) {
                for (i = 0; i < parseInt(plus_bal_pos); i++) {
                    ...
                    cur_plus_bal_cntrl_id = $("#" + plus_bal_cntrl_id).val();
                    hid_plus_opr_cntrl_id = pls_cntrl_id + i + "_hidSecSaleOpr";  // opertor     

                    hid_plus_cur_opr_cntrl_id = $("#" + hid_plus_opr_cntrl_id).val();

                    //Calculating Total qty
                    if (parseInt(cur_plus_bal_cntrl_id) > 0) {
                        //If the field is mapped with '+' then add the closing balance with the current value
                        if (hid_plus_cur_opr_cntrl_id == '+') {
                            plusbalqty = parseInt(plusbalqty) + parseInt(cur_plus_bal_cntrl_id);
                            // alert("Calculating Total qty : " + plusbalqty);
                        }
                    }
                }

                $("#" + plusbal).val(plusbalqty);

                if (val_plusbal != null) {
                    var val_plus = (plusbalqty * prate).toFixed(2);
                    $("#" + val_plusbal).val(val_plus);
                }
            ...
            var hid_clopr = $("#hidClBal").attr('id');
            var hid_clopr_val = $("#hidClBal").val();
            var close_cntrl_id = cls_cntrl_id + hid_clopr_val + "_txtSecSale";
            var cls_bal_pos = hid_clopr_val;
            var clsbal = $("#" + close_cntrl_id).attr('id');
            ...
            var val_close_cntrl_id = cls_cntrl_id + hid_clopr_val + "_txtval";
            var val_clsbal = $("#" + val_close_cntrl_id).attr('id');
            ...
            if (clsbal != null) {
                ...
                for (i = 0; i < parseInt(cls_bal_pos); i++) {
                    ...
                    close_bal_cntrl_id = $("#" + cls_cntrl_id + i + "_txtSecSale").attr('id');
                    cur_close_bal_cntrl_id = $("#" + close_bal_cntrl_id).val();

                    hid_close_bal_cntrl_id = $("#" + cls_cntrl_id + i + "_hidSecSalecalc").attr('id');   // Calc needed
                    hid_cur_close_bal_cntrl_id = $("#" + hid_close_bal_cntrl_id).val();    // Calc needed

                    hid_opr_cntrl_id = $("#" + cls_cntrl_id + i + "_hidSecSaleOpr").attr('id');           // opertor
                    hid_cur_opr_cntrl_id = $("#" + hid_opr_cntrl_id).val();    // opertor

                    hid_form_cntrl_id = $("#" + cls_cntrl_id + i + "_hidSSFormula").attr('id');            // Formula
                    hid_cur_form_cntrl_id = $("#" + hid_form_cntrl_id).val();    // Formula

                    hid_ss_code_cntrl_id = $("#" + cls_cntrl_id + i + "_hidSecSaleCode").attr('id');     // sec sale code
                    hid_cur_ss_code_cntrl_id = $("#" + hid_ss_code_cntrl_id).val();    // sec sale code

                    hid_CF_Field_Other = $("#" + cls_cntrl_id + i + "_hidSS_CF_Other").attr('id');     // CF Other Field
                    hid_cur_CF_Field_Other = $("#" + hid_CF_Field_Other).val();    // CF Other Field

                    var hid_cur_CF_Field_Other_val = $("#" + hid_CF_Field_Other).val();


                    if (hid_cur_opr_cntrl_id == "D") {

                        hid_CalculationMode = $("#" + cls_cntrl_id + i + "_hidSS_CalculationMode").attr('id');           // opertor
                        hid_CalculationMode_Val = $("#" + hid_CalculationMode).val();    // opertor

                        //alert("hid_CalculationMode_Val :" + hid_CalculationMode_Val);

                        if ($.trim(hid_CalculationMode_Val) == "D(+)") {

                            $("#" + hid_opr_cntrl_id).val("+");

                        }
                        else if ($.trim(hid_CalculationMode_Val) == "D(-)") {

                            $("#" + hid_opr_cntrl_id).val("-");

                        }
                        else if (hid_CalculationMode_Val == "N") {
                        }
                    }

                    if (hid_cur_CF_Field_Other_val != "") {

                        CF_Field = hid_cur_CF_Field_Other_val;

                        hid_Rep_Cnt_ID = $("#" + cls_cntrl_id + i + "_hid_CF_Rep_Val").attr('id');
                        // Hid_Rec_Cnl_Val = $("#" + hid_Rep_Cnt_ID).val();

                        var CF_Val = parseInt($("#" + hid_Rep_Cnt_ID).val());

                        // alert("CF_Val :" + CF_Val);

                        if (hid_cur_form_cntrl_id != '') {
                            //1 + 2 - 5
                            form_val = 0;

                            arrForm = hid_cur_form_cntrl_id.split(' ');
                                ...
                                if (arrForm[j].length > 0) {
                                    if ((arrForm[j].trim() == '+') || (arrForm[j].trim() == '-')) {
                                        ...
                                        for (clbal_i = 0; clbal_i <= parseInt(cls_bal_pos); clbal_i++) {
                                            ...
                                            form_ss_cntrl_id = $("#" + cls_cntrl_id + clbal_i + "_hidSecSaleCode").attr('id');
                                            form_bal_cntrl_id = $("#" + cls_cntrl_id + clbal_i + "_txtSecSale").attr('id');
                                            cur_form_ss_cntrl_id = $("#" + form_ss_cntrl_id).val();
                                            cur_form_bal_cntrl_id = $("#" + form_bal_cntrl_id).val();


                                            // alert("cur_form_bal_cntrl_id :" + cur_form_bal_cntrl_id);

                                            if (cur_form_ss_cntrl_id.trim() == arrForm[j].trim()) {

                                                if (parseInt(cur_form_bal_cntrl_id) > 0) {

                                                    if (form_val != '') {
                                                        if (form_opr == '+') {
                                                            form_val = form_val + parseInt(cur_form_bal_cntrl_id);
                                                        ...
                                                        if (Cur_CF > 0) {
                                                            form_val = parseInt(Cur_CF) + parseInt(cur_form_bal_cntrl_id);

                                                            // alert("Cur_CF_form_val :" + form_val);
                                                        }
                                                        else {
                                                            form_val = parseInt(cur_form_bal_cntrl_id);

                                                            // alert("form_valElsse :" + form_val);
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        } //End of clbal for loop

                                        //alert("form_val if :" + form_val);

                                        $("#" + close_bal_cntrl_id).val(form_val);

                                        // alert("close_bal_cntrl_id :"+ $("#" + close_bal_cntrl_id).val());
                                ...
                                if (arrForm[j].length > 0) {
                                    ...
                                    if ((arrForm[j].trim() == '+') || (arrForm[j].trim() == '-')) {
                                        ...
                                        for (clbal_i = 0; clbal_i <= parseInt(cls_bal_pos); clbal_i++) {
                                            ...
                                            // alert("cur_form_bal_cntrl_id else:" + cur_form_bal_cntrl_id);
                                            if (cur_form_ss_cntrl_id.trim() == arrForm[j].trim()) {
                                                ...
                                                if (parseInt(cur_form_bal_cntrl_id) > 0) {
                                                    if (form_val != '') {
                                                        ...
                                                        // alert("Elseform_valels :" + form_val);
                                                    }
                                                }
                                            }
                                        } //end for loop
                                        ...
                                        // alert("close_bal_cntrl_id else:" + $("#" + close_bal_cntrl_id).val());
                                    }
                        ...
                        } //End of hid_cur_form_cntrl_id if
                    } //End of hid_cur_CF_Field_Other_val


                    //Calculating Closing Balance
                    // alert('val: ' + cur_close_bal_cntrl_id);

                    var cur_close_bal_cntrl_id = $("#" + close_bal_cntrl_id).val();

                    // alert('val: ' + cur_close_bal_cntrl_id);

                    if (parseInt(cur_close_bal_cntrl_id) > 0) {
                        // Below condition is to check the calculation needed for this field. This is fetched from setup

                        //alert('hid_cur_close_bal_cntrl_id.value : ' + hid_cur_close_bal_cntrl_id.value);
                        if (parseInt(hid_cur_close_bal_cntrl_id) == 1) {
                            //If the field is mapped with '+' then add the closing balance with the current value

                            if (hid_cur_opr_cntrl_id == '+') {
                                //alert('hid_cur_opr_cntrl_id.value : ' + hid_cur_opr_cntrl_id.value);
                                clsbalqty = parseInt(clsbalqty) + parseInt(cur_close_bal_cntrl_id);

                                //  alert("clsbalqty (+): " + clsbalqty);
                            }
                            //If the field is mapped with '-' then subtract the closing balance with the current value
                            else if (hid_cur_opr_cntrl_id == '-') {
                                clsbalqty = parseInt(clsbalqty) - parseInt(cur_close_bal_cntrl_id);
                ...
                } //end og clspos for loop

                //alert('clbal : ' + clsbalqty);
                //alert(' tot+ : ' + plusbalqty);
                if (plusbalqty != null) {
                    $("#" + clsbal).val(clsbalqty - plusbalqty);
                    //   alert("plusbalqty not null: " + clsbal.value); 
                }
                else {
                    $("#" + clsbal).val(clsbalqty);
                    // alert("plusbalqty null: " + clsbal.value); 
                }

                if (plusbalqty != null) {
                    if (val_clsbal != null) {
                        $("#" + val_clsbal).val((clsbalqty - plusbalqty) * prate);
                        $("#" + val_clsbal).val((parseFloat($("#" + val_clsbal).val()).toFixed(2)));
            ...
            var hid_Tot_Order_Cnt = $("#hid_Sec_Sale_Order").attr('id');

            var hid_Order = $("#hid_Sec_Sale_Order").val();

            var hid_tot = parseInt(hid_Order) - 1;

            //alert("hid_tot :" + hid_tot);

            var custcol_cntrl_id = cls_cntrl_id + hid_tot + "_txtSecSale";

            var Cur_Tot_Head_Pos = hid_Order;

            var cust_col_pos = hid_Order;

            var cusCol = $("#" + custcol_cntrl_id).attr('id');
            ...
            var val_cus_col_cntrl_id = cls_cntrl_id + hid_Order + "_txtval";
            var val_cus_col = document.getElementById(val_cus_col_cntrl_id);
            ...
            if (parseInt(cust_col_pos) > parseInt(cls_bal_pos)) {
                ...
                if (hid_Order != "") {
                    ...
                    for (i = 0; i < parseInt(cust_col_pos); i++) {
                        ...
                        cus_col_cntrl_id = $("#" + cls_cntrl_id + i + "_txtSecSale").attr('id');
                        cur_cus_col_cntrl_id = $("#" + cus_col_cntrl_id).val();

                        hid_cus_col_cntrl_id = $("#" + cls_cntrl_id + i + "_hidSecSalecalc").attr('id');                  // Calc needed
                        hid_cur_cus_col_cntrl_id = $("#" + hid_cus_col_cntrl_id).val();   // Calc needed
                                ...
                                if (arrForm[j].length > 0) {
                                    ...
                                    if ((arrForm[j].trim() == '+') || (arrForm[j].trim() == '-')) {
                                        ...
                                        for (clb = 0; clb <= parseInt(hid_tot); clb++) {
                                            ...
                                            form_ss_cntrl_id = $("#" + cls_cntrl_id + clb + "_hidSecSaleCode").attr('id');
                                            form_bal_cntrl_id = $("#" + cls_cntrl_id + clb + "_txtSecSale").attr('id');
                                            cur_form_ss_cntrl_id = $("#" + form_ss_cntrl_id).val();
                                            cur_form_bal_cntrl_id = $("#" + form_bal_cntrl_id).val();
                                        ...
                                        $("#" + cur_cus_col_cntrl_id).val(form_val);
                                    }
   ...
   <%-- <script type="text/javascript">
        ...
        $(document).ready(function () 
        {
            ...
            $("#btn").click(function (e) {
                new popup($("#popup_box"), $("#container"), ProdArry).load();
            });
        ...
        $(document).unload(function () {
            new popup($("#popup_box"), $("#container"), ProdArry).unload();
        });


        function popup(popup, container, ProdArry) {

            var thisPopup = this,
            timer,
            counter = ProdArry.length - 1,
            countDown = $("#CntDown").text(counter.toString());
            ...
            thisPopup.load = function () {
                ...
                timer = setInterval(function () {
                    ...
                    else 
                    {
                        ...
                        $("#ProdCNt").text("Product Loading :" + ProdArry[i]);
                    }
...
<body>
    ...
    <div id="popup_box">
        <!-- OUR PopupBox DIV-->
        <a id="popupBoxClose"><span id="CntDown"></span></a>
        <h1 id="ProdCNt" style="color: Purple; text-align: center; font-size: 14px; font-weight: bold">
        </h1>
    ...
    <div>
        ...
        <center>
            ...
            <center>
              ...
              <%--     <asp:LinkButton ID="btnGo" runat="server" Text="Go" style="text-decoration:none;text-align:center"
                OnClick="btnGo_Click" CssClass="btnReAct btnReActivation" Width="60px" ></asp:LinkButton>--%>
                &nbsp;&nbsp;
                <asp:Button ID="btnClear" runat="server" Text="Clear" Width="60px" CssClass="savebutton"
                    OnClick="btnClear_Click" />

                  <%--  <asp:LinkButton ID="btnClear" runat="server" Text="Clear" style="text-decoration:none;text-align:center"
                OnClick="btnClear_Click" CssClass="btnReAct btnReActivation" Width="60px" ></asp:LinkButton>--%>

            </center>
            <div style="float:right">
            <a href="SecSalesEntry_New.aspx" title="new">New</a>
            </div>
            <br />
            ...
            <asp:Panel ID="pnlSecSale" BorderStyle="Solid" runat="server" Visible="false" CssClass="padd">
                <table id="tblSecSale" border="1px solid" cellpadding="5" cellspacing="5" style="border-collapse: collapse;
                    ...
                    <tr><asp:Repeater ID="rptProduct" runat="server" OnItemDataBound="rptProduct_ItemDataBound">
                        <ItemTemplate>
                            <tr class="rpttr">
            ...
            <asp:Button ID="btn" runat="server" Text="Draft Save" 
              ...
              <%--    <asp:LinkButton ID="btn" runat="server" Text="Draft Save Stockist" style="text-decoration:none;text-align:center"
                OnClick="btn_Click" Visible="false" CssClass="btnReAct btnReActivation" Width="160px" Height="25px" ></asp:LinkButton>--%>
            &nbsp; &nbsp;
            ...
            <%--    <asp:LinkButton ID="btnSubmit" runat="server" Text="Send to Admin" 
                OnClick="btnSubmit_Click" Visible="false" CssClass="btnReAct btnReActivation" style="text-decoration:none;text-align:center"

...
//Added by Preethi
public partial class MasterFiles_Dashboard_Admin_Dashboard : System.Web.UI.Page
{
    #region Declaration
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/Admin_Dashboard.aspx?sf_code=" + sf_code + "&divCode=" + div_code + "&sf_type=" + sf_type);

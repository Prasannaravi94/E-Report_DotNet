    ...
    <div id="Divid" runat="server"></div>
        <div class="home-section-main-body position-relative clearfix">
            ...
            <div class="row justify-content-center ">
                <div class="col-lg-11">
                    <h2 class="text-center">Hospital Creation</h2>
                            ...
                            <div class="table-responsive" style="scrollbar-width: thin;overflow:inherit;">
                               ...
                               <br />
                                <table runat="server" id="tblChemist" width="80%">
                                    <tr>
                                        <td valign="top" style="width: 100%;overflow:inherit;" align="right">
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="grdHospital" runat="server" Width="100%" HorizontalAlign="Center"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Hospital Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Hospital_Name" runat="server" onkeypress="AlphaNumeric_NoSpecialChars(event)" CssClass="input" MaxLength="250" Width="250px" Height="45px" Text='<%#Eval("Hospital_Name")%>'></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Address" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Hospital_Address1" runat="server" CssClass="input" MaxLength="250" Width="250px" Height="45px" Text='<%#Eval("Hospital_Address1")%>' onkeypress="AlphaNumeric(event);"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Contact Person" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Hospital_Contact" runat="server" CssClass="input" onkeypress="AlphaNumeric_NoSpecialChars(event)" MaxLength="250" Width="190px" Height="45px" Text='<%#Eval("Hospital_Contact")%>'></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Phone" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Hospital_Phone" runat="server" onkeypress="CheckNumeric(event);" CssClass="input" MaxLength="250" Width="150px" Height="45px" Text='<%#Eval("Hospital_Phone")%>'></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Territory" HeaderStyle-HorizontalAlign="Center">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList ID="ddlTerr" runat="server" CssClass="nice-select" Width="150%" Height="45px" DataSource="<%# FillTerritory() %>" DataTextField="Territory_Name" DataValueField="Territory_Code">
                                                                        </asp:DropDownList>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

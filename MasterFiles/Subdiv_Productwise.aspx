<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subdiv_Productwise.aspx.cs" Inherits="MasterFiles_Subdiv_Productwise" %>
...
<head runat="server">
    <title>Subdivision - Productwise View</title>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12">
                        <h2 class="text-center">Subdivision - Productwise View</h2>
                        <div class="designation-reactivation-table-area clearfix">
                            <div class="display-name-heading text-center clearfix">
                                <div class="d-inline-block division-name">
                                    <asp:Label ID="lblProduct" runat="server" Text="Sub Division Name"></asp:Label>
                                </div>
                                <div class="d-inline-block align-middle">
                                    <div class="single-des-option">
                                        <asp:DropDownList ID="ddlProduct" CssClass="nice-select" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="text-align: center">
                                <asp:Button ID="btnProduct" runat="server" Text="Go" CssClass="savebutton"
                                ...
                                <div class="table-responsive overflow-x-none" align="center">
                                    ...
                                    <asp:GridView ID="grdProduct" runat="server" Width="100%" HorizontalAlign="Center"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Product Code" SortExpression="Product_Detail_Code" Visible="false">
                                                <ItemTemplate>

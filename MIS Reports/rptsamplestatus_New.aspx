<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptsamplestatus_New.aspx.cs" Inherits="MIS_Reports_rptsamplestatus_New" %>
 ...
 <script src="../JsFiles/jquery-1.10.1.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sfname) {
            ...
            popUpObj = window.open("rptsamplestatus_New2.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sfname=" + sfname,
     "_blank",
    "ModalPopUp," +
    "toolbar=no," +
    "scrollbars=yes," +
    ...
    <div>
        ...
        <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                   <td align="center">
                            <asp:Label ID="lblHead" runat="server" Text="Sample Despatch Status for the month of " ForeColor="#794044"
        ...
        <center>
            ...
            <asp:Label ID="lblNoRecord" runat="server" Width="60%" ForeColor="Black" BackColor="AliceBlue"
                ...
                <asp:GridView ID="grdDespatch" runat="server" Width="90%" HorizontalAlign="Center"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sample_Input_Modify_MRWise_Rpt.aspx.cs" Inherits="MIS_Reports_Sample_Input_Modify_MRWise_Rpt" %>
                ...
                <div class="row justify-center">
                    <div class="col-lg-12">
                        <div class="designation-reactivation-table-area clearfix">
                                ...
                                DataTextField="Product_Detail_Name" DataValueField="Product_Code_SlNo">
                            </asp:DropDownList>
                            <br />
                                                ...
                                                <ItemTemplate>
                                                   <%-- <asp:Label ID="lblprd_Name" runat="server" Text='<%#Eval("Product_Detail_Name")%>'></asp:Label>--%>
                                                    ...
                                                    <asp:DropDownList ID="ddlState" runat="server"  DataSource="<%# FillState() %>"
                                                        DataTextField="Product_Detail_Name" DataValueField="Product_Code_SlNo"></asp:DropDownList><%--CssClass="custom-select2 nice-select"--%>
                                                </ItemTemplate>
                                            </asp:TemplateField>

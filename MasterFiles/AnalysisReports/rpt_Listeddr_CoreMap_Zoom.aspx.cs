...
public partial class MasterFiles_AnalysisReports_rpt_Listeddr_CoreMap_Zoom : System.Web.UI.Page
{
     #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Manager - Core Doctor Details for the month of  " + strFrmMonth + " " + FYear;
      ...
      private void FillReport()
    {
       ...
       int cyear = Convert.ToInt32(FYear);
        ...
        sProc_Name = "Listeddr_Core_Map_Vst_Zoom_New";
    ...
    protected void GrdFixation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            for (int i = 11, m = 0; i < e.Row.Cells.Count; i++)
            {
                string strConn = System.Configuration.ConfigurationManager.ConnectionStrings["Ereportcon"].ToString();
                SqlConnection con = new SqlConnection(strConn);

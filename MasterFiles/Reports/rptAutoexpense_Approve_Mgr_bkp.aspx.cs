...
public partial class MasterFiles_Reports_rptAutoexpense_Approve_Mgr : System.Web.UI.Page
{
    ...
    {
        Distance_calculation dv = new Distance_calculation();
        dsSubDivision = dv.getSfReporting(divcode, ddlSubdiv.SelectedValue.ToString());
        ...
        if (mainTable.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < dt1.Rows.Count; i++)
            {
                ...
                grdSalesForce.Columns[6 + i].HeaderText = dt1.Rows[i]["Expense_Parameter_Name"].ToString();

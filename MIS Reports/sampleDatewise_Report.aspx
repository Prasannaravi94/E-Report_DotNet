<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sampleDatewise_Report.aspx.cs" Inherits="MIS_Reports_sampleDatewise_Report" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, sf_name, FromDate, ToDate) {
            popUpObj = window.open("sampledesDatewiseZoom.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&FromDate=" + FromDate + "&ToDate=" + ToDate,
     //"_blank",
    "ModalPopUp,"// +
    //"toolbar=no," +
    //"scrollbars=yes," +

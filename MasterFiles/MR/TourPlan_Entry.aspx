    ...
    <div>   
        ...
        <center>
            ...
            <table>
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="btnSave" CssClass="savebutton" runat="server" Width="80px" Text="Draft Save" OnClick="btnSave_Click" OnClientClick="return DraftValidateEmptyValue()" />
                        &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnSubmit" CssClass="savebutton" Width="170px" runat="server" Text="Send to Manager Approval"

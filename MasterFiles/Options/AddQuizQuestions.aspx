<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddQuizQuestions.aspx.cs"
...
<head id="Head1" runat="server">
    ...
    <script src="../../JScript/Service_CRM/Quiz_JS/PreviewQuiz_JS.js" type="text/javascript"></script>
</head>
<body>
                    ...
                    <div class="col-lg-11">
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdSurveyQuestions" runat="server" OnRowCreated="grdSurveyQuestions_RowCreated"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Question_Id" HeaderText="Code" Visible="false"></asp:BoundField>
                        ...
                        <ItemStyle BorderColor="LightGray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                                            ...
                                            <asp:TemplateField HeaderText="Question">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:TextBox ID="txtQuestion" Visible='<%# IsInEditMode %>' Style="height: 100px !important;" CssClass="input" runat="server" Text='<%# Eval("Question_Text") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                        ...
                        <ItemStyle BorderColor="LightGray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                                ...
                                <div class="w-100 designation-submit-button text-center clearfix">
                                    <br />
                                    <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="savebutton" OnClick="btnEdit_Click" />

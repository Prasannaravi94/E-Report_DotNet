                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="designation-area clearfix">
                            <div class="single-des clearfix">
                                <asp:Label ID="lblSt" runat="server" CssClass="label" Text="Super Stockiest"></asp:Label>
                                <asp:DropDownList ID="ddlst" CssClass="custom-select2 nice-select" runat="server">
                                </asp:DropDownList>
                            </div>
                            <div class="single-des clearfix">

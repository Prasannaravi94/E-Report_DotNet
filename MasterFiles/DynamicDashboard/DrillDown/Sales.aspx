<%@ Page Title="" Language="C#" MasterPageFile="~/MasterFiles/DynamicDashboard/Layout.master" AutoEventWireup="true" CodeFile="Sales.aspx.cs" Inherits="MasterFiles_DynamicDashboard_DrillDown_Sales" %>
...
<script>
    ScrollableTable("Mytable", {
        remoteUrl: "./DrillDownWebService.asmx/Sales",

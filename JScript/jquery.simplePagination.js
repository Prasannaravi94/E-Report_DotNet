        ...
        _appendItem: function (pageIndex, opts) {
            ...
            if (pageIndex == o.currentPage || o.disabled) {
                ...
                if (options.text == "Next") {
                    ...
                    $link = $('<span class="current" style="display:none">' + (options.text) + '</span>');
                ...
                $link.click(function (event) {
                    if ((options.text) == "Next") {
                        ...
                        var grid = document.getElementById("grdPreviewQuestion");

                        for (i = pageIndex; i < grid.rows.length; i++) {
                            ...
                            && grid.rows[i].getElementsByTagName("input")[0].type == "radio") {
                                ...
                                && grid.rows[i].getElementsByTagName("input")[3].checked == false) {
                                    //alert('Please select any one option.');


                                    var txt = "Please select any one option";

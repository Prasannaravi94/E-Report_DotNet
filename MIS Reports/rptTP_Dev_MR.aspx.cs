...
public partial class MIS_Reports_rptTP_Dev_MR : System.Web.UI.Page
{
    ...
    private void FillDeviation()
    {
        ...
        dsSalesForce = sal.TP_DeviationMR_New(divcode, sfCode, Convert.ToInt16(FMonth), Convert.ToInt16(FYear));

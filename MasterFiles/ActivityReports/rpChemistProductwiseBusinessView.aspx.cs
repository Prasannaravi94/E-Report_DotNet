...
public partial class MIS_Reports_dcview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Chemist_Productwise_Business_for_" + strFMonthName + "_" + FYear + "_" + "To" + "_" + strTMonthName + "_" + TYear;
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = ch.rpChPrBus_value(drFF["sf_code"].ToString(), divcode, cmonth, cyear);

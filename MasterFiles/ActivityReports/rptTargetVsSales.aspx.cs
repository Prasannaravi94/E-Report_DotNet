...
public partial class MasterFiles_ActivityReports_rptTargetVsSales : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Target Vs Sales Report From " + strFrmMonth + " " + FYear + " to " + " " + strToMonth + " " + " " + TYear;
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Product Name", "#F1F5F8", true);
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Pack", "#F1F5F8", true);
            // AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Rate", "#F1F5F8", true);
            ...
            for (int i = 0; i <= months1; i++)
            {
                ...
                AddMergedCells(objgridviewrow, objtablecell, 0, 5, sTxt, "#F1F5F8", true);


                AddMergedCells(objgridviewrow2, objtablecell2, 0, 2, "Target", "#F1F5F8", false);
                ...
                AddMergedCells(objgridviewrow2, objtablecell2, 0, 2, "Sale", "#F1F5F8", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Qty", "#F1F5F8", false);
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Value", "#F1F5F8", false);

                AddMergedCells(objgridviewrow2, objtablecell, 2, 1, "Achieve (%)", "#F1F5F8", false);
            ...
            if (dtrowClr.Rows[indx][1].ToString() == "Grand Total")
            {
                ...
                for (int l = 3, j = 1; l < e.Row.Cells.Count; l++, j++)
                {
                    ...
                    if (j % 5 == 0)
                    {
                        ...
                        double a2 = 0;
                        double a3 = 0;
                        if (e.Row.Cells[l - 1].Text == "" || e.Row.Cells[l - 1].Text == "&nbsp;" || e.Row.Cells[l - 1].Text == null)
                        {
                            e.Row.Cells[l - 1].Text = "0";
                        }
                        if (e.Row.Cells[l - 3].Text == "" || e.Row.Cells[l - 3].Text == "&nbsp;" || e.Row.Cells[l - 3].Text == null)
                        {
                            e.Row.Cells[l - 3].Text = "0";
                        }
                        a1 = Convert.ToDouble(e.Row.Cells[l - 1].Text);
                        a2 = Convert.ToDouble(e.Row.Cells[l - 3].Text);
                        a3 = Math.Round((a1 / a2) * 100, 2);
                        e.Row.Cells[l].Text = a3.ToString();
                    }

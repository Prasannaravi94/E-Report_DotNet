...
public partial class MasterFiles_AnalysisReports_rpt_Listeddr_Period_MGR : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Visit - Based on Baselevels/Managers for the month of  " + strFrmMonth + " " + FYear + "  To  " + strToMonth + " " + TYear;
    ...
    private void FillReport()
    {
        ...
        sProc_Name = "Listeddr_Period_MGR";

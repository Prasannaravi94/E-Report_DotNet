...
public partial class MasterFiles_Options_Chemists_Upload : System.Web.UI.Page
{
    ...
    private void InsertData()
    {
        ...
        for (int i = 0; i < Dt.Rows.Count; i++)
        {
            ...
            dslstDR = lstDR.GetTerritory_Code(columns[7].Trim(), ddlFilter.SelectedValue);
            ...
            if ((columns[1].Trim() != "" && columns[1].Trim() != null))
            {
                ...
                if (dslstDR.Tables[0].Rows.Count == 0)
                {
                    string strQry = "insert into Mas_Territory_Creation (Territory_Code,Territory_Name,Territory_Cat,Territory_Sname,division_code, " +
                        ...
                        " VALUES('" + terrcode + "', '" + columns[7].Trim() + "' ,'1', null, " +
                ...
                sql += "VALUES('" + Chemists_Code + "', '" + ddlFilter.SelectedValue + "','" + columns[1].Trim() + "', '" + columns[2] + "', '" + columns[3] + "','" + columns[4] + "','" + columns[5] + "',0, '" + StrTerritory_Code + "',0,'" + div_code + "',getdate())";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.ExecuteNonQuery();

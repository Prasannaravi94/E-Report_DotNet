<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTargetFixationValueView.aspx.cs" Inherits="MIS_Reports_dcview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Target_Fixation_Valuewise_Entry_View</title>
    <meta charset="utf-8">
                ...
                <div class="col-lg-12">
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            ...
                            <div align="center">
                                <br />
                                <asp:Label ID="lblHead" runat="server" Text="Target Fixation Valuewise Entry View" CssClass="reportheader"></asp:Label>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <table width="100%">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <table width="100%" align="center">
                            ...
                            <tr>
                                <td align="left">
                                    <asp:Label ID="lblIdRegionName" Text="Field ForceName :" runat="server" CssClass="label"></asp:Label>

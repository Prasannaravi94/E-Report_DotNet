...
public partial class MasterFiles_Dashboard_Visit_Datewise : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MIS%20Reports/rptVisitDetail_Datewise.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&FYear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text +  "&div_code=" + div_code + "&mode="+1+"&checkmatrix="+0+"&ddlmatrix=''");

...
public partial class MIS_Reports_Product_Exp_Detail_Unlisted : System.Web.UI.Page
{
        ...
        else
        {
            if (FYear <= TYear)
            {
                ...
                if (ddlprod.SelectedValue != "-1")
                {
                    ...
                    {
                        sURL = "rptProduct_Exp_Detail.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + FMonth.ToString() + "&FYear=" + FYear.ToString() + "&TMonth=" + TMonth.ToString() + "&TYear=" + TYear.ToString() + "&Prod=" + ddlprod.SelectedValue.ToString() + "&Prod_Name=" + ddlprod.SelectedItem.Text.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString();
                    }
                    else
                    {
                        sURL = "rptProduct_Exp_Detail.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + FMonth.ToString() + "&FYear=" + FYear.ToString() + "&TMonth=" + TMonth.ToString() + "&TYear=" + TYear.ToString() + "&Prod=" + ddlprod.SelectedValue.ToString() + "&Prod_Name=" + ddlprod.SelectedItem.Text.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString();
                ...
                else
                {
                    ...
                    if (ddlprod.SelectedIndex > 0)
                    {
                        ...
                        else
                        {
                            ...
                            sURL = "rptProduct_Exp_Detail.aspx?sfcode=" + ddlMR.SelectedValue.ToString() + "&FMonth=" + FMonth.ToString() + "&FYear=" + FYear.ToString() + "&TMonth=" + TMonth.ToString() + "&TYear=" + TYear.ToString() + "&Prod=" + ddlprod.SelectedValue.ToString() + "&Prod_Name=" + ddlprod.SelectedItem.Text.ToString() + "&sf_name=" + ddlMR.SelectedItem.Text.ToString();
                        }
                    }
                    else
                    {
    ...
    protected void ddlprod_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlprod.SelectedValue == "-1")
        {
          ...
          //  dsSalesForce = sf.UserList_getMR(div_code, ddlFieldForce.SelectedValue.ToString());
            dsSalesForce = sf.AllMR_withNOVacant(div_code, ddlFieldForce.SelectedValue.ToString());
            if (dsSalesForce.Tables[0].Rows.Count > 0)
            {
                lblMR.Visible = true;
                ddlMR.Visible = true;

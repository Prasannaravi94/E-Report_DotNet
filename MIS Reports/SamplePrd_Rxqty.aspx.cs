...
public partial class MIS_Reports_SamplePrd_Rxqty : System.Web.UI.Page
{
    ...
    //                sURL = "rptSampleGift_details.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString();
    ...
    private void FillSample()
    {
        ...
        {
            dsChkinput = dr.getSamplePrd_Brand(div_code);
            chksample.DataSource = dsChkinput;
            chksample.DataTextField = "Product_Brd_Name";
            chksample.DataValueField = "Product_Brd_Code";
            chksample.DataBind();
            setValueToChkBoxList();
        }
    ...
    //{
    //    string input = "";
    //    for (int iIndex = 0; iIndex < chkinput.Items.Count; iIndex++)
    //    {
    //        if (chkinput.Items[iIndex].Selected == true)
    //        {
    //            input += chkinput.Items[iIndex].Value + ",";

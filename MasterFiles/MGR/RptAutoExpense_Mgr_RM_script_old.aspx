...
//              //alert($et);
          ...
          //}
             ...
             if (isNaN(tempTotFare)) tempTotFare = 0;

             alert(rowDis + "::" + tempTotFare);
             totDist = totDist + rowDis;
             totFare = totFare + tempTotFare;
         }
        ...
        if (isNaN(oldDist)) oldDist = 0;
        if (isNaN(oldT)) oldT = 0;
       ...
       var  $grndTot = document.getElementById("grandTotalName");
        ...
        if (isNaN(totFareVal)) totFareVal = 0;

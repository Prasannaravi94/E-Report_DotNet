    ...
    $["ajax"]({
        ...
        success: function (variable_0) {
            if (variable_0["d"]["length"] > 0) {
                ...
                variable_1 += "<th style=\"width:34px\"><input type=\"checkbox\" id=\"chkHead\" class=\"selectAll\"  onchange=\"checkAll(this)\"/><label for=\"chkHead\" text=\".\"/></th>";
                variable_1 += "<th style=\"width:33px\">#</th>";
                variable_1 += "<th style=\"width:270px\">Field Force Name</th>";
                variable_1 += "<th style=\"width:130px\">HQ</th>";
                variable_1 += "<th style=\"width:10px\">Designation</th>";
                variable_1 += "<th style=\"width:167px\">State</th>";
                variable_1 += "<th style=\"display:none\">SF Code</th>";
                variable_1 += "</tr></thead>";
                variable_1 += "<tbody>";
                for (var variable_2 = 0; variable_2 < variable_0["d"]["length"]; variable_2++) {
                    variable_1 += "<tr>";
                    if (variable_0["d"][variable_2]["ChkBox"] == "True") {
                        variable_1 += "<td style=\"width:50px;color:Blue;text-decoration: line-through\"><input type=\"checkbox\" class = \"chcktbl\" disabled=\"disabled\" style=\"display:none;border-color:Red;\"  id=\"delit_" + variable_0["d"][variable_2]["RowNo"] + "\" /><label for=\"delit_" + variable_0["d"][variable_2]["RowNo"] + "\" text=\".\"/></td>";
                        ...
                        variable_1 += "<td style=\"width:50px\"><input type=\"checkbox\" class = \"chcktbl\" id=\"delit_" + variable_0["d"][variable_2]["RowNo"] + "\" /><label for=\"delit_" + variable_0["d"][variable_2]["RowNo"] + "\" text=\".\"/></td>";
            ...
            success: function (variable_0) {
                if (variable_0["d"]["length"] > 0) {
                    ...
                    for (var variable_2 = 0; variable_2 < variable_0["d"]["length"]; variable_2++) {
                        variable_1 += "<tr>";
                        if (variable_0["d"][variable_2]["ChkBox"] == "True") {
                            variable_1 += "<td style=\"width:50px;color:Blue;text-decoration: line-through\"><input type=\"checkbox\" class = \"chcktbl\" disabled=\"disabled\" style=\"display:none;border-color:Red;\"  id=\"delit" + variable_0["d"][variable_2]["RowNo"] + "\" /></td>";
                            variable_1 += "<td style=\"width:50px;color:Blue;text-decoration: line-through\">" + variable_0["d"][variable_2]["RowNo"] + "</td>";
                            variable_1 += "<td id=\"SFName\" style=\"width:250px;color:Blue;text-decoration: line-through\">" + variable_0["d"][variable_2]["FieldForceName"] + "</td>"
                        } else {
                            variable_1 += "<td style=\"width:50px\"><input type=\"checkbox\" class = \"chcktbl\" id=\"delit_" + variable_0["d"][variable_2]["RowNo"] + "\" /><label for=\"delit_" + variable_0["d"][variable_2]["RowNo"] + "\" text=\".\"/></td>";

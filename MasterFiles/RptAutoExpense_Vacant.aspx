<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAutoExpense_Vacant.aspx.cs" Inherits="MasterFiles_MR_RptAutoExpense" %>
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
    <script type="" language="javascript">
        function TerritoryView(sfCode, divCode) {
            window.open("Territory_View.aspx?sfCode=" + sfCode + "&divCode=" + divCode, 'ModalPopUp');
        }
        function sfcView(sfCode, divCode) {
            // alert("sss");
            window.open("/../masterfiles/Reports/Distance_fixation_view.aspx?sfCode=" + sfCode + "&divCode=" + divCode, 'ModalPopUp');
        }
...
<td align="center" style="font-weight:bold" width="50%" ><h2 class="text-center">Expense Statement For The month of <span style="background-color:yellow;color:red" id="mnthtxtId" runat="server"></span>-<span style="background-color:yellow;color:red" id="yrtxtId" runat="server"></span></h2></td>
...
<font class="print" style="color:blue;cursor:pointer;font-weight:bold"><a onclick="sfcView(sfCode.value,divCode.value)"><b>SFC View</b></a></font>&nbsp;&nbsp;&nbsp;
 ...
 <table align="center" width="100%">
<tr>
<td align="left"  style="font-weight:bold;font-size:small; width:35%;" id="fieldforceId" runat="server"></td>
...
<tr>
<td align="left"  style="font-weight:bold;font-size:small; width:35%;" id="DivId" runat="server"></td>
<td align="center" style="font-weight:bold;font-size:small;" id="StsId" runat="server"></td>
<td align="right" style="font-weight:bold;font-size:small;" id="Confirmdt" runat="server"></td>
</tr>
</table></div>
...
<br />
        ...
        <asp:Button ID="btnDrftSave" runat="server"  CssClass="savebutton" Width="80px" Height="25px"
            ...
            Text="Send To HO" Visible="true" OnClientClick="saveOtherExp()" OnClick="btnSave_Click" />
             <p align="right"><asp:Button ID="bakfldfrce" runat="server" CssClass="savebutton" Width="130px" Height="25px"
            Text="BacK To FieldForce" Visible="true" OnClientClick="return validate();" OnClick="btnField_Click" /></p>
    </center>
    </div>
    </div>

...
public partial class Reports_rptRoutePlanStatus : System.Web.UI.Page
{
    ...
    private void FillPlan()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            tc_SF_Name.Attributes.Add("class", "stickyFirstRow");
            ...
            tc_SF_HQ.Attributes.Add("class", "stickyFirstRow");
            ...
            tc_SF_TotDr.Attributes.Add("class", "stickyFirstRow");
            Literal lit_DR_TotDr = new Literal();
            lit_DR_TotDr.Text = "<center>Total Drs</center>";
            ...
            tc_SF_NoPlans.Attributes.Add("class", "stickyFirstRow");
            tc_SF_NoPlans.HorizontalAlign = HorizontalAlign.Center;
            Literal lit_DR_NoPlans = new Literal();
            lit_DR_NoPlans.Text = "<center>No of Plans</center>";
            ...
            tc_SF_AlCDrs.Attributes.Add("class", "stickyFirstRow");
            tc_SF_AlCDrs.HorizontalAlign = HorizontalAlign.Center;
            Literal lit_DR_AlCDrs = new Literal();
            lit_DR_AlCDrs.Text = "<center>Allocated Drs</center>";
            ...
            tc_SF_NotAlCDrs.Attributes.Add("class", "stickyFirstRow");
            tc_SF_NotAlCDrs.HorizontalAlign = HorizontalAlign.Center;
            Literal lit_DR_NotAlCDrs = new Literal();
            lit_DR_NotAlCDrs.Text = "<center>Not Allocated Drs</center>";

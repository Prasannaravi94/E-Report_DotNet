...
<body class="bodycss">
    ...
    <asp:Panel ID="pnlContents" runat="server" Width="100%">
     <center> <font size="3" face="Verdana, Arial, Helvetica, sans-serif"><b>TABLETS INDIA LIMITED <p> <span id="divid" runat="server"></span>  DIVISION <p> TRAVEL EXPENSES STATEMENT  FOR THE MONTH OF <span id="mnthtxtId" runat="server"></span>-<span id="yrtxtId" runat="server"></span><span id="iddNtTot" runat="server" style="position:absolute;padding:10px;border:solid 1px #000000;text-align:right;top:33px;right:5%;font-family:Times New Roman;font-weight:bold;font-size:50px;"></span></b></font></center>
<br /> 
 ...
 <div id="MainId1" runat="server" visible="true">
  <table align="center" width="100%">
<tr>
<td align="left"   style="font-weight:bold;font-size:14px;white-space:pre" id="fieldforceId" runat="server"></td>
<td align="center" style="font-weight:bold;font-size:14px;white-space:pre" id="empId" runat="server"></td>
    <td align="center" style="font-weight:bold;font-size:14px;white-space:pre" id="hqdesig" runat="server"></td>
    <td align="right" style="font-weight:bold;font-size:14px;white-space:pre" id="hqid" runat="server"></td>
    <td align="right" style="font-weight:bold;font-size:14px;white-space:pre" id="mgrName" runat="server"></td>
    </tr>
      <tr height="10px"></tr>
      <tr>
...
<td style="width:50px"><asp:Label runat="server"  name="excesfare" id="excesfare"  value=""></asp:Label></td>
<td><asp:Label  name="OthExpRmk" id="excesremks" runat="server" value=""></asp:Label></td>
 </tr>
                            <tr>
                
<td align="center" style="white-space:pre">Excess Allowance of Previous Month</td>

<td style="width:50px"><asp:Label  runat="server"  name="excesallw" id="excesallw"  value="" ></asp:Label></td>
<td><asp:Label  name="OthExpRmk" runat="server" id="excesallwrmks" value="" ></asp:Label></td>
 </tr>
                            </table>
                </td>
                    </tr>
...
<br />
 ...
 <asp:GridView ID="adminExpGrid" runat="server"  Width="60%" Font-Name="Verdana"  Font-Size="8pt" 
            HeaderStyle-BackColor="#FFEFD5"
            HeaderStyle-ForeColor="black" HorizontalAlign="Center"
                                AutoGenerateColumns="false" EmptyDataText="No Records Found" GridLines="None"
                                PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
...
<br />
<table width="90%" border="1" align="center" id="rmks">

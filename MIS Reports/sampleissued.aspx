<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sampleissued.aspx.cs" Inherits="MIS_Reports_sampleissued" %>
...
//        }
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sfname) {
            ...
            popUpObj = window.open("samplemr.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sfname=" + sfname,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
        ...
        <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                    ...
                    <asp:Label ID="lblHead" Text="Sample Despatch Status" SkinID="lblMand" 

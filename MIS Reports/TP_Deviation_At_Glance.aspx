<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TP_Deviation_At_Glance.aspx.cs" Inherits="MIS_Reports_TP_Deviation_At_Glance" %>
...
<head runat="server">
    <title>TP - Deviation - At a Glance</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name) {
            ...
            popUpObj = window.open("rptTP_Dev_atglance_new.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name,
   "ModalPopUp",
   //"toolbar=no," +
   //"scrollbars=yes," +
   //"location=no," +
   ...
   //"top=0"
            ...
            $(popUpObj.document.body).ready(function () {
                ...
                var ImgSrc = "https://s15.postimg.org/3z6o1o9wb/design_800p.gif"
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">TP - Deviation - At a Glance</h2>

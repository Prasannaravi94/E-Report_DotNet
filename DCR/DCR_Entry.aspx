...
<head runat="server">
   ...
   <%-- <script src="../JsFiles/DCR_Entry.js" type="text/javascript"></script>--%>
     <script src="../JsFiles/DCR_Entry_New_1.0.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name) {
            ...
            popUpObj = window.open("../MIS Reports/rptsamplestatus_New_New_DCR.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name,
   "ModalPopUp",
   "toolbar=no," +
   "scrollbars=yes," +
   "location=no," +
   ...
   "top=0"
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp_Input(sfcode, fmon, fyr, tmon, tyr, sf_name) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("../MIS Reports/rptInputstatus_New_New_DCR.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name,
   "ModalPopUp",
   "toolbar=no," +
   "scrollbars=yes," +
   "location=no," +
   ...
   "top=0"
    ...
    <style>
        #tProd .ddl-Drop .ddl-results .active-result label, #tInput .ddl-Drop .ddl-results .active-result label {
...
<body class="loading">
    ...
    <form id="frm" runat="server">
        ...
        <div class="pad HDBg">
            <a href="#" class="button mnu-bt" onclick="toggleMenu()"><i class="fa fa-bars"></i></a><a runat="server" id="aHome" class="button home-bt">Home</a><a runat="server" id="aIS" class="button home-bt">IS</a><a runat="server" id="aSS" class="button home-bt">SS</a>
            <div class='hCap'>Daily Calls Report For :
                <div runat="server" class="highlightor" id="SFInf"></div>
                -
                <div id="DtInf" runat="server" class="dtDisp"></div>
            </div>
            <div>
                <marquee onmouseover="this.setAttribute('scrollamount', 0, 0);" onmouseout="this.setAttribute('scrollamount', 6, 0);"><asp:Label ID="lblFlash" runat="Server"  ForeColor="Brown" Font-Size="16px" Font-Names="Tahoma"  Text='<%# Eval("FN_Cont1") %>' /></marquee>
            </div>
        </div>
        <div id="mnuWrapr">
            <div class="aside active">
                <div class="sidebar">
                    <div class="WTplcH">
                        <span class="mnuLblCap">Work Type</span>
                        <asp:DropDownList ID="ddl_WorkType" onchange="ChangeWT()" class="ddlBox green" runat="server" Style="display: block; width: 100%;">
                            <asp:ListItem Text="Select the Work Type"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <ul id="mnuTab"></ul>
                    <a href="#" class="button button-green submit-bt FSubmit" onclick="DCR.validDCR()">Final Submit</a>
                </div>
            </div>
            <div id="WorkArea" class="Work-Area active">
                <div id="planer">
                    ...
                    <div class="plnPlholder">
                        ...
                        <asp:DropDownList ID="ddl_SDP" onchange="srtCusTwbs(this);" class="ddlBox" runat="server" data-PM_Visit="PM_Visit">
                        </asp:DropDownList>
                    </div>
                    <div class="plnDeivate">
                        <table>
                            <tr>
                                <td>
                                    <input type="checkbox" id="chkDeviate" name="Deviate" value="Deviate" onchange="chkActivate(this)" />
                                    <span runat="server" id="SpnDeviate" class="lblCap lblSDP">Deviate</span>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <a href="#" class="button button-green submit-bt1 FSubmit" onclick="DCR.validDCR()">Final Submit</a>
                </div>
                <div id="working-Area">
                </div>
                ...
                <div id="wProd" class="wind-o">
                    <table class="fg-group TBH">
                        <tr>
                            <th w="280">Product</th>
                            <th w="80" id="idTPQH">
                                <asp:Label ID="lblSampleQty" runat="server" Text=""></asp:Label></th>
                            <th w="80" class="TPVH" id="idTPVH">
                                <asp:Label ID="lblQty" runat="server" Text=""></asp:Label></th>
                            <th w="130" class="PRxH">Feedback</th>
                    ...
                    <div class="wScroll">
                        <table id='tProd' class="fg-group TBD">
                            <tr>
                                ...
                                <td id="idtPQ">
                                    <input type="number" class="tPQ" name="tPQ" min="0" maxlength="2" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></td>
                                <td id="idtPV">
                                    <input type="number" class="tPV" name="tPV" value="0" min="0" maxlength="7"></td>
                                <td>
                                    <div class="ddl-Box PRx" data-inwidth="200px" data-value="" data-text="- Select the Rx Feedback -" data-src="d_Rxs" data-vf='id' data-tf='name'></div>
                                </td>
                ...
                <div id="wInput" class="wind-o">
                    <table class="fg-group TBH">
                        <tr>
                            <th w="280">Input</th>
                            <th w="80">Qty</th>
                            <th w="40"><a href="#" class="button go-bt" onclick="addRow('tInput')">+</a></th>
                        </tr>
                    </table>
                    <div class="wScroll">
                        <table id="tInput" class="fg-group TBD">
                            <tr>
                                <td>
                                    <div class="ddl-Box search" data-value="" data-text="- Select the Input -" data-src="d_Input" data-vf='id' data-tf='name'></div>
                                </td>
                                <td>
                                    <input type="number" class="tGQ" name="tGQ" min="0" maxlength="2" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></td>
                                <td><a href="#" class="button button-red go-bt" onclick="delRow(this)">-</a></td>
                            </tr>
                        </table>
                    </div>
                ...
                <div id="wRem" class="wind-o" style="padding: 5px 1px">
                    <table class="fg-group">
                        ...
                        <tr>
                            <td>
                                <div id="ddl_fedBk" class="ddl-Box" style="width: 100%;" data-value="" data-text="- Select the Call Feedback -" data-src="d_fedbk" data-vf='id' data-tf='name'></div>
                            </td>
                        </tr>
                        <tr>
                            <th>Remarks</th>
                        ...
                        <tr>
                            <td>
                                <textarea id="tCusRem" style="display: block; width: 380px; height: 200px"></textarea></td>
                        </tr>

                    </table>
                    <a href='#' class='button button-green go-bt' onclick="svWinVal(event)" style="margin: 0px 5px;">Save</a>
                </div>
                <div id="wHalf" class="wind-o" style="padding: 5px 1px">

                    <div>HalfDay Work</div>
                    <div id="tCusHalf" style="padding: 2px; overflow: auto;">
                        <asp:CheckBoxList class="bor" ID="ddl_check" runat="server">
                        </asp:CheckBoxList>
                    </div>
                    ...
                    <div class="cntnr">
                        ...
                        <table class="fg-group">
                            <tr>
                                <td>Name</td>
                                <td colspan="3">
                                    <input type="text" value="" id="tNwCus" />
                                </td>
                            </tr>
                            <tr>
                                <td>Address</td>
                                <td colspan="3">
                                    <input type="text" value="" id="tNwAdd" />
                                </td>
                            </tr>
                            <tr>
                                <td class="lblSDP">SDP</td>
                                <td colspan="3">
                                    <div id="ddl_Ntwn" class="ddl-Box search" data-value="" data-text="- Select -" data-src="d_twns" data-vf='id' data-tf='name'></div>
                                </td>
                            </tr>
                            <tr class="drE">
                                <td>Category</td>
                                <td>
                                    <div id="ddl_NCat" class="ddl-Box search" data-value="" data-text="- Select -" data-src="d_Cat" data-vf='id' data-tf='name'></div>
                                </td>
                                <td>Specialty</td>
                                <td>
                                    <div id="ddl_NSpc" class="ddl-Box search" data-value="" data-text="- Select -" data-src="d_Spec" data-vf='id' data-tf='name'></div>
                                </td>
                            </tr>
                            <tr class="drE">
                                <td>Class</td>
                                <td>
                                    <div id="ddl_NCla" class="ddl-Box search" data-value="" data-text="- Select -" data-src="d_Cla" data-vf='id' data-tf='name'></div>
                                </td>
                                <td>Qual.</td>
                                <td>
                                    <div id="ddl_NQua" class="ddl-Box search" data-value="" data-text="- Select -" data-src="d_Qua" data-vf='id' data-tf='name'></div>
                                </td>
                            </tr>
                        </table>
        ...
        <asp:HiddenField ID="hTerrType" runat="server" />
        <asp:HiddenField ID="hSRem" runat="server" />
        ...
        <script type="text/javascript">
            _C = {
                ...
                cus: { id: 'cus', cap: 'Customer', w: '250', src: 'd_cus', df: '-- Customer --', val: '', ty: 'ddl-Box search', iw: '300', adf: 'TCd,TNm,sf,prd_clrcode' },
            ...
            __Menu = {
                ...
                A: { name: 'Halfday', key: 'A', ic: 'commenting', imp: 1 },

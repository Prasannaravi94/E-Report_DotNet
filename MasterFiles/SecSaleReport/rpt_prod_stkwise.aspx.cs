...
public partial class MasterFiles_SecSaleReport_rpt_prod_stkwise : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("Sec_Product_Stk_stwise", con);
            ...
            if (months1 >= 0)
            {
                ...
                for (int j = 1; j <= months1 + 1; j++)
                {
                    ...
                    foreach (DataRow dr in dtrowdt.Rows)
                    {
                        ...
                        //{
                        iColSpan += 2;
                        AddMergedCells(objgridviewrow2, objtablecell2, 0, 2, dr["Name"].ToString(), "#0097AC", false);
                    ...
                    AddMergedCells(objgridviewrow, objtablecell, 0, iColSpan, sf.getMonthName(cmonth1.ToString()).Substring(0, 3) + " - " + cyear1, "#0097AC", true);
                    cmonth1 = cmonth1 + 1;
                    if (cmonth1 == 13)
                    {
                        cmonth1 = 1;

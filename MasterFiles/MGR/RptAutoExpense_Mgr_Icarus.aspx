<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAutoExpense_Mgr_Icarus.aspx.cs" Inherits="MasterFiles_MR_RptAutoExpense" %>
                    ...
                    <tr>
                        <td align="right">
                            ...
                            HeaderStyle-BackColor="#FFEFD5" HeaderStyle-CssClass="mainGrid" HeaderStyle-VerticalAlign="Middle" HeaderStyle-ForeColor="black"  HorizontalAlign="Center"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="From and To" ItemStyle-HorizontalAlign="Left">
                                     ...
                                     <asp:TemplateField HeaderText="Fare</br>(in Rs/-)" ItemStyle-HorizontalAlign="Left">
                                        ...
                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="#9AA3A9"></HeaderStyle>
                                        <ItemTemplate><asp:TextBox ID="txtFare" onkeyup="onFareChange(this);" visible="false" onkeypress="CheckNumeric(event);" width="30" runat="server" Text='<%# Bind("Fare") %>'></asp:TextBox><asp:Label ID="lblFare" runat="server" Text='<%# Bind("Fare") %>'></asp:Label><asp:HiddenField ID="fareHidden" runat="server" Value='<%# Bind("Fare") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="#9AA3A9"></HeaderStyle>
                                    <ItemTemplate>
                                        <asp:TextBox runat="server" ID="txtaddexp" onkeyup="onaddExpChange(this);" Text='<%# Bind("rw_amount") %>' onkeypress="CheckNumeric(event);"
                                ...
                                <asp:TemplateField HeaderText="Remarks ( 50 Char )" ItemStyle-HorizontalAlign="Left" Visible="true">
                                    <ControlStyle></ControlStyle>
                                    <ItemStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="#9AA3A9" HorizontalAlign="center">
                                    </ItemStyle>
                                    <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="#9AA3A9"></HeaderStyle>
                                    <ItemTemplate>
                                        <asp:TextBox runat="server" ID="txtrmks" Text='<%# Bind("rw_rmks")%>' onkeypress="AlphaNumeric_NoSpecialChars(event);" Width="150"></asp:TextBox>
...
//    }
    ...
    function _CalDist($x, TotDist, fare) {
        ...
        else if ("FA" == type || "FF" == type || "FD" == type) {

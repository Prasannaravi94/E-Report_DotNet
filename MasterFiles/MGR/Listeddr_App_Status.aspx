...
<head runat="server">
    <title>Listed Doctor Approval - Status</title>
    <%--<style type="text/css">
        .modal
        {
            position: fixed;

...
<ul>
    <li><a href="../../../../MasterFiles/MR/ListedDoctor/LstDoctorView.aspx" onclick="ShowProgress();">Listed Doctor</a></li>
    ...
    <li><a href="../../../../MasterFiles/MR/UnListedDoctor/Unlisteddr_Terr_View.aspx" onclick="ShowProgress();">Unlisted Doctor</a></li>
</ul>
    </li>         
 	<li><a href="#">Approvals &raquo;</a>
<ul>
	<li><a href="../../../../MasterFiles/MGR/ListedDR_Add_Approve.aspx" onclick="ShowProgress();">Listed Dr Addition</a></li>
	<li><a href="../../../../MasterFiles/MGR/ListedDR_DeActivate_Approve.aspx" onclick="ShowProgress();">Listed Dr DeActivation</a></li>
    ...
    <li><a href="../../../../MasterFiles/Reports/rptAutoexpense_Approve.aspx" onclick="ShowProgress();">Expense</a></li>
</ul>						
	</li>
    ...
    <li><a href="../../../../MasterFiles/MGR/Listeddr_App_Status.aspx" onclick="ShowProgress();">Listed Doctor Approval Status</a></li>
    <li><a href="../../../../MasterFiles/MGR/Convert_Unlistto_Listeddr.aspx" onclick="ShowProgress();">Unlisted Dr Convert to Listed Dr</a></li>  
</ul>
	</li>
	<li><a href="#">Activities &raquo;</a>
<ul>
    <li><a href="#">
        <asp:Label ID="lblRoute" Text="Route Plan" runat="server"></asp:Label>&raquo;</a>                       
<ul>
...
<ul> 		
	...
	<%--<li><a href="../../../../MasterFiles/MGR/TourPlan_Calen.aspx" onclick="ShowProgress();">Edit</a></li>--%>
	...
	<li><a href="../../../../MasterFiles/Report/TP_Consolidated_View.aspx" onclick="ShowProgress();">Consolidated View</a></li>  		
</ul>						
	</li>
...
<ul>
    ...
    <li><a href="../../../../MasterFiles/MGR/RptAutoExpense_MGR.aspx" onclick="ShowProgress();">Expense Entry</a></li>
...
<ul>
    <li><a href="../../../../MasterFiles/Reports/DoctorList_Reportaspx.aspx" onclick="ShowProgress();"> View</a></li>
    <li><a href="../../../../MasterFiles/Reports/MR_Status_Report.aspx" onclick="ShowProgress();">Status</a></li>
</ul>
    </li>              
    <li><a href="../../../../MasterFiles/AnalysisReports/Missed_Call.aspx" onclick="ShowProgress();"> Missed Call</a></li>
	<li><a href="#">Analysis &raquo;</a>
<ul>
    <li><a href="../../../../MIS Reports/DCR_Analysis.aspx" onclick="ShowProgress();">DCR</a></li>
    <li><a href="../../../../MasterFiles/AnalysisReports/Mgr_Coverage.aspx" onclick="ShowProgress();">HQ - Coverage wise</a></li>
    <li><a href="../../../../MasterFiles/AnalysisReports/Coverage_Analysis.aspx" onclick="ShowProgress();">Coverage - I</a></li>                     
	<li><a href="../../../../MasterFiles/AnalysisReports/Coverage_Analysis_2.aspx" onclick="ShowProgress();"> Coverage - II</a></li>
    <li><a href="../../../../MasterFiles/AnalysisReports/JointWk_Analysis.aspx" onclick="ShowProgress();">Joint Work</a></li>
	<li><a href="../../../../MasterFiles/Reports/CallAverage.aspx" onclick="ShowProgress();">Call Average </a></li>
    <li><a href="../../../../MasterFiles/Reports/frmWorkTypeStatusView.aspx" onclick="ShowProgress();">Work Type wise</a></li>
    <li><a href="../../../../MIS Reports/Visit_Month_Vertical_Wise.aspx" onclick="ShowProgress();">Visit Analysis</a></li>
</ul>
    </li>
    <li><a href="#">Visit Details &raquo;</a>
<ul>                    
    <li><a href="../../../../MasterFiles/AnalysisReports/Visit_Details_Cat_Cls_Spclty_LstDr_Wise.aspx" onclick="ShowProgress();">Cat/Cls/Splty/LstdDr Wise </a></li>   
    <li><a href="../../../../MIS Reports/VisitDetail_Datewise.aspx" onclick="ShowProgress();">Datewise</a></li>
    <li><a href="../../../../MasterFiles/AnalysisReports/Listeddr_View_Period.aspx"  onclick="ShowProgress();">Doctorwise(Periodically)</a></li>      
    <li><a href="../../../../MasterFiles/AnalysisReports/Callfeedback_Pobwise.aspx" onclick="ShowProgress();">Call Feedbackwise</a></li>                   
    <li><a href="../../../../MIS Reports/Visit_Details_Fixation.aspx" onclick="ShowProgress();"> Fixationwise(By Visit)</a></li>
    <li><a href="../../../../MIS Reports/Visit_Details_Basedon_ModeWise.aspx" onclick="ShowProgress();">Based on Modewise</a></li>
    <li><a href="../../../../MIS Reports/Visit_Details_At_a_Glance.aspx" onclick="ShowProgress();"> at a Glance</a></li>
</ul>
    </li>
    <li><a href="#">Secondary Sales &raquo;</a>
<ul>
    <li><a href="../../../../MasterFiles/Reports/SecSalesReport.aspx" onclick="ShowProgress();">View</a></li>
    <li><a href="../../../../MasterFiles/Reports/Sec_Sales_Stockiest.aspx" onclick="ShowProgress();">Entry Status</a></li> 
</ul>                
    </li>      
...
<ul>
    ...
    <li><a href="../../../../MIS Reports/Territory_Format.aspx" onclick="ShowProgress();"> ListedDr - Productwise Visit</a></li>
    
</ul>                       
    </li>               
    <li><a href="#">Campaign &raquo;</a>
<ul>
    <li><a href="../../../../MIS Reports/ListeddrCamp_View.aspx" onclick="ShowProgress();">View</a></li>
    <li><a href="../../../../MasterFiles/Reports/Campaign_View.aspx" onclick="ShowProgress();">Status</a></li>   
</ul>
    </li>
    <li><a href="#">Exception &raquo;</a>
<ul>
    <li><a href="../../../../MIS Reports/TP_Deviation.aspx" onclick="ShowProgress();">Tour Plan</a></li>  
</ul>
    </li>
</ul>
    </li>

        ...
        <div>
            ...
            <table width="100%" align="center">
                <tbody>
                    <tr>
                        <td align="center">
                            <asp:GridView ID="grdTP" runat="server" Width="80%" HorizontalAlign="Center" EmptyDataText="No Records Found" 
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="#">
                                   ...
                                   <asp:TemplateField  HeaderText="Fieldforce Name" ItemStyle-HorizontalAlign="Left" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblsf_name" runat="server" Width="200px" Text='<%#Eval("Sf_Name")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

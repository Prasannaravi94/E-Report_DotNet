<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Primary_Product_Bill_View.aspx.cs" Inherits="MasterFiles_AnalysisReports_rpt_Primary_Product_Bill_View" %>
                                    ...
                                    <div class="table-responsive" style="scrollbar-width: thin;">
                                        <asp:Panel ID="Panel1" runat="server">
                                            <asp:GridView ID="GrdFixation" runat="server" AlternatingRowStyle-CssClass="alt"
                                                ...
                                                GridLines="Both" HorizontalAlign="Center" OnRowCreated="GrdFixation_RowCreated"

                                ...
                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="A1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Reports</a>
                                    ...
                                    <ul id="lireports" runat="server" class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        ...
                                        <li id="liFS" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Reports/MR_Status_Report.aspx"
                                            onclick="ShowProgress();">Doctor and Chemist Master</a></li>
                                        <li id="liCall" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Reports/CallAverage.aspx"
                                            onclick="ShowProgress();">Drs Met/Visit and Call Average</a></li>
                        ...
                        Territory view</a></li>
                                ...
                                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="A3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Options</a>
                                    <ul id="lioption" runat="server" class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        ...
                                        <li id="liStkDmp" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Stockist_HQFF_Dump.aspx" onclick="ShowProgress();">Stockist Dump </a></li>
										<li id="li3" runat="server"><a class="dropdown-item" href="../../../../MIS Reports/ColorSetting.aspx" onclick="ShowProgress();">Color setting</a></li>
                                   <li id="li5" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Bank_Details.aspx" onclick="ShowProgress();">Bank Details</a></li>
                                        <li id="Lisaindump" runat="server"><a class="dropdown-item" href="../../../../MIS Reports/Sample_Input_Issued_Calendar_Yearwise.aspx" onclick="ShowProgress();">Sample/Input Dump</a></li>

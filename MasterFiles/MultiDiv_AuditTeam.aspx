...
<body>
       ...
       <table width = "80%">
            <tr>
                <td colspan="2" align="right">
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="btnGo" runat="server" Width="30px" Height="25px" Text="Go" onclick="btnGo_Click" CssClass="savebutton" Visible="false"/>
                </td>
            </tr>            
      </table>        
    ...
    <div class="div_fixed">
        <asp:Button ID="btnSubmit" runat="server" CssClass="savebutton" Width="70px" Height="25px" Text="Update" Visible = "false" onclick="btnSubmit_Click"/>
    </div>

...
public partial class MasterFiles_Reports_New_rpt_DCR_Status_Datewise_Det : System.Web.UI.Page
{
    ...
    private void CreateDynamicTable()
    {
        ...
        if (ViewState["dsSalesForce"] != null)
        {
            ...
            TableCell tc_DOJ = new TableCell();
            tc_DOJ.BorderStyle = BorderStyle.Solid;
            tc_DOJ.BorderWidth = 1;
            tc_DOJ.Width = 600;
            Literal lit_DOJ = new Literal();
            lit_DOJ.Text = "<center>Date of<br>Join</center>";
            tc_DOJ.Controls.Add(lit_DOJ);
            tr_header.Cells.Add(tc_DOJ);
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                TableCell tc_det_Date_of_join = new TableCell();
                Literal lit_det_Date_of_join = new Literal();
                lit_det_Date_of_join.Text =  drFF["UsrDfd_UserName"].ToString();
                tc_det_Date_of_join.RowSpan = 2;
                tc_det_Date_of_join.Width = 110;
                tc_det_Date_of_join.BorderStyle = BorderStyle.Solid;
                tc_det_Date_of_join.BorderWidth = 1;
                tc_det_Date_of_join.Controls.Add(lit_det_Date_of_join);
                //tc_det_SNo.Height = 10;
                tr_det.Cells.Add(tc_det_Date_of_join);
                //tr_det.Height = 10;
                ...
                //dsSf = sf1.CheckSFNameVacant_Temp(drFF["sf_code"].ToString(), Convert.ToInt16(dtDCRfrom.ToString("MM")), Convert.ToInt16(dtDCRfrom.ToString("yyyy")));
                ...
                //if (sf_name.Contains("Vacant"))
                //{
                //    lit_det_FF.Text = "&nbsp;" + sf_name;
                //}
                //else
                //{
                ...
                //    //if (dsSf.Tables[0].Rows[0][2].ToString() != "")
                //    //{
                //    //    lit_det_FF.Text  = "<span style='color: red;'> " + dsSf.Tables[0].Rows[0].ItemArray.GetValue(2) + " </span>";
                ...
                lit_det_User_Name.Text =  drFF["Sf_Joining_Date"].ToString();
                ...
                if (dsDCR.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow datarow in dsDCR.Tables[0].Rows)
                    {
                        ...
                        do
                            ...
                            if ((sDCR.Trim() != "L") && (sDCR.Trim() != "LP") && (sDCR.Trim() != "") && (sDCR.Trim() != "R"))
                            {
                                tot_No_of_Days += 1;
                            }

                            if (sDCR.Trim() == "L" || sDCR.Trim() == "LP")
                            {
                                tot_No_of_Leave += 1;
                            }

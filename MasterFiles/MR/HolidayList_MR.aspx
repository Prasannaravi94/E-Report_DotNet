<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HolidayList_MR.aspx.cs" Inherits="MasterFiles_MR_HolidayList_MR" %>
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-1">
                                        <asp:Button ID="btnGo" runat="server" CssClass="savebutton"

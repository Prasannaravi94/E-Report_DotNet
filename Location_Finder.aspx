...
<body>
    <form id="form1" runat="server">
        ...
        <table id="tbMain">
            <tr>
                <td colspan="3" valign="top" style="height: 1%; background-color: #f1f1f1; border-bottom: solid 1px #cacaca">
                    <div class="pad HDBg">
                        <a href="#" class="button mnu-bt" onclick="toggleMenu()"><i class="fa fa-bars"></i></a><a runat="server" href="BasicMaster.aspx" id="aHome" class="button home-bt">Home</a><div class='hCap' style="width: 300px; overflow: hidden;">Location Finder</div>
                        <div class='hCap' id="spWT" style="width: 230px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"></span></div>
                    ...
                    <div id="mvstDet" style="display: block; height: 90.5%; white-space: nowrap; font-weight: bold; border: solid 1px #000; border-radius: 0px 0px 5px 5px; border-top-width: 0px;">
                        ...
                        <div style="display: block; background: #dcdcdc;">
                            <table style="width: 100%; color: black; font: 10px tahoma; font-weight: bold">
                                <tr>
                                    <td style="padding: 5px;">Tot.POB (value) : <span id="tpval" style="color: Green"></span></td>
                                    <td style="padding: 5px;">Tot.POB (Ltrs) : <span id="tltrs" style="color: Green"></span></td>
                                </tr>
                            </table>
                        </div>
                    </div>
        ...
        <script type="text/javascript" src="treeView/js/jquery.smoothdivscroll-1.3-min.js"></script>
        ...
        <script type="text/javascript">
            ...
            function Callback(DtTm, movMark) {
                ...
                if (!DtTm) DtTm = selDt;
                KMTot = 0;
                $.get("/server/old/db.php?axn=get/track&SF_Code=" + $("#selSF").val() + "&Dt=" + DtTm + "",
                    function (response) {
                        if (movMark == true) {
            ...
            getMyTP = function (TPDt) {
                ...
                $('#spDis').html("");
                $('#spRT').html("");
                $.get("/server/old/db.php?axn=get/mytp&SF_Code=" + $("#selSF").val() + "&Dt=" + TPDt + "",
                    function (response) {

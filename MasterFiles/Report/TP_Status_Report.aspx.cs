...
public partial class Reports_TP_Status_Report : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string sURL = "rptTPStatus.aspx?state_code=" + ddlState.SelectedValue.ToString() + "&vacant=" + chkVacant.Checked + "&cur_month=" + MonthVal.ToString() + "&cur_year=" + YearVal.ToString() + "&Option=" + rdoMGRState.SelectedValue +
            "&sf_code=" + ddlMR.SelectedValue + "&sf_name=" + ddlMR.SelectedItem.Text;

...
public partial class MasterFiles_Reports_TP_Reject_Report : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "TP Reject View From "  + strFrmMonth + "- " + FYear;
        FillDCR();
    }
    ...
    {        
        ...
        dsDCR = dr.getTP_Rej_Report(div_code,FMonth, FYear, sf_code);

...
background: #FFEFD5; /* Old browsers */
    ...
    <script type="" language="javascript">
        ...
        function sfcView(sfCode, divCode) {
            // alert("sss");
            window.open("/../masterfiles/Reports/Distance_fixation_view_new_1.aspx?sfCode=" + sfCode + "&divCode=" + divCode, 'sfcView', 'left=0,top=0,width=800,height=500,tollbar=0,scrollbars=1,status=0,resizable=yes');
        }
...
<td colspan="8" align="right">
            ...
            HeaderStyle-ForeColor="black" HorizontalAlign="Center"
                                ...
                                <AlternatingRowStyle CssClass="alt"></AlternatingRowStyle>
                                <Columns>
                                     <asp:TemplateField HeaderText="Fixed Expenses" ItemStyle-HorizontalAlign="Left">
                                        <ControlStyle ></ControlStyle>
...
//        }
    ...
    function onAllowTypeComboChange($e, flag, type) {
        ...
        $R.cells[4].children[1].value = allType;
        wbtyp = $R.cells[8].children[0].value;
        //alert(wbtyp);
        var oldAllow = parseFloat($R.cells[5].children[1].value.replace(/,/g, ''));
        var oldlc = parseFloat($R.cells[6].children[0].innerHTML.replace(/,/g, ''));
        var oldRowTot = parseFloat($R.cells[12].children[0].innerHTML.replace(/,/g, ''));
       ...
       // $optionEle.options[$optionEle.selectedIndex].text = "Without Bill";
        ...
        var newlc = "0";
        if (allType == "OS")
            newlc = parseFloat($R.cells[6].children[0].innerHTML.replace(/,/g, ''));
        else
            newlc = 0;
        //alert(newlc);
        ...
        $R.cells[7].children[0].innerHTML = oldRowTotlc - oldAllow + newAllow - oldlc + newlc;
        $R.cells[7].children[1].value = oldRowTotlc - oldAllow + newAllow - oldlc + newlc;

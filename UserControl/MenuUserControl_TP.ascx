<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MenuUserControl_TP.ascx.cs" Inherits="UserControl_MenuUserControl_TP" %>
                                        ...
                                        <ul id="ulMas" runat="server" class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            ...
                                            <li id="ulliMas" runat="server" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">SubDivision </a>
                                                <ul id="ululMas" class="dropdown-menu" runat="server">
                                                    ...
                                                    <li id="li3000" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/ActivityMasterList.aspx"
                                                            onclick="ShowProgress();">Activity - Master</a></li>
                                                    <li id="li31pro" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Processing_Activity.aspx"
                                                            onclick="ShowProgress();">Processing Activity</a></li>
                                                        <li id="li42" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/ActivityReport.aspx"
                                            ...
                                            <li id="ulliProd" runat="server" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Product </a>
                                                <ul id="ululProd" class="dropdown-menu" runat="server">
                                                    ...
                                                    <li id="li30" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/MR/ProductRate_Mnthwise.aspx"
                                            ...
                                            <li id="Li15" runat="server" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Chemist </a>
                                                <ul id="ul4" class="dropdown-menu" runat="server">
                                                    ...
                                                    <li id="li7" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Chemist_Campaign/ChemistCampaignList.aspx"
                        ...
                        onclick="ShowProgress();">Doctor - Service CRM</a></li>--%>
                                ...
                                HQ Map</a></li>--%>
                                            ...
                                            <li id="ulliExpense" runat="server" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Expense </a>
                                                <ul id="ululExpense" class="dropdown-menu" runat="server">
                                                    ...
                                                    <li id="li28" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Territory_SFC_Download.aspx"
                                                        onclick="ShowProgress();">SFC Download(MR)</a></li>
                                                    <li id="li26" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Territory_SFC_Download_mgr.aspx"
                           ...
                           <li id="ex_setup"><a href="../../../../MasterFiles/Options/Expense_Setup.aspx" onclick="ShowProgress();">
                            ...
                            onclick="ShowProgress();">CRM - Approval - Status</a></li>   --%>
                                    ...
                                    <li id="Act" class="nav-item dropdown" runat="server"><a class="nav-link dropdown-toggle" href="#" id="A2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">Activities </a>
                        ...
                        <li><a href="#">View</a></li>
                                            ...
                                            <li id="ulliApp" runat="server" class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Approvals </a>
                                                <ul id="ululApp" class="dropdown-menu" runat="server">
                                                    ...
                                                    <li id="liA5" visible="false" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Leave_Admin_Approval.aspx"
                        ...
                        <ul>
                            ...
                            <li><a href="../../../../MasterFiles/Reports/rptExp_Consolidated_View.aspx"
                                onclick="ShowProgress();">Consolidated View</a></li>
                                            ...
                                            <li id="ulliDocBus" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Doctor Business </a>
                                ...
                                View</a></li>--%>
                                                    ...
                                                    <li id="liA8" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/ActivityReports/DoctorProductBusinessView.aspx"
                                                        onclick="ShowProgress();">View</a></li>
                                                    <li id="li3011" runat="server"><a class="dropdown-item" href="../../../../MIS Reports/Prescriber_report.aspx"
                        ...
                        <ul>
                            ...
                            <li><a href="../../../../MasterFiles/ActivityReports/InputDespatchHQStatus.aspx"
                                onclick="ShowProgress();">Status</a> </li>--%>
                                            ...
                                            <li id="Li35" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Payslip</a>
                                                <ul id="ul1" class="dropdown-menu" runat="server">
                                                    <li id="li37" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Options/Payslip.aspx"
                                                        onclick="ShowProgress();">
                                                        <asp:Label ID="Label3" runat="server" Text="View"></asp:Label>
                                                    </a></li>
                                                    <li id="li38" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Options/Payslip_Status.aspx"
                                                        onclick="ShowProgress();">Status</a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li id="ulliTP" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Tour Plan </a>
                                                <ul id="ululTP" class="dropdown-menu" runat="server">
                                                    ...
                                                    <li id="liAR5" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Report/TP_Status_Report.aspx"
                                                        onclick="ShowProgress();">Status</a></li>
                                                    <li id="li20" runat="server"><a class="dropdown-item" href="../../../../MIS Reports/TourPlan_Datewise.aspx"
                                        ...
                                        <ul id="ulmis" runat="server" class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            ...
                                            <li id="ulliRprt" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Report </a>
                                                <ul id="ululRprt" class="dropdown-menu" runat="server">
                                                    ...
                                                    <li id="li33" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Spcltywise_Coverage_Analysis.aspx"
                                                        onclick="ShowProgress();">Spclty Wise Coverage Analysis </a></li>
                                                    <li id="li40" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/SS_Inventory_Prodwise.aspx"
                                                    ...
                                                    <li id="li43" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/SS_ALL_Dump_Multi_Mnth.aspx"
                                            ...
                                            <li id="Li48" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Digital Detailing </a>
                                                <ul id="ul2" class="dropdown-menu" runat="server">
                                                    <li id="li49" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/ActivityReports/Detaildrs_Visit.aspx"
                                                        onclick="ShowProgress();">Visit wise </a></li>
                                                    <li id="li54" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/ActivityReports/Brdwise_Star_Rating.aspx"
                                                        onclick="ShowProgress();">Brand wise Star Rating</a></li>
                                                    <li id="li50" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/ActivityReports/Dashboard_DDSlide.aspx"
                                ...
                                onclick="ShowProgress();">Visit At A Glance</a></li>--%>
                                                    <li id="liMis8" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Analysis_Pob_count.aspx"
                                                        onclick="ShowProgress();">Drs/Chemists POB Report</a></li>
                                ...
                                onclick="ShowProgress();">Sales Details</a></li>--%>
                                         ...
                                         <ul id="ul16" class="dropdown-menu" runat="server">
                                               ...
                                               <li id="liMc30" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Missed_Call.aspx"
                        ...
                        <li><a href="#">Productwise</a></li>--%>
                                            ...
                                            <li id="ullicore" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">MVD </a>
                                                <ul id="ul5" class="dropdown-menu" runat="server">
                                                    ...
                                                    <li id="li29" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Core_drs_Status.aspx"
                                                        onclick="ShowProgress();">Status</a></li>
                                                    <li id="li32" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Core_drs_Speclty_wise.aspx"
                            ...
                            <li><a href="../../../../MIS Reports/Territory_Format.aspx" onclick="ShowProgress();">
                                ...
                                onclick="ShowProgress();">Leave</a></li>--%>
                                                    ...
                                                    <li id="liMis68" runat="server"><a class="dropdown-item" href="../../../../MIS Reports/Mail_Status.aspx"
                                                      ...
                                                      <li id="li14new" runat="server"><a class="dropdown-item" href="../../../../MIS Reports/Missed_DCR_Status.aspx"
                                            ...
                                            <li id="ulliDump" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Dump </a>
                                                <ul id="ululDump" class="dropdown-menu" runat="server">
                                                    ...
                                                    <li id="li14" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/SS_ALL_Dump_New_NRV.aspx"
                                                    ...
                                                    <li id="li22" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Chemists_Dump.aspx"
                                                        onclick="ShowProgress();">Chemist</a></li>
                                                    <li id="li25" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/Campaign_Dump.aspx"
                                           ...
                                           <li id="ullidump2" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Dump-II</a>
                                            ...
                                            <li id="Li1sum" class="dropdown-submenu" runat="server" visible="false"><a class="dropdown-item dropdown-toggle" href="#">Summary</a>
                                                <ul id="ul3" class="dropdown-menu" runat="server">
                                                    <li id="li23" runat="server" visible="false"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/DCR_Dump.aspx"
                                                        onclick="ShowProgress();">Day Wise Report</a></li>
                                                    <li id="li27" runat="server" visible="false"><a class="dropdown-item" href="../../../../MasterFiles/AnalysisReports/DCR_Dump_Detail.aspx"
                                ...
                                Mobile Apps Setting</a></li>--%>
                                            ...
                                            <li id="ulliUpld" class="dropdown-submenu" runat="server"><a class="dropdown-item dropdown-toggle" href="#">Upload </a>
                                                <ul id="ululUpld" class="dropdown-menu" style="left: -100%; width: 100%" runat="server">
                                                    ...
                                                    <li id="li34" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Options/Gift_Upload.aspx"
                                                    ...
                                                    <li id="li17" runat="server"><a class="dropdown-item" href="../../../../MasterFiles/Options/frmBrandWiseSlidesUpd.aspx"
                                                        onclick="ShowProgress();">
                                                        <asp:Label ID="lblSlide" runat="server" Text="Slides Upload"></asp:Label></a></li>

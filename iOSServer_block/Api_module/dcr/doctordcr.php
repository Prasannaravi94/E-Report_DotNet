...
function doctordcr( $ARCd, $Prods, $ProdsNm, $Inps, $InpsNm, $JWWrk, $JWWrkNm, $GC, $GN, $GQ, $StockNm, $data ) {
    ...
    $query = "exec ios_svDCRLstDet_App_Edet '" . $ARCd . "',0,'" . $data[ 'sfcode' ] . "',1,'" . $data[ 'CustCode' ] . "','" . $data[ 'CustName' ] . "','" . $data[ 'vstTime' ] . "','" . $DCSUPOB . "','" . $JWWrk . "','" . $JWWrkNm . "','" . $Prods . "','" . $ProdsNm . "','','','" . $GC . "','" . $GN . "','" . $GQ . "','" . $Inps . "','" . $InpsNm . "','','".str_replace("'","",$data['Remarks'])."','" . $DivCode[ 0 ] . "','" . $Drcallfeedbackcode . "','" . $data[ 'ModTime' ] . "','" . $loc[ 0 ] . "','" . $loc[ 1 ] . "','" . $data[ 'Rsf' ] . "','NA','" . $data[ 'Mod' ] . "','" . $data[ 'town_code' ] . "','" . $data[ 'town_name' ] . "','0','','','','','" . $StockNm . "','" . $data[ 'sample_validation' ] . "','" . $data[ 'input_validation' ] . "'";

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_SecSale_Report_Stockistwise.aspx.cs" Inherits="MasterFiles_AnalysisReports_rpt_SecSale_Report_Stockistwise" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#GrdFixation tr:last-child').each(function () {
                ...
                $(this).children('td').css('font-size', '14px');
            });
        });
    </script>

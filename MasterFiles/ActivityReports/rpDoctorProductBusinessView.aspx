<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpDoctorProductBusinessView.aspx.cs" Inherits="MIS_Reports_dcview" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, sf_name, cyear, cmonth, sCurrentDate, basadOn) {
            popUpObj = window.open("rpDoctorProductBusinessView1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&sCurrentDate=" + sCurrentDate + "&MR=0&FMonth=&FYear=&TMonth=&TYear=&basedOn=" + basadOn,
                     "_blank",
                    "ModalPopUp," +
                    "toolbar=no," +
                    "scrollbars=yes," +

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptProduct_Exp_Detail_Unlisted.aspx.cs" Inherits="MIS_Reports_rptProduct_Exp_Detail_Unlisted" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, sf_name, cyear, cmonth, Prod_Name, Prod, sCurrentDate) {
            popUpObj = window.open("rptProduct_Exp_Detail_Unlisted1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod + "&sCurrentDate=" + sCurrentDate + "&type=1",
     "_blank",
    "ModalPopUp" //+
    //"toolbar=no," +
    //"scrollbars=yes," +
    ...
    //"top=0"
        ...
        function show(sfcode, sf_name, cyear, cmonth, Prod_Name, Prod, sCurrentDate) {
            popUpObj = window.open("rptProduct_Exp_Detail_Unlisted1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod + "&sCurrentDate=" + sCurrentDate + "&type=2",
     "_blank",
    "ModalPopUp"// +
    //"toolbar=no," +
    //"scrollbars=yes," +
    ...
    //"top=0"
        ...
        function showModal(sfcode, sf_name, Prod_Name, Prod) {
            popUpObj = window.open("rptProduct_Exp_Detail_Unlisted1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod,
     "_blank",
    "ModalPopUp," +
    "toolbar=no," +
    "scrollbars=yes," +
                            ...
                            <div class="display-Approvaltable clearfix">
                                <div class="table-responsive" style="scrollbar-width: thin; overflow: inherit">
                                    ...
                                    <asp:Table ID="tbl" runat="server" Style="border-collapse: collapse; border: solid 1px Black; font-family: Calibri"
                                        Font-Size="8pt" GridLines="Both" Width="95%">
                                    </asp:Table>
                                </div>
                            </div>
                        </div>

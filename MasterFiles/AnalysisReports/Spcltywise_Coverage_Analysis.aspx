<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Spcltywise_Coverage_Analysis.aspx.cs" Inherits="MasterFiles_AnalysisReports_Spcltywise_Coverage_Analysis" %>
...
<head runat="server">
    <title>Speciality Wise Coverage Analysis </title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name) {
            ...
            popUpObj = window.open("Rpt_Spcltywise_Coverage_Analysis.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name,
   "ModalPopUp"//,
   //"toolbar=no," +
   //"scrollbars=yes," +
   //"location=no," +
        ...
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                if ((frmMonth <= toMonth && parseInt(frmYear) === parseInt(toYear)) || (parseInt(frmYear) < parseInt(toYear) && (frmMonth <= toMonth || frmMonth >= toMonth))) {
                    showModalPopUp(sf_Code, frmMonth, frmYear, toYear, toMonth, Name);
                }
                else {
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Speciality Wise Coverage Analysis</h2>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSamplePrd_Rxqty2.aspx.cs" Inherits="MIS_Reports_rptSamplePrd_Rxqty2" %>
                ...
                <div class="col-lg-12">
                    <asp:Panel ID="pnlContents" runat="server" Width="100%">
                        ...
                        <div align="center">
                            ...
                            <br />
                            <br />
                            <asp:Label ID="lblfieldname" runat="server" Font-Size="16px" CssClass="label" Text="Fieldforce Name:"></asp:Label>
                            <asp:Label ID="lblname" runat="server" Font-Size="16px" CssClass="label"></asp:Label>
                        </div>
                        <br />
                        <br />
                        ...
                        <div class="display-reportMaintable clearfix">
                            <div class="table-responsive" style="scrollbar-width: thin; max-height: 700px;">
                                <asp:GridView ID="grdDr" runat="server" Width="100%" HorizontalAlign="Center" EmptyDataText="No Records Found" OnRowDataBound="grdDr_RowDataBound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Trans_Detail_Info_Code" ItemStyle-HorizontalAlign="Left" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDrCode" runat="server"  Text='<%#Eval("Trans_Detail_Info_Code")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Fieldforce Name" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblforce" runat="server"  Text='<%#Eval("Fieldforce_Name")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Doctor Name" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblforceDr_name" runat="server"  Text='<%#Eval("Trans_Detail_Name")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Qualification" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblqua" runat="server"  Text='<%#Eval("Doc_Qua_Name")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Class" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblclass" runat="server"  Text='<%#Eval("Doc_Class_ShortName")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Territory" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblterr" runat="server" Text='<%#Eval("territory_Name")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Product Name" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPrd_Name" runat="server" Text='<%# Bind("Product_Detail_Name") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Rx Quantity" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSample_Qty" runat="server" Text='<%# Bind("Rx_qty") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Retailor Price" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblretailor" runat="server" Text='<%# Bind("Retailor_Price") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Value" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvalue" runat="server" Text='<%# Bind("valuee") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

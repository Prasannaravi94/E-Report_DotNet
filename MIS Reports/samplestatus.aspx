<%@ Page Language="C#" AutoEventWireup="true" CodeFile="samplestatus.aspx.cs" Inherits="MIS_Reports_samplestatus" %>
...
<link type="text/css" rel="Stylesheet" href="../css/rptMissCall.css" />
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, prod) {
            ...
            popUpObj = window.open("sampleissued.aspx?sfcode=" + sfcode + " &sfname="+sfname+"&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&Prod=" + prod,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
    ...
    <div>
          ...
          <%--<asp:UpdatePanel ID="updatepanel4" runat="server">
           ...
           <br />
               ...
               <tr>
                   <td align="left" class="stylespc" width="120px">
                    ...
                    <td align="left">
                        ...
                        <asp:DropDownList ID="ddlFieldForce" runat="server" SkinID="ddlRequired"  CssClass="ddl" Width="250px">
                             <asp:ListItem Value="0" Text="Select FeildForce"></asp:ListItem>
                        </asp:DropDownList>
             ...
             <br />
             <br />
               <%--<asp:ImageButton ID="btnGo" runat="server" Width="55px" Height="25px" ImageUrl="~/Images/button(1).png" OnClick="btnGo_Click"/>--%>

...
<head runat="server">
    <title>Listed Dr - Type Map</title>
...
<body>
    ...
    <div>
     <div id="Divid" runat="server"></div>
          ...
          <td style="width: 7.2%" />
            <td>
                ...
                <td align="left" style="vertical-align:bottom">
                    <asp:Button ID="btnOk" runat="server" CssClass="savebutton" Width="35px" Height="25px" Text="Go" 
                        onclick="btnOk_Click" />
        ...
        <br />
        <center>
        <asp:Button ID="btnUpdate" runat="server" CssClass="savebutton" Text="Update" onclick="btnUpdate_Click"  Width="70px" Height="25px" 
                />
        </center>
        </center>

          <div class="div_fixed">
         <asp:Button ID="btnSave" runat="server" Text="Update" CssClass="savebutton" Width="70px" Height="25px"

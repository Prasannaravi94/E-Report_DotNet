...
public partial class MIS_Reports_Product_Exp_specat : System.Web.UI.Page
{
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        int FYear = Convert.ToInt32(Convert.ToDateTime(txtFromMonthYear.Text).Year);
        int TYear = Convert.ToInt32(Convert.ToDateTime(txtToMonthYear.Text).Year);
        int FMonth = Convert.ToInt32(Convert.ToDateTime(txtFromMonthYear.Text).Month);
        int TMonth = Convert.ToInt32(Convert.ToDateTime(txtToMonthYear.Text).Month);
        ...
        else
        {
            if (FYear <= TYear)
            {
                ...
                if (ddlprod.SelectedValue != "-1")
                {
                    ...
                    {
                        sURL = "rptProduct_Exp_specat.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + FMonth.ToString() + "&FYear=" + FYear.ToString() + "&TMonth=" + TMonth.ToString() + "&TYear=" + TYear.ToString() + "&Prod=" + ddlprod.SelectedValue.ToString() + "&Prod_Name=" + ddlprod.SelectedItem.Text.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString() + "&chkspec=" + strspec + "&chkcat=" + strcat + "&Type=" + rdoType.SelectedValue.ToString() + "&mode=" + ddlmode.SelectedValue;
                    }
                    else
                    {
                        sURL = "rptProduct_Exp_specat.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + FMonth.ToString() + "&FYear=" + FYear.ToString() + "&TMonth=" + TMonth.ToString() + "&TYear=" + TYear.ToString() + "&Prod=" + ddlprod.SelectedValue.ToString() + "&Prod_Name=" + ddlprod.SelectedItem.Text.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString() + "&chkspec=" + strspec + "&chkcat=" + strcat + "&Type=" + rdoType.SelectedValue.ToString() + "&mode=" + ddlmode.SelectedValue;
                    ...
                    string newWin = "window.open('" + sURL + "','popup_window','');";
                ...
                else
                {
                    ...
                    if (ddlprod.SelectedIndex > 0)
                    {
                        ...
                        else
                        {
                            ...
                            sURL = "rptProduct_Exp_specat.aspx?sfcode=" + ddlMR.SelectedValue.ToString() + "&FMonth=" + FMonth.ToString() + "&FYear=" + FYear.ToString() + "&TMonth=" + TMonth.ToString() + "&TYear=" + TYear.ToString() + "&Prod=" + ddlprod.SelectedValue.ToString() + "&Prod_Name=" + ddlprod.SelectedItem.Text.ToString() + "&sf_name=" + ddlMR.SelectedItem.Text.ToString() + "&chkspec=" + strspec + "&chkcat=" + strcat + "&Type=" + rdoType.SelectedValue.ToString() + "&mode=" + ddlmode.SelectedValue;
                        }
                    }
                    else
                    {
    ...
    private void Fill_Product_Name()
    {
        ...
        dsProduct = pr.getProduct_Exp_new(div_code, ddlmode.SelectedValue);
    ...
    private void FillSpeciality()
    {
        ...
        dsChkSp = spec.getSpec_Exp(div_code, ddlmode.SelectedValue);
        ...
        else
        {
            if (ddlmode.SelectedValue == "2")
            {
                ...
                lblspec.Text = " No Speciality found for Campaign Exposure";
    ...
    private void FillCategory()
    {
        ...
        dsChkCat = cat.getCat_Exp(div_code, ddlmode.SelectedValue);
        chkcat.DataSource = dsChkCat;
        if (dsChkCat.Tables[0].Rows.Count > 0)
        {
            chkcat.DataSource = dsChkCat;
        ...
        else
        {
            if (ddlmode.SelectedValue == "2")
            {
                ...
                lblspec.Visible = true;
                lblspec.Text = " No Category found for Campaign Exposure";

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Prod_Grp_React.aspx.cs" Inherits="MasterFiles_Prod_Grp_React" %>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-11">
                        <br />
                        <h2 class="text-center">Product Group Reacivation</h2>
                        <div class="display-table clearfix">
                            <div class="table-responsive">

                                <asp:GridView ID="grdProGrp" runat="server" Width="70%" HorizontalAlign="Center"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Product_Grp_SName"  ItemStyle-HorizontalAlign="Left" SortExpression="Product_Grp_SName"

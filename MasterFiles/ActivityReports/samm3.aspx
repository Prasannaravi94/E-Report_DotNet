<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="samm3.aspx.cs" Inherits="MasterFiles_AnalysisReports_samm" %>
                ...
                <center>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <select id="lstFieldForce" multiple="true" runat="server" class="ddl" placeholder="Select manager"
                        ...
                        <tr>
                            ...
                            <td class="stylespc" style="width: 170px">
                                <asp:ListBox ID="lstBaseLevel" runat="server" SelectionMode="Multiple"
                                    CssClass="ddl" Font-Bold="True">

...
public partial class MasterFiles_Common_Doctors_Unique_ListedDrDeactivate : System.Web.UI.Page
{
    #region "Declaration"
    DataSet dsDoc = null;
    ...
    private void getWorkName()
    {
        ...
        {
            string str = "Doctor Area Cluster Name";
    ...
    private void FillDoc()
    {
        ...
        dsDoc = LstDoc.getListedDr_Deactivate_FDC(sfCode,div_code);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdDoctor.Rows)
        {
            ...
            string ListedDR = lblDR.Text.ToString();
               TextBox Reason = (TextBox)gridRow.Cells[2].FindControl("txtReason"); 
            int iflag = -1;
            ...
            if ((ListedDR.Trim().Length > 0) && (bCheck == true))
            {
                ...
                {
                    ListedDR lstDR = new ListedDR();
                    iReturn = lstDR.DeActivate_Dr_Unique(ListedDR, iflag, div_code, sf_code, Reason.Text.Trim());
                }
                else
                {
                    ListedDR lstDR = new ListedDR();

...
namespace Bus_EReport.DynamicDashboard.DrillDown.MarketingKpi
{
    ...
    public class BrandPriorityDrillDown : DrilldownBase
    {
        public int StartMonth;
        public int EndMonth;
        public int StartYear;
        public int EndYear;
        public BrandPriorityDrillDown()
        {
        ...
        {
            FileName = "Priority Brand Wise visited";
            PreferenceName = "BrandPriorityDrillDown";
        }
        ...
        public string getQuery()
        {
            ...
            {
                sqlQry += " LEFT JOIN Mas_Product_Brand ON Mas_Product_Detail.Product_Brd_Code = Mas_Product_Brand.Product_Brd_Code ";
            }
            ...
            if (Filters["widgetFilters"].ContainsKey("brands") && Filters["widgetFilters"]["brands"] != null && Filters["widgetFilters"]["brands"] != "")
            {
                sqlQry += " AND Mas_Product_Detail.Product_Brd_Code IN (" + Filters["widgetFilters"]["brands"] + ") ";
            }
            return sqlQry;
        }
        ...
        public override int GetTotalRecords()
        {
            ...
            if (Filters["widgetFilters"].ContainsKey("brands") && Filters["widgetFilters"]["brands"] != null && Filters["widgetFilters"]["brands"] != "")
            {
                strQry += " AND Mas_Product_Detail.Product_Brd_Code IN (" + Filters["widgetFilters"]["brands"] + ") ";
            }

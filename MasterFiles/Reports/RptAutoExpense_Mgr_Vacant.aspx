<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAutoExpense_Mgr_Vacant.aspx.cs" Inherits="MasterFiles_MR_RptAutoExpense" %>
...
<tr>
<td align="left"  style="font-weight:bold;font-size:small;" id="DivId" runat="server"></td>
...
<br />
        ...
        <asp:Button ID="btnDrftSave" runat="server"  CssClass="BUTTON" Width="80px" Height="25px"
            ...
            Text="Send To HO" Visible="true" OnClientClick="saveOtherExp()" OnClick="btnSave_Click" />
             <p align="right"><asp:Button ID="bakfldfrce" runat="server" CssClass="BUTTON" Width="130px" Height="25px"
            Text="BacK To FieldForce" Visible="true" OnClick="btnField_Click" /></p>
    </center>
    </div>
    </div>

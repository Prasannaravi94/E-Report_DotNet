...
public partial class MIS_Reports_InputDatewise_Report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Input Despatch View for " + FDate + " " + "To" + " " + TDate;
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                tr_det.Cells.Add(tc_det_Designation);
                        ...
                        dsDoc = sf.input_quantity_MrDatewise(drFF["sf_code"].ToString(), divcode, FromDate, ToDate);

...
public partial class MasterFiles_Reports_New_rpt_DCR_Status_Datewise : System.Web.UI.Page
{
    ...
    int tot_days = -1;
    int cday = 1;
    int tot_No_of_Days = 0;
    int tot_No_of_Leave = 0;
    int ccsday = 0;
    int ddate = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        chkatten = Request.QueryString["chkatten"].ToString();
    ...
    private void FillSalesForce(string div_code, string sf_code)
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            if (checkVacant == "0")
            {
                dsSalesForce.Tables[0].DefaultView.RowFilter = " sf_tp_active_flag='active'";
                DataTable dt = dsSalesForce.Tables[0].DefaultView.ToTable("table1");
                DataSet ds1 = new DataSet();
                dsSalesForce.Merge(dt);
                ds1.Merge(dt);
                ViewState["dsSalesForce"] = ds1;
            }
            else
            {
    ...
    private void CreateDynamicTable()
    {
        ...
        if (ViewState["dsSalesForce"] != null)
        {
            ...
            TableCell tc_SF_Emp_ID = new TableCell();
            tc_SF_Emp_ID.BorderStyle = BorderStyle.Solid;
            tc_SF_Emp_ID.BorderWidth = 1;
            tc_SF_Emp_ID.Width = 50;
            Literal lit_SF_Emp_ID = new Literal();
            lit_SF_Emp_ID.Text = "<center>Emp ID</center>";
            tc_SF_Emp_ID.Controls.Add(lit_SF_Emp_ID);
            tr_header.Cells.Add(tc_SF_Emp_ID);
            //tr_header.BackColor = System.Drawing.Color.Bisque;
            ...
            TableCell tc_FF_hq = new TableCell();
            tc_FF_hq.BorderStyle = BorderStyle.Solid;
            tc_FF_hq.BorderWidth = 1;
            tc_FF_hq.Width = 200;
            Literal lit_ff_hq = new Literal();
            lit_ff_hq.Text = "<center>HQ</center>";
            tc_FF_hq.Controls.Add(lit_ff_hq);
            tr_header.Cells.Add(tc_FF_hq);

            TableCell tc_ff_desig = new TableCell();
            tc_ff_desig.BorderStyle = BorderStyle.Solid;
            tc_ff_desig.BorderWidth = 1;
            tc_ff_desig.Width = 120;
            Literal lit_ff_desig = new Literal();
            lit_ff_desig.Text = "<center>Designation</center>";
            tc_ff_desig.Controls.Add(lit_ff_desig);
            tr_header.Cells.Add(tc_ff_desig);

            TableCell tc_ff_joining = new TableCell();
            tc_ff_joining.BorderStyle = BorderStyle.Solid;
            tc_ff_joining.BorderWidth = 1;
            tc_ff_joining.Width = 200;
            Literal lit_ff_joining = new Literal();
            lit_ff_joining.Text = "<center>Date of Joining</center>";
            tc_ff_joining.Controls.Add(lit_ff_joining);
            tr_header.Cells.Add(tc_ff_joining);
            ...
            if (chkatten == "1")
            {
                TableCell tc_No_of_Days = new TableCell();
                tc_No_of_Days.BorderStyle = BorderStyle.Solid;
                tc_No_of_Days.BorderWidth = 1;
                tc_No_of_Days.Width = 100;
                Literal lit_No_of_Days = new Literal();
                lit_No_of_Days.Text = "<center>No of Days <br>Present </center>";
                tc_No_of_Days.Controls.Add(lit_No_of_Days);
                tr_header.Cells.Add(tc_No_of_Days);

                TableCell tc_No_of_Leave = new TableCell();
                tc_No_of_Leave.BorderStyle = BorderStyle.Solid;
                tc_No_of_Leave.BorderWidth = 1;
                tc_No_of_Leave.Width = 100;
                Literal lit_No_of_Leave = new Literal();
                lit_No_of_Leave.Text = "<center>No of Days <br>Leave </center>";
                tc_No_of_Leave.Controls.Add(lit_No_of_Leave);
                tr_header.Cells.Add(tc_No_of_Leave);
            }
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                TableCell tc_det_User_Emp_Id = new TableCell();
                Literal lit_det_User_Emp_Id = new Literal();
                
                lit_det_User_Emp_Id.Text = "&nbsp;" + drFF["sf_emp_id"].ToString();
                tc_det_User_Emp_Id.BorderStyle = BorderStyle.Solid;
                tc_det_User_Emp_Id.BorderWidth = 1;
                tc_det_User_Emp_Id.Controls.Add(lit_det_User_Emp_Id);
                //tc_det_SNo.Height = 10;
                tr_det.Cells.Add(tc_det_User_Emp_Id);
                ...
                //--------- Old Code -------------------
                //dsSf = sf1.CheckSFNameVacant_Temp(drFF["sf_code"].ToString(), dtDCRfrom.Month, dtDCRfrom.Year);
                ...
                //dsSf = sf1.CheckSFNameVacant_Temp(drFF["sf_code"].ToString(), Convert.ToInt16(dtDCRto.ToString("MM")), Convert.ToInt16(dtDCRfrom.ToString("yyyy")));
                //if (dsSf.Tables[0].Rows.Count > 0)
                //{
                ...
                //        {
                //            lit_det_FF.Text = strVacant[0] + "<span style='color: red;'>" + strVacant[1] + "</span>" + "<span style='color: red;'>" + dsSf.Tables[0].Rows[0].ItemArray.GetValue(1).ToString() + "</span>";
                //        }
                //        else
                //        {
                //            lit_det_FF.Text = strVacant[0] + " - " + drFF["sf_hq"].ToString() + " - " + drFF["Designation_Short_Name"].ToString();
                //        }
                //    }
                //    else
                //    {
                //        lit_det_FF.Text = dsSf.Tables[0].Rows[0].ItemArray.GetValue(0) + "<span style='color: red;'>" + dsSf.Tables[0].Rows[0].ItemArray.GetValue(1).ToString() + "</span>";
                //    }
                ...
                lit_hq.Text = "&nbsp;" + drFF["sf_hq"].ToString();
                tc_hq.BorderStyle = BorderStyle.Solid;
                tc_hq.BorderWidth = 1;
                tc_hq.Controls.Add(lit_hq);
                tr_det.Cells.Add(tc_hq);

                TableCell tc_desig = new TableCell();
                Literal lit_desig = new Literal();
                if (sf_type == "2")
                {
                    lit_desig.Text = "&nbsp;" + drFF["Designation_Short_Name"].ToString();
                }
                else
                {
                    lit_desig.Text = "&nbsp;" + drFF["Designation_Short_Name"].ToString();
                }
                tc_desig.BorderStyle = BorderStyle.Solid;
                tc_desig.BorderWidth = 1;
                tc_desig.Controls.Add(lit_desig);
                tr_det.Cells.Add(tc_desig);

                TableCell tc_joining = new TableCell();
                Literal lit_joining = new Literal();
                lit_joining.Text = "&nbsp;" + drFF["Sf_Joining_Date"].ToString();
                tc_joining.BorderStyle = BorderStyle.Solid;
                tc_joining.BorderWidth = 1;
                tc_joining.Controls.Add(lit_joining);
                tr_det.Cells.Add(tc_joining);
                    ...
                    if (dsDCR.Tables[0].Rows.Count > 1)
                    {
                        ...
                        foreach (DataRow datarow in dsDCR.Tables[0].Rows)
                        {
                            ...
                            do
                            {
                                ...
                                if (sDCR.Trim() == "P" || sDCR.Trim() == "FW")
                                {
                                    tot_No_of_Days += 1;
                                }

                                if (sDCR.Trim() == "A" || sDCR.Trim() == "L")
                                {
                                    tot_No_of_Leave += 1;
                                }
                ...
                if (chkatten == "1")
                {
                    TableCell tc_No_of_Days_Total = new TableCell();
                    tc_No_of_Days_Total.BorderStyle = BorderStyle.Solid;
                    tc_No_of_Days_Total.BorderWidth = 1;
                    tc_No_of_Days_Total.Width = 50;
                    tc_No_of_Days_Total.HorizontalAlign = HorizontalAlign.Center;
                    Literal lit_det_days_Total = new Literal();
                    lit_det_days_Total.Text = tot_No_of_Days.ToString();
                    //tc_No_of_Days_Total.RowSpan = 2;
                    tc_No_of_Days_Total.Controls.Add(lit_det_days_Total);
                    tr_det.Cells.Add(tc_No_of_Days_Total);


                    TableCell tc_No_of_Leave_Total = new TableCell();
                    tc_No_of_Leave_Total.BorderStyle = BorderStyle.Solid;
                    tc_No_of_Leave_Total.BorderWidth = 1;
                    tc_No_of_Leave_Total.Width = 50;
                    tc_No_of_Leave_Total.HorizontalAlign = HorizontalAlign.Center;
                    Literal lit_det_tot_Leave_Total = new Literal();
                    lit_det_tot_Leave_Total.Text = tot_No_of_Leave.ToString();
                    //tc_No_of_Leave_Total.RowSpan = 2;
                    tc_No_of_Leave_Total.Controls.Add(lit_det_tot_Leave_Total);
                    tr_det.Cells.Add(tc_No_of_Leave_Total);
                }

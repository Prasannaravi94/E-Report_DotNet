<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TerrTypeWise_DrVisit.aspx.cs" Inherits="MIS_Reports_TerrTypeWise_DrVisit" %>
...
<head runat="server">
    <title>Territory wise - Listed Doctor Visit</title>
    <%--<link type="text/css" rel="Stylesheet" href="../css/rptMissCall.css" />
    <link type="text/css" rel="stylesheet" href="../css/Grid.css" />
    <link type="text/css" rel="stylesheet" href="../css/style.css" />--%>
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(cmon, cyear, SF_code, SName, modee) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rptTerrTypeWise_DrVisit.aspx?cmon=" + cmon + "&cyear=" + cyear + "&SF_code=" + SF_code + "&SName=" + SName + "&mode=" + modee,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
    ...
    //"top=0"
            ...
            $(popUpObj.document.body).ready(function () {
                ...
                var ImgSrc = "https://s29.postimg.org/t7qoahsnb/preloader_2.gif"
                $(popUpObj.document.body).append('<div><p style="color:orange;">Loading Please Wait.....</p></div><div class="preload"> <img src="' + ImgSrc + '"  style=" width:850px; height: 300px;position: fixed;top: 20%;left: 10%;"  alt="" /></div>');
            });
            //LoadModalDiv();
        }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                showModalPopUp(cmon, cyear, SF_code, SName, modee);
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:DropDownList ID="ddlmode" runat="server" CssClass="nice-select">
                                    <asp:ListItem Value="1" Text="Territory"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="Speciality"></asp:ListItem>
                                    <asp:ListItem Value="3" Text="Category"></asp:ListItem>
                                    <asp:ListItem Value="4" Text="Class"></asp:ListItem>
                                    <asp:ListItem Value="5" Text="Campaign"></asp:ListItem>
                                </asp:DropDownList>
                            </div>

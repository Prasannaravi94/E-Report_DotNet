            ...
            <table width="100%">
                <tr>
                    ...
                    <%-- <td width="80%" align="center">
                        <asp:Label ID="lblProd" runat="server" Text="ListedDr - Product Visit" SkinID="lblMand" Font-Underline="true"></asp:Label>
                    </td>--%>
                    <td align="right">
                        <table>
                            <tr>
                        ...
                        <div class="display-table3rowspan clearfix">
                            <div class="table-responsive" style="scrollbar-width: thin; max-height: 700px;">
                                <asp:GridView ID="grdDr" runat="server" Width="100%" HorizontalAlign="Center" EmptyDataText="No Records Found" OnRowCreated="grdDr_RowCreated"
                                    AutoGenerateColumns="false" GridLines="None" CssClass="table" ShowHeader="false" AlternatingRowStyle-CssClass="alt" OnRowDataBound="grdDr_RowDataBound"
                                    AllowSorting="True">                                  
                                    <Columns>
                                ...
                                <asp:TemplateField HeaderText="Product Visit" ItemStyle-HorizontalAlign="Left">
                                 <ControlStyle Width="80%"></ControlStyle>
                                    <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="visit1_pri_seen1" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvisit1_pri_seen1" runat="server" Text='<%# Bind("visit1_pri_seen1") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>


                                        <asp:TemplateField HeaderText="visit1_pri_seen2" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvisit1_pri_seen2" runat="server" Text='<%# Bind("visit1_pri_seen2") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="visit1_pri_seen3" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvisit1_pri_seen3" runat="server" Text='<%# Bind("visit1_pri_seen3") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="visit2_pri_seen1" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvisit2_pri_seen1" runat="server" Text='<%# Bind("visit2_pri_seen1") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="visit2_pri_seen2" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvisit2_pri_seen2" runat="server" Text='<%# Bind("visit2_pri_seen2") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="visit2_pri_seen3" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvisit2_pri_seen3" runat="server" Text='<%# Bind("visit2_pri_seen3") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="visit3_pri_seen1" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvisit3_pri_seen1" runat="server" Text='<%# Bind("visit3_pri_seen1") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="visit3_pri_seen2" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvisit3_pri_seen2" runat="server" Text='<%# Bind("visit3_pri_seen2") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="visit3_pri_seen3" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="visit3_pri_seen3" runat="server" Text='<%# Bind("visit3_pri_seen3") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

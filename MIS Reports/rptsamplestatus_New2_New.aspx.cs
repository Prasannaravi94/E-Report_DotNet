...
public partial class MIS_Reports_rptsamplestatus_New2_New : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblProd.Text = "Sample Despatch Status of  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    private void FillPrd()
    {
        ...
        //dsDr = sf.Sample_Status_New_Product_New(div_code, sf_code, FMonth, FYear, TMonth, TYear);
        dsDr = sf.sample_Des_New_Modify(div_code, sf_code, FMonth, FYear, TMonth, TYear, "2", "0", "");
        //dsDr = sf.sample_Des_New_Modify_New(div_code, sf_code, FMonth, FYear);
    ...
    protected void grdDr_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label lblprod_name = (Label)e.Row.FindControl("lblprd_name");

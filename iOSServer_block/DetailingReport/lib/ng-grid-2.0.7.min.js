...
var ngGrid = function ($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q) {
    ...
    $scope.enableRowTotalValue = self.config.enableRowTotalValue;
...
window.ngGrid.i18n['en'] = {
    ...
    ngTotalItemsLabel1: 'Total Order Value:',
...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('footerTemplate.html',
    ...
    "\n" +
         "            <span ng-if=\"enableRowTotalValue\" style=\"float:right;margin-right:100px;font-size:16px;color:green;font-weight:bold\" class=\"ngLabel\">{{i18n.ngTotalItemsLabel1}} {{fmcgData.value}}</span>\r" +
    "\n" +

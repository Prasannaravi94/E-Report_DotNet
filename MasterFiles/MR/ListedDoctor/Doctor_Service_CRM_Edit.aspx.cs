...
public partial class MasterFiles_MR_ListedDoctor_Doctor_Service_CRM_Edit : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string F_Code = Request.QueryString["F_Code"];
            Session["F_Code"] = F_Code;
            Session["sf_code"] = F_Code;
        }
        if (Request.QueryString["CrmStatus"] != null && Request.QueryString["CrmStatus"] != "")
        {
            string CrmStatus = Request.QueryString["CrmStatus"];
        }
        if (Session["sf_code"] != null && Session["sf_code"] != "")
        {
            Session["SF_ID"] = Session["sf_code"].ToString();
        }
        ...
        if (Request.QueryString["TypeDr"] != null && Request.QueryString["TypeDr"] != "")
        {
            Session["TypeDr"] = Request.QueryString["TypeDr"];
        }
    ...
    private void FillReport()
    {
        ...
        if (Session["TypeDr"] != null)
        {
            TypeDr = Session["TypeDr"].ToString();
        }
        ...
        DataTable SfCodes = new DataTable();

        if (TypeDr == "1" || TypeDr == "2")
        {
            SfCodes = sf1.GetCRM_MR_Detail(div_code, sf_code, 0);
        }
        else
        {
            SfCodes = sf1.getMRJointWork_camp(div_code, sf_code, 0);
        }
    ...
    protected void btnBack_Click(object sender, EventArgs e)
    {
        try
        {
            string TypeDr = Request.QueryString["TypeDr"];

            if (TypeDr != null && TypeDr != "")
            {
                if (TypeDr == "1")
                {
                    Session["sf_code"] = S_Code;
                    Response.Redirect("Doctor_Service_CRM_Approve_MGR.aspx");
                }
                else if (TypeDr == "2")
                {
                    Session["sf_code"] = S_Code;
                    Response.Redirect("Doctor_Service_CRM_Admin_Approve.aspx");
                }
            ...
            {
                Session["sf_code"] = S_Code;
                Response.Redirect("Doctor_Service_CRM_New.aspx");
            }
        }
        catch (Exception ex)
        {

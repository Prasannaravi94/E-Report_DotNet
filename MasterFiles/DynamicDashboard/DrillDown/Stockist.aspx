<%@ Page Title="" Language="C#" MasterPageFile="~/MasterFiles/DynamicDashboard/Layout.master" AutoEventWireup="true" CodeFile="Stockist.aspx.cs" Inherits="MasterFiles_DynamicDashboard_DrillDown_Stockist" %>
            ...
            <div class="table-responsive bg-white">
                ...
                <asp:GridView ID="DrillDownRecords" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ERPCode" HeaderText="ERP Code" HeaderStyle-CssClass="bg-dark text-light" />
                        <asp:BoundField DataField="AssignedEmpl" HeaderText="Assigned Employees" HeaderStyle-CssClass="bg-dark text-light" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>

...
public partial class MasterFiles_Mails_Mail_Head : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (sf_Type == "2" || sf_Type == "1")
        {
            ...
            LblUser.Text = div_Name + " - " + Session["Designation_Short_Name"] + " - " + Session["Sf_HQ"];
        }
        else
        {
            string division_Name = Session["div_Name"].ToString();
            lblSfName.Text = division_Name;
            LblUser.Text = division_Name;
        }
    ...
    private void FillAddressBook()
    {
        ...
        //else if (sf_HO_ID != "0")
        //{
        //    sf_code = Session["Corporate"].ToString();
        //}
    ...
    protected void lnkButton_Click(object sender, EventArgs e)
    {
        ...
        if (ViewState["mail_to_sf_code"] != null)
        {
            ...
            //if (dsMailCompose.Tables[0].Rows.Count == 0 || dsMailCompose.Tables[0].Rows.Count.ToString() == "")
            //{
            //    blnMail = false;
            //}

            //ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>alert('"+ dsMailCompose.Tables[0].Rows.Count +"');</script>");
        }
        ...
        {
            ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>alert('Retry Once Again!');</script>");
        }
    }

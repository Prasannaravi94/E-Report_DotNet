            ...
            <div id="horizontalmenu" >
                    <ul> 
                        ...
                        <li>
                            ...
                            <ul> 
                                <li><a href="MasterFiles/MR/ProductRate.aspx">Product Rate</a></li> 
                                <li><a href="MasterFiles/MR/Territory/Territory.aspx">Territory</a></li>
                                <li><a href="MasterFiles/MR/ListedDoctor/LstDoctorList.aspx">Listed Doctor Details</a></li> 
                                <li><a href="MasterFiles/MR_ChemistDetails.aspx">Chemist Details</a></li> 
                                <li><a href="MasterFiles/MR_StockistDetails.aspx">Stockist Details</a></li> 
                                <li><a href="MasterFiles/MR_HospitalHDetails.aspx">Hospital Details</a></li> 
                                <li><a href="MasterFiles/MR_UnListedDoctor.aspx">Unlisted Doctor</a></li> 
                                <li><a href="MasterFiles/MR_HolidayList.aspx">Holiday List</a></li> 
                                <li><a href="MasterFiles/MR_ListedDR_Pending.aspx">Listed Doctor - Approval Pending View</a></li> 
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul> 
                                <li><a href="MasterFiles/MR_StdDayPlan.aspx">Std. Daywise Plan</a></li> 
                                <li><a href="MasterFiles/MR_TourPlan.aspx">Tour Plan</a></li> 
                                <li><a href="MasterFiles/MR_DCR.aspx">DCR</a></li> 
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul> 
                                ...
                                <li><a href="MasterFiles/MR_MissedCalls.aspx">Missed Calls</a></li> 
                                <li><a href="MasterFiles/MR_VisitDetails.aspx">Visit Details</a></li> 
                            </ul>
                        </li>
                        <li>
                            <a href="#">Options</a>
                            <ul> 
                                <li><a href="MasterFiles/MR_ChangePassword.aspx">Change Password</a></li> 
                                <li><a href="MasterFiles/MR_MailBox.aspx">Mail Box</a></li>                     
                            </ul>
                        </li>
                        <li>

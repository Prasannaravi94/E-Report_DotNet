<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_SecSale_StockSale_MR_wise_Report.aspx.cs"
    Inherits="MasterFiles_AnalysisReports_rpt_SecSale_StockSale_MR_wise_Report" %>
...
<head runat="server">
    ...
    <script src="../../JScript/Service_CRM/SecSale/rpt_StockandSale_MR_JS.js" type="text/javascript"></script>
    <style type="text/css">
                    ...
                    <div class="col-lg-12">
                        <asp:Panel ID="pnlContents" runat="server">
                            ...
                            <div id="MainDiv">
                                ...
                                <br />
                                <br />
                                <div id="lblField" class="reportheader"></div>                                                           
                                </center>

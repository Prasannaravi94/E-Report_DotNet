...
public partial class MasterFiles_Sample_Despatch : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "//" + host + ":" + port + "/MIS%20Reports/rptsamplestatus_New_New.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&Fyear=" + cyear + "&TMonth=" + cmonth + "&Tyear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&Dashboard=" + "1" + "&div_code=" + div_code);

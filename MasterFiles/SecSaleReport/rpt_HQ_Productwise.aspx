<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_HQ_Productwise.aspx.cs" Inherits="MasterFiles_SecSaleReport_rpt_HQ_Productwise" %>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            <div align="center">
                                ...
                                <br />
                                <asp:Label ID="lblprod" runat="server" CssClass="reportheader" Font-Size="16px" ForeColor="#696d6e"></asp:Label>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <table width="100%">

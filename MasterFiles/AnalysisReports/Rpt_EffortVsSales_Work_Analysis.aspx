<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_EffortVsSales_Work_Analysis.aspx.cs" Inherits="MasterFiles_AnalysisReports_Rpt_EffortVsSales_Work_Analysis" %>
                                        ...
                                        <table width="100%">
                                            <caption>
                                                <asp:GridView ID="GrdFixation" runat="server" AlternatingRowStyle-CssClass="alt"
                                                    ...
                                                    GridLines="Both" HorizontalAlign="Center" Style="background-color: white" BorderWidth="1" BorderColor="WhiteSmoke"

...
public partial class Reports_rptRoutePlanView : System.Web.UI.Page
{
   ...
   // string mgr_act = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Convert.ToInt16(Request.QueryString["mgract"]) != null)
        {
            mgr_act = Convert.ToInt16(Request.QueryString["mgract"]);
        }
        CreateDynamicTable();
        GetWorkName();
        ExportData();
    ...
    private void CreateDynamicTable()
    {
        ...
        if (mgr_act == 2)
        {
            dssal = sf1.SalesForceList_MR_ALL(div_code, sf_code);
        }
        else
        {
            dssal = dc.getSfName_HQ(sf_code);
        }
        if (dssal.Tables[0].Rows.Count > 0)
        {
            foreach (DataRow dr1 in dssal.Tables[0].Rows)
            {
                dsSalesForce = rp.FetchTerritoryName(dr1["sf_code"].ToString());
                ...
                if (dsSalesForce.Tables[0].Rows.Count > 0)
                {
                    ...
                    tbldetail_main31.Style.Add("width","100%");
                    ...
                    tc_det_head_main31.Style.Add("font-size", "12pt");
                    tc_det_head_main31.Style.Add("Color", "Red");
                    tc_det_head_main31.Width = 100;
                    Literal lit_det_main31 = new Literal();
                    lit_det_main31.Text = "<b>"+ "<span style='color:#696d6e'>  " + " Field Force Name: " + "</span>"+ "&nbsp;" + dr1["sf_name"].ToString() + " - " + dr1["sf_Designation_Short_Name"].ToString() + " - " + dr1["Sf_HQ"].ToString() + "  </b>";
                    ...
                    tblgrid.Controls.Add(tbldetail_main31);
                    ...
                    tblgrid.Controls.Add(tbl_head_empty3);
                    ...
                    foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
                    {
                        ...
                        tc_det_head_main3.Style.Add("font-size", "12pt");
                        tc_det_head_main3.Style.Add("color", "Red");
                        tc_det_head_main3.Width = 100;
                        Literal lit_det_main3 = new Literal();
                        lit_det_main3.Text = "<b>"+ "<span style='color:#696d6e'>  " + " Territory Name: " + "</span>"+"&nbsp;" + drFF["Territory_Name"].ToString() + "</b>";
                        ...
                        tblgrid.Controls.Add(tbldetail_main3);
                        ...
                        tblgrid.Controls.Add(tbl_head_empty);
                        ...
                        tc_doc.Attributes.Add("class", "stickyFirstRow");

                        Literal lit_doc = new Literal();
                        lit_doc.Text = "<center>Listed DR Name</center>";
                        ...
                        tc_spec.Attributes.Add("class", "stickyFirstRow");
                        Literal lit_spec = new Literal();
                        lit_spec.Text = "<center>Specialty</center>";
                        ...
                        tc_qual.Attributes.Add("class", "stickyFirstRow");
                        Literal lit_qual = new Literal();
                        lit_qual.Text = "<center>Qual</center>";
                        ...
                        tc_class.Attributes.Add("class", "stickyFirstRow");
                        Literal lit_class = new Literal();
                        lit_class.Text = "<center>Class</center>";
                        ...
                        dtRP = rp.get_ListedDoctor_RoutePlan(dr1["sf_code"].ToString(), drFF["Territory_Code"].ToString());
                        ...
                        tblgrid.Controls.Add(tbl_head_empty1);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaveForm.aspx.cs" Inherits="MasterFiles_MR_LeaveForm" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            var MaxLength = 100;
            $('#lblValidreason').keypress(function (e) {
                if ($(this).val().length >= MaxLength) {
                    e.preventDefault();
                }
            });
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel ID="pnlleaveback" HorizontalAlign="Right" Width="90%" runat="server" Visible="false">
                <asp:ImageButton ID="btnleavedcr" ImageUrl="~/Images/back3.jpg" runat="server" OnClick="btnleavedcr_Click" />
            </asp:Panel>
            <div class="container home-section-main-body position-relative clearfix">
                        ...
                        <br />
                                    ...
                                    <asp:Label ID="Label15" runat="server" Text="LOP:" SkinID="lblMand"></asp:Label>
                                                                ...
                                                                <td style="text-align: right">
                                                                    ...
                                                                    <asp:Label ID="Label13" runat="server" Text="Approval Pending:-" Font-Bold="true" ForeColor="Red"></asp:Label>
                                                                    &nbsp;&nbsp;&nbsp;
                                            ...
                                            <asp:TableRow HorizontalAlign="Left" CssClass="leaveformtabletrsplit">
                                                <asp:TableCell CssClass="padding">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbltype" runat="server" Text="Type of Leave " CssClass="label"></asp:Label>
                                                                <asp:Label ID="Label5" runat="server">: </asp:Label></td>
                                                            <td>
                                                                <asp:DropDownList ID="ddltype" runat="server" CssClass="leaveformselect">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                    ...
                    <asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="savebutton" OnClick="btnClear_Click" />
                                    ...
                                    <center>
                                        <asp:Panel ID="pnlmgr" Visible="false" runat="server">
                                            <asp:Button ID="btnApproved" runat="server" Text="Approve" CssClass="savebutton" OnClick="btnApproved_Click" />
                                            <asp:Button ID="btnReject" runat="server" Text="Reject" CssClass="savebutton" OnClick="btnReject_Click" />
                ...
                <asp:TextBox ID="txtreject" runat="server" TextMode="MultiLine" BorderStyle="Solid"
                    BorderColor="Gray" Visible="false" Height="70px" Width="350px"></asp:TextBox>
                                            &nbsp
                <asp:Button ID="btnSubmit" CssClass="savebutton" Width="140px" runat="server" Visible="false"
                    OnClientClick="return validate();" Text="Send for FieldForce" OnClick="btnSubmit_Click" />
                                        </asp:Panel>
                                    </center>
                                </div>
                            </div>

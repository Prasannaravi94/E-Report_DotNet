<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorProductBusinessView.aspx.cs" EnableEventValidation="true" Inherits="MIS_Reports_doctorbusview" %>
...
<head id="Head1" runat="server">
    <title>Doctor Business - View</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sfname, basedOn) {
            popUpObj = window.open("rpDoctorProductBusinessView.aspx?sfcode=" + sfcode + " &sfname=" + sfname + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sfname + "&basedOn=" + basedOn,
                        "ModalPopUp"//,
                        //"toolbar=no," +
                        //"scrollbars=yes," +
                        //"location=no," +
        ...
        function showModalPopUp1(sfcode, fmon, fyr, tmon, tyr, sfname, sCurrentDate, basedOn) {
            popUpObj1 = window.open("rpDoctorProductBusinessView1.aspx?sf_code=" + sfcode + "&sf_name=" + sfname + "&Year=" + fyr + "&Month=" + fmon + "&sCurrentDate=" + sCurrentDate + "&MR=1&FMonth=&FYear=&TMonth=&TYear=&basedOn=" + basedOn + "",
                    "ModalPopUp,"// +
                    //"toolbar=no," +
                    //"scrollbars=yes," +
                    //"location=no," +
                ...
                <div class="col-lg-5">
                    <center>
                        <table>
                            <tr>
                                <td align="center">
                                    <h2 class="text-center">Doctor Business Productwise - View</h2>
                                </td>
                            </tr>
                        </table>
                    </center>

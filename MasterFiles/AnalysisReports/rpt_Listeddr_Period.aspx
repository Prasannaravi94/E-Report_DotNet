<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Listeddr_Period.aspx.cs" Inherits="MasterFiles_AnalysisReports_rpt_Listeddr_Period" %>
                                ...
                                <div class="display-Approvaltable clearfix">
                                    ...
                                    <div class="table-responsive" style="scrollbar-width: thin; overflow-x: inherit">
                                        <asp:Panel ID="Panel1" runat="server">
                                            <table width="100%">
                                                <caption>
                                                    <asp:GridView ID="GrdFixation" runat="server" AlternatingRowStyle-CssClass="alt" BorderWidth="1" BorderColor="WhiteSmoke"
                                                        AutoGenerateColumns="true" CssClass="table" EmptyDataText="No Records Found"
                                                        GridLines="Both" HorizontalAlign="Center" Style="background-color: white;"

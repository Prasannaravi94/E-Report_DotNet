...
public partial class MasterFiles_AnalysisReports_rptMgr_Coverage_Detail_Zoom : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            lblHead.Text = "View Detail of " + strFrmMonth + " " + FYear;
    ...
    private void FillReport()
    {
        ...
        if (mode == "1")
        {
            sProc_Name = "Hq_Coverage_Detail_Zoom";  //rptMgr_Coverage_Detail
        ...
        {
            sProc_Name = "Hq_Coverage_Detail_Zoom"; //rpt_Coverage_Pivot
        ...
        else if (mode == "3")
        {
            if (TYear == "MGR")
            {
                sProc_Name = "MGR_JointWrk_Zoom"; ////rptJointWk_Analysis
            }

            else if (TYear == "MR")
            {
                sProc_Name = "MR_JointWrk_Zoom";
            }
        ...
        {
            sProc_Name = "Mgr_Coverage_Analysis_Zoom"; //rpt_Fieldwork_Pivot
            SqlCommand cmd = new SqlCommand(sProc_Name, con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Div_Code", Convert.ToInt32(div_code));
            cmd.Parameters.AddWithValue("@Mnth", FMonth);
            cmd.Parameters.AddWithValue("@Year", FYear);
            cmd.Parameters.AddWithValue("@Msf_code", Sf_CodeMGR);
            cmd.Parameters.AddWithValue("@Desgnation", TYear);
            cmd.Parameters.AddWithValue("@Field", "Listed Dr Name");
            cmd.Parameters.AddWithValue("@Order", "ASC");
            cmd.CommandTimeout = 600;
            SqlDataAdapter da = new SqlDataAdapter(cmd);

...
public partial class MasterFiles_Options_QuizTitleCreation : System.Web.UI.Page
{
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.AddWithValue("@Effective_Date", txtEffFrom.Text);
        ...
        if (iReturn == 2)
        {
            ...
            Response.Write("<script>createCustomAlert('Title has been Updated Successfully') ; location.href='Quiz_List.aspx'</script>");
            Clear();
        }
        else if (iReturn != 0)
        {
            ClientScript.RegisterStartupScript(GetType(), "TestAlert", "createCustomAlert('Title has been Inserted Successfully');", true);
            Clear();
        }

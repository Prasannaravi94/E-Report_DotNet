<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard_Missed_Call.aspx.cs" Inherits="MasterFiles_Dashboard_Missed_Call"
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upAdmDashboard" runat="server">
                                            ...
                                            <div class="panel panel-primary">
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="container-fluid">
                                                            <div class="table-responsive">
                                                                <asp:GridView ID="GrdFixation" runat="server" AutoGenerateColumns="true"
                                                                    CssClass="table table-bordered table-hover tbSSBFS" EmptyDataText="No Records Found"
                                                                    HorizontalAlign="Center" OnRowCreated="GrdFixation_RowCreated"
                                                                    ShowHeader="False" OnRowDataBound="GrdFixation_RowDataBound" CellSpacing="0" >
                                                                    <Columns>
                                                                    </Columns>
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="ddlFYear" />
                <asp:PostBackTrigger ControlID="ddlTMonth" />
                <asp:PostBackTrigger ControlID="ddlTYear" />

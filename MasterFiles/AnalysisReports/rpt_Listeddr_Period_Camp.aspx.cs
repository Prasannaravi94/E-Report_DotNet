...
public partial class MasterFiles_AnalysisReports_rpt_Listeddr_Period_Camp : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Campaign - Periodically - for the month of  " + strFrmMonth + " " + FYear + "  To  " + strToMonth + " " + TYear;
    ...
    private void FillReport()
    {
        ...
        sProc_Name = "Listeddr_Period_Vst_Camp_New";
    ...
    protected void GrdFixation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            for (int s = 0; s < dtrowdt.Rows.Count; s++)
            {
                ...
                {
                    for (int i = 11, m = 1; i < e.Row.Cells.Count; i++)
                    {

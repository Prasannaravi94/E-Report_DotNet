...
public partial class MIS_Reports_Territory_Format : System.Web.UI.Page
{
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        int FYear = Convert.ToInt32(Convert.ToDateTime(txtFromMonthYear.Text).Month);
        int TYear = Convert.ToInt32(Convert.ToDateTime(txtToMonthYear.Text).Month);
        int FMonth = Convert.ToInt32(Convert.ToDateTime(txtFromMonthYear.Text).Year);
        int TMonth = Convert.ToInt32(Convert.ToDateTime(txtToMonthYear.Text).Year);
        ...
        else
        {
            ...
            if (FYear <= TYear)
            {
                ...
                if (ddlFieldForce.SelectedIndex > 0)
                {
                    ...
                    sURL = "rptTerritory_Format.aspx?sfcode=" + ddlMR.SelectedValue.ToString() + "&FMonth=" + FMonth.ToString() + "&FYear=" + FYear.ToString() + "&TMonth=" + TMonth.ToString() + "&TYear=" + TYear.ToString() + "&sf_name=" + ddlMR.SelectedItem.Text.ToString();

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorPotentialBusinessView.aspx.cs" Inherits="MasterFiles_ActivityReports_DoctorPotentialBusinessView" %>
...
<head id="Head1" runat="server">
    <title>Doctor Potential - View</title>
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sfname, basedOn) {
            popUpObj = window.open("rpDoctorPotentialBusinessView.aspx?sfcode=" + sfcode + " &sfname=" + sfname + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sfname + "&basedOn=" + basedOn,
                        "ModalPopUp"//,
                        //"toolbar=no," +
                        //"scrollbars=yes," +
                        //"location=no," +
        ...
        var popUpObj1;
        function showModalPopUp1(sfcode, fmon, fyr, tmon, tyr, sfname, sCurrentDate, basedOn) {
            popUpObj1 = window.open("rpDoctorPotentialBusinessView1.aspx?sf_code=" + sfcode + "&sf_name=" + sfname + "&Year=" + fyr + "&Month=" + fmon + "&sCurrentDate=" + sCurrentDate + "&MR=1&FMonth=&FYear=&TMonth=&TYear=&basedOn=" + basedOn + "",
                    "ModalPopUp,"// +
                    //"toolbar=no," +
                    //"scrollbars=yes," +
                    //"location=no," +
            ...
            $('#btnGo').click(function () {
                ...
                if (FYea <= TYea) {
                    if (SMCode == 1) {
                        ...
                        var sfname = '<%= Session["sf_name"] + " - " + Session["Designation_Short_Name"] + " - " + Session["Sf_HQ"] %>';
                        <%--var fmon = $('#<%=ddlFMonth.ClientID%> :selected').val();
                        var fyr = $('#<%=ddlFYear.ClientID%> :selected').val();--%>
                        var TMont = "";
                        var TYea = "";
                        var sCurrentDate = "";
                        var basedOn = $('#<%=hdnBasedOn.ClientID%>').val();

                        showModalPopUp1(sfcode, FMont, FYea, TMont, TYea, sfname, sCurrentDate, basedOn)
                    }
                    else {
                        var sfcode = $('#<%=ddlFieldForce.ClientID%> :selected').val();
                        var sfname = $('#<%=ddlFieldForce.ClientID%> :selected').text();
                        ...
                        showModalPopUp(sfcode, FMont, FYea, TMont, TYea, sfname, basedOn)
                    }
                }
            });
        });
                ...
                <div class="col-lg-5">
                    <center>
                        <table>
                            <tr>
                                <td align="center">
                                    <h2 class="text-center">Doctor Potential Productwise - View</h2>
                                </td>
                            </tr>
                        </table>
                    </center>

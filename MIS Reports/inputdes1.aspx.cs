...
public partial class MIS_Reports_inputdes1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //FillProd();
            lblProd.Text = "Input Despatch View for the Period of " + strMonthName + " " + Year + " ";
    ...
    private void CreateDynamicTable()
    {
        ...
        //foreach (string prd in Product_Code)
        //{
        dsDr = dr.getinput_productname(div_code, sf_code, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate);
        ...
        if (dsDr.Tables[0].Rows.Count > 0)
        {
            ...
            lit_det_head_qua.Text = "<b>Gift Name</b>";

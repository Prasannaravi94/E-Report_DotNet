...
public partial class MasterFiles_AnalysisReports_rpt_Hq_Multiple : System.Web.UI.Page
{
   ...
   //     dsmgrsf.Tables.Add(ProdCodes);
        string HQ = HQ_name.Remove(HQ_name.Length - 1);
        string[] Productdet;
        Productdet = HQ.Split(',');
        ...
        sProc_Name = "SecSale_Analysis_HQ_Horizontal";
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            if (months1 >= 0)
            {
                ...
                for (int j = 1; j <= months1 + 1; j++)
                {
                    ...
                    int iColSpan = 0;
                    //iLstColCnt.Add(3);
                    string strrprod = HQ_name.Remove(HQ_name.Length - 1);
                    ...
                    foreach (string str in strSplit)
                    {
                        ...
                        AddMergedCells(objgridviewrow2, objtablecell2,2, str, "#0097AC", false);

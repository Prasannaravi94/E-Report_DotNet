...
public partial class MIS_Reports_Input_Status_CalendarYearWise : System.Web.UI.Page
{
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        {
            //strqry = "Exec Input_CalnedarYearwise_FFwise_OB '" + div_code + "','" + From_year + "','" + To_year + "'";
            if (sf_code.Contains("MGR") || sf_code.Contains("MR"))
            {
                //strqry = "Exec Input_CalnedarYearwise_FFwise_OB_Add_Hierarchy '" + div_code + "','" + sf_code + "','" + From_year + "','" + To_year + "'";

                strqry = "Exec Input_CalnedarYearwise_FFwise_OB_Add_Hierarchy_ty '" + div_code + "','" + sf_code + "','" + From_year + "','" + To_year + "'";
            ...
            else
            {
                ...
                strqry = "Exec Input_CalnedarYearwise_FFwise_OB_ty '" + div_code + "','" + From_year + "','" + To_year + "'";   // changed on 29-10-25
        ...
        else
        {
            if (sf_code.Contains("MGR") || sf_code.Contains("MR"))
            {
                //strqry = "Exec Input_CalnedarYearwise_OB_Add_Hierar '" + div_code + "','" + sf_code + "','" + From_year + "','" + To_year + "'";

                strqry = "Exec Input_CalnedarYearwise_OB_Add_Hierar_ty '" + div_code + "','" + sf_code + "','" + From_year + "','" + To_year + "'";

            }
            else
            {
                //strqry = "Exec Input_CalnedarYearwise_OB '" + div_code + "','" + From_year + "','" + To_year + "'";

                strqry = "Exec Input_CalnedarYearwise_OB_ty '" + div_code + "','" + From_year + "','" + To_year + "'";
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        if (Fieldforcewise.Checked == true)
        {
            ...
            else
            {
                ...
                strqry = "Exec Input_CalnedarYearwise_FFwise_OB_ty '" + div_code + "','" + From_year + "','" + To_year + "'";

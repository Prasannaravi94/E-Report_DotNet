        ...
        if (ViewState["dsDocSubCat"] != null)
        {
            ...
            foreach (DataRow drFF in dsDocSubCat.Tables[0].Rows)
            {
                ...
                foreach (DataRow dataRow in dsSalesForce.Tables[0].Rows)
                {
                    ...
                    if (dataRow["sf_code"].ToString().Contains("MR"))
                    {
                        ...
                        else
                        {
                            ...
                            sURL = "rptCampaign_View.aspx?sf_code=" + dataRow["sf_code"].ToString() + "&sf_name=" + dataRow["Sf_Name"].ToString() + "&camp_code=" + drFF["Doc_SubCatCode"].ToString() + " &sf_name=" + dataRow["sf_name"].ToString() + "&sf_hq=" + dataRow["sf_hq"].ToString() + "&div=" + div_code + " &mode=1";
                    ...
                    else
                    {
                        ...
                        foreach (DataRow dr in dsSfMR.Tables[0].Rows)
                        {
                            ...
                            else
                            {
                                ...
                                sURL = "rptCampaign_View.aspx?sf_code=" + dataRow["sf_code"].ToString() + "&sf_name=" + dataRow["Sf_Name"].ToString() + "&camp_code=" + drFF["Doc_SubCatCode"].ToString() + " &sf_name=" + dataRow["sf_name"].ToString() + "&sf_hq=" + dataRow["sf_hq"].ToString() + "&div=" + div_code + "&mode=2";
                                hyp_catg_det_name.Attributes["onclick"] = "javascript:window.open('" + sURL + "',null,'');";
                                hyp_catg_det_name.NavigateUrl = "#";
                ...
                else
                {
                    foreach (DataRow dataRow in dsSalesForce.Tables[0].Rows)
                    {
                        sURL = "rptCampaign_View.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&camp_code=" + drFF["Doc_SubCatCode"].ToString() + "&sf_name=" + dataRow["Sf_Name"].ToString() + "&div=" + div_code + "&mode=3";
            ...
            foreach (DataRow dataRow in dsSalesForce.Tables[0].Rows)
            {
                ...
                if (iTotal_Catg[i] > 0)
                    ...
                    {
                        sURL = "rptCampaign_View.aspx?sf_code=" + dataRow["sf_code"].ToString() + "&sf_name=" + dataRow["Sf_Name"].ToString() + "&div=" + div_code + "&mode=4";
            ...
            if (tot_catg > 0)
                foreach (DataRow dataRow in dsSalesForce.Tables[0].Rows)
                {
                    ...
                    sURL = "rptCampaign_View.aspx?sf_code=" + sf_code + "&sf_name=" + dataRow["Sf_Name"].ToString() + "&div=" + div_code + "&mode=5";

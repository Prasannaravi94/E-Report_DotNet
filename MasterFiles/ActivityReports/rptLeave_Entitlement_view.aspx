<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptLeave_Entitlement_view.aspx.cs" Inherits="MasterFiles_ActivityReports_rptLeave_Entitlement_view" %>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                    ...
                    <asp:Label ID="lblHead" Text="Leave Status View" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Primary_Stk_Bill_View.aspx.cs" Inherits="MasterFiles_AnalysisReports_Primary_Stk_Bill_View" %>
...
<head runat="server">
    <title>Primary Bill Stockist View</title>
    <style type="text/css">
        td.stylespc {
            padding-bottom: 5px;
            padding-right: 5px;
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(fmon, fyr, tyear, tmonth, Sf_Code, div_code) {
            ...
            popUpObj = window.open("rpt_Primary_Stk_Bill_View.aspx?Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + "&Mode=" + "1" + "&Sf_Code=" + Sf_Code + "&div_code=" + div_code,
"ModalPopUp"//,
//"toolbar=no," +
//"scrollbars=yes," +
//"location=no," +

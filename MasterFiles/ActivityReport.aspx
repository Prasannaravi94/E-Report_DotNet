<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActivityReport.aspx.cs" Inherits="MasterFiles_ActivityReport" %>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Activity Reports</h2>
                        ...
                        <div class="designation-area clearfix">
                            ...
                            <asp:Panel ID="pnlFFDate" runat="server" Visible="false">
                                ...
                                <%--<div class="single-des clearfix">
                                    <asp:CheckBox ID="chkTick" runat="server" Text="With Processed" onclick="SelectAllCheckboxes(this, '.AllTick')" Visible="false"></asp:CheckBox>
                                </div>--%>
                            </asp:Panel>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-10">
                        <div class="display-table clearfix">
                            <div class="table-responsive">
                                <asp:GridView ID="grdActUpload" runat="server" Width="100%" HorizontalAlign="Center" AutoGenerateColumns="false"  EmptyDataText="No Records Found" OnRowCommand="grdActUpload_RowCommand" GridLines="None" CssClass="table" PagerStyle-CssClass="pgr" OnRowDataBound="grdActUpload_RowDataBound"  AllowPaging="True"
                                        PageSize="50" OnPageIndexChanging="grdActUpload_PageIndexChanging"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Print View" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <%--  <a href="#" onclick="window.open('Processing_ActPrint.aspx?Activity_ID=<%#Eval("Activity_ID")%>&amp;Sf_Code=<%#Eval("Sf_Code")%>&amp;Date_Activity_Approval=<%#Eval("Date_Activity_Approval")%>&amp;','PrintMe','height=700px,width=700px,scrollbars=1');">Click Print</a>--%>
                                        ...
                                        <asp:TemplateField HeaderText="Process status" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hdnProcess" runat="server" Value='<%# Bind("Process_Flag") %>' />
                                                <asp:Label ID="lblProcess_Flag" runat="server" Text='<%# Bind("Process_Flag") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Distance_fixation_view_Allsfc.aspx.cs"
    Inherits="MasterFiles_sfc_view" %>
        ...
        <div id="mainDiv" runat="server">
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <h2 class="text-center">Distance Fixation View</h2>
                        <div class="designation-reactivation-table-area clearfix">
                            <div class="display-name-heading text-center clearfix">
                                ...
                                <div class="d-inline-block division-name">
                                    <div class="single-des-option" style="width:55%">
                                        <asp:DropDownList ID="ddlSubdiv" CssClass="custom-select2 nice-select" Visible="false" runat="server">
                                        </asp:DropDownList>
                            ...
                            <div style="text-align: center">
                                <asp:Button ID="btnSF" runat="server" Text="Go" CssClass="savebutton" Visible="false"
                                    OnClick="btnSF_Click" />
                            </div>
                            <br />
                            <div class="row ">
                                <div class="col-lg-12">
                                    <asp:Panel ID="pnlprint" CssClass="panelmarright" runat="server" Visible="false">
...
<%--                                                            <ControlStyle Width="90%"></ControlStyle>
                                ...
                                <table width="50%" align="center">
                                    <tr>
                                        <td align="center">
                                            <asp:GridView ID="Gridwrktyp" runat="server" Width="50%" HorizontalAlign="Center"
                                                AutoGenerateColumns="false" EmptyDataText="No Records Found" GridLines="None"
                                                CssClass="table" PagerStyle-CssClass="GridView1" AlternatingRowStyle-CssClass="alt" Visible="false">
                                                <Columns>

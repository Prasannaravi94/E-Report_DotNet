...
public partial class MasterFiles_AnalysisReports_Core_Drs : System.Web.UI.Page
{
    ...
    //    dsDoctor = doc.getDocCampaign_all(div_code);
    //    dsDoctor.Tables[0].Rows[1].Delete();
    ...
    private void FillManagers_OLD()
    {
        ...
        //{
        //    ddlAlpha.Visible = false;
        dsSalesForce = sf.UserListTP_Hierarchy_New(div_code, "admin");
        //}
    ...
    //    }
    //}
    private void FillManagers_Only()
    {
        SalesForce sf = new SalesForce();
        DataSet DsAudit = sf.SF_Hierarchy(div_code, sf_code);
        if (DsAudit.Tables[0].Rows.Count > 0)

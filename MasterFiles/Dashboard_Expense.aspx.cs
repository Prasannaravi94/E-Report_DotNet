...
public partial class MasterFiles_Dashboard_Expense : System.Web.UI.Page
{
    #region Declaration
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MasterFiles/MR/RptAutoExpense_RowWise_Dashboard.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&monthId=" + cmonth + "&yearId=" + cyear + "&divCode=" + div_code + "&sfname=" + ddlFieldForce.SelectedItem.Text + "&dbtype=1");
        //ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MasterFiles/Reports/RptAutoExpense_view1.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&monthId=" + cmonth + "&yearId=" + cyear + "&divCode=" + div_code + "&sfname=" + ddlFieldForce.SelectedItem.Text);

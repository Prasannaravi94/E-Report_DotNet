<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SecSales_Stockist_Edit_FinYr.aspx.cs" Inherits="MasterFiles_Options_SecSales_Stockist_Edit_FinYr" %>

<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Secondary Sales Delete</title>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="w-100 designation-submit-button text-center clearfix">
                            <br />
                            <asp:Button ID="btnSubmit" runat="server" Text="Delete" CssClass="savebutton" Visible="false" OnClientClick="return confirm('Do you want to allow Sec Sales Delete for the selected stockiest(s)');"

...
using DBase_EReport;
using ClosedXML;
public partial class MasterFiles_AnalysisReports_ListeddrPeriod_ALL_Dump : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        for (int iCol = 0; iCol < countCol; iCol++)
        {
            ...
            if (col.ColumnName != "sno" && col.ColumnName != "sf_name" && col.ColumnName != "SVL_No"
                && col.ColumnName != "Backend Code"
               && col.ColumnName != "ListedDr_Name" && col.ColumnName != "Cat" && col.ColumnName != "Spec")
            {
    ...
    **/
        ...
        //Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "Dump.xls"));

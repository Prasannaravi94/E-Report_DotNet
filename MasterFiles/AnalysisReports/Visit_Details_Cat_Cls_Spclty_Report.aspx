<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Cat_Cls_Spclty_Report.aspx.cs"
...
<body style="overflow-x: scroll">
    <form id="form1" runat="server">
        <%--<div>--%>
          ...
          <script src="../../JScript/table2excel.js" type="text/javascript"></script>
            <script type="text/javascript">
              
                function FrameDownload() {
                    $("[id*=GrdDoctor]").table2excel({

...
public partial class MIS_Reports_InputFor_Drs : System.Web.UI.Page
{
    ...
    private void Fillinput()
    {
        ...
        dsChkinput = dr.getinput_Name(div_code);
        chkinput.DataSource = dsChkinput;
    ...
    private void setValueToChkBoxList()
    {
        try
        {
            foreach (ListItem item in chkinput.Items)
            {

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewDetails_DrWise_Report.aspx.cs"
                        ...
                        <div class="col-lg-12">
                            <asp:Panel ID="pnlContents" runat="server">
                                <div align="center">
                                 ...
                                 <asp:Label ID="lblSpci" runat="server" CssClass="label"
                                     Font-Size="18px"></asp:Label>
                                </div>
                                ...
                                <div class="display-reportMaintable clearfix">
                                    <div class="table-responsive" style="scrollbar-width: thin;">
                                        <asp:Panel runat="server">
                                            <table width="100%">
                                                <caption>
                                                    <asp:GridView ID="GrdDoctor" runat="server" AutoGenerateColumns="true" AllowSorting="true" Style="background-color: white" BorderWidth="1" BorderColor="WhiteSmoke"
                                                        EmptyDataText="No Records Found" GridLines="Both" CssClass="table" HorizontalAlign="Center" Width="100%" OnSorting="grdDoctor_Sorting">

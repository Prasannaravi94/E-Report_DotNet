...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                ...
                <div class="row justify-content-center ">
                    <div class="col-lg-11">
                        <h2 class="text-center">Listed Doctor Deactivation</h2>
                            ...
                            <div class="display-name-heading clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-11" style="padding-top: 22px;">
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <asp:Image ID="imgCrosslbl" runat="server" ImageUrl="../../../Images/cross.png" />&nbsp;
                                                <asp:Label ID="lblvisit" runat="server" ForeColor="#696D6E" Text="Visited Dr"></asp:Label>
                                            </div>
                                           <%-- <div class="col-lg-4">
                                                <asp:Image ID="imgCross2lbl" runat="server" ImageUrl="~/Images/Campcross.png" />&nbsp;
                                                   <asp:Label ID="lblcamp" runat="server" ForeColor="#696D6E" Text="Camp Dr and Core/Camp"></asp:Label>
                                            </div>
                                            <div class="col-lg-2">
                            ...
                            <div class="display-table clearfix">
                                <div class="table-responsive" style="scrollbar-width: thin;">
                                    <asp:GridView ID="grdDoctor" runat="server" Width="100%" HorizontalAlign="Center" EmptyDataText="No Records Found"
                                        ...
                                        <Columns>
                                            <asp:TemplateField SortExpression="ListedDrCode" HeaderText="#">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Image ID="imgCross2" runat="server" ImageUrl="../../../Images/Campcross.png" Visible="false" />
                                            ...
                                            <asp:TemplateField HeaderText="Created Date" SortExpression="ListedDr_Created_Date" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCreated" runat="server" Text='<%#Bind("ListedDr_Created_Date") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
        ...
        <div class="div_fixed">
            <asp:Button ID="btnSave" runat="server" CssClass="savebutton" Text="De-Activate" OnClick="btnSave_Click" Visible="false" />
        </div>

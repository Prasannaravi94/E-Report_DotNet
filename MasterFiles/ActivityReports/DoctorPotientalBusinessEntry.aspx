<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="DoctorPotientalBusinessEntry.aspx.cs" Inherits="MasterFiles_ActivityReports_DoctorPotientalBusinessEntry" %>
            ...
            <div class="col-lg-5">
                <center>
                    <table>
                        <tr>
                            <td align="center">
                                <h2 class="text-center">Doctor Potential Productwise - Entry</h2>
                            </td>
                        </tr>
                    </table>
                </center>
                            ...
                            <center>
                                ...
                                <asp:GridView ID="gvProduct" runat="server" AlternatingRowStyle-CssClass="alt"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Potential Qty" HeaderStyle-Width="100">
                                            <ItemTemplate>

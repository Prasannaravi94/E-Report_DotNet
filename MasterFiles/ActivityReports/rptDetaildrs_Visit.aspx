<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDetaildrs_Visit.aspx.cs" Inherits="MasterFiles_Reports_rptExp_Consolidated_View" %>
...
<head id="Head1" runat="server">
    ...
    <script type = "text/javascript">
        ...
        function showModalPopUp(sfcode, divcode, FMonth, FYear, mode,selValues, Sf_Name, SfMGR) {
            //alert('HI');
            popUpObj = window.open("rptDetaildrs_Visit_Zoom.aspx?sfcode=" + sfcode + "&divcode=" + divcode + "&FMnth=" + FMonth + "&FYear=" + FYear + "&mode=" + mode + "&selValues=" + selValues + "&Sf_Name=" + Sf_Name + "&SfMGR=" + SfMGR,
            "_blank",
        "ModalPopUp_Level1," +
         "0," +
        "toolbar=no," +

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Chmst_Product_Wise_Sale_Report.aspx.cs" Inherits="MIS_Reports_Visit_Details_Chmst_Product_Wise_Sale_Report" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, SfName, Months, Year, fmon, fyr, cmode, Type) {
            popUpObj = window.open("Visit_Details_Chmst_Product_Wise_Sale_Zoom_Report.aspx?sfcode=" + sfcode + "&SfName=" + SfName + "&Months=" + Months + "&Year=" + Year + "&FMonth=" + fmon + "&Mode=" + "1" + "&FYear=" + fyr + "&cMode=" + cmode + "&Type=" + Type,
            "_blank",
        "ModalPopUp_Level1," +
         "0" //+
        //"toolbar=no," +
                    ...
                    <div class="col-lg-12">
                        <asp:Panel ID="pnlContents" runat="server">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <asp:Label ID="lblHQ1" runat="server" Text="HQ" CssClass="label"
                                        Font-Size="16px"></asp:Label>
                                </div>
                                <div class="col-lg-3">

    ...
    <form id="form1" runat="server">
         ...
         <center>
                ...
                <table id="Table1" runat="server" style="width: 100%;  font-family:Tahoma; font-size:x-small;" cellspacing="0" cellpadding= "0">
                    <tr>
                        <td align="center">
                            <asp:Label ID="lblld" runat="server" Text="Listed Doctor Details" Font-Size="Small" Font-Names="Verdana"  Font-Underline="true"></asp:Label>
                ...
                <br />
                 <table id="tblPreview_UnLstDoc" runat="server" style="width: 100%;  font-family:Tahoma; font-size:x-small;" cellspacing="0" cellpadding= "0">
                    <tr>
                        <td align="center">
                         <asp:Label ID="lblunls" runat="server" Text="UnListed Doctor Details" Font-Size="Small" Font-Names="Verdana"  Font-Underline="true"></asp:Label>
               ...
               <br />
                ...
                <div style="margin-left:40%">
                    <asp:Button ID="btnSave" CssClass="savebutton" runat="server" Text="Approve DCR" OnClick="btnSave_Click" />
                    &nbsp
                    <asp:Button ID="btnReject" CssClass="savebutton" runat="server" Text="Reject DCR" OnClick="btnReject_Click" />
                    &nbsp                               

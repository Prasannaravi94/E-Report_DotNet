...
public partial class MIS_Reports_sampledes1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //FillProd();
            lblProd.Text = "Sample Despatch View for the Period of " + strMonthName + " " + Year + " ";
    ...
    private void CreateDynamicTable()
    {
        ...
        //foreach (string prd in Product_Code)
        //{
        dsDr = dr.getdespatch_productname(div_code, sf_code, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate);

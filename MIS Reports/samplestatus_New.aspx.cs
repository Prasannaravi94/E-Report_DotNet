...
public partial class MIS_Reports_samplestatus_New : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dsmonth = sf.samplemnthyr(div_code);
        if (dsmonth.Tables[0].Rows.Count <= 0)
        {
            monthval.Value = "1";
        }
        else if (dsmonth.Tables[0].Rows.Count > 0 && dsmonth.Tables[0].Rows[0]["SI_EM_Month"].ToString() == "0" || dsmonth.Tables[0].Rows[0]["SI_EM_Year"].ToString() == "0")
        {
            monthval.Value = "1";
        }
        if (!Page.IsPostBack)
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        //            sURL = "sampleissued.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString();

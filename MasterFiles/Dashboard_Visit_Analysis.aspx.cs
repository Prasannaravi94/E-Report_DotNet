...
public partial class MasterFiles_Dashboard_Visit_Analysis : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MIS%20Reports/Visit_Month_Vertical_Wise_Report.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&Fyear=" + cyear + "&TMonth=" + cmonth + "&Tyear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&cMode=" + "1" + "&cLvl=" + "1" + "&div_code=" + div_code);

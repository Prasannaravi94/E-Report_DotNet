<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptProduct_Priority_Wise1.aspx.cs" Inherits="MIS_Reports_rptProduct_Priority_Wise1" %>
            ...
            <table width="100%">
                <tr>
                    ...
                    <%-- <td width="80%" align="center">
                        <asp:Label ID="lblProd" runat="server" Text="Product Prioritywise" SkinID="lblMand"></asp:Label>
                    </td>--%>
                    <td align="right">
                        <table>
                            <tr>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <asp:Panel ID="pnlContents" runat="server" Width="100%">
                        <div align="center">
                            <asp:Label ID="lblProd" runat="server" Text="Product Prioritywise" CssClass="reportheader"></asp:Label>
                            <br />
                            <br />
                            <asp:Label ID="lblfieldname" runat="server" CssClass="label" Font-Size="18px"></asp:Label>
                            <asp:Label ID="lblname" runat="server" CssClass="label" Font-Size="18px"></asp:Label>
                            <br />
                            <br />
                        </div>

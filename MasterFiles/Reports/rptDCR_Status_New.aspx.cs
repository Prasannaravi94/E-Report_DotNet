...
public partial class MasterFiles_Reports_rptDCR_Status_New : System.Web.UI.Page
{
    ...
    private void status_peridically()
    {
        ...
        if (dtDCRfrom.Month == Current_month_Year.Month && dtDCRfrom.Year == Current_month_Year.Year && dtDCRto.Month == Current_month_Year.Month && dtDCRto.Year == Current_month_Year.Year || dtDCRfrom.Month == Current_month_Year.Month && dtDCRfrom.Year == Current_month_Year.Year)
        {

            SqlCommand cmd = new SqlCommand("DCR_STATUS_NEW_NEW_Periodically_Currnt_Month", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Div_Code", Convert.ToInt32(divcode));
            cmd.Parameters.AddWithValue("@Msf_code", sfCode);
            cmd.Parameters.AddWithValue("@MnthTbl", dtMnYr);
        ...
        else
        {
            ...
            SqlCommand cmd = new SqlCommand("DCR_STATUS_NEW_NEW_Periodically", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Div_Code", Convert.ToInt32(divcode));
            cmd.Parameters.AddWithValue("@Msf_code", sfCode);
            cmd.Parameters.AddWithValue("@MnthTbl", dtMnYr);
        ...
        {
            if (dtDCRto.Month == Current_month_Year.Month && dtDCRto.Year == Current_month_Year.Year)
            {


                SqlConnection conn = new SqlConnection(strConn);

                SqlCommand cmd1 = new SqlCommand("DCR_STATUS_NEW_NEW_Periodically2_Currnt_Month", conn);
                cmd1.CommandType = CommandType.StoredProcedure;
                cmd1.Parameters.AddWithValue("@Div_Code", Convert.ToInt32(divcode));
                cmd1.Parameters.AddWithValue("@Msf_code", sfCode);
                cmd1.Parameters.AddWithValue("@MnthTbl", dtMnYr);
                // cmd1.Parameters.AddWithValue("@Strfromth", dtfrmth);
                cmd1.Parameters.AddWithValue("@StrTomth", dtTomth);
                cmd1.Parameters.AddWithValue("@fromdate", fromdate);
                cmd1.Parameters.AddWithValue("@todate", todate);
                cmd1.Parameters.AddWithValue("@Tomonth", dtDCRto.Month);
                cmd1.Parameters.AddWithValue("@Toyear", dtDCRto.Year);
                cmd1.Parameters.AddWithValue("@Detailed", 0);
                cmd1.Parameters.AddWithValue("@checkVacant", checkVacant);
                cmd1.CommandTimeout = 150;

                SqlDataAdapter daa = new SqlDataAdapter(cmd1);
                DataSet dsts1 = new DataSet();
                daa.Fill(dsts1);
                dtrowClr_New = dsts1.Tables[0].Copy();
                //dsts1.Tables[0].Columns.RemoveAt(11);
                dsts1.Tables[0].Columns.RemoveAt(10);
                dsts1.Tables[0].Columns.RemoveAt(9);
                dsts1.Tables[0].Columns.RemoveAt(8);
                dsts1.Tables[0].Columns.RemoveAt(7);
                dsts1.Tables[0].Columns.RemoveAt(6);
                dsts1.Tables[0].Columns.RemoveAt(5);
                dsts1.Tables[0].Columns.RemoveAt(4);
                dsts1.Tables[0].Columns.RemoveAt(3);
                dsts1.Tables[0].Columns.RemoveAt(2);
                dsts1.Tables[0].Columns.RemoveAt(1);
                dsts1.Tables[0].Columns.RemoveAt(0);
                GridView1.DataSource = dsts1;
                GridView1.DataBind();
            }
            ...
            else
            {
                ...
                SqlCommand cmd1 = new SqlCommand("DCR_STATUS_NEW_NEW_Periodically2", conn);
                cmd1.CommandType = CommandType.StoredProcedure;
                cmd1.Parameters.AddWithValue("@Div_Code", Convert.ToInt32(divcode));
                cmd1.Parameters.AddWithValue("@Msf_code", sfCode);
                cmd1.Parameters.AddWithValue("@MnthTbl", dtMnYr);
    ...
    private void FillSample_Prd()
    {
        ...
        if (Convert.ToInt16(FMonth) == Current_month_Year.Month && Convert.ToInt16(FYear) == Current_month_Year.Year)
        {
            ...
            SqlCommand cmd = new SqlCommand("DCR_STATUS_NEW_NEW_Currnt_Month", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Div_Code", Convert.ToInt32(divcode));
            cmd.Parameters.AddWithValue("@Msf_code", sfCode);
            cmd.Parameters.AddWithValue("@MnthTbl", dtMnYr);
        ...
        {
            SqlCommand cmd = new SqlCommand("DCR_STATUS_NEW_NEW", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Div_Code", Convert.ToInt32(divcode));
            cmd.Parameters.AddWithValue("@Msf_code", sfCode);
            cmd.Parameters.AddWithValue("@MnthTbl", dtMnYr);
    ...
    protected void Grdprd_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (type == "1")
        {
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                AddMergedCells(objgridviewrow, objtablecell, 0, days, sTxt, "#0097AC", true);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            for (int i = 1, j = 2; i < e.Row.Cells.Count; i++, j++)
            {
                if (e.Row.Cells[i].Text != "-" && e.Row.Cells[i].Text != "&nbsp;")
                {
                    HyperLink hLink = new HyperLink();
                    hLink.Text = e.Row.Cells[i].Text;
                    string sSf_code = dtrowClr_New.Rows[iInx][1].ToString();
                    string sdate = dtrowClr_New.Rows[iInx][11].ToString();
                    ...
                    if ((month == Convert.ToInt16(dtDCRto.Month)) && (year == Convert.ToInt16(dtDCRto.Year)))
                    {
                    ...
                    int value;
                    tot = hLink.Text;
                    if (!(int.TryParse(hLink.Text, out value)))
                    {

                        if (tot != "L" && tot != "LP" && tot != "NA" && tot != "D" && tot != "DR" && tot != "MD" && tot != "MR" && tot != "SL" && tot != "PL" && tot != "CL" && tot != "LOP" && tot != "R" && tot != "RE" && tot != "TD" && tot != "TDR")
                        {
                            if (chkatten == "1")
                            {
                                hLink.Text = "P";
                        ...
                        else if (tot == "L" || tot == "LP" || tot == "SL" || tot == "PL" || tot == "CL" || tot == "LOP" || tot == "R" || tot == "RE")
                        {
                            if (chkatten == "1")
                            {
                        ...
                        if (tot == "D" || tot == "DR")
                        {
                            ...
                            e.Row.Cells[i].ForeColor = System.Drawing.Color.Magenta;
                        }
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                for (int i = 6, j = 1; i < e.Row.Cells.Count; i++, j++)
                {
                    ...
                    if (e.Row.Cells[i].Text != "-" && e.Row.Cells[i].Text != "&nbsp;")
                    {
                        ...
                        if (tot != "L" && tot != "LP" && tot != "NA" && tot != "D" && tot != "DR" && tot != "MD" && tot != "MR" && tot != "SL" && tot != "PL" && tot != "CL" && tot != "LOP" && tot != "LR" && tot != "R" && tot != "RE" && tot != "TL" && tot != "TD" && tot != "TDR")
                        {
                            if (chkatten == "1")
                            {
                                if (tot == "WO" || tot == "H")
                        ...
                        else if (tot == "L" || tot == "LP" || tot == "SL" || tot == "PL" || tot == "CL" || tot == "LOP" || tot == "LR" || tot == "R" || tot == "RE" || tot == "TL")
                        {
                            if (chkatten == "1")
                            {
                                //  hLink.Text = "A";
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                for (int i = 6, j = dtDCRfrom.Day; i < e.Row.Cells.Count; i++, j++)
                {
                    ...
                    if (e.Row.Cells[i].Text != "-" && e.Row.Cells[i].Text != "&nbsp;")
                    {
                        ...
                        tot = hLink.Text;
                        if (tot != "L" && tot != "LP" && tot != "NA" && tot != "D" && tot != "DR" && tot != "MD" && tot != "MR" && tot != "SL" && tot != "PL" && tot != "CL" && tot != "LOP" && tot != "LR" && tot != "R" && tot != "RE" && tot != "TD" && tot != "TDR")
                        {
                            if (chkatten == "1")
                            {
                        ...
                        else if (tot == "L" || tot == "LP" || tot == "SL" || tot == "PL" || tot == "CL" || tot == "LOP" || tot == "LR" || tot == "R" || tot == "RE")
                        {
                            if (chkatten == "1")
                            {
                                //hLink.Text = "A";

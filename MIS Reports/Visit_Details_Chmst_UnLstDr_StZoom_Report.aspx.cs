...
public partial class MIS_Reports_Visit_Details_Chmst_UnLstDr_StZoom_Report : System.Web.UI.Page
{
    #region variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Stockiest Visit For  - " + FMonth + " " + FYear;
 ...
 #region FillReport
    private void FillReport()
    {
        ...
        //}
        //
            string cDate = (Convert.ToInt32(Months) + 1).ToString() + "-01-" + FYear;
            if (Months == "12")
            {
                cDate = "01-01-" + (Convert.ToInt32(FYear) + 1).ToString();
            }
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("visit_details_Chmst_UnLst_Stockiest_Seen", con);
    ...
    protected void GrdFixationMode_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            //AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Chemist Code", "#99FF99", false); 
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Stockiest Name", "#99FF99", true);
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Teritory Name", "#99FF99", true);
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "HQ", "#99FF99", true);
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Visit Count", "#99FF99", true);

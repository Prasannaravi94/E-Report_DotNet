...
public partial class MIS_Reports_Visit_Details_Basedonfield_Level1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sLvl = Request.QueryString["cLvl"].ToString();
        ...
        lblHead.Text = "Visit Analysis Of " + sHeading + " Wise Between  - " + strFrmMonth.Substring(0,3) + " " + FYear + "  To  " + strToMonth.Substring(0,3) + " " + TYear;
        LblForceName.Text = "Field Force Name : " + sf_name;
        screen_name = "Visit_Month_Vertical_Wise_Report";
        if (!Page.IsPostBack)
        {
            FillCatg();
        }
    ...
    private void FillCatg()
    {
        ...
        //{
        //    if (sLvl == "1")
        //        sProc_Name = "visit_Month_Vertical_wise_Cat";
        //    else
        //        sProc_Name = "visit_Month_Vertical_wise_Cat_Mgr";
        //}
        //else if (sReportType == 2)
        //{
        //    if (sLvl == "1")
        //        sProc_Name = "visit_Month_Vertical_wise_Spclty";
        //    else
        //        sProc_Name = "visit_Month_Vertical_wise_Spclty_Mgr";
        //}
        //else if (sReportType == 3)
        //{
        //    if (sLvl == "1")
        //        sProc_Name = "visit_Month_Vertical_wise_Cls";
        //    else
        //        sProc_Name = "visit_Month_Vertical_wise_Cls_Mgr";
        //}
        if (sLvl == "1")
            sProc_Name = "visit_Month_Vertical_wise_Rpt_Cat_Met";
        else
            sProc_Name = "visit_Month_Vertical_wise_Rpt_Cat_Mgr";
        con.Open();
    ...
    protected void GrdFixationMode_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 3, 0, "Design", "#008080", true);
            ...
            //
            AddMergedCells(objgridviewrow, objtablecell, 2, iMax_Visit + 2, "Call Details", "#008080", true);
            string iVal_Visit = "";
            for (int k = 0; k <= iMax_Visit; k++)
            {
                if (k==iMax_Visit)
                    iVal_Visit="Dr Met Above "+(k).ToString()+" Times";
                else
                    iVal_Visit = "Dr Met " + (k + 1).ToString() + " Times";
                AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, iVal_Visit, "#008080", false);
            }
            //
            AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Dr missed", "#008080", false);
            //
            AddMergedCells(objgridviewrow, objtablecell, 2, 5, "Daywise Detail", "#008080", true);
            ...
            AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "No Field", "#008080", false);
            ...
            //
            AddMergedCells(objgridviewrow, objtablecell, 2, 3, "Territory Coverage", "#008080", true);
            AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "HQ Worked", "#008080", false);
            AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "EX Worked", "#008080", false);
            AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "OS Worked", "#008080", false);
            AddMergedCells(objgridviewrow, objtablecell, 2, 2, "Total", "#008080", true);
            AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Lst dr Met", "#008080", false);
            AddMergedCells(objgridviewrow3, objtablecell3, 0, 0, "Lst dr Seen", "#008080", false);
            //
    ...
    protected void GrdFixationMode_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //if (sReportType == 1)
            {
                ...
                hLink.Text = e.Row.Cells[e.Row.Cells.Count - 2].Text;
                hLink.Attributes.Add("class", "btnDrSn");
                hLink.Attributes.Add("onclick", "javascript:showModalPopUp('" + sf_code + "',  '" + (dtMnYr.Rows[Convert.ToInt32(e.Row.Cells[7].Text) - 1]["MNTH"].ToString()) + "', '" + dtMnYr.Rows[Convert.ToInt32(e.Row.Cells[7].Text) - 1]["YR"].ToString() + "', '" + TMonth + "', '" + TYear + "','" + sLvl + "','" + Request.QueryString["sf_name"].ToString() + "','" + Convert.ToString(dtrowClr.Rows[indx][1].ToString()) + "')");
                ...
                e.Row.Cells[e.Row.Cells.Count - 2].Controls.Add(hLink);

...
public partial class MIS_Reports_rptinputstatus_New : System.Web.UI.Page
{
    int cmonth = -1;
    int cyear = -1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblHead.Text = "Input Despatch Status of  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
        }
    ...
    private void FillDespatch_status()
    {
        ...
        dsSalesForce = sf.Input_Status_New(div_code, SF_code, FMonth, FYear, TMonth, TYear);
    ...
    protected void grdDespatch_OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label lblinputqty = (Label)e.Row.FindControl("lblinputqty");
            Label lblissued = (Label)e.Row.FindControl("lblissued");
            Label lblclosing = (Label)e.Row.FindControl("lblclosing");

            //e.Row.Cells[2].Attributes.Add("onmouseover", "this.style.backgroundColor='lightblue'");
            //e.Row.Cells[2].Attributes.Add("onmouseout", "this.style.backgroundColor='white'");
            //e.Row.Cells[2].Attributes.Add("onmouseover", "this.style.textDecoration='underline'");

            //e.Row.Cells[2].Attributes["onmouseover"] = "javascript:SetMouseOver(this)";
           ...
           // linksf_name.Attributes.Add("style", "color:black");


            if ((lblissued.Text != "") && (lblopening.Text != "") && (lblinputqty.Text != ""))
            {
                int open1 = Convert.ToInt32(lblopening.Text);
                int samp1 = Convert.ToInt32(lblinputqty.Text);
                ...
                else
                {
                    ...
                    int sampldes = Convert.ToInt32(lblinputqty.Text);
            ...
            else if (lblopening.Text != "" && lblinputqty.Text != "" && lblissued.Text == "")
            {
                int ope = Convert.ToInt32(lblopening.Text);
                int samm = Convert.ToInt32(lblinputqty.Text);
                int clg = ope + samm;
            ...
            else if (lblopening.Text == "" && lblinputqty.Text != "" && lblissued.Text != "")
            {
                ...
                int sampldes3 = Convert.ToInt32(lblinputqty.Text);
                int issued3 = Convert.ToInt32(lblissued.Text);

                if (issued3 > sampldes3)
                {
                    lblclosing.Text = "";
                    lblissued.Text = lblinputqty.Text;
                }
                else
                {
            ...
            {
                lblclosing.Text = lblinputqty.Text;
            }
            ...
            if (lblopening.Text == "" && lblinputqty.Text == "")
            {
                lblissued.Text = "";
            }

            else if (lblopening.Text == "0" && lblinputqty.Text == "")
            {
                lblissued.Text = "";
            }
            else if (lblopening.Text == "" && lblinputqty.Text == "0")
            {
                lblissued.Text = "";
            }
            else if (lblopening.Text == "0" && lblinputqty.Text == "0")
            {
                lblissued.Text = "";
            }

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllowanceFixation_NEW.aspx.cs" Inherits="MasterFiles_AllowanceFixation_NEW" %>
...
<body style="overflow-x:scroll">
    ...
    <style>
        ...
        .display-reportMaintable .table th,.display-reportMaintable .table td {
            font-size: 10px !important;
        }
        .display-reportMaintable .table tr td:first-child {
            padding: 0px 0px !important;
        }
        .home-section-main-body label {
    color: #696d6e;
    font-size: 10px !important;
}
                                ...
                                <div class="single-des">
                                    <div class="row">
                                        <div class="col-lg-2">
                                            ...
                                            <asp:DropDownList ID="ddldesig" runat="server" CssClass="custom-select2 nice-select" AutoPostBack="false">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-lg-2">
                                            <asp:Label ID="Label7" runat="server" CssClass="label" Text="Category"></asp:Label>
                                            <asp:DropDownList ID="dd2cat" runat="server" CssClass="custom-select2 nice-select" AutoPostBack="false">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <asp:DropDownList ID="dd3sts" runat="server" CssClass="custom-select2 nice-select" AutoPostBack="false">
                                    ...
                                    <div class="row" style="padding-top:5px">
                                        ...
                                        <div class="col-lg-2">
                                            <asp:Button Visible="true" ID="btndes" runat="server" Width="60px"  Text="Go"
                                                CssClass="savebutton" OnClick="btndes_Click" />
                                        </div>
                                    </div>
                                </div>
                            </asp:Panel>
                                    ...
                                    <asp:GridView ID="grdWTAllowance" Width="100%" runat="server" AutoGenerateColumns="false"
                                        ...
                                        <asp:TextBox ID="txtRange3" Style="text-align: center;" Width="50px" CssClass="input" Text='60' runat="server"></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderText="Wtype_Fixed_Column5" Visible="false" ItemStyle-HorizontalAlign="Center">
                                             ...
                                             <asp:TemplateField HeaderText="Local Conveyance" ItemStyle-HorizontalAlign="Center" Visible="false" HeaderStyle-Width="10px">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtlclcon" Style="text-align: center;" Width="60px" CssClass="input" Text='' runat="server"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Meeting Allowance" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10px" Visible="false">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtmeetallw" Style="text-align: center;" Width="60px" CssClass="input" Text='' runat="server"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>

...
<head runat="server">
    ...
    //"top=0"
        ...
        function showModal(sfcode, sf_name, cyear, cmonth, Prod, sCurrentDate) {
            popUpObj = window.open("rptsampleproduct_details2.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&Prod=" + Prod + "&sCurrentDate=" + sCurrentDate + "&totalinput=" + cmonth,
     "_blank",
    "ModalPopUp"// +
    //"toolbar=no," +
    //"scrollbars=yes," +

        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <br />
                        <h2 id="hHeading" class="text-center" style="border-bottom: none !important;" runat="server"></h2>
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                    ...
                                    <div class="card-body">
                                        <div class="designation-area clearfix">
                                            <div class="single-des clearfix">
                                                ...
                                                <asp:DropDownList ID="ddlWorkingAreaList" runat="server">
                                ...
                                <div class="card border-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="designation-area clearfix">
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label4" runat="server" CssClass="label">No.of Listed Doctors Allowed For DCR Entry
                                                </asp:Label>
                                                <asp:TextBox ID="txtDRAllow" runat="server" MaxLength="3" CssClass="input" Width="100%"></asp:TextBox>
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label5" runat="server" CssClass="label">No.of Chemists Allowed For DCR Entry
                                                </asp:Label>
                                                <asp:TextBox ID="txtChemAllow" runat="server" CssClass="input" Width="100%" MaxLength="3"></asp:TextBox>
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label24" runat="server" CssClass="label">No.of Stockists Allowed For DCR Entry
                                                </asp:Label>
                                                <asp:TextBox ID="txtStkAllow" runat="server" CssClass="input" Width="100%" MaxLength="3"></asp:TextBox>
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label6" runat="server" CssClass="label">No.of UnListed Doctors Allowed For DCR Entry
                                                </asp:Label>
                                                <asp:TextBox ID="txtUNLAllow" runat="server" CssClass="input" Width="100%" MaxLength="3"></asp:TextBox>
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label15" runat="server" CssClass="label">No.of Hospitals Allowed For DCR Entry
                                                </asp:Label>
                                                <asp:TextBox ID="txtHosAllow" runat="server" CssClass="input" Width="100%" MaxLength="3"></asp:TextBox>
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label7" runat="server" CssClass="label">Doctors listing display in DCR Entry
                                                </asp:Label>
                                            ...
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label33" runat="server" CssClass="label">DCR Approval System
                                                </asp:Label>
                                            ...
                                            <div class="single-des clearfix">
                                                ...
                                                <span runat="server" id="Span3" class="label">DCR Del<asp:LinkButton ID="LinkButton1" runat="server" Text="a" ForeColor="#414d55" OnClick="LinkButton1_Click"></asp:LinkButton>yed System</span>
                                                <asp:RadioButton ID="rdoDlyNo" runat="server" CssClass="pull-right" AutoPostBack="true" OnCheckedChanged="rdoDlyNo_CheckedChanged" Text="Not Needed" GroupName="DLY" />
                                                <asp:RadioButton ID="rdoDlyYes" runat="server" CssClass="pull-right" AutoPostBack="true" OnCheckedChanged="rdoDly_CheckedChanged" Text="Needed" GroupName="DLY" />

                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label29" runat="server" CssClass="label">Week Off / Holiday Calculated in Delayed
                                                </asp:Label>
                                            ...
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label28" runat="server" CssClass="label">No.of Days Allowed For Delay
                                                </asp:Label>
                                            ...
                                            <div class="single-des clearfix">
                                                ...
                                                <asp:RadioButton ID="rdolock_no" runat="server" Text="No" CssClass="pull-right" Visible="false" GroupName="DLYT" />
                                                <asp:RadioButton ID="rdolock_yes" runat="server" Text="Yes" CssClass="pull-right" Visible="false" GroupName="DLYT" />
                                            ...
                                            <div class="single-des clearfix">
                                                ...
                                                <asp:TextBox ID="txtlock_timelimit" runat="server" CssClass="input" Width="100%" MaxLength="3" Visible="false"></asp:TextBox>
                                                <asp:Button ID="btnlockdays" runat="server" Text="Save" CssClass="savebutton" Width="50px" Height="25px" OnClick="btnlockdays_Click" Visible="false" />
                                            </div>
                                            <div class="single-des clearfix">

                                                <asp:Label ID="Label31" runat="server" CssClass="label">DCR Auto Post Holiday
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoAutoHldNo" runat="server" Text="No" CssClass="pull-right" GroupName="APHLD" />
                                                <asp:RadioButton ID="rdoAutoHldYes" runat="server" Text="Yes" CssClass="pull-right" GroupName="APHLD" />

                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label32" runat="server" CssClass="label">Week Off
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoAutoSunNo" runat="server" Text="No" CssClass="pull-right" GroupName="APSun" />
                                                <asp:RadioButton ID="rdoAutoSunYes" runat="server" Text="Yes" CssClass="pull-right" GroupName="APSun" />
                                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card border-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="designation-area clearfix">
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label9" runat="server" CssClass="label">No.of Characters Allowed For Remarks
                                                </asp:Label>
                                                <asp:TextBox ID="txtFFRemarks" runat="server" CssClass="input" Width="100%"></asp:TextBox>
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label10" runat="server" CssClass="label">Maximum Product Selection Allowed For DCR Entry
                                                </asp:Label>
                                                <asp:TextBox ID="txtFFProd" runat="server" CssClass="input" Width="100%"></asp:TextBox>
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label26" runat="server" CssClass="label">No. of Products Selection Mandatory For DCR Entry
                                                </asp:Label>
                                                <asp:TextBox ID="txtMaxProd" runat="server" CssClass="input" Width="100%"></asp:TextBox>
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label11" runat="server" CssClass="label" Visible="false">Remove Session in DCR Entry
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoFFDCRNo" runat="server" Text="No" CssClass="pull-right" Visible="false" GroupName="DCREntryFF" />
                                                <asp:RadioButton ID="rdoFFDCRYes" runat="server" Text="Yes" CssClass="pull-right" Visible="false" GroupName="DCREntryFF" />
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label12" runat="server" CssClass="label" Visible="false">Remove Time in DCR Entry
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoFFDCRTimeNo" runat="server" Text="No" CssClass="pull-right" Visible="false" GroupName="DCREntryFFTime" />
                                                <asp:RadioButton ID="rdoFFDCRTimeYes" runat="server" Text="Yes" CssClass="pull-right" Visible="false" GroupName="DCREntryFFTime" />

                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label17" runat="server" CssClass="label">Is Session Mandatory in DCR Entry
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoSessMNo" runat="server" Text="No" CssClass="pull-right" GroupName="DCREntrySessM" />
                                                <asp:RadioButton ID="rdoSessMYes" runat="server" Text="Yes" CssClass="pull-right" GroupName="DCREntrySessM" />
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label25" runat="server" CssClass="label">Is Time Mandatory in DCR Entry
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoTimeMNo" runat="server" Text="No" CssClass="pull-right" GroupName="DCREntryTimeM" />
                                                <asp:RadioButton ID="rdoTimeMYes" runat="server" Text="Yes" CssClass="pull-right" GroupName="DCREntryTimeM" />
                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label13" runat="server" CssClass="label">After Product Selection Qty Value 0(Listed Dr Sample Qty)
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoFFDCRQtyNo" runat="server" Text="No" CssClass="pull-right" GroupName="DCREntryFFQty" />
                                                <asp:RadioButton ID="rdoFFDCRQtyYes" runat="server" Text="Yes" CssClass="pull-right" GroupName="DCREntryFFQty" />
                                            </div>
                                             <div class="single-des clearfix">
                                            ...
                                            <div class="single-des clearfix">
                                                ...
                                                <asp:RadioButtonList ID="rdoRxqntyYes_No" runat="server" CssClass="pull-right" RepeatDirection="Horizontal">
                                            ...
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label14" runat="server" CssClass="label" Visible="false">UnListed Doctor Entry Needed
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoFFUNLNo" runat="server" Text="No" CssClass="pull-right" Visible="false" GroupName="DCREntryFFUNL" />
                                                <asp:RadioButton ID="rdoFFUNLYes" runat="server" Text="Yes" CssClass="pull-right" Visible="false" GroupName="DCREntryFFUNL" />
                                            ...
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label34" runat="server" CssClass="label">Is Doctor-wise Remarks Mandatory
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoDRNo" runat="server" Text="No" CssClass="pull-right" GroupName="DCREntryDRYes" />
                                                <asp:RadioButton ID="rdoDRYes" runat="server" Text="Yes" CssClass="pull-right" GroupName="DCREntryDRYes" />

                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label35" runat="server" CssClass="label">Allow to Enter New Chemist in DCR Entry
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoCheNo" runat="server" Text="No" CssClass="pull-right" GroupName="DCREntryCheYes" />
                                                <asp:RadioButton ID="rdoCheYes" runat="server" Text="Yes" CssClass="pull-right" GroupName="DCREntryCheYes" />

                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label36" runat="server" CssClass="label">Allow to Enter New Un-Listed Dr in DCR Entry
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoUnNo" runat="server" Text="No" CssClass="pull-right" GroupName="DCREntryUnYes" />
                                                <asp:RadioButton ID="rdoUnYes" runat="server" Text="Yes" CssClass="pull-right" GroupName="DCREntryUnYes" />

                                            </div>
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label151" runat="server" CssClass="label" Visible="false">Productwise POB Entry Needed
                                                </asp:Label>
                                                <asp:RadioButton ID="rdoFFPOBNo" runat="server" Text="No" CssClass="pull-right" Visible="false" GroupName="DCREntryFFPOB" />
                                                <asp:RadioButton ID="rdoFFPOBYes" runat="server" Text="Yes" CssClass="pull-right" Visible="false" GroupName="DCREntryFFPOB" />
                                            ...
                                            <div class="single-des clearfix">
                                                <asp:Label ID="Label16" runat="server" CssClass="label">Half day Work Entry Needed
                                                </asp:Label>
                                                <asp:RadioButtonList ID="rdoFFDayYes_No" CssClass="pull-right" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Value="1">Yes</asp:ListItem>
                                                    <asp:ListItem Value="0">No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:GridView ID="grdtp_setup" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="table"
                                                                        GridLines="None" PagerStyle-CssClass="gridview1">
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Designation">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblDesignation_shortname" runat="server"
                                    ...
                                    onfocus="this.style.backgroundColor='#E0EE9D'" onkeypress="Calendar_enterBa(event);"
                                     TabIndex="9" Width="118px"></asp:TextBox>--%>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="designation-reactivation-table-area clearfix">
                                                    <div class="single-des clearfix">
                                                        <asp:Label ID="Label41" runat="server" CssClass="label">Tour Plan</asp:Label>
                                                    </div>
                                                    <div class="single-des clearfix">
                                                    ...
                                                    <div class="display-table clearfix">
                                                        <div class="table-responsive">
                                                            <%--<asp:UpdatePanel ID="updpnlDesign" runat="server">
                                                                        <ContentTemplate>--%>
                                                            <asp:GridView ID="gvDesignation" runat="server" CssClass="table" ShowHeader="false" AutoGenerateColumns="False" Width="100%"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="appr" runat="server" CssClass="label" Text="Approval Needed for"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblDesignation" CssClass="label" runat="server" Text='<% #Eval("Designation_Short_Name")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField ItemStyle-HorizontalAlign="center">
                                                                        <ItemTemplate>
                                                                            <asp:CheckBox ID="chkId" Text="Yes" runat="server"
                                                                                AutoPostBack="true" OnCheckedChanged="chkId_OnCheckedChanged" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:CheckBox ID="chkNo" Text="No" runat="server" AutoPostBack="true"
                                                    ...
                                                    <div class="single-des clearfix">
                                                        <asp:RadioButton ID="rdoDCRWTP" runat="server" Text="Without Tour Plan Based System" AutoPostBack="true"
                                                            GroupName="TP" />
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="w-100 designation-submit-button text-center clearfix">
                            <br />
                            <asp:Button ID="btnSubmit" runat="server" CssClass="savebutton" OnClientClick="return validate()"
                                Text="Save" OnClick="btnSubmit_Click" />
                            <asp:Button ID="btnClear" runat="server" CssClass="savebutton"
                                Text="Clear" />
                        </div>
                    </div>
                </div>

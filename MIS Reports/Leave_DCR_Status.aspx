...
<head runat="server">
    ...
    <link type="text/css" rel="stylesheet" href="../css/style.css" />
     <script type="text/javascript">
         var popUpObj;
         function showModalPopUp(sfcode, fmon, fyr, tmon, tyear, sf_name, Detailed, DesName) {
             //popUpObj = window.open("MissedCallReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
             popUpObj = window.open("rptLeave_DCR_Status.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyear + "&sf_name=" + sf_name + "&Detailed=" + Detailed + "&DesName=" + DesName,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
        ...
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                if (chkDetail.checked) {
                    ...
                    var DesName = $('#<%=ddldesig.ClientID%> :selected').text();
...
//                    else {
//                        if (Year1 <= Year2) {
                    showModalPopUp(sfcode, Month1, Year1, Month2, Year2, SName, 1, DesName);
//                        }
//                    }
                }
                else {
...
//                    else {
//                        if (Year1 <= Year2) {
                    showModalPopUp(sfcode, Month1, Year1, Month2, Year2, SName, 0, DesName);
//                        }
//                    }
           ...
           <table >
            ...
            ToolTip="Enter Text Here"></asp:TextBox>
             <asp:LinkButton ID="linkcheck" runat="server" 
                        ...
                        <asp:DropDownList ID="ddlFieldForce" runat="server" Width="300px" SkinID="ddlRequired"  Visible="false">
             ...
             <%--   </tr>--%>
               ...
               <tr>
                 <td align="left" class="stylespc">
                  <asp:Label ID="lbldesig" runat="server" Text ="Designation Wise"></asp:Label>              
                </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Review_Report.aspx.cs" Inherits="MasterFiles_AnalysisReports_Review_Report" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, sf_name, div_code) {
            //popUpObj = window.open("MissedCallReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rpt_Review_Report.aspx?sf_code=" + sfcode + "&FMonth=" + fmon + "&Fyear=" + fyr + "&sf_name=" + sf_name + "&div_code=" + div_code,
  "ModalPopUp"//,
  //"toolbar=no," +
  //"scrollbars=yes," +
  //"location=no," +
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                showModalPopUp(sf_Code, Month1, Year1, Name, div_code);
            });
        });
    </script>
    <script type="text/javascript">
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Review Report</h2>

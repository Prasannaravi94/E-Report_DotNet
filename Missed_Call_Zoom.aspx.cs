...
public partial class Missed_Call_Zoom : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            lblHead.Text = "Missed Call for the month of " + strFrmMonth + " " + FYear;
    ...
    private void FillReport()
    {
        ...
        sProc_Name = "Graph_Team_Calls_Det_Zoom";
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 0,0, "List", "#0097AC", true);
            AddMergedCells(objgridviewrow, objtablecell, 0,0, "Met", "#0097AC", true);
            AddMergedCells(objgridviewrow, objtablecell, 0,0, "Missed", "#0097AC", true);
            ...
            if (dtrowClr.Rows[indx][1].ToString() == "Total")
            {
                ...
                if (e.Row.Cells[8].Text != "0")
                {
                   ...
                   // string sSf_code = dtrowClr.Rows[indx][1].ToString();
                    ...
                    hLink.Attributes.Add("href", "javascript:showMissedDR_Zoom('" + sf_code + "',  '" + FMonth + "', '" + FYear + "',1,'','', '" + div_code + "','" + strFieledForceName + "')");
                    //hLink.ToolTip = "Click here";
                    // hLink.ForeColor = System.Drawing.Color.Red;
                    hLink.Style.Add("text-decoration", "none");
                    hLink.Style.Add("color", "Red");

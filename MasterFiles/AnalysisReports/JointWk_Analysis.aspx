...
<head runat="server">
   ...
   //"top=0"
        ...
        function showModalPopUp_MR(sfcode, fmon, fyr, tyear, tmonth, sf_name) {
            //popUpObj = window.open("MissedCallReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                var mode = $('#ddlmode').find(":selected").index();
                ...
                if ((fromMon <= ToMon && parseInt(fromYear) === parseInt(ToYear)) || (parseInt(fromYear) < parseInt(ToYear) && (fromMon <= ToMon || fromMon >= ToMon))) {
                    if (mode == 0) {
                        ...
                        showModalPopUp_MR(sf_Code, fromMon, fromYear, ToYear, ToMon, Name);
                    }
                }
                else {
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Joint Work Analysis</h2>
                  ...
                  <%--          <div class="single-des clearfix">
                            ...
                            <div class="single-des clearfix">
                                ...
                                <asp:DropDownList ID="ddlmode" runat="server" CssClass="nice-select">
                                    <asp:ListItem Value="0" Selected="True" Text="Based on MGR - DCR"></asp:ListItem>
                                    <asp:ListItem Value="1" Text="Based on MR - DCR"></asp:ListItem>
                                </asp:DropDownList>
                            </div>

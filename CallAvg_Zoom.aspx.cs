...
public partial class CallAvg_Zoom : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            lblHead.Text = "Call Average for the month of " + strFrmMonth + " - " + FYear;
    ...
    private void FillReport()
    {
        ...
        sProc_Name = "CallAve_Graph_Des_Detail";
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 0, 0, "Seen", "#0097AC", true);
            AddMergedCells(objgridviewrow, objtablecell, 0, 0, "FW", "#0097AC", true);
            AddMergedCells(objgridviewrow, objtablecell, 0, 0, "Call Avg", "#0097AC", true);
    ...
    protected void GrdFixation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                e.Row.Cells[0].Text = e.Row.Cells[0].Text + " ( " + e.Row.Cells[9].Text + " ) ";

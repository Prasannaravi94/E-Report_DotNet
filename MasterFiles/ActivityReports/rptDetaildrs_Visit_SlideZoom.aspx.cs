...
public partial class MasterFiles_AnalysisReports_rptAnalysis_Pob_count_Zoom : System.Web.UI.Page  
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            lblHead.Text = "Slide Detailwise Report for " + strFrmMonth + " " + FYear;
    ...
    private void FillReport()
    {
        ...
        sProc_Name = "sp_Detail_Drs_Visitwise_SlideZoom";
        ...
        dsts.Tables[0].Columns.Remove("MSL_CODE");
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 0, 0, "Slide Name", "#0097AC", true);

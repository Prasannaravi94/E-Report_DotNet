<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDelayed_DCR_Status.aspx.cs" Inherits="MIS_Reports_rptDelayed_DCR_Status" %>
                                    ...
                                    <asp:GridView ID="GrdDCRDelayed" runat="server" Width="100%" HorizontalAlign="Center" Style="background-color: white"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Employee_Code" ItemStyle-HorizontalAlign="Left">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblEmp_Code" runat="server" Text='<%# Bind("UsrDfd_UserName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Joining_Date" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <asp:TemplateField HeaderText="Delayed Not Released Dates" ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="alingment">
                                                <ControlStyle Width="180px"></ControlStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNSD" runat="server" Text='<%# Bind("DCR_Dalayed_Dates") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Delayed Release Dates" ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="alingment">
                                                <ControlStyle Width="170px"></ControlStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNSD_Rel" runat="server" Text='<%# Bind("Delayed_Dates_Release") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <%--<asp:TemplateField HeaderText="Delayed Dates Count" ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Size="11px"
                        HeaderStyle-BackColor="#336277" HeaderStyle-ForeColor="White">
                        <ControlStyle Width="40px"></ControlStyle>
                        <ItemTemplate>
                            <asp:Label ID="lblNSC" runat="server" Font-Size="10px"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>  --%>
                                        </Columns>

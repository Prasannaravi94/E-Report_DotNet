...
public partial class MIS_Reports_rptSampleGift_details1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //FillProd();
            lblProd.Text = "Input Details for the Period of " + strMonthName + " " + Year + " ";
    ...
    private void CreateDynamicTable()
    {
        ...
        dsDr = dr.getDr_Input_Sample(div_code, sf_code, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate);
        ...
        if (dsDr.Tables[0].Rows.Count > 0)
        {
            ...
            lit_det_head_doc.Text = "Fieldforce Name";
            ...
            lit_det_head_qua.Text = "Input Name";
            ...
            lit_det_head_Territory.Text = "Input given to No.of Doctors";
            ...
            foreach (DataRow drdoctor in dsDr.Tables[0].Rows)
            {
                ...
                lit_det_usr.Text = "&nbsp;" + drdoctor["Gift_Code"].ToString();
                ...
                if (tot_dr != "0")
                {
                    ...
                    hyp_lst_month.Attributes.Add("href", "javascript:showModalPopUp('" + drdoctor["sf_code"].ToString() + "', '" + drdoctor["Fieldforce_Name"] + "', '" + Year + "', '" + Month + "','" + drdoctor["Gift_Code"] + "','"+sCurrentDate+"')");

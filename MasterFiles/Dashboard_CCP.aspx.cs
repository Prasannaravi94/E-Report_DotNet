...
public partial class MasterFiles_Input_Despatch : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MIS%20Reports/rptTPCCP_View.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&Fyear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&div_code=" + div_code);
        //ifmReviewRep.Attributes.Add("src", "http://" + host + "/MIS%20Reports/rptTPCCP_View.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&Fyear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&div_code=" + div_code);
    }
    #endregion

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptService_Product_Doctorwise_DetailCRM.aspx.cs" Inherits="MasterFiles_MR_ListedDoctor_rptService_Product_Doctorwise_DetailCRM" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <asp:Panel ID="pnlContents" runat="server">
                            <div align="center">
                                <asp:Label ID="lblHead" runat="server" Text="Doctor List" CssClass="reportheader"></asp:Label>
                                <br />
                                <br />
                                        ...
                                        <table width="100%">
                                            <caption>
                                                <asp:GridView ID="GrdFixation" runat="server" AlternatingRowStyle-CssClass="alt"
                                                    ...
                                                    ShowFooter="true" OnRowDataBound="gvMyDayPlan_OnDataBound">                                                   

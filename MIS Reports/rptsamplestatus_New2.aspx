<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptsamplestatus_New2.aspx.cs" Inherits="MIS_Reports_rptsamplestatus_New2" %>
               ...
               <asp:Label ID="lblname" runat="server" Font-Bold="true" ForeColor="Magenta"></asp:Label>
                ...
                <tr>
                        ...
                        <asp:GridView ID="grdprd" runat="server" Width="70%" HorizontalAlign="Center" EmptyDataText="No Records Found" OnRowDataBound="grdDr_RowDataBound" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField  HeaderText="Product_Code_SlNo" ItemStyle-HorizontalAlign="Left" Visible="false" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblprd_code" runat="server" Width="120px" Text='<%#Eval("Product_Code_SlNo")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField  HeaderText="Product Name" ItemStyle-HorizontalAlign="Left"  >
                                    <ItemTemplate>
                                        <asp:Label ID="lblprd_name" runat="server" Width="120px" Text='<%#Eval("Product_Code")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField> 
                                
                                 <asp:TemplateField  HeaderText="Pack" ItemStyle-HorizontalAlign="Left"  >
                                    <ItemTemplate>
                                        <asp:Label ID="lblsale" runat="server" Width="80px" Text='<%#Eval("Productsaleunit")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>    
                    ...
                    <asp:TemplateField HeaderText="Despatch Quantity" ItemStyle-HorizontalAlign="Center" 
                        ...
                        <ControlStyle Width="70px"></ControlStyle>
                        <ItemTemplate>
                            <asp:Label ID="lblsamqty" runat="server" Font-Size="10px" Text='<%# Bind("Sample_qty") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

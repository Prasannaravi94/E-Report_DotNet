...
public partial class MIS_Reports_sampleproduct_details_exel : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        //SqlCommand cmd = new SqlCommand("Sample_Total_Exel", con);
        //SqlCommand cmd = new SqlCommand("Sample_Total_Exel_test", con);
        ...
        //withjob
        SqlCommand cmd = new SqlCommand("Sample_Total_Exel_Dump_Using_Job", con);
        ...
        ws.Cell(1, 1).Value = "Sample Dump (  " + ddlFieldForce.SelectedItem.Text.Trim() + " )";

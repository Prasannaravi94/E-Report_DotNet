<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inputstatus.aspx.cs" Inherits="MIS_Reports_inputstatus" %>
...
<link type="text/css" rel="Stylesheet" href="../css/rptMissCall.css" />
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, prod) {
            ...
            popUpObj = window.open("inputissued.aspx?sfcode=" + sfcode + " &sfname=" + sfname + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&Prod=" + prod,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +

...
public partial class MasterFiles_AnalysisReports_DCR_Dump_Detail : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("DCR_Dump_Detail", con);
        ...
        cmd.Parameters.AddWithValue("@cYr", ddlFrmYear.SelectedValue);

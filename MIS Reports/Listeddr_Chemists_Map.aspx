<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listeddr_Chemists_Map.aspx.cs" Inherits="MIS_Reports_Listeddr_Chemists_Map" %>
...
<head id="Head1" runat="server">
    ...
    <title id="Title1" runat="server">Doctor - Chemists Map Details</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <asp:Panel ID="pnlContents" runat="server" Width="99%">
                            <div align="center">
                                <asp:Label ID="lblHead" runat="server" Text="Doctor - Chemists Map Details" CssClass="reportheader"></asp:Label>
                                <br />
                                <br />
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Listed Doctor Name" >
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="drCodeHidden" runat="server" Value='<%#Eval("ListedDrCode")%>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Chemists" >                                                           
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSts" runat="server" ForeColor="Red" Text='<%# Bind("Product") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>

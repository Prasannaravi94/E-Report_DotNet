...
public partial class MasterFiles_Dashboard_Payslip_View : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MasterFiles/Options/Frm_Tablets_PaySlipView.aspx?SF_Code=" + ddlFieldForce.SelectedValue + "&Month=" + cmonth + "&Year=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&div_code=" + div_code);

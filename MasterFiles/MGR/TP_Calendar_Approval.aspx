    ...
    <asp:Panel ID="pnlCalendar" runat="server" Style="margin-top: 0px;">
        ...
        <center>
            ...
            <br />
                  ...
                  <asp:Button ID="btnSave" CssClass="savebutton" runat="server" Width="90px" Text="Approve TP"
                OnClientClick="return ValidateEmptyValue()" OnClick="btnSave_Click" />
            &nbsp
                    <asp:Button ID="btnReject" CssClass="savebutton" runat="server" Text="Reject TP" Width="90px"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptProduct_Priority_Wise.aspx.cs" Inherits="MIS_Reports_rptProduct_Priority_Wise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Product Prioritywise Analysis</title>
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, sf_name, cyear, cmonth, Prod_Name, Prod, sCurrentDate, Priority) {
            popUpObj = window.open("rptProduct_Priority_Wise1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod + "&sCurrentDate=" + sCurrentDate + "&type=1" + "&Priority=" + Priority,
       "_blank",
      "ModalPopUp" //+
      //"toolbar=no," +
      //"scrollbars=yes," +
      ...
      //"top=0"
        ...
        function show(sfcode, sf_name, cyear, cmonth, Prod_Name, Prod, sCurrentDate, Priority) {
            popUpObj = window.open("rptProduct_Priority_Wise1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod + "&sCurrentDate=" + sCurrentDate + "&type=2" + "&Priority=" + Priority,
       "_blank",
      "ModalPopUp" //+
      //"toolbar=no," +
      //"scrollbars=yes," +
      ...
      //"top=0"
        ...
        function showModal(sfcode, sf_name, Prod_Name, Prod, Priority) {
            popUpObj = window.open("rptProduct_Priority_Wise1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Prod_Name=" + Prod_Name + "&Prod=" + Prod + "&Priority=" + Priority,
       "_blank",
      "ModalPopUp," +
      "toolbar=no," +
      "scrollbars=yes," +
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            <div align="center">
                                <asp:Label ID="lblHead" Text="Product Exposure Analysis" CssClass="reportheader"
                                        ...
                                        <table width="100%">
                                            <caption>
                                                <asp:GridView ID="GrdPrdExp" runat="server" AlternatingRowStyle-CssClass="alt"
                                                    ...
                                                    GridLines="None" HorizontalAlign="Center" OnRowCreated="GrdPrdExp_RowCreated"
                                                    OnRowDataBound="GrdPrdExp_RowDataBound" ShowHeader="False" Width="100%" Font-Names="calibri">

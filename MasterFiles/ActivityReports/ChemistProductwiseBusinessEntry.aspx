<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="ChemistProductwiseBusinessEntry.aspx.cs" EnableViewState="true" Inherits="DoctorBusinessEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function confirm_Save() {
            if (confirm('Do you want to delete the Chemist?')) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var $ddl = $('select[id$=ddlChemists]');
            var $items = $('select[id$=ddlChemists] option');
    ...
    <script type="text/javascript">
        function showLoader(loaderType) {
            ...
            if (loaderType == "Search2") {
                document.getElementById("loaderSearchddlSFCode1").style.display = '';
            }
        }
        ...
        $(document).ready(function () {
            ...
            $('#<%=lblbtnProduct.ClientID%>').click(function () {
                var st2 = $('#<%=ddlChemists.ClientID%> :selected').text();
                if (st2 == "---Select---") { alert("Select Chemists"); $('ddlChemists').focus(); return false; }
                if (st2 == "") { alert("Select Chemists"); $('ddlChemists').focus(); return false; }
            });
    ...
    <div class="container home-section-main-body position-relative clearfix">
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <center>
                    <table>
                        <tr>
                            <td align="center">
                                <h2 class="text-center">Chemist Productwise Business - Entry</h2>
                            </td>
                        </tr>
                    </table>
                </center>
            ...
            <div class="col-lg-12">
                <asp:GridView ID="gvChemists" runat="server" AlternatingRowStyle-CssClass="alt"
                    AutoGenerateColumns="false" CssClass="table"
                    GridLines="None" HorizontalAlign="Center" BorderWidth="0"
                    Width="100%" ShowFooter="true" FooterStyle-HorizontalAlign="Center"
                    Visible="false" OnRowDeleting="gvChemists_RowDeleting">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Chemists Name" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hdnChemists_Code" runat="server" Value='<%#Eval("Chemists_Code")%>'></asp:HiddenField>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Territory" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Value" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Label ID="lblChValue" runat="server"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lblbtnEdit" runat="server" ToolTip="Add Row"
                                    OnClick="lblbtnEdit_Click" CommandName="Add"
                                    OnClientClick="return ValidateEmptyValue()" CssClass="label"><i class="fa fa-pencil"></i></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lblbtnDel" runat="server" ToolTip="Delete Row"
                                    CommandName="Delete" OnClientClick="return confirm_Save();" CssClass="label"><i class="fa fa-times"></i></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
            ...
            <div class="col-lg-9">
                <center>
                    <div id="dvChemists" style="width: 100%">
                        <table id="tbChemists" class="tbChemists" runat="server" visible="false">
                            <thead>
                                <tr style="border-bottom: 10px solid #fff;">
                                    <th align="center" class="tbRCPAth">
                                        <asp:Label ID="lblChemists" runat="server" Text="Chemist Name" CssClass="chklabel"></asp:Label>
                                    </th>
                                    <th align="center" class="tbRCPAth">
                                        <asp:Label ID="lblterritory" runat="server" Text="Territory" CssClass="chklabel"></asp:Label>
                                    </th>
                                    <th align="center" class="tbRCPAth">
                                        <asp:Label ID="lblProduct" runat="server" Text="Product" CssClass="chklabel"></asp:Label>
                                    </th>
                                </tr>
                            </thead>
                            <tr>
                                <td align="center" class="stylespc">
                                    <asp:DropDownList ID="ddlChemists" runat="server" SkinID="ddlRequired"
                                        OnSelectedIndexChanged="ddlChemists_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </td>
                                <td align="center" class="stylespc">
                                    <asp:Label ID="lblTrName" ForeColor="Black" runat="server" Text="-" CssClass="chklabel"></asp:Label>
                                ...
                                <asp:GridView ID="gvProduct" runat="server" AlternatingRowStyle-CssClass="alt"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Qty" HeaderStyle-Width="100">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtQty" runat="server" Width="75" CssClass="textbox" MaxLength="5" onpaste="return false" onkeyup="FetchData(this)" rel="<%# Container.DataItemIndex  %>"></asp:TextBox>
                                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers" TargetControlID="txtQty">

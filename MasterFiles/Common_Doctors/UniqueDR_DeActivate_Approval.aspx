<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UniqueDR_DeActivate_Approval.aspx.cs" Inherits="MasterFiles_UniqueDR_DeActivate_Approval" %>
<%--<%@ Register Src ="~/UserControl/MGR_Menu.ascx" TagName ="Menu" TagPrefix="ucl" %>--%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Listed Doctor DeActivation - Approval</title>
...
<body>
                            ...
                            <Columns>
                              ...
                              <%--  <asp:TemplateField HeaderText="Division Name" HeaderStyle-ForeColor="Black">
                                ...
                                <asp:TemplateField HeaderText="Area Cluster Name" HeaderStyle-ForeColor="Black">
                                  ...
                                  <asp:TemplateField HeaderText="Reason" HeaderStyle-ForeColor="Black">
                                    <ItemTemplate>
                                        <asp:Label ID="txtReason" runat="server" Text='<%# Bind("Deact_Reason") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
  ...
  <br />
  <center>
        <asp:Button ID="btnApprove" runat="server" CssClass="savebutton" Text="Approve - Deactivate Lst.Drs" Width="180px" OnClick="btnApprove_Click" Visible="false" />&nbsp;
        <asp:Button ID="btnReject" runat="server" CssClass="savebutton" Text="Reject - Add Lst.Drs" Width="160px" OnClick="btnReject_Click" Visible="false" />
        </center>

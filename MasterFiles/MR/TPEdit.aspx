        ...
        <center>
            ...
            <table width="75%" align="center">
               ...
               <%-- <tr style="height: 30px">
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="btnSave" CssClass="savebutton" Width="170px" runat="server" Text="Send to Manager Approval"
                            OnClick="btnSave_Click" Visible="False" OnClientClick="return ValidateEmptyValue()" />
                        &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnClear" CssClass="savebutton" runat="server" Width="60px" Height="25px"

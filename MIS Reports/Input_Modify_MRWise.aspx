<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Input_Modify_MRWise.aspx.cs" Inherits="MIS_Reports_Input_Modify_MRWise" %>
...
<head runat="server">
    <title>Input Edit-Doctor Wise</title>
        ...
        <div>
            ...
            <Asp:Panel id="Showlist" runat="server" Visible="false">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Input Edit-Doctor Wise</h2>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Territtory">
                                 ...
                                 <asp:HyperLinkField HeaderText="View" text="Clickhere" Target="_blank" 
                                    DataNavigateUrlFormatString="~/MIS Reports/Input_Modify_MRWise_Rpt.aspx?trans_SlNo={0}&amp;Trans_Detail_Info_Code={1}&amp"

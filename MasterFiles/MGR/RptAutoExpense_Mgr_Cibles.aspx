<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAutoExpense_Mgr_Cibles.aspx.cs" Inherits="MasterFiles_MR_RptAutoExpense" %>
...
<br />
        ...
        <asp:Button ID="btnDrftSave" runat="server"  CssClass="savebutton" Width="80px" Height="25px"
            ...
            Text="Send To HO" Visible="true" OnClientClick="saveOtherExp()" OnClick="btnSave_Click" />
                   <p id="P1" runat="server" align="right"><asp:Button ID="bakfldfrce" runat="server" CssClass="BUTTON" Width="130px" Height="25px"

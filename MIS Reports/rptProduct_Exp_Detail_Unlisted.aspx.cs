...
using DBase_EReport;
public partial class MIS_Reports_rptProduct_Exp_Detail_Unlisted : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Product Exposure Analysis - Unlisted Doctor for the Period of " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    private void FillAll_Product1()
    {
        ...
        SqlCommand cmd = new SqlCommand("AllProduct_Exp_Count_unlisted", con);
    ...
    private void FillSF1()
    {
        ...
        SqlCommand cmd = new SqlCommand("Product_Exp_Count_unlisted", con);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@Div_Code", Convert.ToInt32(divcode));
        cmd.Parameters.AddWithValue("@Msf_code", sfCode);
        cmd.Parameters.AddWithValue("@MnthTbl", dtMnYr);
    ...
    protected void AddMergedCells(GridViewRow objgridviewrow, TableCell objtablecell, int rowSpan, int colspan, string celltext, string backcolor, bool bRowspan)
    {
        ...
        if (celltext == "No. of Drs (As Per DCR)")
        {
                ...
                for (int i = 2, j = 0; i < e.Row.Cells.Count; i++)
                {
                    ...
                    //{
                        ...
                        if (e.Row.Cells[i].Text != "0")
                        {
                            ...
                            hLink.Attributes.Add("href", "javascript:show('" + sfCode + "', '" + sfname + "', '" + cYr + "', '" + cMnth + "','" + Prd_Name + "','" + Prd_code + "', '" + sCurrentDate + "')");
                            hLink.ToolTip = "Click here";
                            hLink.ForeColor = System.Drawing.Color.Blue;
                            e.Row.Cells[i].Controls.Add(hLink);

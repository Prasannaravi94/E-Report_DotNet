...
public partial class MasterFiles_MR_TP_Entry_daywise : System.Web.UI.Page
{
    ...
    string dayyy = string.Empty;
    string dayyy_name = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (sQryStr != null && sQryStr != "")
            {
                ...
                dsTP2 = tp.Tp_NewfillDay_Edit(MR_Code, MR_Month, MR_Year);
            ...
            else
            {
                ...
                if (Edit != null && Edit == "E")
                {
                    ...
                    dsTP2 = tp.Tp_NewfillDay_Edit(sf_code, month, year);
    ...
    private void fill_tp()
    {
        ...
        else
        {
            ...
            dsTP = tp.last_Tp_Datecheck_Day_draft(sf_code, last_tpdatee.Month.ToString(), last_tpdatee.Year.ToString());
            ...
            else
            {
                ...
                strQry = "EXEC TP_Entry_Withdaysplan '" + div_code + "','" + sf_code + "'";
    ...
    protected void grdTP_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (Edit != null && Edit == "E" || Edit =="Approval")
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                HiddenField hdndays_check = (HiddenField)e.Row.FindControl("hdndays_check");
                ...
                ddlTerr.SelectedValue = hdndays_check.Value;
        ...
        else if (Edit == "draft" || Edit == "Reject")
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
    ...
    {
        Response.Redirect("~/MasterFiles/MR/TP_Entry_daywise.aspx?Edit=E" + "&month=" + ViewState["month"].ToString() + "&year=" + ViewState["year"].ToString());
    }
    ...
    private void createtp(string mode)
    {
        ...
        foreach (GridViewRow row in grdTP.Rows)
        {
            ...
            dayyy = ddlTerritory_Type.SelectedValue.ToString();
            ...
            {
                dayyy_name = ddlTerritory_Type.SelectedItem.Text;
            }
            ...
            string daydd = dayyy;
            if (daydd == "25" || daydd == "26")
            {
                if (lblDay_name.Text == "Monday")
                {
                    daydd = "1";
                }
                else if (lblDay_name.Text == "Tuesday")
                {
                    daydd = "2";
                }
                else if (lblDay_name.Text == "Wednesday")
                {
                    daydd = "3";
                }
                else if (lblDay_name.Text == "Thursday")
                {
                    daydd = "4";
                }
                else if (lblDay_name.Text == "Friday")
                {
                    daydd = "5";
                }
                else if (lblDay_name.Text == "Saturday")
                {
                    daydd = "6";
                }
            }
            ...
            iReturn = tp.Tp_Insert_Daywise(TP_Date, wrktype_code, ddlWwrktype_name, TP_Objective, Session["sf_code"].ToString(), lblsf_name.Text, div_code, mode, dayyy, dayyy_name, lblreportname.Text, daydd);
            ...
            if (iReturn > 0)
            {
                ...
                if (mode == "submit")
                {
                    ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>alert('TourPlan Submitted for Approval');window.location='TP_Entry_daywise.aspx'</script>");
                }
                else if (mode == "draft")
                {

                    ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>alert('TourPlan Saved Successfully');window.location='TP_Entry_daywise.aspx'</script>");
                }
            }
            //else
            //{
    ...
    private void Approve_tp()
    {
        ...
        foreach (GridViewRow row in grdTP.Rows)
        {
            ...
            iReturn = tp.Tp_Modify_Apprv_Daywise(TP_Date, wrktype_code, ddlWwrktype_name, TP_Objective, MR_Code, Request.QueryString["sf_name"].ToString(), div_code, dayyy, dayyy_name, Mangername, daydd);
        ...
        if (iReturn > 0)
        {
            ...
            int iretu = tp.TP_Apprv_Day_Update(MR_Code, MR_Month, MR_Year);
            if (iretu > 0)
            {

...
//
//
public partial class MIS_Reports_rpt_Fully_Operative_Report_HQ : System.Web.UI.Page
{
    //
    #region Variables
    ...
    private void FillReport()
    {
        ...
        string sProc_Name = "";
            ...
            sProc_Name = "Full_Operative_Doctor_Detail_Hqwise";
    ...
    protected void GrdFixation_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            for (int i = 0; i <= months; i++)
            {
                ...
                AddMergedCells(objgridviewrow, objtablecell, 0, iColSpan + 8, sTxt, "#003300", true);
                cmonth = cmonth + 1;
                if (cmonth == 13)
                {
                    cmonth = 1;
    ...
    protected void GrdFixation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            for (int i = iColSpan + 7, j = 0; i < e.Row.Cells.Count; i += iColSpan + 8)
            {
            ...
            try
            {
                ...
                e.Row.Attributes.Add("style", "background-color:" + "#" + Convert.ToString(dtrowClr.Rows[j][4].ToString()));
            }
            catch
            {

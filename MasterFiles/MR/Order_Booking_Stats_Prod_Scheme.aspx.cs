...
public partial class MasterFiles_MR_Order_Booking_Stats_Prod_Scheme : System.Web.UI.Page
{
    ...
    protected void btnClear_Click(object sender, EventArgs e)
    {
        ...
        txtEffect_To.Enabled = true;
        txtEffect_From.Enabled = true;
        ddlState.Enabled = true;
        rbtnBased.Enabled = true;
    }
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        try
        {
           ...
           // btnSave.Visible = true;
            if (chkView.Checked)
            {
                dsDoc = LstDoc.get_Product_Scheme_Check(ddlState.SelectedValue.ToString(), div_code, txtEffect_From.Text, txtEffect_To.Text, rbtnBased.SelectedValue.ToString());
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            foreach (GridViewRow gridRow in Grd_Scheme.Rows)
            {
                ...
                TextBox txtSchem_Tax = (TextBox)gridRow.Cells[9].FindControl("txtSchem_Tax");
                ...
                if (chkView.Checked)
                {
                    Return = Lst.RecordAdd_Product_Scheme(lblPack.Text, lblProd_Name.Text, lblProd_Code.Text, txtRate.Text, txtDiscount.Text, txtSchem_Fixa.Text,
                       txtSchem_Qty.Text, ddlState.SelectedValue.ToString(), Convert.ToDateTime(txtEffect_From.Text), Convert.ToDateTime(txtEffect_To.Text), rbtnBased.SelectedValue.ToString(), div_code, txtSchem_Tax.Text);
                }
                else
                {
                    Return = Lst.RecordUpdate_Product_Scheme(lblSl_No.Text, lblPack.Text, lblProd_Name.Text, lblProd_Code.Text, txtRate.Text, txtDiscount.Text, txtSchem_Fixa.Text,
                      txtSchem_Qty.Text, ddlState.SelectedValue.ToString(), Convert.ToDateTime(DateTime.Now), Convert.ToDateTime(DateTime.Now), rbtnBased.SelectedValue.ToString(), div_code, txtSchem_Tax.Text);
                }
                if (Return > 0)
                {

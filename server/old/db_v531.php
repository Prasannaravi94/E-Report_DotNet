...
$vst="0";
            ...
            if ($vTyp != 0) {
                ...
                if ($vTyp == 1 || $vTyp == 4)
                    $sqlsp = $sqlsp . "?,?,?,?,?,";
               	if ($vTyp == 1)   {
  $sqlsp = $sqlsp . "'" . str_replace("'", "", $vals["Town_code"]) . "','" . str_replace("'", "", $vals["Daywise_Remarks"]) . "',?,'" . str_replace("'", "", $vals["rx_t"]) . "','" . date('Y-m-d H:i:s') . "',?,?," . $vals["DataSF"] . ",'" . $DetTB["geoaddress"] . "',".$apps.",".$vst."," . $nextVisitDate . ")}";

} 
  else
 $sqlsp = $sqlsp . "'" . str_replace("'", "", $vals["Town_code"]) . "','" . str_replace("'", "", $vals["Daywise_Remarks"]) . "',?,'" . str_replace("'", "", $vals["rx_t"]) . "','" . date('Y-m-d H:i:s') . "',?,?," . $vals["DataSF"] . ",'" . $DetTB["geoaddress"] . "')}";

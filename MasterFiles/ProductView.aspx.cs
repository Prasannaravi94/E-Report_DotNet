...
public partial class MasterFiles_ProductView : System.Web.UI.Page
{
    ...
    private void FillProd()
    {
        ...
        else if (ddlSrch.SelectedValue == "8" && val != "")
        {
            dsProd = dv.getProdforMode(div_code, val);
        }
    ...
    private DataTable BindGridView()
    {
        ...
        else if (ddlProCatGrp.SelectedIndex > 0)
        {
            ...
            {
                dtGrid = dv.getDTProduct_Mode(div_code, ddlProCatGrp.SelectedValue);
            }
    ...
    private void FillMode(string div_code)
    {
        Division dv = new Division();
        dsmode = dv.getModePerDivision(div_code);
        if (dsmode.Tables[0].Rows.Count > 0)
        {

            ddlProCatGrp.DataTextField = "Product_Mode";
            ddlProCatGrp.DataValueField = "Product_Mode";
            ddlProCatGrp.DataSource = dsmode;
            ddlProCatGrp.DataBind();
        }
    }

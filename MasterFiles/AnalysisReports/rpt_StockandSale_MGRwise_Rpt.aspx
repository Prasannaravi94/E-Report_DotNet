<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_StockandSale_MGRwise_Rpt.aspx.cs"
    Inherits="MasterFiles_AnalysisReports_rpt_StockandSale_MGRwise_Rpt" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../JScript/Service_CRM/SecSale/rpt_StockandSale_MGR_JS.js" type="text/javascript"></script>
    <style type="text/css">
        .container {
            width: 100%;
            padding-right: 15px;
        ...
        .tooltip {
            ...
            .tooltip .tooltiptext {
                ...
                .tooltip .tooltiptext::after {
                    ...
                    border-width: 5px;
                    border-style: solid;
                    border-color: transparent #f7b15a transparent transparent;
                }

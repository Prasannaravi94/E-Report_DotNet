<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAutoExpense_RowWise_Cibeles_Resigned.aspx.cs" Inherits="MasterFiles_MR_RptAutoExpense" %>
...
<asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" CancelControlID="ImgAttachment" 
        ...
        <asp:Button ID="btnDrftSave" runat="server"  CssClass="BUTTON" Width="80px" Height="25px"
            ...
            Text="Send To HO" Visible="true" OnClientClick="saveOtherExp()" OnClick="btnSave_Click" />
                          <p runat="server" align="right"><asp:Button ID="bakfldfrce" runat="server" CssClass="BUTTON" Width="130px" Height="25px"
            Text="Delete" Visible="true" OnClientClick="saveOtherExp()" OnClick="btnField_Click" /></p>
    </center>
    </div>
    </div>

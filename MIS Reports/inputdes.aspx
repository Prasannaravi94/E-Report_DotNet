<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inputdes.aspx.cs" Inherits="MIS_Reports_inputdes" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, sf_name, cyear, cmonth, sCurrentDate) {
            popUpObj = window.open("inputdes1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&sCurrentDate=" + sCurrentDate,
      //"_blank",
    "ModalPopUp,"// +
    //"toolbar=no," +
    //"scrollbars=yes," +

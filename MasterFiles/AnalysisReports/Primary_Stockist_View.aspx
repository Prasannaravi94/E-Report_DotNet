<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Primary_Stockist_View.aspx.cs" Inherits="MasterFiles_AnalysisReports_Primary_Stockist_View" %>
<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Primary Stockist View</title>
     <style type="text/css">
        td.stylespc
        {
            padding-bottom: 5px;
        ...
        <script type="text/javascript">
            ...
            function showModalPopUp(fmon, fyr, tyear, tmonth) {
                ...
                popUpObj = window.open("rpt_Primary_Stockist_View.aspx?Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +

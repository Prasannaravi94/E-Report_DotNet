<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inputissued.aspx.cs" Inherits="MIS_Reports_inputissued" %>
...
<link type="text/css" rel="stylesheet" href="../../css/repstyle.css" />
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sfname) {
            ...
            popUpObj = window.open("inputmr.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sfname=" + sfname,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +

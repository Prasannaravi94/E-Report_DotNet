...
public partial class MasterFiles_Dashboard_Comprehensive : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MasterFiles/AnalysisReports/Rpt_EffortVsSales_Work_Analysis.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&Frm_Month=" + cmonth + "&Frm_year=" + cyear + "&To_Month=" + cmonth + "&To_year=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text +  "&div_code=" + div_code);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Analysis_Pob_count.aspx.cs" Inherits="MasterFiles_AnalysisReports_Analysis_Pob_count" %>
...
<head runat="server">
    <title>Drs/Chemists POB Report</title>
    <style type="text/css">
        .padding {
            padding: 3px;
        }
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name, div_code) {
            ...
            popUpObj = window.open("rptAnalysis_Pob_count.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name + " &div_code=" + div_code,
   "ModalPopUp"//,
   //"toolbar=no," +
   //"scrollbars=yes," +
   //"location=no," +
        ...
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                if ((frmMonth <= toMonth && parseInt(frmYear) === parseInt(toYear)) || (parseInt(frmYear) < parseInt(toYear) && (frmMonth <= toMonth || frmMonth >= toMonth))) {
                    ...
                    showModalPopUp(sf_Code, frmMonth, frmYear, toYear, toMonth, Name, div_code);
                }
                else {
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Drs/Chemists POB Report</h2>

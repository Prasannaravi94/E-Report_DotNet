...
//Added by Preethi
public partial class MasterFiles_Dashboard_Sales_DashBoard_Admin_Brand : System.Web.UI.Page
{
    #region Declaration
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/Sales_DashBoard_Admin_Brand.aspx?AppDashboard=" + "Yes");

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorBusinessValuewise_View.aspx.cs" Inherits="MIS_Reports_doctorbusview" %>
...
<head id="Head1" runat="server">
    <title>Doctor Business Valuewise - View</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sfname) {
            popUpObj = window.open("rpDoctorBusinessValuewise.aspx?sfcode=" + sfcode + " &sfname=" + sfname + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sfname,
                        "ModalPopUp"//,
                        //"toolbar=no," +
                        //"scrollbars=yes," +
                        //"location=no," +
        ...
        function showModalPopUp1(sfcode, fmon, fyr, tmon, tyr, sfname) {
            popUpObj1 = window.open("rpDoctorBusinessValuewise1.aspx?sf_code=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sfname + "&MR=1&Year=&Month=",
                    "ModalPopUp,"// +
                    //"toolbar=no," +
                    //"scrollbars=yes," +
                    //"location=no," +
            ...
            $('#btnGo').click(function () {
                ...
                if (FYea <= TYea) {
                    if (SMCode == 1) {
                        ...
                        showModalPopUp1(sfcode, FMont, FYea, TMont, TYea, sfname)
                    }
                    else if (SMCode == 3) {
                        var sfcode = $('#<%=ddlFieldForce.ClientID%> :selected').val();
                        var sfname = $('#<%=ddlFieldForce.ClientID%> :selected').text();
                        ...
                        showModalPopUp(sfcode, FMont, FYea, TMont, TYea, sfname)
                    }
                    ...
                    <div class="col-lg-5">
                        <center>
                            <table>
                                <tr>
                                    <td align="center">
                                        <h2 class="text-center">Doctor Business Valuewise - View</h2>
                                    </td>
                                </tr>
                            </table>
                        </center>

...
<tr>
<td align="left"   style="font-weight:bold;font-size:16px;font-face:Verdana" id="fieldforceId" runat="server"></td>
    <td>&nbsp;</td>
<td align="center" style="font-weight:bold;font-size:16px;font-face:Verdana" id="empId" runat="server"></td>
    <td>&nbsp;</td>
...
<asp:GridView ID="GridViewExcessfare" runat="server" Width="40%" Font-Name="Verdana"  Font-Size="8pt" 
            ...
            HeaderStyle-ForeColor="black" HorizontalAlign="Center" OnRowDataBound="grdExpense_RowDataBoundfare"
                                AutoGenerateColumns="false" EmptyDataText="No Records Found" GridLines="None"
                                PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
                                <HeaderStyle Font-Bold="true" />
                                <PagerStyle CssClass="pgr"></PagerStyle>

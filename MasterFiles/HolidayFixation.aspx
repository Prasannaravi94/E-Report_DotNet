    ...
    <div align="center">
        <asp:Panel ID="pnl" runat="server">
            ...
            <table border="1" cellpadding="5" cellspacing="5" id="tblLocationDtls" align="center"
                ...
                <tr>
                    <td rowspan="1" style="width: 379px; height: 10px" align="left">
                        ...
                        <asp:CheckBoxList ID="Chkstate" runat="server" DataTextField="StateName" DataValueField="State_Code"
                             RepeatDirection="Vertical" RepeatColumns="4" Width="800px"
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="btngo" runat="server" OnClientClick="return ValidateCheckBoxList()" Width="60px" Height="25px" Text="Go >>>" CssClass="savebutton" OnClick="btngo_onclick" />
                    </td>
                </tr>
                <tr>
        ...
        <asp:Panel ID="pnlholiday" BorderStyle="Solid" runat="server" Visible="false" CssClass="padd" >
            <table id="tblholiday" border="1px solid"  cellpadding="5" cellspacing="5" style=" border-collapse:collapse; border-width:1;
                ...
                Sl No
                    ...
                    <asp:Repeater ID="rptYearHeader" runat="server">
                        <ItemTemplate>
                            <td align="center" style="background-color: LightBlue; color: White; width: 130px;
                                border: 1px solid black">
                              <span style="color:BlueViolet; font-family:Verdana; font-size:12px; width:140px ">      
                              <asp:Literal ID="litYear" Text='<%#Eval("statename") %>' runat="server"></asp:Literal>
                              </span>
                            </td>
                        </ItemTemplate>
                    </asp:Repeater>
            ...
            <br />
            <center>
                <asp:Button ID="btnSave" runat="server" Width="60px" Height="25px" Text="Save" OnClick="btnSave_OnClick" CssClass="savebutton" />
                <br />

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EffortVsSales_Wok_Analysis.aspx.cs" Inherits="MasterFiles_AnalysisReports_EffortVsSales_Wok_Analysis" %>
...
<head id="Head1" runat="server">
    <title>Comprehensive Work Analysis</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name,div_code) {
            popUpObj = window.open("Rpt_EffortVsSales_Work_Analysis.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name+ " &div_code=" + div_code,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
    ...
    <form id="form1" runat="server">
        ...
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <h2 class="text-center" style="border-bottom: none">Comprehensive Work Analysis</h2>

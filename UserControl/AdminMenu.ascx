...
<script type="text/javascript">
    function SessionExpireAlert(timeout) {
        ...
        setTimeout(function () {
            window.location.replace("http://sansfa.info/");
        }, timeout);
    };
    ...
    <ul id="menu">
        ...
        <li><a href="#">Master &raquo;</a>
            <ul  runat="server" id="ul_myLst">
                <li id="LiDiv" runat="server"><a href="../../../MasterFiles/Division_ListAdmin.aspx" onclick="ShowProgress();">
                    Division</a> </li>
                <li id="Listate" runat="server"><a href="../../../MasterFiles/StateLocationList.aspx" onclick="ShowProgress();">
                    State/Location</a></li>
                
                <li id="lihoid" runat="server"><a href="../../../MasterFiles/HO_ID_View_admin.aspx" onclick="ShowProgress();">
                    <asp:Label ID="lblRoute" Text="HO ID Creation" runat="server"></asp:Label> </a></li>

              
                        <li id="Li2" runat="server">
                    <a href="../../../MasterFiles/Menu_Rights_View_admin.aspx" onclick="ShowProgress();">Menu Rights</a>
                    </li>
                         <li id="Li8" runat="server">
                    <a href="../Feed_Back_View.aspx" onclick="ShowProgress();">FeedBack Form View</a>
                    </li>   
                    ...
                    <table id="Table2" runat="server" width="100%" border="1">
                        <tr>
                            ...
                            <td align="right" class="style3" style="width: 55%">
                                <asp:Button ID="btnBack" runat="server" CssClass="savebutton" Height="25px" Width="60px"

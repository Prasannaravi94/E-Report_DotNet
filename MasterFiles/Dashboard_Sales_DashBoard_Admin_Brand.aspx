<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard_Sales_DashBoard_Admin_Brand.aspx.cs" Inherits="MasterFiles_Dashboard_Sales_DashBoard_Admin_Brand"
...
<body>
        ...
        <asp:UpdatePanel ID="upAdmDashboard" runat="server">
            <ContentTemplate>
                <nav class="navbar navbar-default">
                    <div class="container" style="margin-top: 12px;margin-left: 0px;">
                        <div class="row">
                ...
                <div id="main" class="container" style="margin-top: 12px;margin-left: 0px;height:200px;">
                    <div class="row">
                        <div class="col-sm-12" >
                                    ...
                                    <div class="row">
                                        <div class="container-fluid">
                                            <div class="table-responsive">
                                                <iframe id="ifmReviewRep" runat="server" style="border: 0px none; height: 700.9px;width:1350px;"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
     ...
     <script>
        $('iframe#ifmReviewRep').load(function () {
            //$("#ifmReviewRep").contents().find("#menumas").hide();
            $("#ifmReviewRep").contents().find("#btnback").hide();
        });
    </script>
    <script>

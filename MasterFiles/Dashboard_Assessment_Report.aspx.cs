...
public partial class MasterFiles_Assessment_Report : System.Web.UI.Page
{
    ...
    private void FillReport()
    {
        ...
        ifmReviewRep.Attributes.Add("src", "http://" + host + ":" + port + "/MIS Reports/rptMR_Assessment.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&Fyear=" + cyear + "&TMonth=" + cmonth + "&Tyear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&Dashboard=" + "1" + "&div_code=" + div_code);
        //ifmReviewRep.Attributes.Add("src", "http://" + host + "/MIS Reports/rptMR_Assessment.aspx?sfcode=" + ddlFieldForce.SelectedValue + "&FMonth=" + cmonth + "&Fyear=" + cyear + "&TMonth=" + cmonth + "&Tyear=" + cyear + "&sf_name=" + ddlFieldForce.SelectedItem.Text + "&div_code=" + div_code);
    }
    #endregion

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InputDatewise_Report.aspx.cs" Inherits="MIS_Reports_InputDatewise_Report" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, sf_name, FromDate, ToDate) {
            popUpObj = window.open("inputdesDatewiseZoom.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&FromDate=" + FromDate + "&ToDate=" + ToDate,
      //"_blank",
    "ModalPopUp,"// +
    //"toolbar=no," +
    //"scrollbars=yes," +
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="80%" align="center">
                            <asp:Label ID="lblHead" Text="Input Despatch View" CssClass="reportheader" runat="server"></asp:Label>
                        </td>
                        <td align="right">
                            <table>
                                <tr>

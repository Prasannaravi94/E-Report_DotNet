<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BulkEditTPStartDate.aspx.cs" EnableEventValidation="false" Inherits="MasterFiles_BulkEditTPStartDate" %>
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                ...
                <div class="row justify-content-center ">
                    <div class="col-lg-11">
                        <h2 class="text-center">Bulk Edit TP Start Date</h2>
                        ...
                        <div class="designation-reactivation-table-area clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-4">
                                        <div class="single-des clearfix">
                                            <asp:Label ID="lblTPStartDate" runat="server" Text="Starting Date" CssClass="label"></asp:Label>
                                            <asp:TextBox ID="txtTPStartDate" onkeypress="Calendar_enter(event);" TabIndex="1" runat="server" CssClass="input" Width="100%"></asp:TextBox>
                                    ...
                                    <div class="col-lg-2" style="padding-top: 19px; padding-left: 0px">
                                        <asp:Button ID="btnGo" TabIndex="2" runat="server" Width="120px" CssClass="savebutton" Text="Set Starting Date" OnClick="btnGo_Click" />
                                    </div>
                                    <div class="col-lg-1">
                                    </div>
                                    <div class="col-lg-4">
                                        ...
                                        <asp:DropDownList ID="ddlFilter" TabIndex="3" runat="server"  CssClass="custom-select2 nice-select"></asp:DropDownList>
                                    ...
                                    <div class="col-lg-1" style="padding-top: 17px; padding-left: 0px">
                                        <asp:Button ID="btnsrch" TabIndex="4" runat="server"  Text="Go" Width="50px" OnClick="btnsrch_Click" CssClass="savebutton" />
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center ">
                                ...
                                <asp:Label ID="lblSelect" Text="Select the Manager" runat="server" ForeColor="Red" Visible="false"></asp:Label>
                            </div>
                                    ...
                                    <asp:GridView ID="grdSalesForce" runat="server" Width="100%" HorizontalAlign="Center" EmptyDataText="No Records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="New TP Date">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtTPStDt" runat="server" onkeypress="Calendar_enter(event);" CssClass="input"></asp:TextBox>
                                                    <asp:CalendarExtender
                                                        ID="CalendarExtender1"
                                                        TargetControlID="txtTPStDt" Format="dd/MM/yyyy" CssClass="cal_Theme1"
                                                        runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <div class="div_fixed">
                                ...
                                <asp:Button ID="btnSave" runat="server" CssClass="savebutton" Visible="false" Text="Update" OnClick="btnSave_Click" />
                            </div>
                        </div>
                    </div>

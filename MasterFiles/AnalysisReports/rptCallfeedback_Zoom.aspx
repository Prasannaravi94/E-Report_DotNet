<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptCallfeedback_Zoom.aspx.cs"
    Inherits="MasterFiles_AnalysisReports_rptCallfeedback_Zoom" %>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <asp:Panel ID="pnlContents" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <asp:Label ID="lblFFName" runat="server" Text="Field Force Name" CssClass="label" Font-Size="16px"
                                            Visible="false"></asp:Label>
                                    </div>
                                    <div class="col-lg-4">
                                        <asp:Label ID="lblHQ1" runat="server" Text="HQ" CssClass="label" Font-Size="16px"
                                            Visible="false"></asp:Label>
                                    </div>
                                    <div class="col-lg-4">
                                        <asp:Label ID="lblDesignation1" runat="server" Text="Designation" CssClass="label" Font-Size="16px"
                                            Visible="false"></asp:Label>
                                    </div>
                                </div>

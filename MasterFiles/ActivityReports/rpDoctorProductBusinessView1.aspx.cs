...
public partial class MIS_Reports_dcview1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            lblProd.Text = "Listed_Doctor_Product_Business_Entry_View_for_the_Period_of_" + strMonthName + "_" + Year + "";
    ...
    private void LstdDrBusValue()
    {
        ...
        dsDr = dr.Trans_ListedDr_Bus_View(sf_code, div_code, Convert.ToInt16(Month), Convert.ToInt16(Year));

        DataSet ff = new DataSet();
       // ff = gg.getListedDrDiv_new(div_code, sf_code);

        ff = gg.getListedDrDiv_new_Inc(div_code, sf_code, Convert.ToInt16(Month), Convert.ToInt16(Year));
        ...
        if (dtDr.Rows.Count > 0)
        {
            ...
            lit_det_head_qua6.Text = "Business Value in Rs.";
            ...
            foreach (DataRow drdoctor in dtDr.Rows)
            {
                ...
                dsChemists = dr.ListedDrBus_value(sf_code, drdoctor["ListedDrCode"].ToString(), div_code, Convert.ToInt32(Month), Convert.ToInt32(Year), basedOn);
            ...
            {
                dsChemists = dr.ListedDrBus_value(sf_code, drFF["ListedDrCode"].ToString(), div_code, Convert.ToInt32(Month), Convert.ToInt32(Year), basedOn);
    ...
    private void FillLstDrwisePrd()
    {
        ...
        ListedDR dr = new ListedDR();
        dsSalesForce = dr.rpPrdwiseDrBusView(sfCode, divcode, Convert.ToInt32(Year), Convert.ToInt32(Month), basedOn);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            lit_DR_Qty.Text = "<center>Qty</center>";
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                lit_det_qty.Text = "&nbsp;" + drFF["Product_Quantity"].ToString();
    ...
    private void FillPrdwiseLstDr()
    {
        ...
        dsSalesForce = dr.rpDrwisePrdBusView(sfCode, divcode, Convert.ToInt32(Year), Convert.ToInt32(Month), state_code, basedOn);

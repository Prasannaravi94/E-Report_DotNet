...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Search() {
            ...
            SearchEmployees(txtSearch, chkFieldForce);
    ...
    <script type="text/javascript">
        function SearchEmployees(txtSearch, chkFieldForce) {
            if ($(txtSearch).val() != "") {
                var count = 0;
                $(chkFieldForce).children('tbody').children('tr').each(function () {
                    var match = false;
        ...
        <div class="container home-section-main-body position-relative clearfix">
                                ...
                                <asp:Panel ID="pnlCalendar" runat="server">
                                    ...
                                    <table id="tblTitle" runat="server" width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%"></td>
                                            <td>
                                                <asp:Button ID="btnLogin" Width="80px" Height="20px" runat="server" Text="LogOut" Font-Bold="true" ForeColor="Red" PostBackUrl="~/Index.aspx" /></td>
                                    ...
                                    <center>
                                        <div class="container home-section-main-body position-relative clearfix">
                                            <div>
                                                <table align="right" width="100%" style="margin-right: 35px; margin-bottom: 15px;">
                                                    ...
                                                    <asp:BalloonPopupExtender ID="BalloonPopupExtender1" runat="server" TargetControlID="lblNote"
                                                        BalloonPopupControlID="Panel1" Position="TopLeft" DisplayOnMouseOver="true" BalloonSize="Small">
                                                    </asp:BalloonPopupExtender>
                                                    <tr>
                                                        <td align="right" width="100%">
                                                            <asp:Label ID="lblStatingDate" Font-Size="14px" Visible="false" Font-Bold="true"
                                            ...
                                            <br />
                                            <div>
                                                <asp:Calendar ID="Calendar1" runat="server" DayNameFormat="Full" Width="1020px"
                                                    ...
                                                    <DayHeaderStyle BackColor="#F3F7FA" ForeColor="Black" CssClass="TextFont" BorderColor="#F3F7FA" Height="50" />

                                                    <DayStyle BackColor="#FFFFFF" Font-Names="'Roboto', sans-serif" BorderColor="SlateGray"
                                                        BorderWidth="1" Font-Bold="true" ForeColor="404040" CssClass="TextFont" />
                                                    ...
                                                    <SelectorStyle BackColor="DarkSeaGreen" ForeColor="Snow" Font-Names="Times New Roman Greek"
                                                        ...
                                                        VerticalAlign="Middle" />
                                                    <TitleStyle BackColor="#FFFFFF" ForeColor="Black" Height="35" Font-Size="Large"
                                                        BorderColor="#FFFFFF" CssClass="TextFont" />
                                        ...
                                        <div align="center">
                                            <asp:Button ID="btnApprove" CssClass="savebutton" runat="server" Height="25px" Visible="false" Width="90px" Text="Approve TP" OnClick="btnApprove_Click" OnClientClick="return progress();" />
                                            &nbsp
            
            <asp:Button ID="btnReject" CssClass="savebutton" runat="server" Height="25px" Visible="false" Text="Reject TP" Width="90px" OnClick="btnReject_Click" />
            ...
            <asp:TextBox ID="txtReason" Width="400" Height="45" Visible="false" TextMode="MultiLine"
                runat="server"></asp:TextBox>
                                            &nbsp
            <asp:Button ID="btnSendBack" CssClass="savebutton" Width="140px" Height="25px" runat="server" Visible="false" OnClientClick="return progress();"
                                    ...
                                    <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="269px" Width="800px"
                                        ...
                                        <table width="100%" style="border: Solid 3px #4682B4; width: 100%; height: 100%"
                                            ...
                                            runat="server" Width="300px"></asp:TextBox>--%>
                                                                        ...
                                                                        <asp:TextBox ID="txtFieldForce" runat="server" SkinID="TxtBxNumOnly" MaxLength="1" onfocus="this.style.backgroundColor='LavenderBlush'"
                                                                            onblur="this.style.backgroundColor='White'" Width="300px" TabIndex="28" CssClass="TEXTAREA"
                                                                        ...
                                                                        <asp:Panel ID="pnlFieldForce" runat="server" Height="200px" Width="300px" BorderStyle="Solid"
                                                                            BorderWidth="2px" Direction="LeftToRight" ScrollBars="Auto" BackColor="#CCCCCC"
                                                                            Style="display: none; text-transform: capitalize">
                                                                            <div style="height: 15px; position: relative; background-color: #4682B4; overflow-y: scroll; text-transform: capitalize; width: 100%; float: left"
                                                                                align="right">
                                                                                <asp:Button ID="Button2" BackColor="Yellow" Style="font-family: Verdana; height: 15px; font-size: 5pt; width: 20px; color: Black; margin-top: -1px;"
                                                                                    Text="X" runat="server" OnClick="btnCloseFF_Click"
                                                                                    OnClientClick="return HidePopupFF();" />
                                                                            </div>
                                                                            <br />
                                                                            <span class="deleteicon">
                                                                                <input type="text" class="deletable" id="txtSearch" onkeyup="SearchEmployees(this,'#chkFieldForce');">

                                                                                <span onclick="Search()">x</span>
                                                                            </span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:UpdatePanel ID="updatepanel1" runat="server">
                                                        <ContentTemplate>
                                                            <%-- <asp:TextBox ID="txtTerritory" onkeypress="CheckNumeric(event);" SkinID="MandTxtBox" runat="server" Width="300px"></asp:TextBox>--%>
                                                            <asp:TextBox ID="txtTerritory" MaxLength="1" SkinID="MandTxtBox" onkeypress="CheckNumeric(event);" runat="server" Width="300px"></asp:TextBox>
                                                            ...
                                                            <asp:Panel ID="pnlTerritory" runat="server" Height="150px" Width="300px" BorderStyle="Solid"
                                                                BorderWidth="2px" Direction="LeftToRight" Font-Bold="true" ScrollBars="Auto"
                                                                BackColor="#FCFCFC" Style="display: none">
                                                                <div style="height: 15px; position: relative; background-color: #4682B4; overflow-y: scroll; text-transform: capitalize; width: 100%; float: left"
                                                                    align="right">
                                                                    <asp:Button ID="Button1" BackColor="Yellow" Style="font-family: Verdana; font-size: 5pt; width: 20px; color: Black; margin-top: -1px;"
                                                                        Text="X" runat="server"

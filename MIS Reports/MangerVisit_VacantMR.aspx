<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MangerVisit_VacantMR.aspx.cs" Inherits="MIS_Reports_MangerVisit_VacantMR" %>
...
<head runat="server">
    <title>Manager - Visit  (for Vacant HQ's) </title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, sf_name) {
            ...
            popUpObj = window.open("Visit_Details_Vacant_MR_Drs_To_MGR_VST_Report.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&sf_name=" + sf_name,
    "ModalPopUp"//,
    //"toolbar=no," +
    //"scrollbars=yes," +
    //"location=no," +
    ...
    //"top=0"
            ...
            $(popUpObj.document.body).ready(function () {
                ...
                var ImgSrc = "https://s18.postimg.org/57u1gfiqh/tumblr_n5w885r5s_Z1qlc1r4o1_500.gif"
                $(popUpObj.document.body).append('<div><p style="color:orange;">Loading Please Wait.....</p></div><div class="preload"> <img src="' + ImgSrc + '"  style=" width:550px; height: 300px;position: fixed;top: 20%;left: 20%;"  alt="" /></div>');
            });
        }

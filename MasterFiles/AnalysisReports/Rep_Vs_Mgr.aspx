<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rep_Vs_Mgr.aspx.cs" Inherits="MasterFiles_AnalysisReports_Rep_Vs_Mgr" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, sf_name) {
            ...
            popUpObj = window.open("Rpt_Rep_Vs_Mgr.aspx?sf_code=" + sfcode + "&FMonth=" + fmon + "&Fyear=" + fyr + "&sf_name=" + sf_name,
  "ModalPopUp"//,
  //"toolbar=no," +
  //"scrollbars=yes," +
  //"location=no," +
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                ...
                var MonYear = document.getElementById('<%=txtMonthYear.ClientID%>').value.split('-');
                var Month1 = new Date(MonYear[0] + '-1-01').getMonth() + 1 == "NaN" ? new Date(MonYear[0] + '-1-01').getMonth() + 1 :
                    new Date(MonYear[0] + '01, 0001').getMonth() + 1;
                var Year1 = MonYear[1];
        ...
        <div>
            ...
            <div class="container home-section-main-body position-relative clearfix">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <h2 class="text-center">Rep Vs Manager</h2>

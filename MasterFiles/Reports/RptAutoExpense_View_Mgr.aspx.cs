...
using Bus_EReport;
public partial class MasterFiles_Reports_RptAutoExpense_View_Mgr : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (dsSf.Tables[0].Rows.Count > 0)
        {
            ...
            empId.InnerHtml = "Employee Code :" + dsSf.Tables[0].Rows[0].ItemArray.GetValue(3);
        }
        else
        {
        ...
        DataTable t1 = Exp.getSavedRecord(monthId, yearID, sfcode);

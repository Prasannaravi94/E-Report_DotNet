    ...
    <ucl:Menu ID="menu1" runat="server" />
        <div class="container home-section-main-body position-relative clearfix">
            <div class="row justify-content-center">
                <div class="col-lg-11">
                    <br />
                    <h2 class="text-center">Doctor Category Reactivation</h2>
                    <div class="display-table clearfix">
                        <div class="table-responsive">
                            <asp:GridView ID="grdDocCat" runat="server" Width="70%" HorizontalAlign="Center" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Short Name" ItemStyle-HorizontalAlign="Left">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtDoc_Cat_SName" runat="server" CssClass="input" Text='<%# Bind("Doc_Cat_SName") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Category Name" ItemStyle-HorizontalAlign="Left">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtDocCatName" CssClass="input" runat="server" MaxLength="100" Text='<%# Bind("Doc_Cat_Name") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>

    ...
    private void FillDr()
    {
        ...
        else if (Type == "1")
        {
            ...
            if (sf_code != "0")
            {
                ...
                dsDr = dr.getDr_Pro_Exp_categ_new(div_code, sf_code, Convert.ToInt16(Year), Convert.ToInt16(Month), Convert.ToInt16(Prod), sCurrentDate, Convert.ToInt16(Doc_SpeCat_Code)); //sujee
            }
            else
            {
                Sf_Code_multiple = Session["Sf_Code_multiple"].ToString();
